		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MySQLQuerierException.php" class="cssmenu-title">MySQLQuerierException</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MySQLQuerierException</h2></header>
		<div class="content">
...
<span>Throwable</span>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>MySQLQuerierException</span></b>					
