		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AbstractSelectQueryResult.php" class="cssmenu-title">AbstractSelectQueryResult</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractSelectQueryResult</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class encapsulate a query result set</p>
			</div>
...
<b><span>AbstractSelectQueryResult</span></b>					
					 implements 
...
<a href="source-class-AbstractSelectQueryResult.php#16-19" title="Go to source code">__construct</a>( <span> <var>$query</var></span>, <span>array <var>$parameters</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractQueryResult.php#___construct">AbstractQueryResult::__construct()</a></code></div>
...
<a href="source-class-AbstractSelectQueryResult.php#38-41" title="Go to source code">needs_rewind</a>( )
			...
			<div class="responsive-table">
				...
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-SelectQueryResult.php#methods">SelectQueryResult</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-SelectQueryResult.php#_dispose">dispose()</a>, 
									<a href="class-SelectQueryResult.php#_get_rows_count">get_rows_count()</a>, 
									<a href="class-SelectQueryResult.php#_set_fetch_mode">set_fetch_mode()</a>
							</code>
						</td>
					</tr>
				</table>
