		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-DefaultMailService.php" class="cssmenu-title">DefaultMailService</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DefaultMailService</h2></header>
		<div class="content">
			...
			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractPHPMailerMailService.php"><span>AbstractPHPMailerMailService</span></a>
...
<b><span>DefaultMailService</span></b>					
...
<a href="source-class-DefaultMailService.php#18-21" title="Go to source code">set_send_settings</a>( <span>PHPMailer\PHPMailer\PHPMailer <var>$mailer</var></span> )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractPHPMailerMailService.php#methods">AbstractPHPMailerMailService</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractPHPMailerMailService.php#_get_mail_checking_raw_regex">get_mail_checking_raw_regex()</a>, 
									<a href="class-AbstractPHPMailerMailService.php#_get_mail_checking_regex">get_mail_checking_regex()</a>, 
									<a href="class-AbstractPHPMailerMailService.php#_is_mail_valid">is_mail_valid()</a>, 
									<a href="class-AbstractPHPMailerMailService.php#_send">send()</a>, 
									<a href="class-AbstractPHPMailerMailService.php#_send_from_properties"><span class="deprecated">send_from_properties()</span></a>, 
									<a href="class-AbstractPHPMailerMailService.php#_try_to_send">try_to_send()</a>
							</code>
						</td>
					</tr>
				</table>
