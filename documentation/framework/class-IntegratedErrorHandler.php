		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-IntegratedErrorHandler.php" class="cssmenu-title">IntegratedErrorHandler</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>IntegratedErrorHandler</h2></header>
		<div class="content">
			...
			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-ErrorHandler.php"><span>ErrorHandler</span></a>
...
<b><span>IntegratedErrorHandler</span></b>					
		...
		<div class="content">
			...
			<tr data-order="display_debug" id="_display_debug">
...
<a href="source-class-IntegratedErrorHandler.php#15-18" title="Go to source code">display_debug</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-ErrorHandler.php#_display_debug">ErrorHandler::display_debug()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="display_fatal" id="_display_fatal">
...
<a href="source-class-IntegratedErrorHandler.php#20-24" title="Go to source code">display_fatal</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-ErrorHandler.php#_display_fatal">ErrorHandler::display_fatal()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-ErrorHandler.php#methods">ErrorHandler</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-ErrorHandler.php#_add_error_in_log">add_error_in_log()</a>, 
									<a href="class-ErrorHandler.php#_get_errno_class">get_errno_class()</a>, 
									<a href="class-ErrorHandler.php#_get_stackstrace_as_string">get_stackstrace_as_string()</a>, 
									<a href="class-ErrorHandler.php#_handle">handle()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-ErrorHandler.php#constants">ErrorHandler</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-ErrorHandler.php#FATAL_MESSAGE"><b>FATAL_MESSAGE</b></a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-ErrorHandler.php#properties">ErrorHandler</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-ErrorHandler.php#$errclass"><var>$errclass</var></a>, 
									<a href="class-ErrorHandler.php#$errdesc"><var>$errdesc</var></a>, 
									<a href="class-ErrorHandler.php#$errfile"><var>$errfile</var></a>, 
									<a href="class-ErrorHandler.php#$errline"><var>$errline</var></a>, 
									<a href="class-ErrorHandler.php#$errno"><var>$errno</var></a>, 
									<a href="class-ErrorHandler.php#$exception"><var>$exception</var></a>, 
									<a href="class-ErrorHandler.php#$fatal"><var>$fatal</var></a>, 
									<a href="class-ErrorHandler.php#$stacktrace"><var>$stacktrace</var></a>
							</code>
						</td>
					</tr>
				</table>
