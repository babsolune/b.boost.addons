		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MySQLQuerier.php" class="cssmenu-title">MySQLQuerier</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MySQLQuerier</h2></header>
		<div class="content">
			...
			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractSQLQuerier.php"><span>AbstractSQLQuerier</span></a>
...
<a href="source-class-MySQLQuerier.php#20-24" title="Go to source code">__construct</a>( <span><code><a href="class-DBConnection.php">DBConnection</a></code> <var>$connection</var></span>, <span><code><a href="class-SQLQueryTranslator.php">SQLQueryTranslator</a></code> <var>$translator</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractSQLQuerier.php#___construct">AbstractSQLQuerier::__construct()</a></code></div>
...
<a href="source-class-MySQLQuerier.php#38-41" title="Go to source code">escape</a>( <span> <var>$value</var></span> )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractSQLQuerier.php#methods">AbstractSQLQuerier</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractSQLQuerier.php#_disable_query_translator">disable_query_translator()</a>, 
									<a href="class-AbstractSQLQuerier.php#_enable_query_translator">enable_query_translator()</a>, 
									<a href="class-AbstractSQLQuerier.php#_get_executed_requests_count">get_executed_requests_count()</a>, 
									<a href="class-AbstractSQLQuerier.php#_get_link">get_link()</a>, 
									<a href="class-AbstractSQLQuerier.php#_prepare">prepare()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-AbstractSQLQuerier.php#properties">AbstractSQLQuerier</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractSQLQuerier.php#$link"><var>$link</var></a>
							</code>
						</td>
					</tr>
				</table>
