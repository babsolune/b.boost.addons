		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormFieldMultipleValuedCheckboxOption.php" class="cssmenu-title">FormFieldMultipleValuedCheckboxOption</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormFieldMultipleValuedCheckboxOption</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a>\<a href="package-Builder.Form.field.php">field</a>\<a href="package-Builder.Form.field.enum.php">enum</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormFieldMultipleValuedCheckboxOption.php#3-28" title="Go to source code">builder/form/field/enum/FormFieldMultipleValuedCheckboxOption.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-FormFieldMultipleCheckboxOption.php"><span>FormFieldMultipleCheckboxOption</span></a>
...
<b><span>FormFieldMultipleValuedCheckboxOption</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldMultipleValuedCheckboxOption.php#18-22" title="Go to source code">__construct</a>( <span> <var>$id</var></span>, <span> <var>$label</var></span>, <span> <var>$value</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-FormFieldMultipleCheckboxOption.php#___construct">FormFieldMultipleCheckboxOption::__construct()</a></code></div>
			...
			<tr data-order="get_value" id="_get_value">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldMultipleValuedCheckboxOption.php#24-27" title="Go to source code">get_value</a>( )
						</code>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-FormFieldMultipleCheckboxOption.php#methods">FormFieldMultipleCheckboxOption</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-FormFieldMultipleCheckboxOption.php#_get_id">get_id()</a>, 
									<a href="class-FormFieldMultipleCheckboxOption.php#_get_label">get_label()</a>
							</code>
						</td>
					</tr>
				</table>
