<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ObjectNotFoundException.php" class="cssmenu-title">ObjectNotFoundException</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ObjectNotFoundException</h2></header>
		<div class="content">
...
<b><span>ObjectNotFoundException</span></b>					
