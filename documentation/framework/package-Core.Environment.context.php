...
<section id="content">
	<header>
		<h1>Package <a href="package-Core.php">Core</a>\<a href="package-Core.Environment.php">Environment</a>\context</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-Core.php">Core</a>\<a href="package-Core.Environment.php">Environment</a>\context</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-AppContext.php">AppContext</a></td>
	<td class="ellipsis"><p>This class manages all the environment services.
It's able to create each of them and return them.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-PersistenceContext.php">PersistenceContext</a></td>
	<td class="ellipsis"><p>This class manages all the environment services.
It's able to create each of them and return them.</p></td>
</tr>
	</table>
