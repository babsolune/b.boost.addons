		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-BufferedFileWriter.php" class="cssmenu-title">BufferedFileWriter</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>BufferedFileWriter</h2></header>
		<div class="content">
...
<b><span>BufferedFileWriter</span></b>					
					 implements 
						<a href="class-FileWriter.php"><span>FileWriter</span></a>
...
<a href="source-class-BufferedFileWriter.php#32-43" title="Go to source code">append</a>( <span> <var>$content</var></span> )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><code><a href="class-FileWriter.php#_append">FileWriter::append()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
