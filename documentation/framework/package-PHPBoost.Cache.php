...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\Cache</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\Cache</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-AdministratorAlertCache.php">AdministratorAlertCache</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-CommentsCache.php">CommentsCache</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ExtendedFieldsCache.php">ExtendedFieldsCache</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-GroupsCache.php">GroupsCache</a></td>
	<td class="ellipsis">This class contains the cache data of the groups which group users having common criteria.</td>
</tr>
<tr>
	<td class="name"><a href="class-HtaccessFileCache.php">HtaccessFileCache</a></td>
	<td class="ellipsis"><p>This class contains the cache data of the .htaccess file which is located at the root of the site
and is used to change the Apache configuration only in the PHPBoost folder.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-MenusCache.php">MenusCache</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-SmileysCache.php">SmileysCache</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-StatsCache.php">StatsCache</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-UnreadContributionsCache.php">UnreadContributionsCache</a></td>
	<td class="ellipsis"><p>This cache is used to know if there are unread contributions.
If there are, it's able to tell us how much there are for the administrator, and for the other
types of users, it's only able to tell if there are unread contributions.</p></td>
</tr>
	</table>
</div>
