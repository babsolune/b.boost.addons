		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-DispatcherUrlMapping.php" class="cssmenu-title">DispatcherUrlMapping</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DispatcherUrlMapping</h2></header>
		<div class="content">
			...
			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-UrlMapping.php"><span>UrlMapping</span></a>
...
<b><span>DispatcherUrlMapping</span></b>					
...
<a href="source-class-DispatcherUrlMapping.php#20-48" title="Go to source code">__construct</a>( <span><code><a href="class-UrlMapping.php">UrlMapping</a>[]</code> <var>$dispatcher_name</var></span>, <span> <var>$match</var> = <span class="php-quote">'([\w/_-]*)$'</span></span>, <span> <var>$from_path</var> = <span class="php-quote">''</span></span>, <span> <var>$redirect_path</var> = <span class="php-quote">''</span></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$dispatcher_name</var></dt>
									<dd>$mappings</dd>
									<dt><var>$match</var></dt>
									<dd></dd>
									<dt><var>$from_path</var></dt>
									<dd></dd>
									<dt><var>$redirect_path</var></dt>
									<dd></dd>
								</dl></div>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-UrlMapping.php#___construct">UrlMapping::__construct()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="is_high_priority" id="_is_high_priority">
...
<a href="source-class-DispatcherUrlMapping.php#50-56" title="Go to source code">is_high_priority</a>( )
							...
							<div class="description short">
								<p>Check if the Url must be placed in high priority in the .htaccess file</p>
							</div>
			...
			<tr data-order="is_low_priority" id="_is_low_priority">
...
<a href="source-class-DispatcherUrlMapping.php#58-64" title="Go to source code">is_low_priority</a>( )
							...
							<div class="description short">
								<p>Check if the Url must be placed in low priority in the .htaccess file</p>
							</div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-UrlMapping.php#methods">UrlMapping</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-UrlMapping.php#_from">from()</a>, 
									<a href="class-UrlMapping.php#_options">options()</a>, 
									<a href="class-UrlMapping.php#_to">to()</a>
							</code>
						</td>
					</tr>
				</table>
