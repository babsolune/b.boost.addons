...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Member.php">Member</a>\extended-fields</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Member.php">Member</a>\extended-fields</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-PHPBoost.Member.extended.fields.field.php">PHPBoost\Member\extended-fields\field</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-ExtendedField.php">ExtendedField</a></td>
	<td class="ellipsis">This class represente a extended field</td>
</tr>
<tr>
	<td class="name"><a href="class-ExtendedFields.php">ExtendedFields</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ExtendedFieldsDatabaseService.php">ExtendedFieldsDatabaseService</a></td>
	<td class="ellipsis"><p>This class is responsible of all database accesses implied by the extended fields management.
Indeed, for instance when a field is created, the data base structure must be updated throw an ALTER request.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-ExtendedFieldsService.php">ExtendedFieldsService</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-MemberExtendedField.php">MemberExtendedField</a></td>
	<td class="ellipsis">This class represente a member extended field</td>
</tr>
<tr>
	<td class="name"><a href="class-MemberExtendedFieldsService.php">MemberExtendedFieldsService</a></td>
	<td class="ellipsis">This class is responsible for updated, displayed and registed of member extended fields.</td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-ExtendedFieldExtensionPoint.php">ExtendedFieldExtensionPoint</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
