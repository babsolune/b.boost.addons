		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-TemplateLoadingException.php" class="cssmenu-title">TemplateLoadingException</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>TemplateLoadingException</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\<a href="package-IO.Template.loader.php">loader</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-TemplateLoadingException.php#3-24" title="Go to source code">io/template/loader/TemplateLoadingException.class.php</a></span>
			</div>

			<div class="description">
				<p>This exception is thrown when the template cannot been loaded.</p>
			</div>
...
<b><span>TemplateLoadingException</span></b>					
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-FileTemplateLoadingException.php">FileTemplateLoadingException</a>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-TemplateLoadingException.php#16-23" title="Go to source code">__construct</a>( <span>string <var>$message</var></span> )
						</code>
