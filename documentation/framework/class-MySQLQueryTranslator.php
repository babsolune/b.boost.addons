<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-MySQLQueryTranslator.php" class="cssmenu-title">MySQLQueryTranslator</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MySQLQueryTranslator</h2></header>
		<div class="content">
...
<b><span>MySQLQueryTranslator</span></b>					
					 implements 
						<a href="class-SQLQueryTranslator.php"><span>SQLQueryTranslator</span></a>
...
<a href="source-class-MySQLQueryTranslator.php#23-30" title="Go to source code">translate</a>( <span>string <var>$query</var></span> )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><code><a href="class-SQLQueryTranslator.php#_translate">SQLQueryTranslator::translate()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
