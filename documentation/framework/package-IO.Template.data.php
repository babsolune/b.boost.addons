...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\data</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\data</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-DefaultTemplateData.php">DefaultTemplateData</a></td>
	<td class="ellipsis">This class is a default implementation of the <code><a href="class-TemplateData.php">TemplateData</a></code> interface.</td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-TemplateData.php">TemplateData</a></td>
	<td class="ellipsis"><p>This interface describes data which are assigned to a template. There are two types of data:</p>
...
same loop identifier for each loop iteration. Loops can be nested and embed both variables and subtemplates.</p></td>
</tr>
	</table>
</div>
