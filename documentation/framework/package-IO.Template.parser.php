...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\parser</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\parser</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-IO.Template.parser.syntax.php">IO\Template\parser\syntax</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-AbstractTemplateParser.php">AbstractTemplateParser</a></td>
	<td class="ellipsis">This is an abstract implementation of the <code><a href="class-TemplateParser.php">TemplateParser</a></code> interface.</td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-TemplateParser.php">TemplateParser</a></td>
	<td class="ellipsis"><p>This interfaces represents a class that is able to parse a template source and transform it
to a syntax that the PHP engine is able to run.</p></td>
</tr>
	</table>
</div>
