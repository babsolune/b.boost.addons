		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ContentFormattingUnparser.php" class="cssmenu-title">ContentFormattingUnparser</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ContentFormattingUnparser</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Formatting.php">Formatting</a>\<a href="package-Content.Formatting.parser.php">parser</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 06 18
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<div class="description">
				<p>This class is an abstract class. It contains the common elements needed by all the unparsers of PHPBoost.</p>
			</div>
...
<b><span>ContentFormattingUnparser</span></b>					
...
<a href="source-class-ContentFormattingUnparser.php#19-25" title="Go to source code">__construct</a>( )
							...
							<div class="description short">
								<p>Builds a ContentFormattingUnparser class.</p>
							</div>
			...
			<tr data-order="unparse_html" id="_unparse_html">
...
<a href="source-class-ContentFormattingUnparser.php#27-88" title="Go to source code">unparse_html</a>( <span>boolean <var>$action</var></span> )
							...
							<div class="description short">
								<p>Unparses the html code. In a first time, it pick the html tags up, and then, when you have done all the processings you wanted, you reimplant it.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Unparses the html code. In a first time, it pick the html tags up, and then, when you have done all the processings you wanted, you reimplant it.</p>
								...
								<div class="list"><dl>
									...
									<dd>self::PICK_UP if you want to pick up the html tag and self::REIMPLANT to reimplant it.</dd>
								</dl></div>
			...
			<tr data-order="unparse_code" id="_unparse_code">
...
<a href="source-class-ContentFormattingUnparser.php#90-146" title="Go to source code">unparse_code</a>( <span>boolean <var>$action</var></span> )
							...
							<div class="description short">
								<p>Unparses the code tag. In a first time, you pick it up and you reimplant it.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Unparses the code tag. In a first time, you pick it up and you reimplant it.</p>
								...
								<div class="list"><dl>
									<dt><var>$action</var></dt>
									<dd>self::PICK_UP to pick the code tag up, self::REIMPLANT to reinsert them.</dd>
								</dl></div>
