<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-Lang.php" class="cssmenu-title">Lang</a></li>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>This class represents a lang</p>
			</div>
			...
			<tr data-order="get_configuration" id="_get_configuration">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-LangConfiguration.php">LangConfiguration</a></code>
...
<a href="source-class-Lang.php#69-76" title="Go to source code">check_auth</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="ACCES_LANG" id="ACCES_LANG">
						...
						<td class="value">
							<div>
								<a href="#ACCES_LANG" class="anchor">#</a>
