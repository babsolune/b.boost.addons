		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ValidationResult.php" class="cssmenu-title">ValidationResult</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ValidationResult</h2></header>
		<div class="content">
...
<a href="source-class-ValidationResult.php#30-33" title="Go to source code">get_title</a>( )
			...
			<tr data-order="add_error" id="_add_error">
...
<a href="source-class-ValidationResult.php#35-42" title="Go to source code">add_error</a>( <span>string <var>$error_msg</var></span> )
						...
						<div class="description detailed hidden">
							<p>Adds an error message</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$error_msg</var></dt>
									<dd>the error message to add</dd>
								</dl></div>
			...
			<tr data-order="get_errors_messages" id="_get_errors_messages">
...
<a href="source-class-ValidationResult.php#44-51" title="Go to source code">get_errors_messages</a>( )
							...
							<div class="description short">
								<p>Returns the list of the errors messages</p>
							</div>
			...
			<tr data-order="has_errors" id="_has_errors">
...
<p>if there is errors</p>
								...
								<h6>Returns</h6>
								<div class="list">
									boolean<br><pre><span class="php-keyword1">true</span></pre>
