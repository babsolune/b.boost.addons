...
<section id="content">
	<header>
		<h1>Package <a href="package-MVC.php">MVC</a>\Dispatcher</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-MVC.php">MVC</a>\Dispatcher</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-AbstractUrlMapper.php">AbstractUrlMapper</a></td>
	<td class="ellipsis">Call the controller method matching an url</td>
</tr>
<tr>
	<td class="name"><a href="class-Dispatcher.php">Dispatcher</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-DispatcherUrlMapping.php">DispatcherUrlMapping</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-DispatchManager.php">DispatchManager</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-UrlControllerMapper.php">UrlControllerMapper</a></td>
	<td class="ellipsis">Call the controller method matching an url</td>
</tr>
<tr>
	<td class="name"><a href="class-UrlMapping.php">UrlMapping</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-UrlMappings.php">UrlMappings</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-UrlRedirectMapper.php">UrlRedirectMapper</a></td>
	<td class="ellipsis">Redirect to the an url</td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-UrlMapper.php">UrlMapper</a></td>
	<td class="ellipsis">Call the controller method matching an url</td>
</tr>
<tr>
	<td class="name"><a href="class-UrlMappingsExtensionPoint.php">UrlMappingsExtensionPoint</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-DispatcherException.php">DispatcherException</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-MalformedUrlMapperRegexException.php">MalformedUrlMapperRegexException</a></td>
	<td class="ellipsis">The regular expression that the controller have to match is malformed</td>
</tr>
<tr>
	<td class="name"><a href="class-NoSuchControllerException.php">NoSuchControllerException</a></td>
	<td class="ellipsis"><p>The specified method of the controller from the UrlDispatcherItem
matching the url does not exists</p></td>
</tr>
<tr>
	<td class="name"><a href="class-NoUrlMatchException.php">NoUrlMatchException</a></td>
	<td class="ellipsis">No UrlDispatcherItem were found matching the given url</td>
</tr>
	</table>
</div>
