		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-PDOMySQLDBFactory.php" class="cssmenu-title">PDOMySQLDBFactory</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>PDOMySQLDBFactory</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a>\<a href="package-IO.DB.factory.php">factory</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-PDOMySQLDBFactory.php#3-36" title="Go to source code">io/db/factory/PDOMySQLDBFactory.class.php</a></span>
			</div>
...
<b><span>PDOMySQLDBFactory</span></b>					
					 implements 
			...
			<tr data-order="new_db_connection" id="_new_db_connection">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-PDOMySQLDBFactory.php#17-20" title="Go to source code">new_db_connection</a>( )
						</code>
			...
			<tr data-order="new_sql_querier" id="_new_sql_querier">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-PDOMySQLDBFactory.php#22-25" title="Go to source code">new_sql_querier</a>( <span><code><a href="class-DBConnection.php">DBConnection</a></code> <var>$db_connection</var></span> )
						</code>
			...
			<tr data-order="new_dbms_util" id="_new_dbms_util">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-PDOMySQLDBFactory.php#27-30" title="Go to source code">new_dbms_util</a>( <span><code><a href="class-SQLQuerier.php">SQLQuerier</a></code> <var>$querier</var></span> )
						</code>
