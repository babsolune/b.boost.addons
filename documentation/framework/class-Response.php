<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-Response.php" class="cssmenu-title">Response</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
		...
		<div class="content">
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractResponse.php">AbstractResponse</a>, 
					<a href="class-JSONResponse.php">JSONResponse</a>
			</div>
			...
			<tr data-order="send" id="_send">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-Response.php#_send">Response::send()</a></code>
...
<a href="source-class-Response.php#15-18" title="Go to source code">send</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-Response.php#_send">Response::send()</a></code><br>the response to the browser
								</div>
