		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MiniCalendar.php" class="cssmenu-title">MiniCalendar</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MiniCalendar</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class enables you to retrieve easily a date entered by a user.
If the user isn't in the same timezone as the server, the hour will be automatically recomputed.</p>
			</div>
...
<a href="source-class-MiniCalendar.php#41-52" title="Go to source code">__construct</a>( <span>string <var>$html_id</var></span>, <span><code><a href="class-Date.php">Date</a></code> <var>$date</var> = <span class="php-keyword1">null</span></span> )
							...
							<div class="description short">
								<p>Builds a calendar which will be displayable.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Builds a calendar which will be displayable.</p>
								...
								<div class="list"><dl>
									...
									<dd><p>$form_name Name of the mini calendar in the HTML code (you will retrieve the data in that field).
This name must be a HTML identificator.</p></dd>
									<dt><var>$date</var></dt>
									<dd></dd>
								</dl></div>
...
<a href="source-class-MiniCalendar.php#54-61" title="Go to source code">set_date</a>( <span><code><a href="class-Date.php">Date</a></code> <var>$date</var></span> )
							...
							<div class="description short">
								<p>Sets the date at which will be initialized the calendar.</p>
							</div>
			...
			<tr data-order="set_style" id="_set_style">
...
<a href="source-class-MiniCalendar.php#63-72" title="Go to source code">set_style</a>( <span>string <var>$style</var></span> )
							...
							<div class="description short">
								<p>Sets the CSS properties of the element.
...
The template used is framework/mini_calendar.tpl.</p>
							</div>
...
<a href="source-class-MiniCalendar.php#74-81" title="Go to source code">get_date</a>( )
						...
						<div class="description detailed hidden">
							<p>Returns the date</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-Date.php">Date</a></code><br>the date
								</div>
...
<a href="source-class-MiniCalendar.php#83-107" title="Go to source code">display</a>( )
							...
							<div class="description short">
								<p>Displays the mini calendar. You must call the display method in the same order as the calendars are displayed, because it requires a javascript code loading.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Displays the mini calendar. You must call the display method in the same order as the calendars are displayed, because it requires a javascript code loading.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>The code to write in the HTML page.
								</div>
			...
			<tr data-order="retrieve_date" id="_retrieve_date">
...
<a href="source-class-MiniCalendar.php#109-118" title="Go to source code">retrieve_date</a>( <span>string <var>$calendar_name</var></span> )
							...
							<div class="description short">
								<p>Retrieves a date entered in a mini calendar.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Retrieves a date entered in a mini calendar.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$calendar_name</var></dt>
									<dd>Name of the calendar (HTML identifier).</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-Date.php">Date</a></code><br>The date of the calendar.
								</div>
