		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AbstractRichCategoriesFormController.php" class="cssmenu-title">AbstractRichCategoriesFormController</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractRichCategoriesFormController</h2></header>
		<div class="content">
			...
			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractController.php"><span>AbstractController</span></a>
					
					 implements 
						<a href="class-Controller.php"><span>Controller</span></a>
					
					
				</dd>
				<dd style="padding-left:30px">
					<img src="resources/inherit.png" alt="Extended by">
					<a href="class-ModuleController.php"><span>ModuleController</span></a>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
					<a href="class-AbstractCategoriesFormController.php"><span>AbstractCategoriesFormController</span></a>
				...
				<dd style="padding-left:90px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>AbstractRichCategoriesFormController</span></b>					
		...
		<div class="content">
			...
			<tr data-order="get_options_fields" id="_get_options_fields">
...
<a href="source-class-AbstractRichCategoriesFormController.php#17-22" title="Go to source code">get_options_fields</a>( <span><code><a href="class-FormFieldset.php">FormFieldset</a></code> <var>$fieldset</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractCategoriesFormController.php#_get_options_fields">AbstractCategoriesFormController::get_options_fields()</a></code></div>
...
<a href="source-class-AbstractRichCategoriesFormController.php#24-29" title="Go to source code">set_properties</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractCategoriesFormController.php#_set_properties">AbstractCategoriesFormController::set_properties()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractCategoriesFormController.php#methods">AbstractCategoriesFormController</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractCategoriesFormController.php#_build_form">build_form()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_check_authorizations">check_authorizations()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_execute">execute()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_generate_response">generate_response()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_get_add_category_url">get_add_category_url()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_get_authorizations_settings">get_authorizations_settings()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_get_categories_management_url">get_categories_management_url()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_get_categories_manager">get_categories_manager()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_get_category">get_category()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_get_edit_category_url">get_edit_category_url()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_get_id_category">get_id_category()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_get_module_home_page_title">get_module_home_page_title()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_get_module_home_page_url">get_module_home_page_url()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_get_success_message">get_success_message()</a>, 
									<a href="class-AbstractCategoriesFormController.php#_get_title">get_title()</a>
							</code>
						</td>
					</tr>
				</table>
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-ModuleController.php#methods">ModuleController</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-ModuleController.php#_get_right_controller_regarding_authorizations">get_right_controller_regarding_authorizations()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-AbstractCategoriesFormController.php#properties">AbstractCategoriesFormController</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractCategoriesFormController.php#$common_lang"><var>$common_lang</var></a>, 
									<a href="class-AbstractCategoriesFormController.php#$form"><var>$form</var></a>, 
									<a href="class-AbstractCategoriesFormController.php#$is_new_category"><var>$is_new_category</var></a>, 
									<a href="class-AbstractCategoriesFormController.php#$lang"><var>$lang</var></a>, 
									<a href="class-AbstractCategoriesFormController.php#$submit_button"><var>$submit_button</var></a>
							</code>
						</td>
					</tr>
				</table>
