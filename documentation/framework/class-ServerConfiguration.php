		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ServerConfiguration.php" class="cssmenu-title">ServerConfiguration</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ServerConfiguration</h2></header>
		<div class="content">
		...
		<div class="content">
			...
			<tr data-order="get_phpversion" id="_get_phpversion">
...
<a href="source-class-ServerConfiguration.php#20-29" title="Go to source code">get_phpversion</a>( )
			...
			<tr data-order="is_php_compatible" id="_is_php_compatible">
...
<a href="source-class-ServerConfiguration.php#31-37" title="Go to source code">is_php_compatible</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									true<br>if php version fits to phpboost's requirements.
								</div>
			...
			<tr data-order="has_gd_library" id="_has_gd_library">
...
<a href="source-class-ServerConfiguration.php#39-45" title="Go to source code">has_gd_library</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									true<br>if GD library is available, else false.
								</div>
			...
			<tr data-order="has_curl_library" id="_has_curl_library">
...
<a href="source-class-ServerConfiguration.php#47-53" title="Go to source code">has_curl_library</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									true<br>if curl library is available, else false.
								</div>
			...
			<tr data-order="has_mbstring_library" id="_has_mbstring_library">
...
<a href="source-class-ServerConfiguration.php#55-61" title="Go to source code">has_mbstring_library</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									true<br>if MBstring (UTF-8) library is available, else false.
								</div>
			...
			<tr data-order="has_url_rewriting" id="_has_url_rewriting">
...
<a href="source-class-ServerConfiguration.php#63-73" title="Go to source code">has_url_rewriting</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									true<br>if url rewriting is available, else false.
								</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="MIN_PHP_VERSION" id="MIN_PHP_VERSION">

						<td class="attributes"><code>string</code></td>
						<td class="name">
							<code>
								<a href="source-class-ServerConfiguration.php#17" title="Go to source code"><b>MIN_PHP_VERSION</b></a>
							</code>
