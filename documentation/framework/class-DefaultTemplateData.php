<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DefaultTemplateData.php" class="cssmenu-title">DefaultTemplateData</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DefaultTemplateData</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\<a href="package-IO.Template.data.php">data</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 09 14
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2010 02 19
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-DefaultTemplateData.php#3-171" title="Go to source code">io/template/data/DefaultTemplateData.class.php</a></span>
			</div>

			<div class="description">
				<p>This class is a default implementation of the <code><a href="class-TemplateData.php">TemplateData</a></code> interface.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>DefaultTemplateData</span></b>					
					 implements 
						<a href="class-TemplateData.php"><span>TemplateData</span></a>
		...
		<div class="content">
			...
			<tr data-order="enable_strict_mode" id="_enable_strict_mode">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#21-27" title="Go to source code">enable_strict_mode</a>( )
						</code>

							<div class="description short">
								<p>Enables the strict mode. If a variable that does not exist in the object is requested,
  then an exception will be raised.</p>
							</div>

						<div class="description detailed hidden">
							<p>Enables the strict mode. If a variable that does not exist in the object is requested, then an exception will be raised.</p>
								...
								<div class="list"><code><a href="class-TemplateData.php#_enable_strict_mode">TemplateData::enable_strict_mode()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="disable_strict_mode" id="_disable_strict_mode">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#29-35" title="Go to source code">disable_strict_mode</a>( )
						</code>

							<div class="description short">
								<p>Disables the strict mode. If a variable that does not exist in the object is requested,
  then an empty value will be returned.</p>
							</div>

						<div class="description detailed hidden">
							<p>Disables the strict mode. If a variable that does not exist in the object is requested, then an empty value will be returned.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateData.php#_disable_strict_mode">TemplateData::disable_strict_mode()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="auto_load_frequent_vars" id="_auto_load_frequent_vars">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#37-55" title="Go to source code">auto_load_frequent_vars</a>( )
						</code>

							<div class="description short">
								<p>Loads the most common vars which are useful in the whole PHPBoost templates. The variables are:</p>
...
<ul> <li>THEME the theme used by the current user</li> <li>LANG the lang used by the current user</li> <li>IS_USER_CONNECTED tells whether the user is connected (member, moderator or administrator)</li> <li>IS_ADMIN tells whether the user is administrator</li> <li>IS_MODERATOR tells whether the user is moderator</li> <li>PATH_TO_ROOT is the path which starts from the domain root (in HTTP context) and goes to the PHPBoost
root. For instance if PHPBoost is installed at www.example.com/directory/, its value will be /directory.</li> <li>PHP_PATH_TO_ROOT is the server side path, it's the path which goes to the PHPBoost's root.</li> <li>TOKEN is the CSRF protection token. It's to use in the critical actions to show that the user really
intended doing the action</li> <li>REWRITED_SCRIPT the current url</li>
</ul>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateData.php#_auto_load_frequent_vars">TemplateData::auto_load_frequent_vars()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="put" id="_put">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#57-63" title="Go to source code">put</a>( <span> <var>$key</var></span>, <span> <var>$value</var></span> )
						</code>

							<div class="description short">
								<p>Assigns the value</p>

<pre><span class="php-var">$value</span></pre>

<p>to the template variable of name</p>

<pre><span class="php-var">$key</span></pre>
							</div>
...
<pre><span class="php-var">$key</span></pre>
								...
								<div class="list"><dl>
									<dt><var>$key</var></dt>
									<dd>template parameter name</dd>
									<dt><var>$value</var></dt>
									<dd>template parameter value</dd>
								</dl></div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateData.php#_put">TemplateData::put()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="put_all" id="_put_all">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#65-74" title="Go to source code">put_all</a>( <span>array <var>$vars</var></span> )
						</code>

							<div class="description short">
								<p>Assigns template variables. It could be simple variables, loop or subtemplates.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Assigns template variables. It could be simple variables, loop or subtemplates.</p>
								...
								<div class="list"><dl>
									<dt><var>$vars</var></dt>
									<dd><p>A map key => value where</p>

<pre><span class="php-var">$value</span></pre>

<p>will be assigned to the template variable of name</p>

<pre><span class="php-var">$key</span></pre></dd>
								</dl></div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateData.php#_put_all">TemplateData::put_all()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="assign_block_vars" id="_assign_block_vars">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#76-100" title="Go to source code">assign_block_vars</a>( <span>string <var>$block_name</var></span>, <span>array <var>$array_vars</var></span>, <span>array <var>$subtemplates</var> = <span class="php-keyword1">array</span>()</span> )
						</code>

							<div class="description short">
								<p>Assigns a template block. A block represents a loop and has a name which be used in your template file to indicate which loop you want to browse.
To know what syntax to use to browse a loop, see the class description, there are examples.</p>
							</div>
...
To know what syntax to use to browse a loop, see the class description, there are examples.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$block_name</var></dt>
									<dd>Block name.</dd>
									<dt><var>$array_vars</var></dt>
									<dd>A map var_name => var_value. Generally, var_name is written in caps characters.</dd>
									<dt><var>$subtemplates</var></dt>
									<dd>The list of subtemplates to embed in the loop's iteration.</dd>
								</dl></div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateData.php#_assign_block_vars">TemplateData::assign_block_vars()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_block" id="_get_block">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#102-108" title="Go to source code">get_block</a>( <span>string <var>$blockname</var></span> )
						</code>

							<div class="description short">
								<p>Returns the block $blockname in the template block list</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the block $blockname in the template block list</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$blockname</var></dt>
									<dd>the blockname of the block to retrieve</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									mixed[]<br>the requested block
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateData.php#_get_block">TemplateData::get_block()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_block_from_list" id="_get_block_from_list">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#110-124" title="Go to source code">get_block_from_list</a>( <span>string <var>$blockname</var></span>, <span>mixed[] <var>$parent_block</var></span> )
						</code>

							<div class="description short">
								<p>Returns the block $blockname in the parent_block</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the block $blockname in the parent_block</p>
								...
								<div class="list"><dl>
									<dt><var>$blockname</var></dt>
									<dd>the blockname of the block to retrieve</dd>
									<dt><var>$parent_block</var></dt>
									<dd>the parent block in which $blockname will be searched for</dd>
								</dl></div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateData.php#_get_block_from_list">TemplateData::get_block_from_list()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="is_true" id="_is_true">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#126-132" title="Go to source code">is_true</a>( <span>string <var>$value</var></span> )
						</code>

							<div class="description short">
								<p>Tells whether a condition is true. Conditions are global boolean variables.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Tells whether a condition is true. Conditions are global boolean variables.</p>
								...
								<div class="list"><dl>
									<dt><var>$value</var></dt>
									<dd>$varname the name of the variable to check if it is true</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									boolean<br>true if the variable $varname exists and is not considered as false
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateData.php#_is_true">TemplateData::is_true()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get" id="_get">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#134-140" title="Go to source code">get</a>( <span>string <var>$varname</var></span> )
						</code>

							<div class="description short">
								<p>Returns the $varname variable content searched in from the $list</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the $varname variable content searched in from the $list</p>
								...
								<div class="list"><dl>
									...
									<dd>the name of the variable to retrieve</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>the $varname variable content
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateData.php#_get">TemplateData::get()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_from_list" id="_get_from_list">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#142-156" title="Go to source code">get_from_list</a>( <span>string <var>$varname</var></span>, <span>mixed[] <var>&amp; $list</var></span> )
						</code>

							<div class="description short">
								<p>Similar from the get_var method but it works with loop variables instead of global variables.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Similar from the get_var method but it works with loop variables instead of global variables.</p>
								...
								<div class="list"><dl>
									...
									<dd>The name of the variable to retrieve</dd>
									<dt><var>$list</var></dt>
									<dd>The list into which retrieve the variable</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>The variable content
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateData.php#_get_from_list">TemplateData::get_from_list()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="bind_vars" id="_bind_vars">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultTemplateData.php#164-170" title="Go to source code">bind_vars</a>( <span><code><a href="class-TemplateData.php">TemplateData</a></code> <var>$data</var></span> )
						</code>

							<div class="description short">
								<p>Binds vars on another <code><a href="class-TemplateData.php">TemplateData</a></code> object. The two instances will share the same data.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Binds vars on another <code><a href="class-TemplateData.php">TemplateData</a></code> object. The two instances will share the same data.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateData.php#_bind_vars">TemplateData::bind_vars()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
