...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\Image</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\Image</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-Image.php">Image</a></td>
	<td class="ellipsis">This class allows you to obtain informations on an image.</td>
</tr>
<tr>
	<td class="name"><a href="class-ImageResizer.php">ImageResizer</a></td>
	<td class="ellipsis">This class allows you to resize images easily.</td>
</tr>
	</table>
</div>
