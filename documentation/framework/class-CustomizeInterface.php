		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CustomizeInterface.php" class="cssmenu-title">CustomizeInterface</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CustomizeInterface</h2></header>
		<div class="content">
		...
		<div class="content">
			...
			<tr data-order="set_header_logo_path" id="_set_header_logo_path">
...
<a href="source-class-CustomizeInterface.php#17-20" title="Go to source code">set_header_logo_path</a>( <span> <var>$header_logo_path</var></span> )
			...
			<tr data-order="get_header_logo_path" id="_get_header_logo_path">
...
<a href="source-class-CustomizeInterface.php#22-25" title="Go to source code">get_header_logo_path</a>( )
			...
			<tr data-order="remove_header_logo_path" id="_remove_header_logo_path">
