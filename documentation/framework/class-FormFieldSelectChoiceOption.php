		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormFieldSelectChoiceOption.php" class="cssmenu-title">FormFieldSelectChoiceOption</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormFieldSelectChoiceOption</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a>\<a href="package-Builder.Form.field.php">field</a>\<a href="package-Builder.Form.field.enum.php">enum</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormFieldSelectChoiceOption.php#3-45" title="Go to source code">builder/form/field/enum/FormFieldSelectChoiceOption.class.php</a></span>
			</div>

			<div class="description">
				<p>This class manage select field options.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractFormFieldEnumOption.php"><span>AbstractFormFieldEnumOption</span></a>
					
					 implements 
						<a href="class-FormFieldEnumOption.php"><span>FormFieldEnumOption</span></a>
					
					
				</dd>
				<dd style="padding-left:30px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>FormFieldSelectChoiceOption</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldSelectChoiceOption.php#19-27" title="Go to source code">__construct</a>( <span> <var>$label</var></span>, <span> <var>$raw_value</var></span>, <span>string[] <var>$field_choice_options</var> = <span class="php-keyword1">array</span>()</span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<div class="list"><dl>
									<dt><var>$label</var></dt>
									<dd>The label</dd>
									<dt><var>$raw_value</var></dt>
									<dd>The raw value</dd>
									<dt><var>$field_choice_options</var></dt>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractFormFieldEnumOption.php#___construct">AbstractFormFieldEnumOption::__construct()</a></code></div>
			...
			<tr data-order="display" id="_display">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldSelectChoiceOption.php#29-44" title="Go to source code">display</a>( )
						</code>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractFormFieldEnumOption.php#methods">AbstractFormFieldEnumOption</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractFormFieldEnumOption.php#_compute_options">compute_options()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_get_field">get_field()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_get_field_id">get_field_id()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_get_label">get_label()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_get_option">get_option()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_get_option_id">get_option_id()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_get_raw_value">get_raw_value()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_is_active">is_active()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_is_disable">is_disable()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_set_active">set_active()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_set_disable">set_disable()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_set_field">set_field()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_set_label">set_label()</a>, 
									<a href="class-AbstractFormFieldEnumOption.php#_set_raw_value">set_raw_value()</a>
							</code>
						</td>
					</tr>
				</table>
