		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MySQLSelectQueryResult.php" class="cssmenu-title">MySQLSelectQueryResult</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MySQLSelectQueryResult</h2></header>
		<div class="content">
			...
			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractQueryResult.php"><span>AbstractQueryResult</span></a>
				...
				<dd style="padding-left:30px">
					...
					<a href="class-AbstractSelectQueryResult.php"><span>AbstractSelectQueryResult</span></a>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>MySQLSelectQueryResult</span></b>					
...
<a href="source-class-MySQLSelectQueryResult.php#40-45" title="Go to source code">__construct</a>( <span> <var>$query</var></span>, <span> <var>$parameters</var></span>, <span> <var>$resource</var></span>, <span> <var>$fetch_mode</var> = self::FETCH_ASSOC</span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractSelectQueryResult.php#___construct">AbstractSelectQueryResult::__construct()</a></code></div>
...
<a href="source-class-MySQLSelectQueryResult.php#102-112" title="Go to source code">dispose</a>( )
			...
			<tr data-order="needs_rewind" id="_needs_rewind">
...
<a href="source-class-MySQLSelectQueryResult.php#114-117" title="Go to source code">needs_rewind</a>( )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractSelectQueryResult.php#methods">AbstractSelectQueryResult</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractSelectQueryResult.php#_fetch">fetch()</a>, 
									<a href="class-AbstractSelectQueryResult.php#_has_next">has_next()</a>
							</code>
						</td>
					</tr>
				</table>
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractQueryResult.php#methods">AbstractQueryResult</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractQueryResult.php#_get_parameters">get_parameters()</a>, 
									<a href="class-AbstractQueryResult.php#_get_query">get_query()</a>
							</code>
						</td>
					</tr>
				</table>
