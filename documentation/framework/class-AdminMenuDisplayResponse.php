		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AdminMenuDisplayResponse.php" class="cssmenu-title">AdminMenuDisplayResponse</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AdminMenuDisplayResponse</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-MVC.php">MVC</a>\<a href="package-MVC.Response.php">Response</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2017 06 23
						</span>
						<span class="infos-options">
							<b>Since:</b>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-AdminMenuDisplayResponse.php#3-66" title="Go to source code">mvc/response/AdminMenuDisplayResponse.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractResponse.php"><span>AbstractResponse</span></a>
					
					 implements 
						<a href="class-Response.php"><span>Response</span></a>
					
					
				</dd>
				<dd style="padding-left:30px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>AdminMenuDisplayResponse</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AdminMenuDisplayResponse.php#22-46" title="Go to source code">__construct</a>( <span><code><a href="class-View.php">View</a></code> <var>$view</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractResponse.php#___construct">AbstractResponse::__construct()</a></code></div>
			...
			<tr data-order="set_title" id="_set_title">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AdminMenuDisplayResponse.php#48-51" title="Go to source code">set_title</a>( <span> <var>$title</var></span> )
						</code>
			...
			<tr data-order="add_link" id="_add_link">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AdminMenuDisplayResponse.php#53-59" title="Go to source code">add_link</a>( <span> <var>$name</var></span>, <span> <var>$url</var></span> )
						</code>
			...
			<tr data-order="send" id="_send">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-AdminMenuDisplayResponse.php#_send">AdminMenuDisplayResponse::send()</a></code>
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AdminMenuDisplayResponse.php#61-65" title="Go to source code">send</a>( )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-AdminMenuDisplayResponse.php#_send">AdminMenuDisplayResponse::send()</a></code><br>the response to the browser
								</div>



								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractResponse.php#_send">AbstractResponse::send()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractResponse.php#methods">AbstractResponse</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractResponse.php#_get_graphical_environment">get_graphical_environment()</a>
							</code>
						</td>
					</tr>
				</table>
