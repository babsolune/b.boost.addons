<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ModulePagination.php" class="cssmenu-title">ModulePagination</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ModulePagination</h2></header>
		<div class="content">
...
<a href="source-class-ModulePagination.php#33-36" title="Go to source code">display</a>( )
			...
			<tr data-order="get_number_items_per_page" id="_get_number_items_per_page">
...
<a href="source-class-ModulePagination.php#38-41" title="Go to source code">get_number_items_per_page</a>( )
			...
			<tr data-order="current_page_is_empty" id="_current_page_is_empty">
...
<a href="source-class-ModulePagination.php#43-46" title="Go to source code">current_page_is_empty</a>( )
			...
			<tr data-order="get_display_from" id="_get_display_from">
...
<a href="source-class-ModulePagination.php#48-52" title="Go to source code">get_display_from</a>( )
			...
			<tr data-order="has_several_pages" id="_has_several_pages">
