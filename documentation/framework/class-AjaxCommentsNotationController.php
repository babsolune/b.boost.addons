		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AjaxCommentsNotationController.php" class="cssmenu-title">AjaxCommentsNotationController</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AjaxCommentsNotationController</h2></header>
		<div class="content">
			...
			<dl class="tree">
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>AjaxCommentsNotationController</span></b>					
...
<a href="source-class-AjaxCommentsNotationController.php#18-50" title="Go to source code">execute</a>( <span><code><a href="class-HTTPRequestCustom.php">HTTPRequestCustom</a></code> <var>$request</var></span> )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="LESS_NOTE" id="LESS_NOTE">
						...
						<td class="value">
							<div>
								<a href="#LESS_NOTE" class="anchor">#</a>
								<code><span class="php-quote">'less'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PLUS_NOTE" id="PLUS_NOTE">
						...
						<td class="value">
							<div>
								<a href="#PLUS_NOTE" class="anchor">#</a>
								<code><span class="php-quote">'plus'</span></code>
							</div>
						</td>
					</tr>
				</table>
