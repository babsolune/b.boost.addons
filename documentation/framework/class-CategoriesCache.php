<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-CategoriesCache.php" class="cssmenu-title">CategoriesCache</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CategoriesCache</h2></header>
		<div class="content">
...
For instance,</p>
			...
			<tr data-order="get_table_name" id="_get_table_name">
...
<a href="source-class-CategoriesCache.php#69" title="Go to source code">get_table_name</a>( )
			...
			<tr data-order="get_category_class" id="_get_category_class">
...
<a href="source-class-CategoriesCache.php#71" title="Go to source code">get_category_class</a>( )
			...
			<tr data-order="get_module_identifier" id="_get_module_identifier">
...
<a href="source-class-CategoriesCache.php#73" title="Go to source code">get_module_identifier</a>( )
			...
			<tr data-order="get_root_category" id="_get_root_category">
...
<a href="source-class-CategoriesCache.php#75" title="Go to source code">get_root_category</a>( )
			...
			<tr data-order="get_category_elements_number" id="_get_category_elements_number">
...
<a href="source-class-CategoriesCache.php#77-80" title="Go to source code">get_category_elements_number</a>( <span> <var>$id_category</var></span> )
			...
			<tr data-order="get_categories" id="_get_categories">
...
<a href="source-class-CategoriesCache.php#87-124" title="Go to source code">get_children</a>( <span> <var>$id_category</var></span>, <span> <var>$allowed_categories_filter</var> = <span class="php-keyword1">array</span>()</span> )
			...
			<tr data-order="category_exists" id="_category_exists">
...
<a href="source-class-CategoriesCache.php#131-138" title="Go to source code">get_category</a>( <span> <var>$id</var></span> )
			...
			<tr data-order="has_categories" id="_has_categories">
...
<a href="source-class-CategoriesCache.php#145-152" title="Go to source code">load</a>( )
							...
							<div class="description short">
								<p>Loads and returns the categories cached data.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads and returns the categories cached data.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-CategoriesCache.php">CategoriesCache</a></code><br>The cached data
								</div>
...
<a href="source-class-CategoriesCache.php#154-160" title="Go to source code">invalidate</a>( )
							...
							<div class="description short">
								<p>Invalidates categories cached data.</p>
							</div>
			...
			<tr data-order="get_class" id="_get_class">
...
<a href="source-class-CategoriesCache.php#162-166" title="Go to source code">get_class</a>( )
			...
			<tr data-order="categories" id="$categories">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$categories" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
