		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SitemapCategoriesModule.php" class="cssmenu-title">SitemapCategoriesModule</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SitemapCategoriesModule</h2></header>
		<div class="content">
...
<b><span>SitemapCategoriesModule</span></b>					
					 implements 
<span>SitemapExtensionPoint</span>
...
<a href="source-class-SitemapCategoriesModule.php#21-24" title="Go to source code">__construct</a>( <span><code><a href="class-CategoriesManager.php">CategoriesManager</a></code> <var>$categories_manager</var></span> )
			...
			<tr data-order="get_public_sitemap" id="_get_public_sitemap">
...
<a href="source-class-SitemapCategoriesModule.php#26-29" title="Go to source code">get_public_sitemap</a>( )
			...
			<tr data-order="get_user_sitemap" id="_get_user_sitemap">
...
<a href="source-class-SitemapCategoriesModule.php#31-34" title="Go to source code">get_user_sitemap</a>( )
			...
			<tr data-order="get_category_url" id="_get_category_url">
