		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormFieldsetHTMLHeading.php" class="cssmenu-title">FormFieldsetHTMLHeading</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormFieldsetHTMLHeading</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a>\<a href="package-Builder.Form.fieldset.php">fieldset</a></span>
						...
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 5.1 - 2018 10 26
						</span>
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormFieldsetHTMLHeading.php#3-43" title="Go to source code">builder/form/fieldset/FormFieldsetHTMLHeading.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractFormFieldset.php"><span>AbstractFormFieldset</span></a>
				...
				<dd style="padding-left:30px">
					...
					<a href="class-FormFieldsetHTML.php"><span>FormFieldsetHTML</span></a>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>FormFieldsetHTMLHeading</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldsetHTMLHeading.php#15-22" title="Go to source code">__construct</a>( <span>string <var>$id</var></span>, <span> <var>$name</var> = <span class="php-quote">''</span></span>, <span> <var>$options</var> = <span class="php-keyword1">array</span>()</span> )
						</code>
						...
						<div class="description detailed hidden">
							<p>constructor</p>
								...
								<div class="list"><dl>
									<dt><var>$id</var></dt>
									<dd>$name The name of the fieldset</dd>
									<dt><var>$name</var></dt>
									<dd></dd>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-FormFieldsetHTML.php#___construct">FormFieldsetHTML::__construct()</a></code></div>
			...
			<tr data-order="display" id="_display">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldsetHTMLHeading.php#24-42" title="Go to source code">display</a>( <span><code><a href="class-Template.php">Template</a></code> <var>$template</var>,…</span> )
						</code>
						...
						<div class="description detailed hidden">
							<p>Return the form</p>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-FormFieldsetHTML.php#_display">FormFieldsetHTML::display()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-FormFieldsetHTML.php#methods">FormFieldsetHTML</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-FormFieldsetHTML.php#_get_default_template">get_default_template()</a>, 
									<a href="class-FormFieldsetHTML.php#_get_title">get_title()</a>, 
									<a href="class-FormFieldsetHTML.php#_set_title">set_title()</a>
							</code>
						</td>
					</tr>
				</table>
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractFormFieldset.php#methods">AbstractFormFieldset</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractFormFieldset.php#_add_element">add_element()</a>, 
									<a href="class-AbstractFormFieldset.php#_add_field">add_field()</a>, 
									<a href="class-AbstractFormFieldset.php#_assign_template_fields">assign_template_fields()</a>, 
									<a href="class-AbstractFormFieldset.php#_compute_options">compute_options()</a>, 
									<a href="class-AbstractFormFieldset.php#_disable">disable()</a>, 
									<a href="class-AbstractFormFieldset.php#_enable">enable()</a>, 
									<a href="class-AbstractFormFieldset.php#_get_field">get_field()</a>, 
									<a href="class-AbstractFormFieldset.php#_get_fields">get_fields()</a>, 
									<a href="class-AbstractFormFieldset.php#_get_html_id">get_html_id()</a>, 
									<a href="class-AbstractFormFieldset.php#_get_id">get_id()</a>, 
									<a href="class-AbstractFormFieldset.php#_get_onsubmit_validations">get_onsubmit_validations()</a>, 
									<a href="class-AbstractFormFieldset.php#_get_template_to_use">get_template_to_use()</a>, 
									<a href="class-AbstractFormFieldset.php#_get_validation_error_messages">get_validation_error_messages()</a>, 
									<a href="class-AbstractFormFieldset.php#_has_field">has_field()</a>, 
									<a href="class-AbstractFormFieldset.php#_is_disabled">is_disabled()</a>, 
									<a href="class-AbstractFormFieldset.php#_set_css_class">set_css_class()</a>, 
									<a href="class-AbstractFormFieldset.php#_set_description">set_description()</a>, 
									<a href="class-AbstractFormFieldset.php#_set_form_id">set_form_id()</a>, 
									<a href="class-AbstractFormFieldset.php#_set_template">set_template()</a>, 
									<a href="class-AbstractFormFieldset.php#_validate">validate()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-FormFieldsetHTML.php#properties">FormFieldsetHTML</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-FormFieldsetHTML.php#$title"><var>$title</var></a>
							</code>
						</td>
					</tr>
				</table>
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-AbstractFormFieldset.php#properties">AbstractFormFieldset</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractFormFieldset.php#$description"><var>$description</var></a>, 
									<a href="class-AbstractFormFieldset.php#$disabled"><var>$disabled</var></a>, 
									<a href="class-AbstractFormFieldset.php#$elements"><var>$elements</var></a>, 
									<a href="class-AbstractFormFieldset.php#$fields"><var>$fields</var></a>, 
									<a href="class-AbstractFormFieldset.php#$id"><var>$id</var></a>
							</code>
						</td>
					</tr>
				</table>
