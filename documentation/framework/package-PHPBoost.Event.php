...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\Event</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\Event</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-AdministratorAlert.php">AdministratorAlert</a></td>
	<td class="ellipsis"><p>This class represents an alert which must be sent to the administrator.
It allows to the module developers to handle the administrator alerts.
The administrator alerts can be in the administration panel and can be used when you want to signal an important event to the administrator(s).</p></td>
</tr>
<tr>
	<td class="name"><a href="class-AdministratorAlertService.php">AdministratorAlertService</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-Contribution.php">Contribution</a></td>
	<td class="ellipsis"><p>This class represents a contribution made by a user to complete the content of the website.
All the contributions are managed in the contribution panel.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-ContributionService.php">ContributionService</a></td>
	<td class="ellipsis">This service allows developers to manage their contributions.</td>
</tr>
<tr>
	<td class="name"><a href="class-Event.php">Event</a></td>
	<td class="ellipsis"><p>It's the common part between two types of event existing now in PHPBoost:</p>
...
<tr>
	<td class="name"><a href="class-Notification.php">Notification</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
