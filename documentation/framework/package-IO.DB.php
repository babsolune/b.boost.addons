...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\DB</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\DB</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-IO.DB.dbms.php">IO\DB\dbms</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.DB.driver.php">IO\DB\driver</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.DB.factory.php">IO\DB\factory</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.DB.translator.php">IO\DB\translator</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.DB.util.php">IO\DB\util</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-DBQuerier.php">DBQuerier</a></td>
	<td class="ellipsis">implements some simple queries</td>
</tr>
<tr>
	<td class="name"><a href="class-SQLQueryVars.php">SQLQueryVars</a></td>
	<td class="ellipsis">implements the query var replacement method</td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-DBConnection.php">DBConnection</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-InjectQueryResult.php">InjectQueryResult</a></td>
	<td class="ellipsis">this class encapsulate an inject query result</td>
</tr>
<tr>
	<td class="name"><a href="class-QueryResult.php">QueryResult</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-SelectQueryResult.php">SelectQueryResult</a></td>
	<td class="ellipsis"><p>this class encapsulate a query result set
usage is:</p>

<pre><span class="php-keyword1">foreach</span> (<span class="php-var">$my_query_result</span> <span class="php-keyword1">as</span> <span class="php-var">$result</span>) {
       <span class="php-comment">// do something with the $result</span>
}</pre></td>
</tr>
<tr>
	<td class="name"><a href="class-SQLQuerier.php">SQLQuerier</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-DBConnectionException.php">DBConnectionException</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-NotASingleRowFoundException.php">NotASingleRowFoundException</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-RowNotFoundException.php">RowNotFoundException</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-SQLQuerierException.php">SQLQuerierException</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-UnexistingDatabaseException.php">UnexistingDatabaseException</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
