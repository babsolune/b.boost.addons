<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-LangNotFoundException.php" class="cssmenu-title">LangNotFoundException</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>LangNotFoundException</h2></header>
		<div class="content">
...
<b><span>LangNotFoundException</span></b>					
