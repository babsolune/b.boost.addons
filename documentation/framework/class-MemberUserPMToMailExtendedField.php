		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MemberUserPMToMailExtendedField.php" class="cssmenu-title">MemberUserPMToMailExtendedField</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MemberUserPMToMailExtendedField</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Member.php">Member</a>\<a href="package-PHPBoost.Member.extended.fields.php">extended-fields</a>\<a href="package-PHPBoost.Member.extended.fields.field.php">field</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2016 02 11
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 4.1 - 2015 09 19
						</span>
					<span class="infos-options"><b>Located at:</b> <a href="source-class-MemberUserPMToMailExtendedField.php#3-56" title="Go to source code">phpboost/member/extended-fields/field/MemberUserPMToMailExtendedField.class.php</a></span>
			</div>
...
<b><span>MemberUserPMToMailExtendedField</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MemberUserPMToMailExtendedField.php#15-22" title="Go to source code">__construct</a>( )
						</code>
			...
			<tr data-order="display_field_create" id="_display_field_create">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MemberUserPMToMailExtendedField.php#24-31" title="Go to source code">display_field_create</a>( <span><code><a href="class-MemberExtendedField.php">MemberExtendedField</a></code> <var>$member_extended_field</var></span> )
						</code>
			...
			<tr data-order="display_field_update" id="_display_field_update">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MemberUserPMToMailExtendedField.php#33-40" title="Go to source code">display_field_update</a>( <span><code><a href="class-MemberExtendedField.php">MemberExtendedField</a></code> <var>$member_extended_field</var></span> )
						</code>
			...
			<tr data-order="display_field_profile" id="_display_field_profile">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MemberUserPMToMailExtendedField.php#42-46" title="Go to source code">display_field_profile</a>( <span><code><a href="class-MemberExtendedField.php">MemberExtendedField</a></code> <var>$member_extended_field</var></span> )
						</code>
			...
			<tr data-order="get_data" id="_get_data">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MemberUserPMToMailExtendedField.php#48-55" title="Go to source code">get_data</a>( <span><code><a href="class-HTMLForm.php">HTMLForm</a></code> <var>$form</var></span>, <span><code><a href="class-MemberExtendedField.php">MemberExtendedField</a></code> <var>$member_extended_field</var></span> )
						</code>
						...
						<div class="description detailed hidden">
							<p>This function returned value form fields</p>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractMemberExtendedField.php#_get_data">AbstractMemberExtendedField::get_data()</a></code></div>
