		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ServerEnvironmentConfig.php" class="cssmenu-title">ServerEnvironmentConfig</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ServerEnvironmentConfig</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Config.php">Config</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2017 06 11
						</span>
						<span class="infos-options">
							<b>Since:</b>
...
<b><span>ServerEnvironmentConfig</span></b>					
		...
		<div class="content">
			...
			<tr data-order="is_url_rewriting_enabled" id="_is_url_rewriting_enabled">
...
<a href="source-class-ServerEnvironmentConfig.php#30-33" title="Go to source code">is_url_rewriting_enabled</a>( )
			...
			<tr data-order="set_url_rewriting_enabled" id="_set_url_rewriting_enabled">
...
<a href="source-class-ServerEnvironmentConfig.php#35-38" title="Go to source code">set_url_rewriting_enabled</a>( <span> <var>$enabled</var></span> )
			...
			<tr data-order="is_redirection_www_enabled" id="_is_redirection_www_enabled">
...
<a href="source-class-ServerEnvironmentConfig.php#40-43" title="Go to source code">is_redirection_www_enabled</a>( )
			...
			<tr data-order="enable_redirection_www" id="_enable_redirection_www">
...
<a href="source-class-ServerEnvironmentConfig.php#45-48" title="Go to source code">enable_redirection_www</a>( )
			...
			<tr data-order="disable_redirection_www" id="_disable_redirection_www">
...
<a href="source-class-ServerEnvironmentConfig.php#50-53" title="Go to source code">disable_redirection_www</a>( )
			...
			<tr data-order="get_redirection_www_mode" id="_get_redirection_www_mode">
...
<a href="source-class-ServerEnvironmentConfig.php#55-58" title="Go to source code">get_redirection_www_mode</a>( )
			...
			<tr data-order="is_redirection_www_mode_with_www" id="_is_redirection_www_mode_with_www">
...
<a href="source-class-ServerEnvironmentConfig.php#60-63" title="Go to source code">is_redirection_www_mode_with_www</a>( )
			...
			<tr data-order="set_redirection_www_mode" id="_set_redirection_www_mode">
...
<a href="source-class-ServerEnvironmentConfig.php#65-68" title="Go to source code">set_redirection_www_mode</a>( <span> <var>$value</var></span> )
			...
			<tr data-order="is_redirection_https_enabled" id="_is_redirection_https_enabled">
...
<a href="source-class-ServerEnvironmentConfig.php#70-73" title="Go to source code">is_redirection_https_enabled</a>( )
			...
			<tr data-order="enable_redirection_https" id="_enable_redirection_https">
...
<a href="source-class-ServerEnvironmentConfig.php#75-78" title="Go to source code">enable_redirection_https</a>( )
			...
			<tr data-order="disable_redirection_https" id="_disable_redirection_https">
...
<a href="source-class-ServerEnvironmentConfig.php#80-83" title="Go to source code">disable_redirection_https</a>( )
			...
			<tr data-order="is_hsts_security_enabled" id="_is_hsts_security_enabled">
...
<a href="source-class-ServerEnvironmentConfig.php#85-88" title="Go to source code">is_hsts_security_enabled</a>( )
			...
			<tr data-order="enable_hsts_security" id="_enable_hsts_security">
...
<a href="source-class-ServerEnvironmentConfig.php#90-93" title="Go to source code">enable_hsts_security</a>( )
			...
			<tr data-order="disable_hsts_security" id="_disable_hsts_security">
...
<a href="source-class-ServerEnvironmentConfig.php#95-98" title="Go to source code">disable_hsts_security</a>( )
			...
			<tr data-order="get_hsts_security_duration" id="_get_hsts_security_duration">
...
<a href="source-class-ServerEnvironmentConfig.php#100-103" title="Go to source code">get_hsts_security_duration</a>( )
			...
			<tr data-order="set_hsts_security_duration" id="_set_hsts_security_duration">
...
<a href="source-class-ServerEnvironmentConfig.php#105-108" title="Go to source code">set_hsts_security_duration</a>( <span> <var>$value</var></span> )
			...
			<tr data-order="get_config_hsts_security_duration" id="_get_config_hsts_security_duration">
...
<a href="source-class-ServerEnvironmentConfig.php#110-113" title="Go to source code">get_config_hsts_security_duration</a>( )
			...
			<tr data-order="is_hsts_security_subdomain_enabled" id="_is_hsts_security_subdomain_enabled">
...
<a href="source-class-ServerEnvironmentConfig.php#115-118" title="Go to source code">is_hsts_security_subdomain_enabled</a>( )
			...
			<tr data-order="enable_hsts_subdomain_security" id="_enable_hsts_subdomain_security">
...
<a href="source-class-ServerEnvironmentConfig.php#120-123" title="Go to source code">enable_hsts_subdomain_security</a>( )
			...
			<tr data-order="disable_hsts_subdomain_security" id="_disable_hsts_subdomain_security">
...
<a href="source-class-ServerEnvironmentConfig.php#125-128" title="Go to source code">disable_hsts_subdomain_security</a>( )
			...
			<tr data-order="get_htaccess_manual_content" id="_get_htaccess_manual_content">
...
<a href="source-class-ServerEnvironmentConfig.php#136-139" title="Go to source code">get_htaccess_manual_content</a>( )
			...
			<tr data-order="set_htaccess_manual_content" id="_set_htaccess_manual_content">
...
<a href="source-class-ServerEnvironmentConfig.php#141-144" title="Go to source code">set_htaccess_manual_content</a>( <span> <var>$content</var></span> )
			...
			<tr data-order="is_output_gziping_enabled" id="_is_output_gziping_enabled">
...
<a href="source-class-ServerEnvironmentConfig.php#146-149" title="Go to source code">is_output_gziping_enabled</a>( )
			...
			<tr data-order="set_output_gziping_enabled" id="_set_output_gziping_enabled">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-ServerEnvironmentConfig.php">ServerEnvironmentConfig</a></code>
...
<a href="source-class-ServerEnvironmentConfig.php#180-186" title="Go to source code">save</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="URL_REWRITING_ENABLED" id="URL_REWRITING_ENABLED">
						...
						<td class="value">
							<div>
								<a href="#URL_REWRITING_ENABLED" class="anchor">#</a>
								<code><span class="php-quote">'url_rewriting_enabled'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="REDIRECTION_WWW_ENABLED" id="REDIRECTION_WWW_ENABLED">
						...
						<td class="value">
							<div>
								<a href="#REDIRECTION_WWW_ENABLED" class="anchor">#</a>
								<code><span class="php-quote">'redirection_www_enabled'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="REDIRECTION_WWW_MODE" id="REDIRECTION_WWW_MODE">
						...
						<td class="value">
							<div>
								<a href="#REDIRECTION_WWW_MODE" class="anchor">#</a>
								<code><span class="php-quote">'redirection_www_mode'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="REDIRECTION_WWW_WITH_WWW" id="REDIRECTION_WWW_WITH_WWW">
						...
						<td class="value">
							<div>
								<a href="#REDIRECTION_WWW_WITH_WWW" class="anchor">#</a>
								<code><span class="php-quote">'with_www'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="REDIRECTION_WWW_WITHOUT_WWW" id="REDIRECTION_WWW_WITHOUT_WWW">
						...
						<td class="value">
							<div>
								<a href="#REDIRECTION_WWW_WITHOUT_WWW" class="anchor">#</a>
								<code><span class="php-quote">'without_www'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="REDIRECTION_HTTPS_ENABLED" id="REDIRECTION_HTTPS_ENABLED">
						...
						<td class="value">
							<div>
								<a href="#REDIRECTION_HTTPS_ENABLED" class="anchor">#</a>
								<code><span class="php-quote">'redirection_https_enabled'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="HSTS_SECURITY_ENABLED" id="HSTS_SECURITY_ENABLED">
						...
						<td class="value">
							<div>
								<a href="#HSTS_SECURITY_ENABLED" class="anchor">#</a>
								<code><span class="php-quote">'hsts_security_enabled'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="HSTS_SECURITY_SUBDOMAIN_ENABLED" id="HSTS_SECURITY_SUBDOMAIN_ENABLED">
						...
						<td class="value">
							<div>
								<a href="#HSTS_SECURITY_SUBDOMAIN_ENABLED" class="anchor">#</a>
								<code><span class="php-quote">'hsts_security_subdomain_enabled'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="HSTS_SECURITY_DURATION" id="HSTS_SECURITY_DURATION">
						...
						<td class="value">
							<div>
								<a href="#HSTS_SECURITY_DURATION" class="anchor">#</a>
								<code><span class="php-quote">'hsts_security_duration'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="HTACCESS_MANUAL_CONTENT" id="HTACCESS_MANUAL_CONTENT">
						...
						<td class="value">
							<div>
								<a href="#HTACCESS_MANUAL_CONTENT" class="anchor">#</a>
								<code><span class="php-quote">'htaccess_manual_content'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="OUTPUT_GZIPING_ENABLED" id="OUTPUT_GZIPING_ENABLED">
						...
						<td class="value">
							<div>
								<a href="#OUTPUT_GZIPING_ENABLED" class="anchor">#</a>
								<code><span class="php-quote">'output_gziping_enabled'</span></code>
							</div>
						</td>
					</tr>
				</table>
