...
<section id="content">
	...
	<article>
		<header><h2>Package Core</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-Core.Environment.php">Core\Environment</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-Core.Error.php">Core\Error</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-Core.Lang.php">Core\Lang</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-AbstractScheduledJobExtensionPoint.php">AbstractScheduledJobExtensionPoint</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ClassLoader.php">ClassLoader</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-ScheduledJobExtensionPoint.php">ScheduledJobExtensionPoint</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
