		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SelectQueryResult.php" class="cssmenu-title">SelectQueryResult</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SelectQueryResult</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>this class encapsulate a query result set
usage is:</p>
...
<b><span>SelectQueryResult</span></b>					
					 implements 
						<a href="class-QueryResult.php"><span>QueryResult</span></a>, 
...
<span>iterator</span>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractSelectQueryResult.php">AbstractSelectQueryResult</a>, 
					<a href="class-SelectQueryResultMapper.php">SelectQueryResultMapper</a>
			</div>

			<div>
				<h6>Indirect known implementers</h6>
					<a href="class-MySQLSelectQueryResult.php">MySQLSelectQueryResult</a>, 
					<a href="class-PDOSelectQueryResult.php">PDOSelectQueryResult</a>
			</div>
...
<a href="source-class-SelectQueryResult.php#37-40" title="Go to source code">dispose</a>( )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-QueryResult.php#methods">QueryResult</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-QueryResult.php#_get_parameters">get_parameters()</a>, 
									<a href="class-QueryResult.php#_get_query">get_query()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="FETCH_NUM" id="FETCH_NUM">
						...
						<td class="value">
							<div>
								<a href="#FETCH_NUM" class="anchor">#</a>
								<code><span class="php-num">0x00</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="FETCH_ASSOC" id="FETCH_ASSOC">
						...
						<td class="value">
							<div>
								<a href="#FETCH_ASSOC" class="anchor">#</a>
