<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-HomePage.php" class="cssmenu-title">HomePage</a></li>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Homepage.php">Homepage</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-HomePage.php#2-23" title="Go to source code">content/homepage/HomePage.class.php</a></span>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-DefaultHomePage.php">DefaultHomePage</a>
			</div>
			...
			<tr data-order="get_title" id="_get_title">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HomePage.php#14-17" title="Go to source code">get_title</a>( )
						</code>
			...
			<tr data-order="get_view" id="_get_view">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-View.php">View</a></code>
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HomePage.php#19-22" title="Go to source code">get_view</a>( )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-View.php">View</a></code><br>The content of the home page
								</div>
