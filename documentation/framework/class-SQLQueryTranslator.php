<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-SQLQueryTranslator.php" class="cssmenu-title">SQLQueryTranslator</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SQLQueryTranslator</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a>\<a href="package-IO.DB.translator.php">translator</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-SQLQueryTranslator.php#3-21" title="Go to source code">io/db/translator/SQLQueryTranslator.class.php</a></span>
			</div>

			<div class="description">
				<p>Translates the generic query</p>

<pre><span class="php-var">$query</span></pre>

<p>into the mysql specific dialect</p>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-MySQLQueryTranslator.php">MySQLQueryTranslator</a>
			</div>
			...
			<tr data-order="translate" id="_translate">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-SQLQueryTranslator.php#16-20" title="Go to source code">translate</a>( <span>string <var>$query</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<div class="list"><dl>
									<dt><var>$query</var></dt>
									<dd>the query to translate</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>the translated query
								</div>
