		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ObjectType.php" class="cssmenu-title">ObjectType</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ObjectType</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>Type that maps a PHP object to a clob SQL type.</p>
			</div>
