...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.User.php">User</a>\authentication</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.User.php">User</a>\authentication</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-AuthenticationMethod.php">AuthenticationMethod</a></td>
	<td class="ellipsis"><p>The AuthenticationMethod interface could be implemented in different ways to enable specifics
...
implementations of this class to support LDAP authentication, OpenID, Facebook connect and more...</p></td>
</tr>
<tr>
	<td class="name"><a href="class-AuthenticationService.php">AuthenticationService</a></td>
	<td class="ellipsis"><p>This class manages the authentication mecanism. Several authentication methods could be used.
If the authentication by the selected method successful, the user session is started.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-ExternalAuthenticationsExtensionPoint.php">ExternalAuthenticationsExtensionPoint</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-PHPBoostAuthenticationMethod.php">PHPBoostAuthenticationMethod</a></td>
	<td class="ellipsis"><p>The AuthenticationMethod interface could be implemented in different ways to enable specifics
authentication mecanisms.
PHPBoost comes with a PHPBoostAuthenticationMethod which will be performed on the internal member
list. But it is possible to implement external authentication mecanism by providing others
...
<tr>
	<td class="name"><a href="class-ExternalAuthentication.php">ExternalAuthentication</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
