<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ContentSharingActionsMenuLink.php" class="cssmenu-title">ContentSharingActionsMenuLink</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ContentSharingActionsMenuLink</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Share.php">Share</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 04 14
						</span>
						<span class="infos-options">
							<b>Since:</b>
...
<a href="source-class-ContentSharingActionsMenuLink.php#54-57" title="Go to source code">get_url</a>( )
			...
			<tr data-order="get_image_render_html" id="_get_image_render_html">
...
<a href="source-class-ContentSharingActionsMenuLink.php#59-62" title="Go to source code">get_image_render_html</a>( )
			...
			<tr data-order="get_onclick_tag" id="_get_onclick_tag">
