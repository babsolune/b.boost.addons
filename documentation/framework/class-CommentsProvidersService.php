		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CommentsProvidersService.php" class="cssmenu-title">CommentsProvidersService</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CommentsProvidersService</h2></header>
		<div class="content">
