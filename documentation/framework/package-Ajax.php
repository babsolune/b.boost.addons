...
<section id="content">
	...
	<article>
		<header><h2>Package Ajax</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-Ajax.Controllers.php">Ajax\Controllers</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-AjaxRequest.php">AjaxRequest</a></td>
