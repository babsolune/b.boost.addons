<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-HTMLTable.php" class="cssmenu-title">HTMLTable</a></li>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Table.php">Table</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 10 23
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2009 12 26
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
							Julien BRISWALTER <a href="&#x6d;&#x61;&#x69;&#108;&#116;&#111;:&#x6a;&#x31;&#x2e;&#115;&#101;&#116;h&#x40;&#x70;&#x68;&#112;&#98;&#111;o&#x73;&#x74;&#x2e;&#99;&#111;&#109;">&#x6a;&#x31;&#x2e;&#115;&#101;&#116;h&#x40;&#x70;&#x68;&#112;&#98;&#111;o&#x73;&#x74;&#x2e;&#99;&#111;&#109;</a>
						</span>
					<span class="infos-options"><b>Located at:</b> <a href="source-class-HTMLTable.php#3-331" title="Go to source code">builder/table/HTMLTable.class.php</a></span>
			</div>

			<div class="description">
				<p>This class allows you to manage easily html tables.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractHTMLElement.php"><span>AbstractHTMLElement</span></a>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTable.php#48-61" title="Go to source code">__construct</a>( <span><code><a href="class-HTMLTableModel.php">HTMLTableModel</a></code> <var>$model</var></span>, <span> <var>$css_class</var> = <span class="php-quote">'table'</span></span>, <span> <var>$tpl_path</var> = <span class="php-quote">''</span></span> )
						</code>
			...
			<tr data-order="display" id="_display">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTable.php#63-74" title="Go to source code">display</a>( )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractHTMLElement.php#_display">AbstractHTMLElement::display()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="set_rows" id="_set_rows">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_set_rows">#</a>
						<code>
<a href="source-class-HTMLTable.php#90-99" title="Go to source code">set_rows</a>( <span> <var>$nb_rows</var></span>, <span>array <var>$rows</var></span> )
						</code>
			...
			<tr data-order="set_filters_fieldset_class_HTML" id="_set_filters_fieldset_class_HTML">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_set_filters_fieldset_class_HTML">#</a>
						<code>
<a href="source-class-HTMLTable.php#101-104" title="Go to source code">set_filters_fieldset_class_HTML</a>( )
						</code>
			...
			<tr data-order="set_filters_fieldset_class_vertical" id="_set_filters_fieldset_class_vertical">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_set_filters_fieldset_class_vertical">#</a>
						<code>
<a href="source-class-HTMLTable.php#106-109" title="Go to source code">set_filters_fieldset_class_vertical</a>( )
						</code>
			...
			<tr data-order="generate_row" id="_generate_row">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_generate_row">#</a>
						<code>
<a href="source-class-HTMLTable.php#246-258" title="Go to source code">generate_row</a>( <span><code><a href="class-HTMLTableRow.php">HTMLTableRow</a></code> <var>$row</var></span> )
						</code>
			...
			<tr data-order="get_page_number" id="_get_page_number">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTable.php#312-315" title="Go to source code">get_page_number</a>( )
						</code>
			...
			<tr data-order="get_nb_rows_per_page" id="_get_nb_rows_per_page">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTable.php#317-325" title="Go to source code">get_nb_rows_per_page</a>( )
						</code>
			...
			<tr data-order="get_first_row_index" id="_get_first_row_index">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_get_first_row_index">#</a>
						<code>
<a href="source-class-HTMLTable.php#327-330" title="Go to source code">get_first_row_index</a>( )
						</code>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractHTMLElement.php#methods">AbstractHTMLElement</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractHTMLElement.php#_add_css_class">add_css_class()</a>, 
									<a href="class-AbstractHTMLElement.php#_add_css_style">add_css_style()</a>, 
									<a href="class-AbstractHTMLElement.php#_get_css_class">get_css_class()</a>, 
									<a href="class-AbstractHTMLElement.php#_get_css_style">get_css_style()</a>, 
									<a href="class-AbstractHTMLElement.php#_get_id">get_id()</a>, 
									<a href="class-AbstractHTMLElement.php#_has_css_class">has_css_class()</a>, 
									<a href="class-AbstractHTMLElement.php#_has_css_style">has_css_style()</a>, 
									<a href="class-AbstractHTMLElement.php#_has_id">has_id()</a>, 
									<a href="class-AbstractHTMLElement.php#_set_css_class">set_css_class()</a>, 
									<a href="class-AbstractHTMLElement.php#_set_css_style">set_css_style()</a>, 
									<a href="class-AbstractHTMLElement.php#_set_id">set_id()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<tr data-order="parameters" id="$parameters">
				<td class="attributes">
					<code>
						public  
						<code><a href="class-HTMLTableParameters.php">HTMLTableParameters</a></code>
					</code>
				</td>

				<td class="name">
						<a href="source-class-HTMLTable.php#21-24" title="Go to source code"><var>$parameters</var></a>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-AbstractHTMLElement.php#properties">AbstractHTMLElement</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractHTMLElement.php#$css_class"><var>$css_class</var></a>, 
									<a href="class-AbstractHTMLElement.php#$css_style"><var>$css_style</var></a>, 
									<a href="class-AbstractHTMLElement.php#$id"><var>$id</var></a>
							</code>
						</td>
					</tr>
				</table>
