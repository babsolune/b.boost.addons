		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-UnexistingHTTPParameterException.php" class="cssmenu-title">UnexistingHTTPParameterException</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>UnexistingHTTPParameterException</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.HTTP.php">HTTP</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-UnexistingHTTPParameterException.php#3-19" title="Go to source code">io/http/UnexistingHTTPParameterException.class.php</a></span>
			</div>
...
<b><span>UnexistingHTTPParameterException</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-UnexistingHTTPParameterException.php#15-18" title="Go to source code">__construct</a>( <span> <var>$varname</var></span> )
						</code>
