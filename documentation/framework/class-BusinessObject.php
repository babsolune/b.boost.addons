<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-BusinessObject.php" class="cssmenu-title">BusinessObject</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>BusinessObject</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-MVC.php">MVC</a>\<a href="package-MVC.Model.php">Model</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-BusinessObject.php#3-34" title="Go to source code">mvc/model/BusinessObject.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>BusinessObject</span></b>					
					 implements 
						<a href="class-PropertiesMapInterface.php"><span>PropertiesMapInterface</span></a>
			...
			<tr data-order="populate" id="_populate">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-BusinessObject.php#15-22" title="Go to source code">populate</a>( <span>mixed[string] <var>$properties_map</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<div class="list"><code><a href="class-PropertiesMapInterface.php#_populate">PropertiesMapInterface::populate()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_raw_value" id="_get_raw_value">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-BusinessObject.php#24-33" title="Go to source code">get_raw_value</a>( <span>string[] <var>$properties_list</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-PropertiesMapInterface.php#_get_raw_value">PropertiesMapInterface::get_raw_value()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
