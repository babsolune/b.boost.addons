		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-PlainCodeHighlighter.php" class="cssmenu-title">PlainCodeHighlighter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>PlainCodeHighlighter</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Formatting.php">Formatting</a>\<a href="package-Content.Formatting.parser.php">parser</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-PlainCodeHighlighter.php#3-36" title="Go to source code">content/formatting/parser/PlainCodeHighlighter.class.php</a></span>
			</div>

			<div class="description">
				<p>This is a manual syntax highlighter for plain code with the [highlight]
tag to choose what to highlight.</p>
			</div>
...
<b><span>PlainCodeHighlighter</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-PlainCodeHighlighter.php#21-27" title="Go to source code">__construct</a>( )
						</code>

							<div class="description short">
								<p>Build a PlainCodeHighlighter object.</p>
							</div>
			...
			<tr data-order="parse" id="_parse">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-PlainCodeHighlighter.php#29-35" title="Go to source code">parse</a>( )
						</code>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="HIGHLIGHTING_STYLE" id="HIGHLIGHTING_STYLE">

						<td class="attributes"><code>string</code></td>
						<td class="name">
							<code>
								<a href="source-class-PlainCodeHighlighter.php#19" title="Go to source code"><b>HIGHLIGHTING_STYLE</b></a>
							</code>
						...
						<td class="value">
							<div>
								<a href="#HIGHLIGHTING_STYLE" class="anchor">#</a>
								<code><span class="php-quote">'color:#BA154C; font-weight:bold;'</span></code>
							</div>
						</td>
					</tr>
				</table>
