...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Data.php">Data</a>\config</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Data.php">Data</a>\config</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-AbstractConfigData.php">AbstractConfigData</a></td>
	<td class="ellipsis">This is a default and minimal implementation of the ConfigData interface.</td>
</tr>
<tr>
	<td class="name"><a href="class-ConfigManager.php">ConfigManager</a></td>
	<td class="ellipsis"><p>This class manages config loading and saving. It makes a two-level lazy loading:</p>
...
<tr>
	<td class="name"><a href="class-ConfigData.php">ConfigData</a></td>
	<td class="ellipsis"><p>This interface represents configuration data which are stored automatically by the
config manager. The storage mode is very powerful, it uses a two-level cache and the database.</p>

<p>They are stored in a map associating a value to a property</p></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-ConfigNotFoundException.php">ConfigNotFoundException</a></td>
	<td class="ellipsis"><p>This exception is raised when a configuration entry is load whereas it doesn't exists in the
database.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-PropertyNotFoundException.php">PropertyNotFoundException</a></td>
	<td class="ellipsis">This exception is raised when a not existing property is asked in a ConfigData object.</td>
</tr>
	</table>
</div>
