...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\Member</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\Member</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-PHPBoost.Member.authorization.php">PHPBoost\Member\authorization</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Member.extended.fields.php">PHPBoost\Member\extended-fields</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-GroupsService.php">GroupsService</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-MemberSanctionManager.php">MemberSanctionManager</a></td>
	<td class="ellipsis">This class is responsible a punish member</td>
</tr>
<tr>
	<td class="name"><a href="class-PrivateMsg.php">PrivateMsg</a></td>
	<td class="ellipsis">This class provides methods to manage private message.</td>
</tr>
<tr>
	<td class="name"><a href="class-Uploads.php">Uploads</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
