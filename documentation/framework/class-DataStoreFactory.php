		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-DataStoreFactory.php" class="cssmenu-title">DataStoreFactory</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DataStoreFactory</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Data.php">Data</a>\<a href="package-IO.Data.store.php">store</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 06 29
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<div class="description">
				<p>This factory returns you the data store that are the best for your requirements.</p>
			</div>
		...
		<div class="content">
			...
			<tr data-order="get_ram_store" id="_get_ram_store">

				<td class="attributes">
					<code>
						 public static

						<code><a href="class-DataStore.php">DataStore</a></code>
...
<a href="source-class-DataStoreFactory.php#21-33" title="Go to source code">get_ram_store</a>( <span>string <var>$id</var></span> )
							...
							<div class="description short">
								<p>Returns an efficient data store whose life span can be not infinite.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns an efficient data store whose life span can be not infinite.</p>
								...
								<div class="list"><dl>
									<dt><var>$id</var></dt>
									<dd>Identifier of the data store.</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-DataStore.php">DataStore</a></code><br>The best data store you can use with the current configuration
								</div>
			...
			<tr data-order="get_filesystem_store" id="_get_filesystem_store">
...
<a href="source-class-DataStoreFactory.php#35-47" title="Go to source code">get_filesystem_store</a>( <span>string <var>$id</var></span> )
							...
							<div class="description short">
								<p>Returns an infinite-life span data store that can be not very efficient.</p>
							</div>
			...
			<tr data-order="is_apc_available" id="_is_apc_available">
...
<a href="source-class-DataStoreFactory.php#49-63" title="Go to source code">is_apc_available</a>( )
			...
			<tr data-order="is_apc_enabled" id="_is_apc_enabled">
...
<a href="source-class-DataStoreFactory.php#65-80" title="Go to source code">is_apc_enabled</a>( )
			...
			<tr data-order="set_apc_enabled" id="_set_apc_enabled">
...
<a href="source-class-DataStoreFactory.php#82-92" title="Go to source code">set_apc_enabled</a>( <span>boolean <var>$enabled</var></span> )
							...
							<div class="description short">
								<p>Enables or disables APC. Writes in the file /cache/apc.php</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Enables or disables APC. Writes in the file /cache/apc.php</p>
								...
								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-IOException.php">IOException</a></code><br>If the file cannot be written
								</div>
