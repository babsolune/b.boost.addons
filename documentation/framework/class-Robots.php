		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Robots.php" class="cssmenu-title">Robots</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<a href="source-class-Robots.php#18-21" title="Go to source code">is_robot</a>( )
			...
			<tr data-order="get_current_robot_name" id="_get_current_robot_name">
