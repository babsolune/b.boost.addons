		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AdminDisplayResponse.php" class="cssmenu-title">AdminDisplayResponse</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AdminDisplayResponse</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-MVC.php">MVC</a>\<a href="package-MVC.Response.php">Response</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-AdminDisplayResponse.php#3-20" title="Go to source code">mvc/response/AdminDisplayResponse.class.php</a></span>
			</div>
...
<b><span>AdminDisplayResponse</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AdminDisplayResponse.php#16-19" title="Go to source code">__construct</a>( <span> <var>$view</var></span>, <span> <var>$location_id</var> = <span class="php-quote">''</span></span> )
						</code>
					...
					<tr>
						<td>
							<code>
									...
									<a href="class-AbstractResponse.php#_send">send()</a>
							</code>
						</td>
					</tr>
				</table>
