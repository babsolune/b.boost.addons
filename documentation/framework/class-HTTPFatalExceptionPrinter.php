		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTTPFatalExceptionPrinter.php" class="cssmenu-title">HTTPFatalExceptionPrinter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTTPFatalExceptionPrinter</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Core.php">Core</a>\<a href="package-Core.Error.php">Error</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2017 04 20
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2010 10 18
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
