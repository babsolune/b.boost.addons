...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\renderer</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\renderer</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-DefaultTemplateRenderer.php">DefaultTemplateRenderer</a></td>
	<td class="ellipsis"><p>This template renderer is able to deal with both loader which cache and don't cache.
When the loader supports caching, it includes the cached file to use APC's optimization, but
if it doesn't support it, it simply evals the template code.</p></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-TemplateRenderer.php">TemplateRenderer</a></td>
	<td class="ellipsis"><p>Represents a template renderer as its names shows. Its able to get the result of the template
interpration from a TemplateLoader which gives it the template source and a TemplateData which
contains the data to assign in the template.</p></td>
</tr>
	</table>
</div>
