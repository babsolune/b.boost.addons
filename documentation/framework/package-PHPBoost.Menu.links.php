...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Menu.php">Menu</a>\links</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Menu.php">Menu</a>\links</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-LinksMenu.php">LinksMenu</a></td>
	<td class="ellipsis"><p>Create a Menu with children.
Children could be Menu or LinksMenuLink objects</p></td>
</tr>
<tr>
	<td class="name"><a href="class-LinksMenuElement.php">LinksMenuElement</a></td>
	<td class="ellipsis"><p>A LinksMenuElement contains a Title, an url, and an image url</p>
...
use, on of these</div></td>
</tr>
<tr>
	<td class="name"><a href="class-LinksMenuLink.php">LinksMenuLink</a></td>
	<td class="ellipsis">A Simple menu link</td>
</tr>
	</table>
</div>
