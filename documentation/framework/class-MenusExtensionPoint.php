<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-MenusExtensionPoint.php" class="cssmenu-title">MenusExtensionPoint</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MenusExtensionPoint</h2></header>
		<div class="content">
...
<b><span>MenusExtensionPoint</span></b>					
					 implements 
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'menus'</span></code>
							</div>
						</td>
					</tr>
				</table>
