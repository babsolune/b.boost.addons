		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-PHPBoostFoldersPermissions.php" class="cssmenu-title">PHPBoostFoldersPermissions</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>PHPBoostFoldersPermissions</h2></header>
		<div class="content">
...
<a href="source-class-PHPBoostFoldersPermissions.php#24-35" title="Go to source code">validate</a>( )
			...
			<tr data-order="get_permissions" id="_get_permissions">
