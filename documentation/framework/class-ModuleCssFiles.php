<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ModuleCssFiles.php" class="cssmenu-title">ModuleCssFiles</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ModuleCssFiles</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class allows you to manage css files of a module</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>ModuleCssFiles</span></b>					
					 implements 
						<a href="class-CssFilesExtensionPoint.php"><span>CssFilesExtensionPoint</span></a>
		...
		<div class="content">
			...
			<tr data-order="adding_always_displayed_file" id="_adding_always_displayed_file">
...
<a href="source-class-ModuleCssFiles.php#28-35" title="Go to source code">adding_always_displayed_file</a>( <span>string <var>$css_file</var></span> )
							...
							<div class="description short">
								<p>Adding css files to the module to display only the pages of the module</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Adding css files to the module to display only the pages of the module</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$css_file</var></dt>
									<dd>containing css file name</dd>
								</dl></div>
			...
			<tr data-order="get_css_files_always_displayed" id="_get_css_files_always_displayed">
...
<a href="source-class-ModuleCssFiles.php#37-40" title="Go to source code">get_css_files_always_displayed</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									array<br>css files containing in the templates folder module
								</div>
								...
								<div class="list"><code><a href="class-CssFilesExtensionPoint.php#_get_css_files_always_displayed">CssFilesExtensionPoint::get_css_files_always_displayed()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="adding_running_module_displayed_file" id="_adding_running_module_displayed_file">
...
<a href="source-class-ModuleCssFiles.php#42-49" title="Go to source code">adding_running_module_displayed_file</a>( <span>string <var>$css_file</var></span>, <span> <var>$module_id</var> = <span class="php-quote">''</span></span> )
							...
							<div class="description short">
								<p>Adding css files to display on all pages</p>
							</div>
			...
			<tr data-order="get_css_files_running_module_displayed" id="_get_css_files_running_module_displayed">
...
<a href="source-class-ModuleCssFiles.php#51-54" title="Go to source code">get_css_files_running_module_displayed</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-CssFilesExtensionPoint.php#_get_css_files_running_module_displayed">CssFilesExtensionPoint::get_css_files_running_module_displayed()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-CssFilesExtensionPoint.php#constants">CssFilesExtensionPoint</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-CssFilesExtensionPoint.php#EXTENSION_POINT"><b>EXTENSION_POINT</b></a>
							</code>
						</td>
					</tr>
				</table>
