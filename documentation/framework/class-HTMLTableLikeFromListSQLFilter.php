		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTMLTableLikeFromListSQLFilter.php" class="cssmenu-title">HTMLTableLikeFromListSQLFilter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLTableLikeFromListSQLFilter</h2></header>
		<div class="content">
			...
			<dl class="tree">
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>HTMLTableLikeFromListSQLFilter</span></b>					
					 implements 
...
<a href="source-class-HTMLTableLikeFromListSQLFilter.php#25-39" title="Go to source code">get_sql</a>( )
			...
			<tr data-order="get_like_value" id="_get_like_value">
