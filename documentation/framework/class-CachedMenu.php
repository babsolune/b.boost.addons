<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-CachedMenu.php" class="cssmenu-title">CachedMenu</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CachedMenu</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Menu.php">Menu</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 01 28
						</span>
						<span class="infos-options">
							<b>Since:</b>
...
<a href="source-class-CachedMenu.php#19-23" title="Go to source code">__construct</a>( <span><code><a href="class-Menu.php">Menu</a></code> <var>$menu</var></span> )
			...
			<tr data-order="get_menu" id="_get_menu">
...
<a href="source-class-CachedMenu.php#33-36" title="Go to source code">get_menu</a>( )
			...
			<tr data-order="get_cached_string" id="_get_cached_string">
...
<a href="source-class-CachedMenu.php#38-41" title="Go to source code">get_cached_string</a>( )
			...
			<tr data-order="has_cached_string" id="_has_cached_string">
