		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-LangsManager.php" class="cssmenu-title">LangsManager</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>LangsManager</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Langs.php">Langs</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 01 21
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2012 01 19
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
		...
		<div class="content">
			...
			<tr data-order="get_installed_langs_map" id="_get_installed_langs_map">
...
<a href="source-class-LangsManager.php#19-22" title="Go to source code">get_installed_langs_map</a>( )
			...
			<tr data-order="get_installed_langs_map_sorted_by_localized_name" id="_get_installed_langs_map_sorted_by_localized_name">
...
<a href="source-class-LangsManager.php#24-36" title="Go to source code">get_installed_langs_map_sorted_by_localized_name</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									Lang[string]<br><p>the Lang map (name => lang) of the installed langs (activated or not)
sorted by name</p>
								</div>
			...
			<tr data-order="get_activated_langs_map" id="_get_activated_langs_map">
...
<a href="source-class-LangsManager.php#38-47" title="Go to source code">get_activated_langs_map</a>( )
			...
			<tr data-order="get_activated_langs_map_sorted_by_localized_name" id="_get_activated_langs_map_sorted_by_localized_name">
...
<a href="source-class-LangsManager.php#49-61" title="Go to source code">get_activated_langs_map_sorted_by_localized_name</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									Lang[string]<br><p>the Langs map (name => lang) of the installed langs (and activated)
sorted by name</p>
								</div>
			...
			<tr data-order="get_activated_and_authorized_langs_map" id="_get_activated_and_authorized_langs_map">
...
<a href="source-class-LangsManager.php#63-72" title="Go to source code">get_activated_and_authorized_langs_map</a>( )
			...
			<tr data-order="get_activated_and_authorized_langs_map_sorted_by_localized_name" id="_get_activated_and_authorized_langs_map_sorted_by_localized_name">
...
<a href="source-class-LangsManager.php#74-86" title="Go to source code">get_activated_and_authorized_langs_map_sorted_by_localized_name</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									Lang[string]<br><p>the Langs map (name => lang) of the installed langs (and activated and authorized)
sorted by name</p>
								</div>
			...
			<tr data-order="callback_sort_langs_by_name" id="_callback_sort_langs_by_name">
...
<a href="source-class-LangsManager.php#102-105" title="Go to source code">get_lang</a>( <span> <var>$id</var></span> )
			...
			<tr data-order="get_lang_existed" id="_get_lang_existed">
