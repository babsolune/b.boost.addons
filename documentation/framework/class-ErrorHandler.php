<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ErrorHandler.php" class="cssmenu-title">ErrorHandler</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ErrorHandler</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Core.php">Core</a>\<a href="package-Core.Error.php">Error</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 01 31
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2009 09 30
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-IntegratedErrorHandler.php">IntegratedErrorHandler</a>
			</div>
...
<a href="source-class-ErrorHandler.php#35-58" title="Go to source code">handle</a>( <span>unknown_type <var>$errno</var></span>, <span>unknown_type <var>$errstr</var></span>, <span>unknown_type <var>$errfile</var></span>, <span>unknown_type <var>$errline</var></span> )
							...
							<div class="description short">
								<p>log the error and displays it in debug mode</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>log the error and displays it in debug mode</p>
								...
								<div class="list"><dl>
									<dt><var>$errno</var></dt>
									<dd>contains the level of the error raised, as an integer</dd>
									<dt><var>$errstr</var></dt>
									<dd>contains the error message, as a string</dd>
									<dt><var>$errfile</var></dt>
									<dd>the filename that the error was raised in, as a string</dd>
									<dt><var>$errline</var></dt>
									<dd>the line number the error was raised at, as an integer</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									boolean<br><p>always true because we don't want the php default error handler to process the
error again</p>
								</div>
			...
			<tr data-order="get_stackstrace_as_string" id="_get_stackstrace_as_string">
...
<a href="source-class-ErrorHandler.php#160-163" title="Go to source code">display_fatal</a>( )
			...
			<tr data-order="add_error_in_log" id="_add_error_in_log">
...
<a href="source-class-ErrorHandler.php#170-175" title="Go to source code">add_error_in_log</a>( <span> <var>$error_msg</var></span>, <span> <var>$error_stacktrace</var></span>, <span> <var>$errno</var> = <span class="php-num">0</span></span> )
			...
			<tr data-order="get_errno_class" id="_get_errno_class">
...
<a href="source-class-ErrorHandler.php#212-235" title="Go to source code">get_errno_class</a>( <span> <var>$errno</var></span> )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="FATAL_MESSAGE" id="FATAL_MESSAGE">
						...
						<td class="value">
							<div>
								<a href="#FATAL_MESSAGE" class="anchor">#</a>
								<code><span class="php-quote">'Sorry, we encountered a problem and we cannot complete your request...'</span></code>
							</div>
						</td>
					</tr>
				</table>
			...
			<tr data-order="errno" id="$errno">
				...
				<td class="value">
					<div>
						<a href="#$errno" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="errfile" id="$errfile">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$errfile" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="errline" id="$errline">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$errline" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="errdesc" id="$errdesc">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$errdesc" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="errclass" id="$errclass">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$errclass" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			...
			<tr data-order="stacktrace" id="$stacktrace">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$stacktrace" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="exception" id="$exception">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$exception" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
