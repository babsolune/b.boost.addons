		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AjaxCommentsDisplayController.php" class="cssmenu-title">AjaxCommentsDisplayController</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AjaxCommentsDisplayController</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Comments.php">Comments</a>\<a href="package-Content.Comments.controllers.php">controllers</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 10 22
						</span>
						<span class="infos-options">
							<b>Since:</b>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-AjaxCommentsDisplayController.php#3-30" title="Go to source code">content/comments/controllers/AjaxCommentsDisplayController.class.php</a></span>
			</div>
			...
			<dl class="tree">
				...
				<dd style="padding-left:30px">
					...
					<a href="class-AbstractCommentsController.php"><span>AbstractCommentsController</span></a>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>AjaxCommentsDisplayController</span></b>					
			...
			<tr data-order="execute" id="_execute">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-Response.php">Response</a></code>
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AjaxCommentsDisplayController.php#16-24" title="Go to source code">execute</a>( <span><code><a href="class-HTTPRequestCustom.php">HTTPRequestCustom</a></code> <var>$request</var></span> )
						</code>

							<div class="description short">
								<p>execute the controller and returns the response</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>execute the controller and returns the response</p>
								...
								<div class="list"><dl>
									...
									<dd>the request received</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-Response.php">Response</a></code><br>the controller response
								</div>



								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractCommentsController.php#_execute">AbstractCommentsController::execute()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractCommentsController.php#methods">AbstractCommentsController</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractCommentsController.php#_get_authorizations">get_authorizations()</a>, 
									<a href="class-AbstractCommentsController.php#_get_id_in_module">get_id_in_module()</a>, 
									<a href="class-AbstractCommentsController.php#_get_module_id">get_module_id()</a>, 
									<a href="class-AbstractCommentsController.php#_get_topic_identifier">get_topic_identifier()</a>, 
									<a href="class-AbstractCommentsController.php#_is_authorized_read">is_authorized_read()</a>, 
									<a href="class-AbstractCommentsController.php#_is_display">is_display()</a>
							</code>
						</td>
					</tr>
				</table>
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractController.php#methods">AbstractController</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractController.php#_get_right_controller_regarding_authorizations">get_right_controller_regarding_authorizations()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-AbstractCommentsController.php#properties">AbstractCommentsController</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractCommentsController.php#$id_in_module"><var>$id_in_module</var></a>, 
									<a href="class-AbstractCommentsController.php#$module_id"><var>$module_id</var></a>, 
									<a href="class-AbstractCommentsController.php#$provider"><var>$provider</var></a>, 
									<a href="class-AbstractCommentsController.php#$topic_identifier"><var>$topic_identifier</var></a>
							</code>
						</td>
					</tr>
				</table>
