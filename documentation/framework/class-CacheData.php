<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-CacheData.php" class="cssmenu-title">CacheData</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Data.php">Data</a>\<a href="package-IO.Data.cache.php">cache</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-CacheData.php#3-24" title="Go to source code">io/data/cache/CacheData.class.php</a></span>
			</div>

			<div class="description">
				<p>This interface represents data which are stored automatically by the cache manager.
The storage mode is very powerful, it uses a two-level cache and the database.</p>
...
in a map associating a value to a property</p>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AdministratorAlertCache.php">AdministratorAlertCache</a>, 
					<a href="class-CategoriesCache.php">CategoriesCache</a>, 
					<a href="class-StatsCache.php">StatsCache</a>, 
					<a href="class-UnreadContributionsCache.php">UnreadContributionsCache</a>, 
					<a href="class-CommentsCache.php">CommentsCache</a>, 
					<a href="class-ConfigData.php">ConfigData</a>, 
					<a href="class-ExtendedFieldsCache.php">ExtendedFieldsCache</a>, 
					<a href="class-GroupsCache.php">GroupsCache</a>, 
					<a href="class-HtaccessFileCache.php">HtaccessFileCache</a>, 
					<a href="class-KeywordsCache.php">KeywordsCache</a>, 
					<a href="class-MenusCache.php">MenusCache</a>, 
					<a href="class-SmileysCache.php">SmileysCache</a>
			</div>
			...
			<tr data-order="synchronize" id="_synchronize">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-CacheData.php#19-23" title="Go to source code">synchronize</a>( )
						</code>
