		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-UrlMappings.php" class="cssmenu-title">UrlMappings</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>UrlMappings</h2></header>
		<div class="content">
...
<b><span>UrlMappings</span></b>					
					 implements 
						<a href="class-UrlMappingsExtensionPoint.php"><span>UrlMappingsExtensionPoint</span></a>
...
<a href="source-class-UrlMappings.php#17-23" title="Go to source code">__construct</a>( <span>array <var>$mappings</var></span> )
			...
			<tr data-order="list_mappings" id="_list_mappings">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-UrlMapping.php">UrlMapping</a>[]</code>
...
<a href="source-class-UrlMappings.php#25-31" title="Go to source code">list_mappings</a>( )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><code><a href="class-UrlMappingsExtensionPoint.php#_list_mappings">UrlMappingsExtensionPoint::list_mappings()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-UrlMappingsExtensionPoint.php#constants">UrlMappingsExtensionPoint</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-UrlMappingsExtensionPoint.php#EXTENSION_POINT"><b>EXTENSION_POINT</b></a>
							</code>
						</td>
					</tr>
				</table>
