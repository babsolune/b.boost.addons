<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FormFieldset.php" class="cssmenu-title">FormFieldset</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormFieldset</h2></header>
		<div class="content">
...
<a href="source-class-FormFieldset.php#16-20" title="Go to source code">add_field</a>( <span><code><a href="class-FormField.php">FormField</a></code> <var>$field</var></span> )
							...
							<div class="description short">
								<p>Adds a list in the container</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Sets the id prefix for fields</p>
								...
								<div class="list"><dl>
									...
									<dd>The new id prefix for fields.</dd>
								</dl></div>
