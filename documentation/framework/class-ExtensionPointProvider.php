<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ExtensionPointProvider.php" class="cssmenu-title">ExtensionPointProvider</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ExtensionPointProvider</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This Class allow you to call methods on a ExtensionPointProvider extended class
...
allow your module to share services.</p>
			</div>
...
<a href="source-class-ExtensionPointProvider.php#29-38" title="Go to source code">__construct</a>( <span>string <var>$extension_provider_id</var> = <span class="php-quote">''</span></span> )
							...
							<div class="description short">
								<p>ExtensionPointProvider constructor</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>ExtensionPointProvider constructor</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$extension_provider_id</var></dt>
									<dd><p>the provider id. It's the name of the folder in witch
the extension provider is</p></dd>
								</dl></div>
...
<a href="source-class-ExtensionPointProvider.php#40-46" title="Go to source code">get_id</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>Return the id of the EtensionPoint
								</div>
...
<a href="source-class-ExtensionPointProvider.php#48-62" title="Go to source code">get_extension_point</a>( <span>string <var>$extension_point</var></span>, <span>mixed <var>$args</var> = <span class="php-keyword1">null</span></span> )
							...
							<div class="description short">
								<p>Check the existance of the extension point and if exists call it.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Check the existance of the extension point and if exists call it.</p>
								...
								<div class="list"><dl>
									...
									<dd>the name of the method you want to call</dd>
									<dt><var>$args</var></dt>
									<dd>the args you want to pass to the $extension_point method</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									mixed<br>the $extension_point returns
								</div>

								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-ExtensionPointNotFoundException.php">ExtensionPointNotFoundException</a></code>
								</div>
			...
			<tr data-order="has_extension_point" id="_has_extension_point">
...
<a href="source-class-ExtensionPointProvider.php#64-72" title="Go to source code">has_extension_point</a>( <span>string <var>$extension_point</var></span> )
							...
							<div class="description short">
								<p>Check the availability of the extension_point (hook)</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Check the availability of the extension_point (hook)</p>
								...
								<div class="list"><dl>
									<dt><var>$extension_point</var></dt>
									<dd>the name of the method you want to check the availability</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									boolean<br>true if the extension point exists, false otherwise
								</div>
			...
			<tr data-order="has_extensions_points" id="_has_extensions_points">
...
<a href="source-class-ExtensionPointProvider.php#74-89" title="Go to source code">has_extensions_points</a>( <span>array <var>$extensions_points</var></span> )
							...
							<div class="description short">
								<p>Check the availability of the extensions points (hook)</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Check the availability of the extensions points (hook)</p>
								...
								<div class="list"><dl>
									...
									<dd>the names of the methods you want to check the availability</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									boolean<br>true if all extensions points exist, false otherwise
								</div>
