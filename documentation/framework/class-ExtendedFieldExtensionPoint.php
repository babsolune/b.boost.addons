<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ExtendedFieldExtensionPoint.php" class="cssmenu-title">ExtendedFieldExtensionPoint</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ExtendedFieldExtensionPoint</h2></header>
		<div class="content">
...
<b><span>ExtendedFieldExtensionPoint</span></b>					
					 implements 
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'extended_field'</span></code>
							</div>
						</td>
					</tr>
				</table>
