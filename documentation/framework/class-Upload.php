<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-Upload.php" class="cssmenu-title">Upload</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>This class provides you methods to upload easily files to the ftp.</p>
			</div>
...
<a href="source-class-Upload.php#33-40" title="Go to source code">__construct</a>( <span>string <var>$base_directory</var> = <span class="php-quote">'upload'</span></span> )
						...
						<div class="description detailed hidden">
							<p>constructor</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$base_directory</var></dt>
									<dd>Set the directory to upload the files.</dd>
								</dl></div>
...
<a href="source-class-Upload.php#42-108" title="Go to source code">file</a>( <span>string <var>$filepostname</var></span>, <span>string <var>$regexp</var> = <span class="php-quote">''</span></span>, <span>boolean <var>$uniq_name</var> = <span class="php-keyword1">false</span></span>, <span>integer <var>$weight_max</var> = <span class="php-num">100000000</span></span>, <span>boolean <var>$check_exist</var> = <span class="php-keyword1">true</span></span> )
						...
						<div class="description detailed hidden">
							<p>Uploads a file.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$filepostname</var></dt>
									<dd>Name in the input file formulary.</dd>
									<dt><var>$regexp</var></dt>
									<dd>Regular expression to specify file format.</dd>
									<dt><var>$uniq_name</var></dt>
									<dd>If true assign a new name if a file with same name already exist. Otherwise previous file is overwrite.</dd>
									<dt><var>$weight_max</var></dt>
									<dd>The maximum file size.</dd>
									<dt><var>$check_exist</var></dt>
									<dd>If true verify if a file with the same name exist on the ftp. Otherwise previous file is overwrite.</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									boolean<br>True if the file has been succefully uploaded. Error code if an error occured.
								</div>
			...
			<tr data-order="check_img" id="_check_img">
...
<a href="source-class-Upload.php#110-138" title="Go to source code">check_img</a>( <span>string <var>$width_max</var></span>, <span>integer <var>$height_max</var></span>, <span>integer <var>$delete</var> = <span class="php-keyword1">true</span></span>, <span>boolean <var>$delete</var>,…</span> )
							...
							<div class="description short">
								<p>Checks whether an image is compliant to an maximum width and height, otherwise is $delete value is true delete it.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Checks whether an image is compliant to an maximum width and height, otherwise is $delete value is true delete it.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$width_max</var></dt>
									<dd>$filepath Path to the image.</dd>
									<dt><var>$height_max</var></dt>
									<dd>$width_max Max width</dd>
									<dt><var>$delete</var></dt>
									<dd>$height_max Max height</dd>
									<dt><var>$delete</var>,…</dt>
									<dd></dd>
								</dl></div>
			...
			<tr data-order="get_human_readable_size" id="_get_human_readable_size">
...
<a href="source-class-Upload.php#261-269" title="Go to source code">get_human_readable_size</a>( <span>integer <var>$round</var> = <span class="php-num">1</span></span> )
							...
							<div class="description short">
								<p>Returns filesize in human readable representation.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns filesize in human readable representation.</p>
								...
								<div class="list"><dl>
									<dt><var>$round</var></dt>
									<dd>The number of decimal points</dd>
								</dl></div>
			...
			<tr data-order="disableContentCheck" id="_disableContentCheck">
...
<a href="source-class-Upload.php#276" title="Go to source code">get_extension</a>( )
			...
			<tr data-order="get_original_filename" id="_get_original_filename">
...
<a href="source-class-Upload.php#277" title="Go to source code">get_original_filename</a>( )
			...
			<tr data-order="get_filename" id="_get_filename">
...
<a href="source-class-Upload.php#278" title="Go to source code">get_filename</a>( )
			...
			<tr data-order="get_size" id="_get_size">
...
<a href="source-class-Upload.php#279" title="Go to source code">get_size</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="UNIQ_NAME" id="UNIQ_NAME">
						...
						<td class="value">
							<div>
								<a href="#UNIQ_NAME" class="anchor">#</a>
								<code><span class="php-keyword1">true</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="NO_UNIQ_NAME" id="NO_UNIQ_NAME">
						...
						<td class="value">
							<div>
								<a href="#NO_UNIQ_NAME" class="anchor">#</a>
								<code><span class="php-keyword1">false</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="CHECK_EXIST" id="CHECK_EXIST">
						...
						<td class="value">
							<div>
								<a href="#CHECK_EXIST" class="anchor">#</a>
								<code><span class="php-keyword1">true</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="DELETE_ON_ERROR" id="DELETE_ON_ERROR">
						...
						<td class="value">
							<div>
								<a href="#DELETE_ON_ERROR" class="anchor">#</a>
								<code><span class="php-keyword1">true</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="NO_DELETE_ON_ERROR" id="NO_DELETE_ON_ERROR">
						...
						<td class="value">
							<div>
								<a href="#NO_DELETE_ON_ERROR" class="anchor">#</a>
								<code><span class="php-keyword1">false</span></code>
							</div>
						</td>
					</tr>
