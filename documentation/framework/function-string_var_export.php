<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="function-string_var_export.php" class="cssmenu-title">string_var_export</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="function">
	...
	<article>
		<header><h2>string_var_export</h2></header>
		<div class="content">
			...
			<div class="responsive-table">
				<table class="summary" id="parameters">
					...
					<tr id="$var">
						...
						<td class="value"><code><var>$var</var></code></td>
						<td></td>
					</tr>
				</table>
			</div>
