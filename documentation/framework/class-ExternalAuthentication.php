<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ExternalAuthentication.php" class="cssmenu-title">ExternalAuthentication</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ExternalAuthentication</h2></header>
		<div class="content">
		...
		<div class="content">
			...
			<tr data-order="get_authentication_id" id="_get_authentication_id">
...
<a href="source-class-ExternalAuthentication.php#16-19" title="Go to source code">get_authentication_id</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>Unique identifier for the name of the authentication system
								</div>
			...
			<tr data-order="get_authentication_name" id="_get_authentication_name">
...
<a href="source-class-ExternalAuthentication.php#21-24" title="Go to source code">get_authentication_name</a>( )
			...
			<tr data-order="authentication_actived" id="_authentication_actived">
...
<a href="source-class-ExternalAuthentication.php#26-29" title="Go to source code">authentication_actived</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									boolean<br>true if the authentication system is enabled
								</div>
			...
			<tr data-order="get_image_renderer_html" id="_get_image_renderer_html">
...
<a href="source-class-ExternalAuthentication.php#31-34" title="Go to source code">get_image_renderer_html</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>contains HTML tag image rendering
								</div>
...
<a href="source-class-ExternalAuthentication.php#36-39" title="Go to source code">get_css_class</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>contains css class for button rendering
								</div>
			...
			<tr data-order="get_authentication" id="_get_authentication">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-AuthenticationMethod.php">AuthenticationMethod</a></code>
...
<a href="source-class-ExternalAuthentication.php#41-44" title="Go to source code">get_authentication</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-AuthenticationMethod.php">AuthenticationMethod</a></code><br>class
								</div>
			...
			<tr data-order="delete_session_token" id="_delete_session_token">
