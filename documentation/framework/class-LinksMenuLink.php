		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-LinksMenuLink.php" class="cssmenu-title">LinksMenuLink</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>LinksMenuLink</h2></header>
		<div class="content">
...
<a href="source-class-LinksMenuLink.php#33-53" title="Go to source code">display</a>( <span><code><a href="class-Template.php">Template</a></code> <var>$template</var> = <span class="php-keyword1">false</span></span>, <span> <var>$mode</var> = LinksMenuElement::LINKS_MENU_ELEMENT__CLASSIC_DISPLAYING</span> )
					...
					<tr>
						<td>
							<code>
									...
									<a href="class-LinksMenuElement.php#__parent">_parent()</a>, 
									...
									<a href="class-LinksMenuElement.php#_update_uid">update_uid()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="LINKS_MENU_LINK__CLASS" id="LINKS_MENU_LINK__CLASS">
						...
						<td class="value">
							<div>
								<a href="#LINKS_MENU_LINK__CLASS" class="anchor">#</a>
								<code><span class="php-quote">'LinksMenuLink'</span></code>
							</div>
						</td>
					</tr>
				</table>
