		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SQLQuerier.php" class="cssmenu-title">SQLQuerier</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SQLQuerier</h2></header>
		<div class="content">
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractSQLQuerier.php">AbstractSQLQuerier</a>, 
					<a href="class-DBQuerier.php">DBQuerier</a>
			</div>

			<div>
				<h6>Indirect known implementers</h6>
					<a href="class-MySQLQuerier.php">MySQLQuerier</a>, 
					<a href="class-PDOQuerier.php">PDOQuerier</a>
			</div>
...
<a href="source-class-SQLQuerier.php#50" title="Go to source code">get_executed_requests_count</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="ORDER_BY_ASC" id="ORDER_BY_ASC">
						...
						<td class="value">
							<div>
								<a href="#ORDER_BY_ASC" class="anchor">#</a>
								<code><span class="php-quote">'ASC'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="ORDER_BY_DESC" id="ORDER_BY_DESC">
						...
						<td class="value">
							<div>
								<a href="#ORDER_BY_DESC" class="anchor">#</a>
