<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-PDODBConnectionException.php" class="cssmenu-title">PDODBConnectionException</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>PDODBConnectionException</h2></header>
		<div class="content">
...
<span>Throwable</span>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>PDODBConnectionException</span></b>					
