		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTMLTableSortingRule.php" class="cssmenu-title">HTMLTableSortingRule</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLTableSortingRule</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Table.php">Table</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 05 23
						</span>
						<span class="infos-options">
							<b>Since:</b>
...
<a href="source-class-HTMLTableSortingRule.php#24-28" title="Go to source code">__construct</a>( <span> <var>$sort_parameter</var></span>, <span> <var>$way</var> = self::ASC</span> )
			...
			<tr data-order="get_sort_parameter" id="_get_sort_parameter">
...
<a href="source-class-HTMLTableSortingRule.php#30-33" title="Go to source code">get_sort_parameter</a>( )
			...
			<tr data-order="get_order_way" id="_get_order_way">
...
<a href="source-class-HTMLTableSortingRule.php#35-38" title="Go to source code">get_order_way</a>( )
			...
			<tr data-order="set_is_default_sorting" id="_set_is_default_sorting">
...
<a href="source-class-HTMLTableSortingRule.php#40-43" title="Go to source code">set_is_default_sorting</a>( <span> <var>$is_default_sorting</var></span> )
			...
			<tr data-order="is_default_sorting" id="_is_default_sorting">
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="ASC" id="ASC">
						...
						<td class="value">
							<div>
								<a href="#ASC" class="anchor">#</a>
								<code><span class="php-quote">'!'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="DESC" id="DESC">
