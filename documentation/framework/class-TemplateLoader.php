<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-TemplateLoader.php" class="cssmenu-title">TemplateLoader</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>TemplateLoader</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class is responsible to load a template and transform it in the PHPBoost parsed template
syntax.
...
Even if the <code><a href="class-TemplateLoader.php">TemplateLoader</a></code> interface knows the cache notion, that doesn't mean that the
implementation has to support caching. It's the reason why there is the <code><a href="class-TemplateLoader.php#_supports_caching">TemplateLoader::supports_caching()</a></code> method.</p>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-CachedStringTemplateLoader.php">CachedStringTemplateLoader</a>, 
					<a href="class-FileTemplateLoader.php">FileTemplateLoader</a>, 
					<a href="class-StringTemplateLoader.php">StringTemplateLoader</a>
			</div>
...
<a href="source-class-TemplateLoader.php#30-35" title="Go to source code">supports_caching</a>( )
							...
							<div class="description short">
								<p>Tells whether the loader supports caching. If it supports it, its <code><a href="class-TemplateLoader.php#_get_cache_file_path">TemplateLoader::get_cache_file_path()</a></code>
 will have to return a non-empty value.</p>
							</div>

						<div class="description detailed hidden">
							<p>Tells whether the loader supports caching. If it supports it, its <code><a href="class-TemplateLoader.php#_get_cache_file_path">TemplateLoader::get_cache_file_path()</a></code> will have to return a non-empty value.</p>
...
This method must be called only if the loader supports caching, the <code><a href="class-TemplateLoader.php#_supports_caching">TemplateLoader::supports_caching()</a></code>
