...
<section id="content">
	<header>
		<h1>Package <a href="package-Content.php">Content</a>\<a href="package-Content.Formatting.php">Formatting</a>\parser</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-Content.php">Content</a>\<a href="package-Content.Formatting.php">Formatting</a>\parser</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-AbstractParser.php">AbstractParser</a></td>
	<td class="ellipsis">This class is the basis of all the formatting processings that exist in PHPBoost.</td>
</tr>
<tr>
	<td class="name"><a href="class-BBCodeHighlighter.php">BBCodeHighlighter</a></td>
	<td class="ellipsis"><p>This class is a highlighter for the PHPBoost BBCode language.
It supplies the highlighted code written in XHTML.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-ContentFormattingParser.php">ContentFormattingParser</a></td>
	<td class="ellipsis">This class is abstract. It contains tools that are usefull for implement a content parser.</td>
</tr>
<tr>
	<td class="name"><a href="class-ContentFormattingUnparser.php">ContentFormattingUnparser</a></td>
	<td class="ellipsis">This class is an abstract class. It contains the common elements needed by all the unparsers of PHPBoost.</td>
</tr>
<tr>
	<td class="name"><a href="class-ContentSecondParser.php">ContentSecondParser</a></td>
	<td class="ellipsis"><p>This class ensures the real time processing of the content. The major part of the processing is saved in the database to minimize as much as possible the treatment
...
The content you put in that parser must come from a ContentFormattingParser class (BBCodeParser or TinyMCEParser) (it can have been saved in a database between the first parsing and the real time parsing).</p></td>
</tr>
<tr>
	<td class="name"><a href="class-PlainCodeHighlighter.php">PlainCodeHighlighter</a></td>
	<td class="ellipsis"><p>This is a manual syntax highlighter for plain code with the [highlight]
tag to choose what to highlight.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-TemplateHighlighter.php">TemplateHighlighter</a></td>
	<td class="ellipsis">This is a syntax highlighter for the PHPBoost template syntax.</td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-FormattingParser.php">FormattingParser</a></td>
