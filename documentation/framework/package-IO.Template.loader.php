...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\loader</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\loader</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-CachedStringTemplateLoader.php">CachedStringTemplateLoader</a></td>
	<td class="ellipsis"><p>This loader is to use when you load a template whose source is directly a PHP string
and not a file. It supports caching and saves cache files in the /cache/tpl directory, using
a md5 hash to distinguish eache string input.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-FileTemplateLoader.php">FileTemplateLoader</a></td>
	<td class="ellipsis"><p>This loader is the most used. It takes a file identifier as input. This identifier corresponds
...
their source's real path.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-StringTemplateLoader.php">StringTemplateLoader</a></td>
	<td class="ellipsis"><p>This loader is a very simple one. Its input is a string containing the template source.
It doesn't supports caching so it always parses the input source.</p></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-TemplateLoader.php">TemplateLoader</a></td>
	<td class="ellipsis"><p>This class is responsible to load a template and transform it in the PHPBoost parsed template
syntax.
...
implementation has to support caching. It's the reason why there is the <code><a href="class-TemplateLoader.php#_supports_caching">TemplateLoader::supports_caching()</a></code> method.</p></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-FileTemplateLoadingException.php">FileTemplateLoadingException</a></td>
	<td class="ellipsis">This exception is thrown when the template cannot been loaded.</td>
</tr>
<tr>
	<td class="name"><a href="class-TemplateLoadingException.php">TemplateLoadingException</a></td>
	<td class="ellipsis">This exception is thrown when the template cannot been loaded.</td>
</tr>
	</table>
</div>
