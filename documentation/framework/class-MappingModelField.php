		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MappingModelField.php" class="cssmenu-title">MappingModelField</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MappingModelField</h2></header>
		<div class="content">
...
<a href="source-class-MappingModelField.php#39-53" title="Go to source code">__construct</a>( <span> <var>$property_name</var></span>, <span> <var>$db_field_name</var> = self::DEFAULT_PROPERTY_NAME</span> )
			...
			<tr data-order="get_db_field_name" id="_get_db_field_name">
...
<a href="source-class-MappingModelField.php#55-61" title="Go to source code">get_db_field_name</a>( )
			...
			<tr data-order="get_property_name" id="_get_property_name">
...
<a href="source-class-MappingModelField.php#63-69" title="Go to source code">get_property_name</a>( )
			...
			<tr data-order="getter" id="_getter">
...
<a href="source-class-MappingModelField.php#79-85" title="Go to source code">setter</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="DEFAULT_PROPERTY_NAME" id="DEFAULT_PROPERTY_NAME">
						...
						<td class="value">
							<div>
								<a href="#DEFAULT_PROPERTY_NAME" class="anchor">#</a>
								<code><span class="php-num">0x01</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="GETTER_PREFIX" id="GETTER_PREFIX">
						...
						<td class="value">
							<div>
								<a href="#GETTER_PREFIX" class="anchor">#</a>
								<code><span class="php-quote">'get_'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="SETTER_PREFIX" id="SETTER_PREFIX">
						...
						<td class="value">
							<div>
								<a href="#SETTER_PREFIX" class="anchor">#</a>
								<code><span class="php-quote">'set_'</span></code>
							</div>
						</td>
					</tr>
				</table>
