		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Bench.php" class="cssmenu-title">Bench</a></li>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>This class is done to time a process easily. You choose when to start and when to stop.</p>
			</div>
		...
		<div class="content">
			...
			<tr data-order="to_string" id="_to_string">
...
<a href="source-class-Bench.php#33-46" title="Go to source code">to_string</a>( <span>integer <var>$digits</var> = <span class="php-num">3</span></span> )
							...
							<div class="description short">
								<p>returns the number formatted with $digits floating numbers</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>returns the number formatted with $digits floating numbers</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$digits</var></dt>
									<dd>the desired display precision</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>the formatted duration
								</div>
...
<a href="source-class-Bench.php#57-64" title="Go to source code">start</a>( )
			...
			<tr data-order="get_memory_php_used" id="_get_memory_php_used">
...
<a href="source-class-Bench.php#66-74" title="Go to source code">get_memory_php_used</a>( )
							...
							<div class="description short">
								<p>Returns the amount of memory, that's currently being allocated to PHP script.</p>
							</div>
