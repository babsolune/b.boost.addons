<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-CacheDataNotFoundException.php" class="cssmenu-title">CacheDataNotFoundException</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CacheDataNotFoundException</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This exception is raised when you are asking a cache entry that doesn't exist.</p>
			</div>
...
<b><span>CacheDataNotFoundException</span></b>					
