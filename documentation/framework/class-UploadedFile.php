		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-UploadedFile.php" class="cssmenu-title">UploadedFile</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>UploadedFile</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>Represents a HTTP uploaded file</p>
			</div>
...
<a href="source-class-UploadedFile.php#53-56" title="Go to source code">get_size</a>( )
			...
			<tr data-order="get_temporary_filename" id="_get_temporary_filename">
...
<a href="source-class-UploadedFile.php#63-70" title="Go to source code">save</a>( <span><code><a href="class-File.php">File</a></code> <var>$destination</var></span> )
							...
							<div class="description short">
								<p>Saves the uploaded file on the server's filesystem.</p>
							</div>
