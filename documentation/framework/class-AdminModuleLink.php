<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AdminModuleLink.php" class="cssmenu-title">AdminModuleLink</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AdminModuleLink</h2></header>
		<div class="content">
			...
			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-ModuleLink.php"><span>ModuleLink</span></a>
...
<a href="source-class-AdminModuleLink.php#19-22" title="Go to source code">__construct</a>( <span> <var>$name</var></span>, <span> <var>$url</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-ModuleLink.php#___construct">ModuleLink::__construct()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-ModuleLink.php#methods">ModuleLink</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-ModuleLink.php#_add_sub_link">add_sub_link()</a>, 
									<a href="class-ModuleLink.php#_export">export()</a>, 
									<a href="class-ModuleLink.php#_get_name">get_name()</a>, 
									<a href="class-ModuleLink.php#_get_sub_link">get_sub_link()</a>, 
									<a href="class-ModuleLink.php#_get_url">get_url()</a>, 
									<a href="class-ModuleLink.php#_has_sub_link">has_sub_link()</a>, 
									<a href="class-ModuleLink.php#_is_active">is_active()</a>, 
									<a href="class-ModuleLink.php#_is_visible">is_visible()</a>, 
									<a href="class-ModuleLink.php#_set_name">set_name()</a>, 
									<a href="class-ModuleLink.php#_set_url">set_url()</a>, 
									<a href="class-ModuleLink.php#_set_visibility">set_visibility()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-ModuleLink.php#properties">ModuleLink</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-ModuleLink.php#$name"><var>$name</var></a>, 
									<a href="class-ModuleLink.php#$sub_link"><var>$sub_link</var></a>, 
									<a href="class-ModuleLink.php#$url"><var>$url</var></a>, 
									<a href="class-ModuleLink.php#$visibility"><var>$visibility</var></a>
							</code>
						</td>
					</tr>
				</table>
