		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ExtendedFields.php" class="cssmenu-title">ExtendedFields</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ExtendedFields</h2></header>
		<div class="content">
...
<b><span>ExtendedFields</span></b>					
					 implements 
						<a href="class-ExtendedFieldExtensionPoint.php"><span>ExtendedFieldExtensionPoint</span></a>
...
<a href="source-class-ExtendedFields.php#22-25" title="Go to source code">get_extended_fields</a>( )
							...
							<div class="description short">
								<p>Returns Array class name extended fields</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns Array class name extended fields</p>
								...
								<div class="list"><code><a href="class-ExtendedFieldExtensionPoint.php#_get_extended_fields">ExtendedFieldExtensionPoint::get_extended_fields()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-ExtendedFieldExtensionPoint.php#constants">ExtendedFieldExtensionPoint</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-ExtendedFieldExtensionPoint.php#EXTENSION_POINT"><b>EXTENSION_POINT</b></a>
							</code>
						</td>
					</tr>
				</table>
