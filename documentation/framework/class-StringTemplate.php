		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-StringTemplate.php" class="cssmenu-title">StringTemplate</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>StringTemplate</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class enables you to handle a template whose input is not a file but directly a string.
...
a big efficiency. It will be the case for instance when you know that a string template will be used only once a month.</p>
			</div>
...
<a href="source-class-StringTemplate.php#31-52" title="Go to source code">__construct</a>( <span>string <var>$content</var></span>, <span>boolean <var>$use_cache</var> = self::USE_CACHE_IF_FASTER</span>, <span>boolean <var>$auto_load_vars</var>,…</span> )
							...
							<div class="description short">
								<p>Constructs a StringTemplate</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Constructs a StringTemplate</p>
								...
								<div class="list"><dl>
									...
									<dd>The content of the template (a string containing PHPBoost's template engine syntax).</dd>
									<dt><var>$use_cache</var></dt>
									<dd>Controls if it has or not to use cache</dd>
									<dt><var>$auto_load_vars</var>,…</dt>
									<dd>Tells whether it has to load or not the most common variables.</dd>
								</dl></div>
					...
					<tr>
						<td>
							<code>
									...
									<a href="class-AbstractTemplate.php#_render">render()</a>, 
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="DONT_USE_CACHE" id="DONT_USE_CACHE">
						...
						<td class="value">
							<div>
								<a href="#DONT_USE_CACHE" class="anchor">#</a>
								<code><span class="php-keyword1">false</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="USE_CACHE_IF_FASTER" id="USE_CACHE_IF_FASTER">
						...
						<td class="value">
							<div>
								<a href="#USE_CACHE_IF_FASTER" class="anchor">#</a>
