		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FeedData.php" class="cssmenu-title">FeedData</a></li>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>Contains meta-informations about a feed with its entries</p>
			</div>
...
<a href="source-class-FeedData.php#26-42" title="Go to source code">__construct</a>( <span><code><a href="class-FeedData.php">FeedData</a></code> <var>$data</var> = <span class="php-keyword1">null</span></span> )
						...
						<div class="description detailed hidden">
							<p>Builds a FeedData Object</p>
								...
								<div class="list"><dl>
									<dt><var>$data</var></dt>
									<dd>an other FeedData object to clone</dd>
								</dl></div>
...
<a href="source-class-FeedData.php#50-54" title="Go to source code">set_date</a>( <span><code><a href="class-Date.php">Date</a></code> <var>$value</var></span> )
						...
						<div class="description detailed hidden">
							<p>Sets the feed data date</p>
								...
								<div class="list"><dl>
									<dt><var>$value</var></dt>
									<dd>a date object representing the feed date</dd>
								</dl></div>
...
<a href="source-class-FeedData.php#55-59" title="Go to source code">set_desc</a>( <span>string <var>$value</var></span> )
			...
			<tr data-order="set_lang" id="_set_lang">
...
<a href="source-class-FeedData.php#60-64" title="Go to source code">set_lang</a>( <span>string <var>$value</var></span> )
			...
			<tr data-order="set_host" id="_set_host">
...
<a href="source-class-FeedData.php#65-69" title="Go to source code">set_host</a>( <span>string <var>$value</var></span> )
			...
			<tr data-order="set_auth_bit" id="_set_auth_bit">
...
<a href="source-class-FeedData.php#70-74" title="Go to source code">set_auth_bit</a>( <span>integer <var>$value</var></span> )
							...
							<div class="description short">
								<p>Sets the feed auth bit, useful to check authorizations</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Sets the feed auth bit, useful to check authorizations</p>
								...
								<div class="list"><dl>
									<dt><var>$value</var></dt>
									<dd>the bit position in an int (from 1 to 32)</dd>
								</dl></div>
...
<a href="source-class-FeedData.php#75-86" title="Go to source code">set_link</a>( <span>mixed <var>$value</var></span> )
			...
			<tr data-order="add_item" id="_add_item">
...
<a href="source-class-FeedData.php#98" title="Go to source code">get_lang</a>( )
			...
			<tr data-order="get_host" id="_get_host">
			...
			<tr data-order="get_items" id="_get_items">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-FeedItem.php">FeedItem</a>[]</code>
...
<a href="source-class-FeedData.php#101-115" title="Go to source code">get_items</a>( )
						...
						<div class="description detailed hidden">
							<p>Returns the feed items</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-FeedItem.php">FeedItem</a>[]</code><br>the feed items
								</div>
...
<a href="source-class-FeedData.php#117-120" title="Go to source code">serialize</a>( )
			...
			<tr data-order="subitems" id="_subitems">
...
<a href="source-class-FeedData.php#123-140" title="Go to source code">subitems</a>( <span>integer <var>$number</var> = <span class="php-num">10</span></span>, <span>integer <var>$begin_at</var> = <span class="php-num">0</span></span> )
							...
							<div class="description short">
								<p>Returns a items list containing $number items starting from the $begin_at one</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns a items list containing $number items starting from the $begin_at one</p>
								...
								<div class="list"><dl>
									...
									<dd>the number of items to retrieve</dd>
									<dt><var>$begin_at</var></dt>
									<dd>the number of the first to retrieve</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-FeedItem.php">FeedItem</a>[]</code><br>the items list containing $number items starting from the $begin_at one
								</div>
