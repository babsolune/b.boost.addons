<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-CommentsAuthorizations.php" class="cssmenu-title">CommentsAuthorizations</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CommentsAuthorizations</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class could be used to specified comments authorizations (access, read, post, moderation)</p>
			</div>
		...
		<div class="content">
			...
			<tr data-order="is_authorized_access_module" id="_is_authorized_access_module">
...
<a href="source-class-CommentsAuthorizations.php#27-30" title="Go to source code">is_authorized_read</a>( )
			...
			<tr data-order="is_authorized_post" id="_is_authorized_post">
...
<a href="source-class-CommentsAuthorizations.php#32-35" title="Go to source code">is_authorized_post</a>( )
			...
			<tr data-order="is_authorized_moderation" id="_is_authorized_moderation">
...
<a href="source-class-CommentsAuthorizations.php#37-40" title="Go to source code">is_authorized_moderation</a>( )
			...
			<tr data-order="set_authorized_access_module" id="_set_authorized_access_module">
...
<a href="source-class-CommentsAuthorizations.php#42-48" title="Go to source code">set_authorized_access_module</a>( <span>boolean <var>$authorized</var></span> )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="POST_AUTHORIZATIONS" id="POST_AUTHORIZATIONS">
						...
						<td class="value">
							<div>
								<a href="#POST_AUTHORIZATIONS" class="anchor">#</a>
								<code><span class="php-num">2</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="MODERATE_AUTHORIZATIONS" id="MODERATE_AUTHORIZATIONS">
						...
						<td class="value">
							<div>
								<a href="#MODERATE_AUTHORIZATIONS" class="anchor">#</a>
