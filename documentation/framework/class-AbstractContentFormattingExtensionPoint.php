<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractContentFormattingExtensionPoint.php" class="cssmenu-title">AbstractContentFormattingExtensionPoint</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractContentFormattingExtensionPoint</h2></header>
		<div class="content">
...
<b><span>AbstractContentFormattingExtensionPoint</span></b>					
					 implements 
						<a href="class-ContentFormattingExtensionPoint.php"><span>ContentFormattingExtensionPoint</span></a>
...
<a href="source-class-AbstractContentFormattingExtensionPoint.php#25-31" title="Go to source code">set_forbidden_tags</a>( <span>array <var>$tags</var></span> )
						...
						<div class="description detailed hidden">
							<p>Sets the forbidden tags.</p>
								...
								<div class="list"><dl>
									<dt><var>$tags</var></dt>
									<dd>The list of the forbidden tags (each tag is represented by its string identifier)</dd>
								</dl></div>
								...
								<div class="list"><code><a href="class-ContentFormattingExtensionPoint.php#_set_forbidden_tags">ContentFormattingExtensionPoint::set_forbidden_tags()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractContentFormattingExtensionPoint.php#33-39" title="Go to source code">get_forbidden_tags</a>( )
							...
							<div class="description short">
								<p>Returns the list of the forbidden tags</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the list of the forbidden tags</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string[]<br>The list of the forbidden tags (each tag is represented by its string identifier)
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ContentFormattingExtensionPoint.php#_get_forbidden_tags">ContentFormattingExtensionPoint::get_forbidden_tags()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="add_forbidden_tag" id="_add_forbidden_tag">
...
<a href="source-class-AbstractContentFormattingExtensionPoint.php#41-47" title="Go to source code">add_forbidden_tag</a>( <span>string <var>$tag</var></span> )
						...
						<div class="description detailed hidden">
							<p>Adds a forbidden tag</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ContentFormattingExtensionPoint.php#_add_forbidden_tag">ContentFormattingExtensionPoint::add_forbidden_tag()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="add_forbidden_tags" id="_add_forbidden_tags">
...
<a href="source-class-AbstractContentFormattingExtensionPoint.php#49-58" title="Go to source code">add_forbidden_tags</a>( <span>array <var>$tags</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ContentFormattingExtensionPoint.php#_add_forbidden_tags">ContentFormattingExtensionPoint::add_forbidden_tags()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractContentFormattingExtensionPoint.php#60-66" title="Go to source code">set_html_auth</a>( <span>array <var>$auth</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ContentFormattingExtensionPoint.php#_set_html_auth">ContentFormattingExtensionPoint::set_html_auth()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractContentFormattingExtensionPoint.php#68-74" title="Go to source code">get_html_auth</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ContentFormattingExtensionPoint.php#_get_html_auth">ContentFormattingExtensionPoint::get_html_auth()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-ContentFormattingExtensionPoint.php#methods">ContentFormattingExtensionPoint</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-ContentFormattingExtensionPoint.php#_get_editor">get_editor()</a>, 
									<a href="class-ContentFormattingExtensionPoint.php#_get_name">get_name()</a>, 
									<a href="class-ContentFormattingExtensionPoint.php#_get_parser">get_parser()</a>, 
									<a href="class-ContentFormattingExtensionPoint.php#_get_second_parser">get_second_parser()</a>, 
									<a href="class-ContentFormattingExtensionPoint.php#_get_unparser">get_unparser()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-ContentFormattingExtensionPoint.php#constants">ContentFormattingExtensionPoint</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-ContentFormattingExtensionPoint.php#EXTENSION_POINT"><b>EXTENSION_POINT</b></a>
							</code>
						</td>
					</tr>
				</table>
