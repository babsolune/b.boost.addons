<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ContentEditor.php" class="cssmenu-title">ContentEditor</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ContentEditor</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>Abstract class for editors content.</p>
			</div>
...
<a href="source-class-ContentEditor.php#36-43" title="Go to source code">get_forbidden_tags</a>( )
						...
						<div class="description detailed hidden">
							<p>Get the fordidden tags.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									array<br>List of forbidden tags.
								</div>
...
<a href="source-class-ContentEditor.php#45-52" title="Go to source code">set_identifier</a>( <span>string <var>$identifier</var></span> )
							...
							<div class="description short">
								<p>Set the html identifier of the textarea field which contain the content to edit.</p>
							</div>
...
<a href="source-class-ContentEditor.php#54-61" title="Go to source code">set_template</a>( <span><code><a href="class-Template.php">Template</a></code> <var>$template</var></span> )
							...
							<div class="description short">
								<p>Set an alternative template for the editor.</p>
							</div>
...
<a href="source-class-ContentEditor.php#63-70" title="Go to source code">get_template</a>( )
							...
							<div class="description short">
								<p>Get the template used for the editor.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Get the template used for the editor.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-Template.php">Template</a></code><br>The template
								</div>
			...
			<tr data-order="identifier" id="$identifier">
				...
				<td class="value">
					<div>
						...
						<code><span class="php-quote">'contents'</span></code>
					</div>
				</td>
			</tr>
				</table>
