		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ExtendedFieldsService.php" class="cssmenu-title">ExtendedFieldsService</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ExtendedFieldsService</h2></header>
		<div class="content">
...
<a href="source-class-ExtendedFieldsService.php#19-50" title="Go to source code">add</a>( <span><code><a href="class-ExtendedField.php">ExtendedField</a></code> <var>$extended_field</var></span> )
						...
						<div class="description detailed hidden">
							<p>Add a extended field</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$extended_field</var></dt>
									<dd>ExtendedField containing the name, field name, position, content, field type, possible values, default values, required and regex.</dd>
								</dl></div>
...
<a href="source-class-ExtendedFieldsService.php#52-69" title="Go to source code">update</a>( <span><code><a href="class-ExtendedField.php">ExtendedField</a></code> <var>$extended_field</var></span> )
						...
						<div class="description detailed hidden">
							<p>Update a extended field</p>
								...
								<div class="list"><dl>
									<dt><var>$extended_field</var></dt>
									<dd>ExtendedField containing the id, name, field name, content, field type, possible values, default values, required and regex.</dd>
								</dl></div>
			...
			<tr data-order="delete_by_id" id="_delete_by_id">
...
<a href="source-class-ExtendedFieldsService.php#71-94" title="Go to source code">delete_by_id</a>( <span>integer <var>$id</var></span> )
							...
							<div class="description short">
								<p>Delete a extended field for id</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Delete a extended field for id</p>
								...
								<div class="list"><dl>
									<dt><var>$id</var></dt>
									<dd>the id of the extended field</dd>
								</dl></div>
			...
			<tr data-order="delete_by_field_name" id="_delete_by_field_name">
...
<a href="source-class-ExtendedFieldsService.php#96-119" title="Go to source code">delete_by_field_name</a>( <span>string <var>$field_name</var></span> )
							...
							<div class="description short">
								<p>Delete a extended field for field name</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Delete a extended field for field name</p>
								...
								<div class="list"><dl>
									...
									<dd>the field name of the extended field</dd>
								</dl></div>
			...
			<tr data-order="data_field" id="_data_field">
...
<a href="source-class-ExtendedFieldsService.php#121-157" title="Go to source code">data_field</a>( <span><code><a href="class-ExtendedField.php">ExtendedField</a></code> <var>$extended_field</var></span>, <span>const <var>$sort</var> = self::SORT_BY_ID</span> )
							...
							<div class="description short">
								<p>Return informations for extended field by id or field name</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Return informations for extended field by id or field name</p>
								...
								<div class="list"><dl>
									<dt><var>$extended_field</var></dt>
									<dd>containing the id or the field name</dd>
									<dt><var>$sort</var></dt>
									<dd><p>SORT_BY_ID or SORT_BY_FIELD_NAME
$return Object ExtendedField containing the informations field</p></dd>
								</dl></div>
...
<a href="source-class-ExtendedFieldsService.php#164-174" title="Go to source code">get_error</a>( )
							...
							<div class="description short">
								<p>$return String Possible errors encountered</p>
							</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="SORT_BY_ID" id="SORT_BY_ID">
						...
						<td class="value">
							<div>
								<a href="#SORT_BY_ID" class="anchor">#</a>
								<code><span class="php-num">1</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="SORT_BY_FIELD_NAME" id="SORT_BY_FIELD_NAME">
						...
						<td class="value">
							<div>
								<a href="#SORT_BY_FIELD_NAME" class="anchor">#</a>
