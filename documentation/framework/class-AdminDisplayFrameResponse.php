		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AdminDisplayFrameResponse.php" class="cssmenu-title">AdminDisplayFrameResponse</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AdminDisplayFrameResponse</h2></header>
		<div class="content">
...
<b><span>AdminDisplayFrameResponse</span></b>					
