		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AuthorizationsSettings.php" class="cssmenu-title">AuthorizationsSettings</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AuthorizationsSettings</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class manages authorizations settings which deals with all the actions for which you want
to restrict access. You can choose who can access to between the different roles existing in PHPBoost:</p>

<ul> <li>ranks (guest, member, moderator, administrator)</li> <li>groups (members can belong to one or more groups)</li> <li>members (you can tell that only a particular user can access)</li>
</ul>
...
<a href="source-class-AuthorizationsSettings.php#26-33" title="Go to source code">__construct</a>( <span>array <var>$actions</var> = <span class="php-keyword1">array</span>()</span> )
							...
							<div class="description short">
								<p>Constructs from a list of <code><a href="class-ActionAuthorization.php">ActionAuthorization</a></code></p>
							</div>
			...
			<tr data-order="get_actions" id="_get_actions">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-ActionAuthorization.php">ActionAuthorization</a>[]</code>
...
<a href="source-class-AuthorizationsSettings.php#35-42" title="Go to source code">get_actions</a>( )
							...
							<div class="description short">
								<p>Returns the list of the actions</p>
							</div>
			...
			<tr data-order="add_action" id="_add_action">
...
<a href="source-class-AuthorizationsSettings.php#53-67" title="Go to source code">build_auth_array</a>( )
							...
							<div class="description short">
								<p>Builds and returns the authorization array which is formatted at the legacy format to
...
check authorizations.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									mixed[]<br>The correspondant array
								</div>
...
<a href="source-class-AuthorizationsSettings.php#84-94" title="Go to source code">build_from_auth_array</a>( <span>array <var>$auth_array</var></span> )
							...
							<div class="description short">
								<p>Sets the authorizations from an authorization array formatted at the legacy format.</p>
							</div>
