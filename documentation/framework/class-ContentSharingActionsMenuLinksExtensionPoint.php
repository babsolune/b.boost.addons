		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ContentSharingActionsMenuLinksExtensionPoint.php" class="cssmenu-title">ContentSharingActionsMenuLinksExtensionPoint</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ContentSharingActionsMenuLinksExtensionPoint</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Share.php">Share</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 02 04
						</span>
						<span class="infos-options">
							<b>Since:</b>
...
<b><span>ContentSharingActionsMenuLinksExtensionPoint</span></b>					
					 implements 
...
<a href="source-class-ContentSharingActionsMenuLinksExtensionPoint.php#19-22" title="Go to source code">__construct</a>( <span> <var>$content_sharing_actions_menu_links</var></span> )
			...
			<tr data-order="get_content_sharing_actions_menu_links" id="_get_content_sharing_actions_menu_links">
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'content_sharing_actions_menu_links'</span></code>
							</div>
						</td>
					</tr>
				</table>
