		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CommentsCache.php" class="cssmenu-title">CommentsCache</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CommentsCache</h2></header>
		<div class="content">
...
For instance,</p>
			...
			<tr data-order="get_comments" id="_get_comments">
...
<a href="source-class-CommentsCache.php#49-52" title="Go to source code">get_comments</a>( )
			...
			<tr data-order="comment_exists" id="_comment_exists">
...
<a href="source-class-CommentsCache.php#54-57" title="Go to source code">comment_exists</a>( <span> <var>$id</var></span> )
			...
			<tr data-order="comment_exists_by_module" id="_comment_exists_by_module">
...
<a href="source-class-CommentsCache.php#65-72" title="Go to source code">get_comment</a>( <span> <var>$id</var></span> )
			...
			<tr data-order="get_comments_by_module" id="_get_comments_by_module">
...
<a href="source-class-CommentsCache.php#74-85" title="Go to source code">get_comments_by_module</a>( <span> <var>$module_id</var></span>, <span> <var>$id_in_module</var></span>, <span> <var>$topic_identifier</var></span> )
			...
			<tr data-order="get_count_comments_by_module" id="_get_count_comments_by_module">
...
<a href="source-class-CommentsCache.php#87-90" title="Go to source code">get_count_comments_by_module</a>( <span> <var>$module_id</var></span>, <span> <var>$id_in_module</var></span>, <span> <var>$topic_identifier</var></span> )
			...
			<tr data-order="get_count_comments" id="_get_count_comments">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-CommentsCache.php">CommentsCache</a></code>
...
<a href="source-class-CommentsCache.php#97-104" title="Go to source code">load</a>( )
							...
							<div class="description short">
								<p>Loads and returns the comments cached data.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads and returns the comments cached data.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-CommentsCache.php">CommentsCache</a></code><br>The cached data
								</div>
...
<a href="source-class-CommentsCache.php#106-112" title="Go to source code">invalidate</a>( )
							...
							<div class="description short">
								<p>Invalidates the current comments cached data.</p>
							</div>
