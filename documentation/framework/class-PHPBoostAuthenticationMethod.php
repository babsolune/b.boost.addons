		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-PHPBoostAuthenticationMethod.php" class="cssmenu-title">PHPBoostAuthenticationMethod</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>PHPBoostAuthenticationMethod</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.User.php">User</a>\<a href="package-PHPBoost.User.authentication.php">authentication</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2017 06 08
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2010 11 28
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
			...
			<div class="description">
				<p>The AuthenticationMethod interface could be implemented in different ways to enable specifics
...
implementations of this class to support LDAP authentication, OpenID, Facebook connect and more...</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AuthenticationMethod.php"><span>AuthenticationMethod</span></a>
...
<b><span>PHPBoostAuthenticationMethod</span></b>					
...
<a href="source-class-PHPBoostAuthenticationMethod.php#43-48" title="Go to source code">__construct</a>( <span> <var>$login</var></span>, <span> <var>$password</var></span> )
			...
			<tr data-order="set_association_parameters" id="_set_association_parameters">
...
<a href="source-class-PHPBoostAuthenticationMethod.php#50-54" title="Go to source code">set_association_parameters</a>( <span> <var>$approved</var> = <span class="php-keyword1">true</span></span>, <span> <var>$registration_pass</var> = <span class="php-quote">''</span></span> )
			...
			<tr data-order="get_remaining_attemps" id="_get_remaining_attemps">
...
<a href="source-class-PHPBoostAuthenticationMethod.php#61-86" title="Go to source code">associate</a>( <span>integer <var>$user_id</var></span> )
							...
							<div class="description short">
								<p>associate the current authentication method with the given user_id.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>associate the current authentication method with the given user_id.</p>
								...
								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-IllegalArgumentException.php">IllegalArgumentException</a></code><br>if the user_id is already associate with an authentication method
								</div>
			...
			<tr data-order="dissociate" id="_dissociate">
...
<a href="source-class-PHPBoostAuthenticationMethod.php#88-102" title="Go to source code">dissociate</a>( <span>integer <var>$user_id</var></span> )
							...
							<div class="description short">
								<p>dissociate the current authentication method with the given user_id.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>dissociate the current authentication method with the given user_id.</p>
								...
								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-IllegalArgumentException.php">IllegalArgumentException</a></code><br>if the user_id is already dissociate with an authentication method
								</div>
...
<a href="source-class-PHPBoostAuthenticationMethod.php#105-114" title="Go to source code">authenticate</a>( )
							...
							<div class="description short">
								<p>Tries to authenticate the user and returns true on success, false otherwise.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Tries to authenticate the user and returns true on success, false otherwise.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									integer<br>$user_id, if authentication has been performed successfully
								</div>
			...
			<tr data-order="get_auth_infos" id="_get_auth_infos">
...
<a href="source-class-PHPBoostAuthenticationMethod.php#243-249" title="Go to source code">get_auth_infos</a>( <span> <var>$user_id</var></span> )
			...
			<tr data-order="update_auth_infos" id="_update_auth_infos">
...
<a href="source-class-PHPBoostAuthenticationMethod.php#251-279" title="Go to source code">update_auth_infos</a>( <span> <var>$user_id</var></span>, <span> <var>$login</var> = <span class="php-keyword1">null</span></span>, <span> <var>$approved</var> = <span class="php-keyword1">null</span></span>, <span> <var>$password</var> = <span class="php-keyword1">null</span></span>, <span> <var>$registration_pass</var> = <span class="php-keyword1">null</span></span>, <span> <var>$change_password_pass</var> = <span class="php-keyword1">null</span></span> )
			...
			<tr data-order="registration_pass_exists" id="_registration_pass_exists">
...
<a href="source-class-PHPBoostAuthenticationMethod.php#281-290" title="Go to source code">registration_pass_exists</a>( <span> <var>$registration_pass</var></span> )
			...
			<tr data-order="change_password_pass_exists" id="_change_password_pass_exists">
...
<a href="source-class-PHPBoostAuthenticationMethod.php#292-301" title="Go to source code">change_password_pass_exists</a>( <span> <var>$change_password_pass</var></span> )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AuthenticationMethod.php#methods">AuthenticationMethod</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AuthenticationMethod.php#_check_user_bannishment">check_user_bannishment()</a>, 
									<a href="class-AuthenticationMethod.php#_get_error_msg">get_error_msg()</a>, 
									<a href="class-AuthenticationMethod.php#_has_error">has_error()</a>, 
									<a href="class-AuthenticationMethod.php#_update_user_last_connection_date">update_user_last_connection_date()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="AUTHENTICATION_METHOD" id="AUTHENTICATION_METHOD">
						...
						<td class="value">
							<div>
								<a href="#AUTHENTICATION_METHOD" class="anchor">#</a>
								<code><span class="php-quote">'internal'</span></code>
							</div>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-AuthenticationMethod.php#properties">AuthenticationMethod</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AuthenticationMethod.php#$error_msg"><var>$error_msg</var></a>
							</code>
						</td>
					</tr>
				</table>
