		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTMLTableColumn.php" class="cssmenu-title">HTMLTableColumn</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLTableColumn</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Table.php">Table</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 05 27
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<dl class="tree">
				...
				<dd style="padding-left:30px">
					...
					<a href="class-HTMLTableRowCell.php"><span>HTMLTableRowCell</span></a>
...
<a href="source-class-HTMLTableColumn.php#19-23" title="Go to source code">__construct</a>( <span> <var>$name</var></span>, <span> <var>$sortable_parameter</var> = <span class="php-quote">''</span></span>, <span> <var>$css_class</var> = <span class="php-quote">''</span></span>, <span> <var>$id</var> = <span class="php-quote">''</span></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-HTMLTableRowCell.php#___construct">HTMLTableRowCell::__construct()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="is_sortable" id="_is_sortable">
...
<a href="source-class-HTMLTableColumn.php#25-28" title="Go to source code">is_sortable</a>( )
			...
			<tr data-order="get_sortable_parameter" id="_get_sortable_parameter">
...
<a href="source-class-HTMLTableColumn.php#30-33" title="Go to source code">get_sortable_parameter</a>( )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-HTMLTableRowCell.php#methods">HTMLTableRowCell</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-HTMLTableRowCell.php#_get_colspan">get_colspan()</a>, 
									<a href="class-HTMLTableRowCell.php#_get_value">get_value()</a>, 
									<a href="class-HTMLTableRowCell.php#_is_multi_column">is_multi_column()</a>, 
									<a href="class-HTMLTableRowCell.php#_set_colspan">set_colspan()</a>
							</code>
						</td>
					</tr>
				</table>
					...
					<tr>
						<td>
							<code>
									...
									<a href="class-AbstractHTMLElement.php#_display">display()</a>, 
