		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-WritingPadConfig.php" class="cssmenu-title">WritingPadConfig</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>WritingPadConfig</h2></header>
		<div class="content">
...
<b><span>WritingPadConfig</span></b>					
...
<a href="source-class-WritingPadConfig.php#17-24" title="Go to source code">set_content</a>( <span>string <var>$content</var></span> )
							...
							<div class="description short">
								<p>Sets the content of the writing pad</p>
							</div>
...
<a href="source-class-WritingPadConfig.php#26-40" title="Go to source code">get_content</a>( )
							...
							<div class="description short">
								<p>Returns the content of the writing pad</p>
							</div>
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-WritingPadConfig.php">WritingPadConfig</a></code>
...
<a href="source-class-WritingPadConfig.php#52-59" title="Go to source code">load</a>( )
						...
						<div class="description detailed hidden">
							<p>Returs the configuration.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-WritingPadConfig.php">WritingPadConfig</a></code><br>The configuration
								</div>
