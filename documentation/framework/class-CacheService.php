		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CacheService.php" class="cssmenu-title">CacheService</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CacheService</h2></header>
		<div class="content">
...
<a href="source-class-CacheService.php#32-38" title="Go to source code">clear_cache</a>( )
			...
			<tr data-order="clear_phpboost_cache" id="_clear_phpboost_cache">
...
<a href="source-class-CacheService.php#40-44" title="Go to source code">clear_phpboost_cache</a>( )
			...
			<tr data-order="clear_template_cache" id="_clear_template_cache">
...
<a href="source-class-CacheService.php#46-49" title="Go to source code">clear_template_cache</a>( )
			...
			<tr data-order="clear_css_cache" id="_clear_css_cache">
...
<a href="source-class-CacheService.php#51-54" title="Go to source code">clear_css_cache</a>( )
			...
			<tr data-order="clear_syndication_cache" id="_clear_syndication_cache">
