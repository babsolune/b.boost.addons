		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-JoinMappingModel.php" class="cssmenu-title">JoinMappingModel</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>JoinMappingModel</h2></header>
		<div class="content">
...
<a href="source-class-JoinMappingModel.php#35-41" title="Go to source code">get_table_name</a>( )
			...
			<tr data-order="get_fk_db_field_name" id="_get_fk_db_field_name">
