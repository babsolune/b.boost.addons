<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DoctrineException.php" class="cssmenu-title">DoctrineException</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DoctrineException</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Doctrine.php">Doctrine</a>\<a href="package-Doctrine.Common.php">Common</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-DoctrineException.php#19-148" title="Go to source code">io/db/dbms/Doctrine/Common/DoctrineException.php</a></span>
			</div>
...
<b><span>DoctrineException</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DoctrineException.php#41-53" title="Go to source code">__construct</a>( <span>string <var>$message</var> = <span class="php-quote">&quot;&quot;</span></span>, <span>Exception <var>$cause</var> = <span class="php-keyword1">null</span></span> )
						</code>

							<div class="description short">
								<p>Initializes a new DoctrineException.</p>
							</div>
			...
			<tr data-order="notImplemented" id="_notImplemented">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DoctrineException.php#55-72" title="Go to source code">notImplemented</a>( <span>string <var>$method</var> = <span class="php-keyword1">null</span></span>, <span>string <var>$class</var> = <span class="php-keyword1">null</span></span> )
						</code>

							<div class="description short">
								<p>Throws a DoctrineException reporting not implemented method in a given class</p>
							</div>
			...
			<tr data-order="__callStatic" id="___callStatic">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DoctrineException.php#74-109" title="Go to source code">__callStatic</a>( <span>string <var>$method</var></span>, <span>array <var>$arguments</var> = <span class="php-keyword1">array</span>()</span> )
						</code>

							<div class="description short">
								<p>Implementation of __callStatic magic method.</p>
							</div>

						<div class="description detailed hidden">
							<p>Implementation of __callStatic magic method.</p>

<p>Received a method name and arguments. It lookups a $_messages HashMap
for matching Class#Method key and executes the returned string value
translating the placeholders with arguments passed.</p>
								...
								<div class="list"><dl>
									...
									<dd>Optional arguments to be translated in placeholders</dd>
								</dl></div>
			...
			<tr data-order="getExceptionMessage" id="_getExceptionMessage">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DoctrineException.php#111-137" title="Go to source code">getExceptionMessage</a>( <span>string <var>$messageKey</var></span> )
						</code>

							<div class="description short">
								<p>Retrieves error string given a message key for lookup</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Retrieves error string given a message key for lookup</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$messageKey</var></dt>
									<dd></dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string|false<br>Returns the error string if found; FALSE otherwise
								</div>
			...
			<tr data-order="unknownColumnType" id="_unknownColumnType">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DoctrineException.php#139-142" title="Go to source code">unknownColumnType</a>( <span> <var>$type</var></span> )
						</code>
			...
			<tr data-order="typeExists" id="_typeExists">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DoctrineException.php#144-147" title="Go to source code">typeExists</a>( <span> <var>$type</var></span> )
						</code>
