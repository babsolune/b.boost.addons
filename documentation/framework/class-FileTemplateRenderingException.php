<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FileTemplateRenderingException.php" class="cssmenu-title">FileTemplateRenderingException</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FileTemplateRenderingException</h2></header>
		<div class="content">
...
<b><span>FileTemplateRenderingException</span></b>					
