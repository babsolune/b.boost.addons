		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormButtonLink.php" class="cssmenu-title">FormButtonLink</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormButtonLink</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 04 11
						</span>
						<span class="infos-options">
							<b>Since:</b>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormButtonLink.php#3-35" title="Go to source code">builder/form/button/FormButtonLink.class.php</a></span>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormButtonLink.php#16-34" title="Go to source code">__construct</a>( <span> <var>$label</var></span>, <span> <var>$link</var></span>, <span> <var>$img</var> = <span class="php-quote">''</span></span>, <span> <var>$css_class</var> = <span class="php-quote">''</span></span>, <span> <var>$data_confirmation</var> = <span class="php-quote">''</span></span> )
						</code>
