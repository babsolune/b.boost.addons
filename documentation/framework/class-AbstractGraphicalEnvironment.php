		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AbstractGraphicalEnvironment.php" class="cssmenu-title">AbstractGraphicalEnvironment</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractGraphicalEnvironment</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Environment.php">Environment</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2017 11 11
						</span>
						<span class="infos-options">
							<b>Since:</b>
...
<b><span>AbstractGraphicalEnvironment</span></b>					
					 implements 
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-AbstractDisplayGraphicalEnvironment.php">AbstractDisplayGraphicalEnvironment</a>, 
					<a href="class-AdminNodisplayGraphicalEnvironment.php">AdminNodisplayGraphicalEnvironment</a>, 
					<a href="class-SiteNodisplayGraphicalEnvironment.php">SiteNodisplayGraphicalEnvironment</a>
			</div>
		...
		<div class="content">
			...
			<tr data-order="process_site_maintenance" id="_process_site_maintenance">
...
<a href="source-class-AbstractGraphicalEnvironment.php#17-40" title="Go to source code">process_site_maintenance</a>( )
			...
			<tr data-order="set_page_localization" id="_set_page_localization">
