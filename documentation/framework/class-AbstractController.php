<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractController.php" class="cssmenu-title">AbstractController</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractController</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class defines the minimalist controler pattern</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>AbstractController</span></b>					
					 implements 
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-AbstractCommentsController.php">AbstractCommentsController</a>, 
					<a href="class-AdminController.php">AdminController</a>, 
					<a href="class-AdminModuleController.php">AdminModuleController</a>, 
					<a href="class-AjaxImagePreviewController.php">AjaxImagePreviewController</a>, 
					<a href="class-AjaxKeywordsAutoCompleteController.php">AjaxKeywordsAutoCompleteController</a>, 
					<a href="class-AjaxSearchUserAutoCompleteController.php">AjaxSearchUserAutoCompleteController</a>, 
					<a href="class-AjaxUrlValidationController.php">AjaxUrlValidationController</a>, 
					<a href="class-AjaxUserAutoCompleteController.php">AjaxUserAutoCompleteController</a>, 
					<a href="class-ModuleController.php">ModuleController</a>, 
					<a href="class-PHPBoostIndexController.php">PHPBoostIndexController</a>
			</div>

			<div>
				<h6>Indirect known subclasses</h6>
					<a href="class-AbstractCategoriesFormController.php">AbstractCategoriesFormController</a>, 
					<a href="class-AbstractCategoriesManageController.php">AbstractCategoriesManageController</a>, 
					<a href="class-AbstractDeleteCategoryController.php">AbstractDeleteCategoryController</a>, 
					<a href="class-AbstractRichCategoriesFormController.php">AbstractRichCategoriesFormController</a>, 
					<a href="class-AjaxCommentsDisplayController.php">AjaxCommentsDisplayController</a>, 
					<a href="class-AjaxCommentsNotationController.php">AjaxCommentsNotationController</a>
			</div>
		...
		<div class="content">
			...
			<tr data-order="get_right_controller_regarding_authorizations" id="_get_right_controller_regarding_authorizations">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-Controller.php">Controller</a></code>
...
<a href="source-class-AbstractController.php#16-19" title="Go to source code">get_right_controller_regarding_authorizations</a>( )
							...
							<div class="description short">
								<p>Returns the right controller to execute regarding the authorizations defined
...
for the controller</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-Controller.php">Controller</a></code><br>the right controller
								</div>
								...
								<div class="list"><code><a href="class-Controller.php#_get_right_controller_regarding_authorizations">Controller::get_right_controller_regarding_authorizations()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-Controller.php#methods">Controller</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-Controller.php#_execute">execute()</a>
							</code>
						</td>
					</tr>
				</table>
