...
<section id="content">
	...
	<article>
		<header><h2>Package IO</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-IO.Data.php">IO\Data</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.DB.php">IO\DB</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.Filesystem.php">IO\Filesystem</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.HTTP.php">IO\HTTP</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.Image.php">IO\Image</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.Mail.php">IO\Mail</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.Optimization.php">IO\Optimization</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.Template.php">IO\Template</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-Upload.php">Upload</a></td>
	<td class="ellipsis">This class provides you methods to upload easily files to the ftp.</td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-IOException.php">IOException</a></td>
