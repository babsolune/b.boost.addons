		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MessageHelper.php" class="cssmenu-title">MessageHelper</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MessageHelper</h2></header>
		<div class="content">
...
<a href="source-class-MessageHelper.php#27-87" title="Go to source code">display</a>( <span> <var>$content</var></span>, <span> <var>$type</var></span>, <span> <var>$timeout</var> = <span class="php-num">0</span></span>, <span> <var>$display_small</var> = <span class="php-keyword1">false</span></span> )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="NOTICE" id="NOTICE">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'notice'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="WARNING" id="WARNING">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'warning'</span></code>
							</div>
						</td>
					</tr>
					...
					<tr data-order="QUESTION" id="QUESTION">
						...
						<td class="value">
							<div>
								<a href="#QUESTION" class="anchor">#</a>
								<code><span class="php-quote">'question'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="MEMBER_ONLY" id="MEMBER_ONLY">
						...
						<td class="value">
							<div>
								<a href="#MEMBER_ONLY" class="anchor">#</a>
								<code><span class="php-quote">'member_only'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="MODERATOR_ONLY" id="MODERATOR_ONLY">
						...
						<td class="value">
							<div>
								<a href="#MODERATOR_ONLY" class="anchor">#</a>
								<code><span class="php-quote">'moderator_only'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="ADMIN_ONLY" id="ADMIN_ONLY">
						...
						<td class="value">
							<div>
								<a href="#ADMIN_ONLY" class="anchor">#</a>
								<code><span class="php-quote">'admin_only'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="GROUP" id="GROUP">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'group_only'</span></code>
							</div>
						</td>
					</tr>
				</table>
