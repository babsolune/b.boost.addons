...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\<a href="package-IO.HTTP.php">HTTP</a>\upload</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\<a href="package-IO.HTTP.php">HTTP</a>\upload</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-FileUploadService.php">FileUploadService</a></td>
	<td class="ellipsis">Manages the HTTP file upload</td>
</tr>
<tr>
	<td class="name"><a href="class-UploadedFile.php">UploadedFile</a></td>
	<td class="ellipsis">Represents a HTTP uploaded file</td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-UploadedFileTooLargeException.php">UploadedFileTooLargeException</a></td>
	<td class="ellipsis">Represents a HTTP uploaded file</td>
</tr>
	</table>
</div>
