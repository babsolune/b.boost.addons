		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-UrlRedirectMapper.php" class="cssmenu-title">UrlRedirectMapper</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>UrlRedirectMapper</h2></header>
		<div class="content">
...
<b><span>UrlRedirectMapper</span></b>					
						...
						<div class="description detailed hidden">
							<p>build a new UrlDispatcherItem</p>
								...
								<div class="list"><dl>
									...
									<dd>the url on which the redirection will be done</dd>
