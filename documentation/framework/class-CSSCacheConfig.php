		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CSSCacheConfig.php" class="cssmenu-title">CSSCacheConfig</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CSSCacheConfig</h2></header>
		<div class="content">
...
<a href="source-class-CSSCacheConfig.php#28-31" title="Go to source code">is_enabled</a>( )
			...
			<tr data-order="set_optimization_level" id="_set_optimization_level">
...
<a href="source-class-CSSCacheConfig.php#33-36" title="Go to source code">set_optimization_level</a>( <span> <var>$level</var></span> )
			...
			<tr data-order="get_optimization_level" id="_get_optimization_level">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-CSSCacheConfig.php">CSSCacheConfig</a></code>
...
<a href="source-class-CSSCacheConfig.php#60-66" title="Go to source code">save</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="ACTIVATED" id="ACTIVATED">
						...
						<td class="value">
							<div>
								<a href="#ACTIVATED" class="anchor">#</a>
								<code><span class="php-quote">'activated'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="OPTIMIZATION_LEVEL" id="OPTIMIZATION_LEVEL">
						...
						<td class="value">
							<div>
								<a href="#OPTIMIZATION_LEVEL" class="anchor">#</a>
								<code><span class="php-quote">'optimization_level'</span></code>
							</div>
						</td>
					</tr>
				</table>
