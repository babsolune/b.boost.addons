		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CaptchaService.php" class="cssmenu-title">CaptchaService</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CaptchaService</h2></header>
		<div class="content">
...
<a href="source-class-CaptchaService.php#27-31" title="Go to source code">create_factory</a>( <span> <var>$identifier</var> = <span class="php-quote">''</span></span> )
			...
			<tr data-order="get_default_captcha" id="_get_default_captcha">
...
<a href="source-class-CaptchaService.php#48-51" title="Go to source code">display</a>( )
			...
			<tr data-order="get_captchas_identifier" id="_get_captchas_identifier">
...
<a href="source-class-CaptchaService.php#65-68" title="Go to source code">get_captchas_identifier</a>( )
			...
			<tr data-order="get_available_captchas" id="_get_available_captchas">
...
<a href="source-class-CaptchaService.php#70-79" title="Go to source code">get_available_captchas</a>( )
			...
			<tr data-order="uninstall_captcha" id="_uninstall_captcha">
