<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractCommentsController.php" class="cssmenu-title">AbstractCommentsController</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractCommentsController</h2></header>
		<div class="content">
...
<b><span>AbstractCommentsController</span></b>					
...
<a href="source-class-AbstractCommentsController.php#21-30" title="Go to source code">execute</a>( <span><code><a href="class-HTTPRequestCustom.php">HTTPRequestCustom</a></code> <var>$request</var></span> )
			...
			<tr data-order="is_authorized_read" id="_is_authorized_read">
...
<a href="source-class-AbstractCommentsController.php#32-35" title="Go to source code">is_authorized_read</a>( )
			...
			<tr data-order="is_display" id="_is_display">
...
<a href="source-class-AbstractCommentsController.php#47-50" title="Go to source code">get_id_in_module</a>( )
			...
			<tr data-order="get_topic_identifier" id="_get_topic_identifier">
...
<a href="source-class-AbstractCommentsController.php#57-60" title="Go to source code">get_authorizations</a>( )
			...
			<tr data-order="topic_identifier" id="$topic_identifier">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$topic_identifier" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="provider" id="$provider">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$provider" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
