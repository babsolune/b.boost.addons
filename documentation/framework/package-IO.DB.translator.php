...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a>\translator</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a>\translator</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-MySQLQueryTranslator.php">MySQLQueryTranslator</a></td>
	<td class="ellipsis"><p>Translates the generic query</p>

<pre><span class="php-var">$query</span></pre>

<p>into the mysql specific dialect</p></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-SQLQueryTranslator.php">SQLQueryTranslator</a></td>
	<td class="ellipsis"><p>Translates the generic query</p>
