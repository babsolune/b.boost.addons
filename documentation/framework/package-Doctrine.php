...
<section id="content">
	<header>
		<h1>Package Doctrine</h1>
	</header>
	<article>
		<header><h2>Package Doctrine</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-Doctrine.Common.php">Doctrine\Common</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-Doctrine.DBAL.php">Doctrine\DBAL</a></td>
					</tr>
				</table>
			</div>
