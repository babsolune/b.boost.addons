<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-IllegalArgumentException.php" class="cssmenu-title">IllegalArgumentException</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>IllegalArgumentException</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Util.php">Util</a></span>
						...
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2011 03 12
						</span>
					<span class="infos-options"><b>Located at:</b> <a href="source-class-IllegalArgumentException.php#3-12" title="Go to source code">util/IllegalArgumentException.class.php</a></span>
			</div>
...
<b><span>IllegalArgumentException</span></b>					
