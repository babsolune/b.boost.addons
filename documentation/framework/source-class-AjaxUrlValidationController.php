...
<section>
	<header>
		<h1>File builder/ajax/controllers/AjaxUrlValidationController.class.php</h1>
	</header>
	<article>
		<header><h2>File builder/ajax/controllers/AjaxUrlValidationController.class.php</h2></header>
		<div class="content">
...
</span></span><span id="10" class="l"><span class="php-comment"> * @version     PHPBoost 5.2 - last update: 2016 02 11
</span></span><span id="11" class="l"><span class="php-comment"> * @since       PHPBoost 4.1 - 2015 11 27
</span></span><span id="12" class="l"><span class="php-comment"> */</span>
</span><span id="13" class="l"> 
</span><span id="14" class="l"><span class="php-keyword1">class</span> AjaxUrlValidationController <span class="php-keyword1">extends</span> AbstractController
...
</span><span id="18" class="l">        <span class="php-keyword1">return</span> <span class="php-keyword1">new</span> JSONResponse(<span class="php-keyword1">array</span>(<span class="php-quote">'is_valid'</span> =&gt; (int)Url::check_url_validity(<span class="php-var">$request</span>-&gt;get_value(<span class="php-quote">'url_to_check'</span>, <span class="php-quote">''</span>))));
