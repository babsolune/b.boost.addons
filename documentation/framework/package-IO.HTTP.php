...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\HTTP</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\HTTP</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-IO.HTTP.upload.php">IO\HTTP\upload</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-HTTPCookie.php">HTTPCookie</a></td>
	<td class="ellipsis">Manages cookies via the HTTP protocol</td>
</tr>
<tr>
	<td class="name"><a href="class-HTTPRequestCustom.php">HTTPRequestCustom</a></td>
	<td class="ellipsis">Provides access to the HTTP request parameters</td>
</tr>
<tr>
	<td class="name"><a href="class-HTTPResponseCustom.php">HTTPResponseCustom</a></td>
	<td class="ellipsis">Manages response via the HTTP protocol</td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-ParameterTypeMismatchException.php">ParameterTypeMismatchException</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-UnexistingHTTPParameterException.php">UnexistingHTTPParameterException</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
