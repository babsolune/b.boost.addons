		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-UnsupportedOperationException.php" class="cssmenu-title">UnsupportedOperationException</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>UnsupportedOperationException</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Util.php">Util</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-UnsupportedOperationException.php#3-19" title="Go to source code">util/UnsupportedOperationException.class.php</a></span>
			</div>

			<div class="description">
				<p>Implements the string var replacement method</p>
			</div>
...
<b><span>UnsupportedOperationException</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-UnsupportedOperationException.php#15-18" title="Go to source code">__construct</a>( <span> <var>$msg</var> = <span class="php-quote">'operation is not supported'</span></span> )
						</code>
