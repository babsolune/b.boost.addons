<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractHTMLTableFilter.php" class="cssmenu-title">AbstractHTMLTableFilter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractHTMLTableFilter</h2></header>
		<div class="content">
...
<b><span>AbstractHTMLTableFilter</span></b>					
					 implements 
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-HTMLTableAjaxUserAutoCompleteFilter.php">HTMLTableAjaxUserAutoCompleteFilter</a>, 
					<a href="class-HTMLTableCheckboxFilter.php">HTMLTableCheckboxFilter</a>, 
					<a href="class-HTMLTableDateComparatorSQLFilter.php">HTMLTableDateComparatorSQLFilter</a>, 
					<a href="class-HTMLTableEqualsFromListFilter.php">HTMLTableEqualsFromListFilter</a>, 
					<a href="class-HTMLTableNumberComparatorSQLFilter.php">HTMLTableNumberComparatorSQLFilter</a>, 
					<a href="class-HTMLTableTextFilter.php">HTMLTableTextFilter</a>
			</div>

			<div>
				<h6>Indirect known subclasses</h6>
					<a href="class-HTMLTableAjaxUserAutoCompleteSQLFilter.php">HTMLTableAjaxUserAutoCompleteSQLFilter</a>, 
					...
					<a href="class-HTMLTableLikeFromListSQLFilter.php">HTMLTableLikeFromListSQLFilter</a>, 
					<a href="class-HTMLTableLikeTextSQLFilter.php">HTMLTableLikeTextSQLFilter</a>, 
					<a href="class-HTMLTableUnapprovedSQLFilter.php">HTMLTableUnapprovedSQLFilter</a>, 
					...
					<a href="class-HTMLTableEqualsFromListSQLFilter.php">HTMLTableEqualsFromListSQLFilter</a>, 
...
<a href="source-class-AbstractHTMLTableFilter.php#27-30" title="Go to source code">get_id</a>( )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><code><a href="class-HTMLTableFilter.php#_get_id">HTMLTableFilter::get_id()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_form_field" id="_get_form_field">
...
<a href="source-class-AbstractHTMLTableFilter.php#32-35" title="Go to source code">get_form_field</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-HTMLTableFilter.php#_get_form_field">HTMLTableFilter::get_form_field()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractHTMLTableFilter.php#42-45" title="Go to source code">get_value</a>( )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-HTMLTableFilter.php#methods">HTMLTableFilter</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-HTMLTableFilter.php#_is_value_allowed">is_value_allowed()</a>
							</code>
						</td>
					</tr>
				</table>
