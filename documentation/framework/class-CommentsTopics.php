		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CommentsTopics.php" class="cssmenu-title">CommentsTopics</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CommentsTopics</h2></header>
		<div class="content">
...
<a href="source-class-CommentsTopics.php#17-33" title="Go to source code">__construct</a>( <span>array <var>$comments_topics</var></span> )
			...
			<tr data-order="get_comments_topics" id="_get_comments_topics">
