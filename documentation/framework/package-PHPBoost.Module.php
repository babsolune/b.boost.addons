...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\Module</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\Module</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-PHPBoost.Module.css.php">PHPBoost\Module\css</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Module.tree.links.php">PHPBoost\Module\tree-links</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-DefaultModuleSetup.php">DefaultModuleSetup</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-Module.php">Module</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ModuleConfiguration.php">ModuleConfiguration</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ModuleConfigurationManager.php">ModuleConfigurationManager</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ModulesManager.php">ModulesManager</a></td>
	<td class="ellipsis">This class enables you to manages the PHPBoost packages which are nothing else than the modules.</td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-ModuleSetup.php">ModuleSetup</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
