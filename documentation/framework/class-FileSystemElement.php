		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FileSystemElement.php" class="cssmenu-title">FileSystemElement</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FileSystemElement</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Filesystem.php">Filesystem</a></span>
						...
						<span class="infos-options">
							<b>Contributor:</b>
							ph-7 <a href="&#109;&#97;&#x69;&#x6c;&#x74;&#111;&#58;&#109;&#x65;&#x40;p&#104;&#55;&#x2e;&#x6d;e">&#109;&#x65;&#x40;p&#104;&#55;&#x2e;&#x6d;e</a>
						</span>
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FileSystemElement.php#3-121" title="Go to source code">io/filesystem/FileSystemElement.class.php</a></span>
			</div>

			<div class="description">
				<p>This class represents any file system element.</p>
			</div>
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-File.php">File</a>, 
					<a href="class-Folder.php">Folder</a>, 
					<a href="class-Image.php">Image</a>
			</div>
...
<a href="source-class-FileSystemElement.php#34-41" title="Go to source code">exists</a>( )
							...
							<div class="description short">
								<p>Allows you to know if the file system element exists.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Allows you to know if the file system element exists.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									boolean<br>True if the file exists, else, false.
								</div>
...
<a href="source-class-FileSystemElement.php#52-64" title="Go to source code">get_path_from_root</a>( )
							...
							<div class="description short">
								<p>Returns the element path from the phpboost root.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the element path from the phpboost root.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>The element from the phpboost root.
								</div>
...
<a href="source-class-FileSystemElement.php#66-78" title="Go to source code">get_name</a>( )
			...
			<tr data-order="is_writable" id="_is_writable">
...
<a href="source-class-FileSystemElement.php#80-100" title="Go to source code">is_writable</a>( <span>boolean <var>$force_chmod</var> = <span class="php-keyword1">false</span></span> )
							...
							<div class="description short">
								<p>Returns true if the file or the folder is writable.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns true if the file or the folder is writable.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$force_chmod</var></dt>
									<dd>If true, then, chmod will be forced to 777 if not writable.</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									true<br>if the file or the folder is writable.
								</div>
			...
			<tr data-order="change_chmod" id="_change_chmod">
...
<a href="source-class-FileSystemElement.php#102-114" title="Go to source code">change_chmod</a>( <span>integer <var>$chmod</var></span> )
							...
							<div class="description short">
								<p>Changes the chmod of the element.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Changes the chmod of the element.</p>
								...
								<div class="list"><dl>
									<dt><var>$chmod</var></dt>
									<dd>The new chmod of the file. Put a 0 at the begening of the number to indicate to the PHP parser that it's an octal value.</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									true<br>if the chmod has been successfully changed.
								</div>
			...
			<tr data-order="delete" id="_delete">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FileSystemElement.php#116-120" title="Go to source code">delete</a>( )
						</code>
