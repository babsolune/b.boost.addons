...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a>\driver</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a>\driver</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-IO.DB.driver.mysql.php">IO\DB\driver\mysql</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.DB.driver.pdo.php">IO\DB\driver\pdo</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-AbstractQueryResult.php">AbstractQueryResult</a></td>
	<td class="ellipsis">This class encapsulate a query result set</td>
</tr>
<tr>
	<td class="name"><a href="class-AbstractSelectQueryResult.php">AbstractSelectQueryResult</a></td>
	<td class="ellipsis">This class encapsulate a query result set</td>
</tr>
<tr>
	<td class="name"><a href="class-AbstractSQLQuerier.php">AbstractSQLQuerier</a></td>
