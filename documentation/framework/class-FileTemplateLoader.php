		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FileTemplateLoader.php" class="cssmenu-title">FileTemplateLoader</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FileTemplateLoader</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\<a href="package-IO.Template.loader.php">loader</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2017 04 25
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<div class="description">
				<p>This loader is the most used. It takes a file identifier as input. This identifier corresponds
...
in the <code><a href="class-FileTemplate.php">FileTemplate</a></code> class description.
This loader supports caching and stores cache files in the /cache/tpl directory, their name are related to
their source's real path.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>FileTemplateLoader</span></b>					
					 implements 
						<a href="class-TemplateLoader.php"><span>TemplateLoader</span></a>
...
<a href="source-class-FileTemplateLoader.php#36-49" title="Go to source code">__construct</a>( <span>string <var>$identifier</var></span>, <span><code><a href="class-TemplateData.php">TemplateData</a></code> <var>$data</var></span> )
							...
							<div class="description short">
								<p>Constructs a <code><a href="class-FileTemplateLoader.php">FileTemplateLoader</a></code> from the file's identifier.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Constructs a <code><a href="class-FileTemplateLoader.php">FileTemplateLoader</a></code> from the file's identifier.</p>
								...
								<div class="list"><dl>
									...
									<dd>The file's identifier</dd>
									<dt><var>$data</var></dt>
									<dd><p>The data which is associated to the loader. It is used to assign
the PICTURES_DATA_PATH variable that corresponds the the module's pictures data path (it depends on
whether the theme redefines them or not).</p></dd>
								</dl></div>
...
<a href="source-class-FileTemplateLoader.php#65-76" title="Go to source code">load</a>( )
						...
						<div class="description detailed hidden">
							<p>Loads the template.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>Returns the parsed template ready to be executed by the PHP engine.
								</div>

								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-TemplateLoadingException.php">TemplateLoadingException</a></code><br>If the template cannot been loaded
								</div>



								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateLoader.php#_load">TemplateLoader::load()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="supports_caching" id="_supports_caching">
...
<a href="source-class-FileTemplateLoader.php#231-237" title="Go to source code">supports_caching</a>( )
							...
							<div class="description short">
								<p>Tells whether the loader supports caching. If it supports it, its <code><a href="class-FileTemplateLoader.php#_get_cache_file_path">FileTemplateLoader::get_cache_file_path()</a></code>
 will have to return a non-empty value.</p>
							</div>

						<div class="description detailed hidden">
							<p>Tells whether the loader supports caching. If it supports it, its <code><a href="class-FileTemplateLoader.php#_get_cache_file_path">FileTemplateLoader::get_cache_file_path()</a></code> will have to return a non-empty value.</p>



								<h6>Returns</h6>
								<div class="list">
									boolean<br>true if it supports caching, false otherwise.
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateLoader.php#_supports_caching">TemplateLoader::supports_caching()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_cache_file_path" id="_get_cache_file_path">
...
<a href="source-class-FileTemplateLoader.php#239-249" title="Go to source code">get_cache_file_path</a>( )
							...
							<div class="description short">
								<p>Returns the path of the cache file that can be directly executed by the include PHP instruction.
This method must be called only if the loader supports caching, the <code><a href="class-FileTemplateLoader.php#_supports_caching">FileTemplateLoader::supports_caching()</a></code>
enabled you to know that.</p>
							</div>
...
enabled you to know that.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>The path of the cache file.
								</div>

								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-TemplateLoadingException.php">TemplateLoadingException</a></code><br>If the template cannot been loaded or cached
								</div>



								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateLoader.php#_get_cache_file_path">TemplateLoader::get_cache_file_path()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
