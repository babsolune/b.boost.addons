...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\Data</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\Data</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-IO.Data.cache.php">IO\Data\cache</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.Data.config.php">IO\Data\config</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-IO.Data.store.php">IO\Data\store</a></td>
					</tr>
				</table>
			</div>
