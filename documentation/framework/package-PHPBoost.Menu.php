...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\Menu</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\Menu</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-PHPBoost.Menu.content.php">PHPBoost\Menu\content</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Menu.extension.point.php">PHPBoost\Menu\extension-point</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Menu.feed.php">PHPBoost\Menu\feed</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Menu.links.php">PHPBoost\Menu\links</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Menu.module.php">PHPBoost\Menu\module</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-CachedMenu.php">CachedMenu</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-Filter.php">Filter</a></td>
	<td class="ellipsis">This class represents an abstract filter</td>
</tr>
<tr>
	<td class="name"><a href="class-Menu.php">Menu</a></td>
	<td class="ellipsis">This class represents a menu element and is used to build any kind of menu</td>
</tr>
<tr>
	<td class="name"><a href="class-MenuService.php">MenuService</a></td>
	<td class="ellipsis"><p>This service manage kernel menus by adding the persistance to menus objects.
It also provides all moving and disabling methods to change the website appearance.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-MenusProvidersService.php">MenusProvidersService</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-MenuStringFilter.php">MenuStringFilter</a></td>
	<td class="ellipsis">This class represents a filter based on string comparison</td>
</tr>
	</table>
</div>
