...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\Extension-provider</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\Extension-provider</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-ExtensionPointProvider.php">ExtensionPointProvider</a></td>
	<td class="ellipsis"><p>This Class allow you to call methods on a ExtensionPointProvider extended class
...
allow your module to share services.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-ExtensionPointProviderService.php">ExtensionPointProviderService</a></td>
	<td class="ellipsis"><p>This class is a ExtensionPointProvider factory providing some services like
mass operations (on several modules at the same time) or identifications
methods to get all ExtensionPointProvider that provide a given extension point</p></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-ExtensionPoint.php">ExtensionPoint</a></td>
...
<tr>
	<td class="name"><a href="class-ExtensionPointNotFoundException.php">ExtensionPointNotFoundException</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-UnexistingExtensionPointProviderException.php">UnexistingExtensionPointProviderException</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
