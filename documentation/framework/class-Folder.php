		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Folder.php" class="cssmenu-title">Folder</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>This class allows you to handle very easily a folder on the server.</p>
			</div>
...
<a href="source-class-Folder.php#39-58" title="Go to source code">create</a>( )
							...
							<div class="description short">
								<p>Returns true if the folder exists after this call, else, false</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns true if the folder exists after this call, else, false</p>
								...
								<h6>Returns</h6>
								<div class="list">
									boolean<br>true if the folder exists after this call, else, false
								</div>
			...
			<tr data-order="get_files" id="_get_files">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-File.php">File</a>[]</code>
...
<a href="source-class-Folder.php#102-136" title="Go to source code">get_files</a>( <span>string <var>$regex</var> = <span class="php-quote">''</span></span>, <span>boolean <var>$regex_exclude_files</var> = <span class="php-keyword1">false</span></span> )
							...
							<div class="description short">
								<p>Lists the files contained in this folder.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Lists the files contained in this folder.</p>
								...
								<div class="list"><dl>
									<dt><var>$regex</var></dt>
									<dd>PREG which describes the pattern the files you want to list must match. If you want all of them, don't use this parameter.</dd>
									<dt><var>$regex_exclude_files</var></dt>
									<dd>true if the regex to exclude files</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-File.php">File</a>[]</code><br>The files list.
								</div>
			...
			<tr data-order="get_folders" id="_get_folders">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-Folder.php">Folder</a>[]</code>
...
<a href="source-class-Folder.php#138-160" title="Go to source code">get_folders</a>( <span>string <var>$regex</var> = <span class="php-quote">''</span></span> )
							...
							<div class="description short">
								<p>Lists the folders contained in this folder.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Lists the folders contained in this folder.</p>
								...
								<div class="list"><dl>
									<dt><var>$regex</var></dt>
									<dd>PREG which describes the pattern the folders you want to list must match. If you want all of them, don't use this parameter.</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-Folder.php">Folder</a>[]</code><br>The folders list.
								</div>
			...
			<tr data-order="get_first_folder" id="_get_first_folder">
...
<a href="source-class-Folder.php#162-177" title="Go to source code">get_first_folder</a>( )
							...
							<div class="description short">
								<p>Returns the first folder present in this folder</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the first folder present in this folder</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-Folder.php">Folder</a></code><br>The first folder of this folder or null if it doesn't contain any folder.
								</div>
			...
			<tr data-order="get_all_content" id="_get_all_content">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-FileSystemElement.php">FileSystemElement</a>[]</code>
...
<a href="source-class-Folder.php#179-186" title="Go to source code">get_all_content</a>( )
							...
							<div class="description short">
								<p>Returns all the file system elements contained by the folder.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns all the file system elements contained by the folder.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-FileSystemElement.php">FileSystemElement</a>[]</code><br>The list of the file system element contained in this folder.
								</div>
...
<a href="source-class-Folder.php#188-205" title="Go to source code">delete</a>( )
							...
							<div class="description short">
								<p>Deletes the folder and all what it contains.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Deletes the folder and all what it contains.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									True<br>if deleted successfully.
								</div>
...
<a href="source-class-Folder.php#207-215" title="Go to source code">get_last_modification_date</a>( )
							...
							<div class="description short">
								<p>Returns the date of the last modification of the folder.</p>
							</div>
