		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-NotationService.php" class="cssmenu-title">NotationService</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>NotationService</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class represents the rating system and its parameters</p>
			</div>
...
<a href="source-class-NotationService.php#24-29" title="Go to source code">__static</a>( )
			...
			<tr data-order="display_static_image" id="_display_static_image">
...
<a href="source-class-NotationService.php#31-100" title="Go to source code">display_static_image</a>( <span><code><a href="class-Notation.php">Notation</a></code> <var>$notation</var></span>, <span>boolean <var>$average_notes</var>,…</span> )
							...
							<div class="description short">
								<p>This function required object Notation containing the module_name, id in module and notation_scale.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>This function required object Notation containing the module_name, id in module and notation_scale.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$notation</var></dt>
									<dd>Notation</dd>
									<dt><var>$average_notes</var>,…</dt>
									<dd></dd>
								</dl></div>
			...
			<tr data-order="display_active_image" id="_display_active_image">
...
<a href="source-class-NotationService.php#102-193" title="Go to source code">display_active_image</a>( <span><code><a href="class-Notation.php">Notation</a></code> <var>$notation</var></span> )
							...
							<div class="description short">
								<p>This function required object Notation containing the module_name, id_in_module, user_id, note and notation_scale.</p>
							</div>
			...
			<tr data-order="update_notation_scale" id="_update_notation_scale">
...
<a href="source-class-NotationService.php#195-209" title="Go to source code">update_notation_scale</a>( <span>string <var>$module_name</var></span>, <span>string <var>$old_notation_scale</var></span>, <span>string <var>$new_notation_scale</var></span> )
							...
							<div class="description short">
								<p>This fonction update notation scale by module_name</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>This fonction update notation scale by module_name</p>
								...
								<div class="list"><dl>
									...
									<dd></dd>
									<dt><var>$old_notation_scale</var></dt>
									<dd></dd>
									<dt><var>$new_notation_scale</var></dt>
									<dd></dd>
								</dl></div>
			...
			<tr data-order="delete_notes_id_in_module" id="_delete_notes_id_in_module">
...
<a href="source-class-NotationService.php#211-226" title="Go to source code">delete_notes_id_in_module</a>( <span>string <var>$module_name</var></span>, <span>string <var>$id_in_module</var></span> )
							...
							<div class="description short">
								<p>This fonction delete all notes by id module and id in module element</p>
							</div>
			...
			<tr data-order="delete_notes_module" id="_delete_notes_module">
...
<a href="source-class-NotationService.php#228-242" title="Go to source code">delete_notes_module</a>( <span>string <var>$module_name</var></span> )
							...
							<div class="description short">
								<p>This fonction delete all notes by module</p>
							</div>
			...
			<tr data-order="get_number_notes" id="_get_number_notes">
...
<a href="source-class-NotationService.php#244-255" title="Go to source code">get_number_notes</a>( <span><code><a href="class-Notation.php">Notation</a></code> <var>$notation</var></span> )
							...
							<div class="description short">
								<p>This function required object Notation containing the module_name and id_in_module.</p>
							</div>
			...
			<tr data-order="get_average_notes" id="_get_average_notes">
...
<a href="source-class-NotationService.php#257-268" title="Go to source code">get_average_notes</a>( <span><code><a href="class-Notation.php">Notation</a></code> <var>$notation</var></span> )
			...
			<tr data-order="get_informations_note" id="_get_informations_note">
...
<a href="source-class-NotationService.php#270-291" title="Go to source code">get_informations_note</a>( <span><code><a href="class-Notation.php">Notation</a></code> <var>$notation</var></span> )
							...
							<div class="description short">
								<p>This function required object Notation containing the module_name, id_in_module and user_id.</p>
							</div>
