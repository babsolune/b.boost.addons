		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Pagination.php" class="cssmenu-title">Pagination</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<a href="source-class-Pagination.php#31-36" title="Go to source code">__construct</a>( <span> <var>$nb_pages</var></span>, <span> <var>$current_page</var></span>, <span> <var>$type</var> = self::FULL_PAGINATION</span> )
			...
			<tr data-order="set_url_sprintf_pattern" id="_set_url_sprintf_pattern">
...
<a href="source-class-Pagination.php#38-41" title="Go to source code">set_url_sprintf_pattern</a>( <span> <var>$url_pattern</var></span> )
			...
			<tr data-order="set_url_builder_callback" id="_set_url_builder_callback">
...
<a href="source-class-Pagination.php#43-46" title="Go to source code">set_url_builder_callback</a>( <span> <var>$callback</var></span> )
			...
			<tr data-order="set_before_links_nb" id="_set_before_links_nb">
...
<a href="source-class-Pagination.php#48-51" title="Go to source code">set_before_links_nb</a>( <span> <var>$value</var></span> )
			...
			<tr data-order="set_after_links_nb" id="_set_after_links_nb">
...
<a href="source-class-Pagination.php#58-64" title="Go to source code">export</a>( )
			...
			<tr data-order="get_number_pages" id="_get_number_pages">
...
<a href="source-class-Pagination.php#66-69" title="Go to source code">get_number_pages</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="LINKS_NB" id="LINKS_NB">
						...
						<td class="value">
							<div>
								<a href="#LINKS_NB" class="anchor">#</a>
								<code><span class="php-num">3</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PREV_LINK" id="PREV_LINK">
						...
						<td class="value">
							<div>
								<a href="#PREV_LINK" class="anchor">#</a>
								<code><span class="php-quote">'prev-page'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="NEXT_LINK" id="NEXT_LINK">
						...
						<td class="value">
							<div>
								<a href="#NEXT_LINK" class="anchor">#</a>
								<code><span class="php-quote">'next-page'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="LIGHT_PAGINATION" id="LIGHT_PAGINATION">
						...
						<td class="value">
							<div>
								<a href="#LIGHT_PAGINATION" class="anchor">#</a>
								<code><span class="php-quote">'light'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="FULL_PAGINATION" id="FULL_PAGINATION">
						...
						<td class="value">
							<div>
								<a href="#FULL_PAGINATION" class="anchor">#</a>
								<code><span class="php-quote">'full'</span></code>
							</div>
						</td>
					</tr>
				</table>
