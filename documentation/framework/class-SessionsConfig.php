		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SessionsConfig.php" class="cssmenu-title">SessionsConfig</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SessionsConfig</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Config.php">Config</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 07 04
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2010 07 14
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
...
<b><span>SessionsConfig</span></b>					
		...
		<div class="content">
			...
			<tr data-order="get_cookie_name" id="_get_cookie_name">
...
<a href="source-class-SessionsConfig.php#30-33" title="Go to source code">get_cookie_name</a>( )
			...
			<tr data-order="set_cookie_name" id="_set_cookie_name">
...
<a href="source-class-SessionsConfig.php#35-38" title="Go to source code">set_cookie_name</a>( <span> <var>$cookie_name</var></span> )
			...
			<tr data-order="get_session_duration" id="_get_session_duration">
...
<a href="source-class-SessionsConfig.php#40-43" title="Go to source code">get_session_duration</a>( )
			...
			<tr data-order="set_session_duration" id="_set_session_duration">
...
<a href="source-class-SessionsConfig.php#45-48" title="Go to source code">set_session_duration</a>( <span> <var>$duration</var></span> )
			...
			<tr data-order="get_active_session_duration" id="_get_active_session_duration">
...
<a href="source-class-SessionsConfig.php#50-53" title="Go to source code">get_active_session_duration</a>( )
			...
			<tr data-order="set_active_session_duration" id="_set_active_session_duration">
...
<a href="source-class-SessionsConfig.php#55-58" title="Go to source code">set_active_session_duration</a>( <span> <var>$duration</var></span> )
			...
			<tr data-order="get_autoconnect_duration" id="_get_autoconnect_duration">
...
<a href="source-class-SessionsConfig.php#60-63" title="Go to source code">get_autoconnect_duration</a>( )
			...
			<tr data-order="set_autoconnect_duration" id="_set_autoconnect_duration">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-SessionsConfig.php">SessionsConfig</a></code>
...
<a href="source-class-SessionsConfig.php#89-95" title="Go to source code">save</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="COOKIE_NAME" id="COOKIE_NAME">
						...
						<td class="value">
							<div>
								<a href="#COOKIE_NAME" class="anchor">#</a>
								<code><span class="php-quote">'cookie_name'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="SESSION_DURATION" id="SESSION_DURATION">
						...
						<td class="name">
							...
							<div class="description short">
								<p>Duration of a session (in seconds).</p>
							</div>
						...
						<td class="value">
							<div>
								<a href="#SESSION_DURATION" class="anchor">#</a>
								<code><span class="php-quote">'session_duration'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="ACTIVE_SESSION_DURATION" id="ACTIVE_SESSION_DURATION">
						...
						<td class="name">
							...
							<div class="description short">
								<p>Time during which the sessions is considered as active (the user is online)</p>
							</div>
						...
						<td class="value">
							<div>
								<a href="#ACTIVE_SESSION_DURATION" class="anchor">#</a>
								<code><span class="php-quote">'active_session_duration'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="AUTOCONNECT_DURATION" id="AUTOCONNECT_DURATION">
						...
						<td class="name">
							...
							<div class="description short">
								<p>Duration of autoconnect cookie (in seconds).</p>
							</div>
						...
						<td class="value">
							<div>
								<a href="#AUTOCONNECT_DURATION" class="anchor">#</a>
								<code><span class="php-quote">'autoconnect_duration'</span></code>
							</div>
						</td>
					</tr>
				</table>
