		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-KeyGenerator.php" class="cssmenu-title">KeyGenerator</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>KeyGenerator</h2></header>
		<div class="content">
		...
		<div class="content">
			...
			<tr data-order="generate_key" id="_generate_key">
...
<a href="source-class-KeyGenerator.php#14-24" title="Go to source code">generate_key</a>( <span> <var>$length</var> = <span class="php-keyword1">null</span></span> )
			...
			<tr data-order="generate_token" id="_generate_token">
...
<a href="source-class-KeyGenerator.php#26-29" title="Go to source code">generate_token</a>( )
			...
			<tr data-order="string_hash" id="_string_hash">
...
<a href="source-class-KeyGenerator.php#31-50" title="Go to source code">string_hash</a>( <span>string <var>$string</var></span>, <span>mixed <var>$salt</var> = <span class="php-keyword1">true</span></span> )
							...
							<div class="description short">
								<p>Return a SHA256 hash of the $str string [with a salt]</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Return a SHA256 hash of the $str string [with a salt]</p>
								...
								<div class="list"><dl>
									...
									<dd>the string to hash</dd>
									<dt><var>$salt</var></dt>
									<dd><p>If true, add the default salt : md5($str)
if a string, use this string as the salt
if false, do not use any salt</p></dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>a SHA256 hash of the $string string [with a salt]
								</div>
