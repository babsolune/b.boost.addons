		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTMLTableNumberComparatorSQLFilter.php" class="cssmenu-title">HTMLTableNumberComparatorSQLFilter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLTableNumberComparatorSQLFilter</h2></header>
		<div class="content">
...
<b><span>HTMLTableNumberComparatorSQLFilter</span></b>					
					 implements 
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-HTMLTableEqualsToSQLFilter.php">HTMLTableEqualsToSQLFilter</a>, 
					<a href="class-HTMLTableGreaterThanOrEqualsToSQLFilter.php">HTMLTableGreaterThanOrEqualsToSQLFilter</a>, 
					<a href="class-HTMLTableGreaterThanSQLFilter.php">HTMLTableGreaterThanSQLFilter</a>, 
					<a href="class-HTMLTableLessThanOrEqualsToSQLFilter.php">HTMLTableLessThanOrEqualsToSQLFilter</a>, 
					<a href="class-HTMLTableLessThanSQLFilter.php">HTMLTableLessThanSQLFilter</a>
			</div>
...
<a href="source-class-HTMLTableNumberComparatorSQLFilter.php#68-78" title="Go to source code">get_number</a>( <span> <var>$value</var></span> )
			...
			<tr data-order="check_interval" id="_check_interval">
...
<a href="source-class-HTMLTableNumberComparatorSQLFilter.php#80-91" title="Go to source code">check_interval</a>( <span> <var>$number</var></span> )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="NOT_BOUNDED" id="NOT_BOUNDED">
						...
						<td class="value">
							<div>
								<a href="#NOT_BOUNDED" class="anchor">#</a>
