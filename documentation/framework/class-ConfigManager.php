		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ConfigManager.php" class="cssmenu-title">ConfigManager</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ConfigManager</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Data.php">Data</a>\<a href="package-IO.Data.config.php">config</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2017 03 13
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<div class="description">
				<p>This class manages config loading and saving. It makes a two-level lazy loading:</p>
...
as of the PHP interpreter reaches the end of the page generation.</li> <li>A filesystem or shared RAM cache to avoid querying the database many times to obtain the same value.
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-ConfigData.php">ConfigData</a></code>
...
<a href="source-class-ConfigManager.php#25-73" title="Go to source code">load</a>( <span> <var>$classname</var></span>, <span> <var>$module_name</var></span>, <span> <var>$entry_name</var> = <span class="php-quote">''</span></span> )
							...
							<div class="description short">
								<p>Loads the data identified by the parameters.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads the data identified by the parameters.</p>
								...
								<div class="list"><dl>
									...
									<dd>of the class which is expected to be returned</dd>
									<dt><var>$module_name</var></dt>
									<dd>of the module owning the entry to load</dd>
									<dt><var>$entry_name</var></dt>
									<dd><p>the module wants to manage several entries,
it's the name of the entry you want to load</p></dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-ConfigData.php">ConfigData</a></code><br>The loaded data
								</div>
...
<a href="source-class-ConfigManager.php#115-128" title="Go to source code">save</a>( <span>string <var>$module_name</var></span>, <span><code><a href="class-ConfigData.php">ConfigData</a></code> <var>$data</var></span>, <span>string <var>$entry_name</var> = <span class="php-quote">''</span></span> )
							...
							<div class="description short">
								<p>Saves in the data base (DB_TABLE_CONFIGS table) the data and has it become persistent.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Saves in the data base (DB_TABLE_CONFIGS table) the data and has it become persistent.</p>
								...
								<div class="list"><dl>
									<dt><var>$module_name</var></dt>
									<dd>Name of the module owning this entry</dd>
									<dt><var>$data</var></dt>
									<dd>Data to save</dd>
									<dt><var>$entry_name</var></dt>
									<dd>The name of the entry if the module uses several entries</dd>
								</dl></div>
...
<a href="source-class-ConfigManager.php#130-145" title="Go to source code">delete</a>( <span>string <var>$module_name</var></span>, <span>string <var>$entry_name</var> = <span class="php-quote">''</span></span> )
							...
							<div class="description short">
								<p>Delete an configuration in the database and the cache</p>
							</div>
