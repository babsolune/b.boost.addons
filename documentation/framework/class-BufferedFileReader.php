<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-BufferedFileReader.php" class="cssmenu-title">BufferedFileReader</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>BufferedFileReader</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Filesystem.php">Filesystem</a>\<a href="package-IO.Filesystem.stream.php">stream</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-BufferedFileReader.php#3-110" title="Go to source code">io/filesystem/stream/BufferedFileReader.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>BufferedFileReader</span></b>					
					 implements 
						<a href="class-FileReader.php"><span>FileReader</span></a>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-BufferedFileReader.php#28-32" title="Go to source code">__construct</a>( <span><code><a href="class-File.php">File</a></code> <var>$file</var></span>, <span> <var>$buffer_size</var> = self::DEFAULT_BUFFER_SIZE</span> )
						</code>
			...
			<tr data-order="read_all" id="_read_all">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_read_all">#</a>
						<code>
<a href="source-class-BufferedFileReader.php#34-42" title="Go to source code">read_all</a>( )
						</code>
						...
						<div class="description detailed hidden">
								...
								<div class="list"><code><a href="class-FileReader.php#_read_all">FileReader::read_all()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="read_line" id="_read_line">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_read_line">#</a>
						<code>
<a href="source-class-BufferedFileReader.php#56-74" title="Go to source code">read_line</a>( )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FileReader.php#_read_line">FileReader::read_line()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="DEFAULT_BUFFER_SIZE" id="DEFAULT_BUFFER_SIZE">

						<td class="attributes"><code>integer</code></td>
						<td class="name">
							<code>
								<a href="source-class-BufferedFileReader.php#17" title="Go to source code"><b>DEFAULT_BUFFER_SIZE</b></a>
							</code>
						...
						<td class="value">
							<div>
								<a href="#DEFAULT_BUFFER_SIZE" class="anchor">#</a>
								<code><span class="php-num">100000</span></code>
							</div>
						</td>
					</tr>
				</table>
