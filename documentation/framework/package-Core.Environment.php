...
<section id="content">
	<header>
		<h1>Package <a href="package-Core.php">Core</a>\Environment</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-Core.php">Core</a>\Environment</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-Core.Environment.context.php">Core\Environment\context</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-Environment.php">Environment</a></td>
	<td class="ellipsis"><p>This class manages all the environment that PHPBoost need to run.</p>

<p>It's able to initialize the environment that contains services (database,
users management...) as well as the graphical environment.</p></td>
</tr>
	</table>
</div>
