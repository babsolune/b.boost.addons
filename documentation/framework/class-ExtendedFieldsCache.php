		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ExtendedFieldsCache.php" class="cssmenu-title">ExtendedFieldsCache</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ExtendedFieldsCache</h2></header>
		<div class="content">
...
<b><span>ExtendedFieldsCache</span></b>					
					 implements 
...
For instance,</p>
			...
			<tr data-order="get_extended_fields" id="_get_extended_fields">
...
<a href="source-class-ExtendedFieldsCache.php#57-60" title="Go to source code">get_extended_fields</a>( )
			...
			<tr data-order="get_exist_fields" id="_get_exist_fields">
...
<a href="source-class-ExtendedFieldsCache.php#62-65" title="Go to source code">get_exist_fields</a>( )
			...
			<tr data-order="get_extended_field" id="_get_extended_field">
...
<a href="source-class-ExtendedFieldsCache.php#67-74" title="Go to source code">get_extended_field</a>( <span> <var>$id</var></span> )
			...
			<tr data-order="get_extended_field_by_field_name" id="_get_extended_field_by_field_name">
...
<a href="source-class-ExtendedFieldsCache.php#76-89" title="Go to source code">get_extended_field_by_field_name</a>( <span> <var>$field_name</var></span> )
			...
			<tr data-order="get_websites_or_emails_extended_field_field_types" id="_get_websites_or_emails_extended_field_field_types">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-ExtendedFieldsCache.php">ExtendedFieldsCache</a></code>
...
<a href="source-class-ExtendedFieldsCache.php#106-113" title="Go to source code">load</a>( )
							...
							<div class="description short">
								<p>Loads and returns the extended_fields cached data.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads and returns the extended_fields cached data.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-ExtendedFieldsCache.php">ExtendedFieldsCache</a></code><br>The cached data
								</div>
...
<a href="source-class-ExtendedFieldsCache.php#115-121" title="Go to source code">invalidate</a>( )
							...
							<div class="description short">
								<p>Invalidates the current extended_fields cached data.</p>
							</div>
