<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractUrlMapper.php" class="cssmenu-title">AbstractUrlMapper</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractUrlMapper</h2></header>
		<div class="content">
...
<b><span>AbstractUrlMapper</span></b>					
					 implements 
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-UrlControllerMapper.php">UrlControllerMapper</a>, 
					<a href="class-UrlRedirectMapper.php">UrlRedirectMapper</a>
			</div>
...
<a href="source-class-AbstractUrlMapper.php#31-39" title="Go to source code">match</a>( <span>string <var>$url</var></span> )
							...
							<div class="description short">
								<p>Returns true if the UrlDispatcherItem match the url</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns true if the UrlDispatcherItem match the url</p>
								...
								<h6>Returns</h6>
								<div class="list">
									boolean<br>true if the UrlDispatcherItem match the url
								</div>
								...
								<div class="list"><code><a href="class-UrlMapper.php#_match">UrlMapper::match()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_captured_parameters" id="_get_captured_parameters">
...
<a href="source-class-AbstractUrlMapper.php#41-44" title="Go to source code">get_captured_parameters</a>( )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-UrlMapper.php#methods">UrlMapper</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-UrlMapper.php#_call">call()</a>
							</code>
						</td>
					</tr>
				</table>
