		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-UnexistingDatabaseException.php" class="cssmenu-title">UnexistingDatabaseException</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>UnexistingDatabaseException</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-UnexistingDatabaseException.php#3-13" title="Go to source code">io/db/UnexistingDatabaseException.class.php</a></span>
			</div>
...
<span>Throwable</span>
				...
				<dd style="padding-left:30px">
					...
					<a href="class-DBConnectionException.php"><span>DBConnectionException</span></a>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>UnexistingDatabaseException</span></b>					
