...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\Mail</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\Mail</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-AbstractPHPMailerMailService.php">AbstractPHPMailerMailService</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-DefaultMailService.php">DefaultMailService</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-Mail.php">Mail</a></td>
	<td class="ellipsis">This class allows you to send mails without having to deal with the mail headers and parameters.</td>
</tr>
<tr>
	<td class="name"><a href="class-MailToPHPMailerConverter.php">MailToPHPMailerConverter</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-MailUtil.php">MailUtil</a></td>
	<td class="ellipsis">This class provides you utilities for emails.</td>
</tr>
<tr>
	<td class="name"><a href="class-SMTPConfiguration.php">SMTPConfiguration</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-SMTPMailService.php">SMTPMailService</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-MailService.php">MailService</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
