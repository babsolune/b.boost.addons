		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormBuilderException.php" class="cssmenu-title">FormBuilderException</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormBuilderException</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormBuilderException.php#3-20" title="Go to source code">builder/form/FormBuilderException.class.php</a></span>
			</div>
...
<b><span>FormBuilderException</span></b>					
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-FormBuilderDisabledFieldException.php">FormBuilderDisabledFieldException</a>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormBuilderException.php#16-19" title="Go to source code">__construct</a>( <span> <var>$message</var></span> )
						</code>
