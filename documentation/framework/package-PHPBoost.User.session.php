...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.User.php">User</a>\session</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.User.php">User</a>\session</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-AutoConnectData.php">AutoConnectData</a></td>
	<td class="ellipsis">This class manages all sessions for the users.</td>
</tr>
<tr>
	<td class="name"><a href="class-Session.php">Session</a></td>
	<td class="ellipsis"><p>This class manages all sessions for the users.
Session::gc();
Session::start();</p></td>
</tr>
<tr>
	<td class="name"><a href="class-SessionData.php">SessionData</a></td>
	<td class="ellipsis">This class manages all sessions for the users.</td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-SessionNotFoundException.php">SessionNotFoundException</a></td>
	<td class="ellipsis">This class manages all sessions for the users.</td>
</tr>
	</table>
</div>
