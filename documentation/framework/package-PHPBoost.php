...
<section id="content">
	<header>
		<h1>Package PHPBoost</h1>
	</header>
	<article>
		<header><h2>Package PHPBoost</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-PHPBoost.Cache.php">PHPBoost\Cache</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Config.php">PHPBoost\Config</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Environment.php">PHPBoost\Environment</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Event.php">PHPBoost\Event</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Extension.provider.php">PHPBoost\Extension-provider</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Index.php">PHPBoost\Index</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Langs.php">PHPBoost\Langs</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Member.php">PHPBoost\Member</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Menu.php">PHPBoost\Menu</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Module.php">PHPBoost\Module</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Stats.php">PHPBoost\Stats</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Theme.php">PHPBoost\Theme</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.Update.php">PHPBoost\Update</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.User.php">PHPBoost\User</a></td>
					</tr>
				</table>
			</div>
