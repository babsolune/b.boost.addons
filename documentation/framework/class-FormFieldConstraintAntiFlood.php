		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormFieldConstraintAntiFlood.php" class="cssmenu-title">FormFieldConstraintAntiFlood</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormFieldConstraintAntiFlood</h2></header>
		<div class="content">
...
<b><span>FormFieldConstraintAntiFlood</span></b>					
...
<a href="source-class-FormFieldConstraintAntiFlood.php#19-42" title="Go to source code">__construct</a>( <span>string <var>$last_posted_timestamp</var></span>, <span>string <var>$anti_flood_duration</var> = <span class="php-quote">''</span></span>, <span>string <var>$error_message</var> = <span class="php-quote">''</span></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$last_posted_timestamp</var></dt>
									<dd>Timestamp</dd>
									<dt><var>$anti_flood_duration</var></dt>
									<dd>seconde</dd>
...
<a href="source-class-FormFieldConstraintAntiFlood.php#53-56" title="Go to source code">get_js_validation</a>( <span><code><a href="class-FormField.php">FormField</a></code> <var>$field</var></span> )
			...
			<tr data-order="flooding" id="_flooding">
