		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-GraphicalEnvironmentConfig.php" class="cssmenu-title">GraphicalEnvironmentConfig</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>GraphicalEnvironmentConfig</h2></header>
		<div class="content">
...
<b><span>GraphicalEnvironmentConfig</span></b>					
		...
		<div class="content">
			...
			<tr data-order="is_visit_counter_enabled" id="_is_visit_counter_enabled">
...
<a href="source-class-GraphicalEnvironmentConfig.php#19-22" title="Go to source code">is_visit_counter_enabled</a>( )
			...
			<tr data-order="set_visit_counter_enabled" id="_set_visit_counter_enabled">
...
<a href="source-class-GraphicalEnvironmentConfig.php#24-27" title="Go to source code">set_visit_counter_enabled</a>( <span> <var>$enabled</var></span> )
			...
			<tr data-order="get_display_theme_author" id="_get_display_theme_author">
...
<a href="source-class-GraphicalEnvironmentConfig.php#29-32" title="Go to source code">get_display_theme_author</a>( )
			...
			<tr data-order="set_display_theme_author" id="_set_display_theme_author">
...
<a href="source-class-GraphicalEnvironmentConfig.php#34-37" title="Go to source code">set_display_theme_author</a>( <span> <var>$display</var></span> )
			...
			<tr data-order="is_page_bench_enabled" id="_is_page_bench_enabled">
...
<a href="source-class-GraphicalEnvironmentConfig.php#39-42" title="Go to source code">is_page_bench_enabled</a>( )
			...
			<tr data-order="set_page_bench_enabled" id="_set_page_bench_enabled">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-GraphicalEnvironmentConfig.php">GraphicalEnvironmentConfig</a></code>
...
<a href="source-class-GraphicalEnvironmentConfig.php#67-73" title="Go to source code">save</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="VISIT_COUNTER_ENABLED" id="VISIT_COUNTER_ENABLED">
						...
						<td class="value">
							<div>
								<a href="#VISIT_COUNTER_ENABLED" class="anchor">#</a>
								<code><span class="php-quote">'visit_counter_enabled'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="DISPLAY_THEME_AUTHOR" id="DISPLAY_THEME_AUTHOR">
						...
						<td class="value">
							<div>
								<a href="#DISPLAY_THEME_AUTHOR" class="anchor">#</a>
								<code><span class="php-quote">'display_theme_author'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PAGE_BENCH_ENABLED" id="PAGE_BENCH_ENABLED">
						...
						<td class="value">
							<div>
								<a href="#PAGE_BENCH_ENABLED" class="anchor">#</a>
								<code><span class="php-quote">'page_bench_enabled'</span></code>
							</div>
						</td>
					</tr>
				</table>
