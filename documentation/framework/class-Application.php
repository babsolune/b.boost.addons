<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-Application.php" class="cssmenu-title">Application</a></li>
						...
						<div class="description detailed hidden">
							<p>constructor of the class</p>
								...
								<div class="list"><dl>
									...
									<dd></dd>
									<dt><var>$type</var></dt>
									<dd>APPLICATION_TYPE_xxx constants</dd>
...
<a href="source-class-Application.php#71-170" title="Go to source code">load</a>( <span> <var>$xml_desc</var></span> )
						...
						<div class="description detailed hidden">
							<p>Loads an XML description</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$xml_desc</var></dt>
									<dd>to xml description</dd>
								</dl></div>
...
<a href="source-class-Application.php#171-178" title="Go to source code">get_identifier</a>( )
							...
							<div class="description short">
								<p>Gets an identifier of the application</p>
							</div>
			...
			<tr data-order="check_compatibility" id="_check_compatibility">
...
<a href="source-class-Application.php#179-197" title="Go to source code">check_compatibility</a>( )
							...
							<div class="description short">
								<p>Checks compatibility with limits</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Checks compatibility with limits</p>
								...
								<h6>Returns</h6>
								<div class="list">
									boolean<br>TRUE if compatible FALSE if not
								</div>
...
<a href="source-class-Application.php#204-207" title="Go to source code">get_name</a>( )
			...
			<tr data-order="get_language" id="_get_language">
...
<a href="source-class-Application.php#208-211" title="Go to source code">get_language</a>( )
			...
			<tr data-order="get_localized_language" id="_get_localized_language">
...
<a href="source-class-Application.php#212-215" title="Go to source code">get_localized_language</a>( )
							...
							<div class="description short">
								<p>Accessor of Localized language</p>
							</div>
...
<a href="source-class-Application.php#216-219" title="Go to source code">get_type</a>( )
			...
			<tr data-order="get_repository" id="_get_repository">
...
<a href="source-class-Application.php#220-223" title="Go to source code">get_repository</a>( )
			...
			<tr data-order="get_version" id="_get_version">
...
<a href="source-class-Application.php#224-227" title="Go to source code">get_version</a>( )
			...
			<tr data-order="get_compatibility_min" id="_get_compatibility_min">
...
<a href="source-class-Application.php#228-231" title="Go to source code">get_compatibility_min</a>( )
							...
							<div class="description short">
								<p>Accessor of Compatibility min value</p>
							</div>
			...
			<tr data-order="get_compatibility_max" id="_get_compatibility_max">
...
<a href="source-class-Application.php#232-235" title="Go to source code">get_compatibility_max</a>( )
							...
							<div class="description short">
								<p>Accessor of Compatibility Max value</p>
							</div>
			...
			<tr data-order="get_pubdate" id="_get_pubdate">
...
<a href="source-class-Application.php#236-239" title="Go to source code">get_pubdate</a>( )
							...
							<div class="description short">
								<p>Accessor of Publication Date</p>
							</div>
...
<a href="source-class-Application.php#240-243" title="Go to source code">get_priority</a>( )
			...
			<tr data-order="get_security_update" id="_get_security_update">
...
<a href="source-class-Application.php#244-247" title="Go to source code">get_security_update</a>( )
							...
							<div class="description short">
								<p>Accessor of Security Update</p>
							</div>
			...
			<tr data-order="get_download_url" id="_get_download_url">
...
<a href="source-class-Application.php#248-251" title="Go to source code">get_download_url</a>( )
			...
			<tr data-order="get_update_url" id="_get_update_url">
...
<a href="source-class-Application.php#252-255" title="Go to source code">get_update_url</a>( )
			...
			<tr data-order="get_authors" id="_get_authors">
...
<a href="source-class-Application.php#260-263" title="Go to source code">get_description</a>( )
							...
							<div class="description short">
								<p>Accessor of Description Text</p>
							</div>
			...
			<tr data-order="get_new_features" id="_get_new_features">
...
<a href="source-class-Application.php#264-267" title="Go to source code">get_new_features</a>( )
							...
							<div class="description short">
								<p>Accessor of New Features Text</p>
							</div>
			...
			<tr data-order="get_improvements" id="_get_improvements">
...
<a href="source-class-Application.php#268-271" title="Go to source code">get_improvements</a>( )
							...
							<div class="description short">
								<p>Accessor of improvements Text</p>
							</div>
			...
			<tr data-order="get_bug_corrections" id="_get_bug_corrections">
...
<a href="source-class-Application.php#272-275" title="Go to source code">get_bug_corrections</a>( )
							...
							<div class="description short">
								<p>Accessor of Bug Corrections Text</p>
							</div>
			...
			<tr data-order="get_security_improvements" id="_get_security_improvements">
...
<a href="source-class-Application.php#276-279" title="Go to source code">get_security_improvements</a>( )
							...
							<div class="description short">
								<p>Accessor of Security improvements</p>
							</div>
			...
			<tr data-order="get_warning_level" id="_get_warning_level">
...
<a href="source-class-Application.php#280-283" title="Go to source code">get_warning_level</a>( )
			...
			<tr data-order="get_warning" id="_get_warning">
...
<a href="source-class-Application.php#284-287" title="Go to source code">get_warning</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="KERNEL_TYPE" id="KERNEL_TYPE">
						...
						<td class="value">
							<div>
								<a href="#KERNEL_TYPE" class="anchor">#</a>
								<code><span class="php-quote">'kernel'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="MODULE_TYPE" id="MODULE_TYPE">
						...
						<td class="value">
							<div>
								<a href="#MODULE_TYPE" class="anchor">#</a>
								<code><span class="php-quote">'module'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="TEMPLATE_TYPE" id="TEMPLATE_TYPE">
						...
						<td class="value">
							<div>
								<a href="#TEMPLATE_TYPE" class="anchor">#</a>
