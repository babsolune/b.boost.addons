...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\Filesystem</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\Filesystem</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-IO.Filesystem.stream.php">IO\Filesystem\stream</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-File.php">File</a></td>
	<td class="ellipsis">This class represents a text file which can be read and written.</td>
</tr>
<tr>
	<td class="name"><a href="class-FileSystemElement.php">FileSystemElement</a></td>
	<td class="ellipsis">This class represents any file system element.</td>
</tr>
<tr>
	<td class="name"><a href="class-FileType.php">FileType</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-Folder.php">Folder</a></td>
	<td class="ellipsis">This class allows you to handle very easily a folder on the server.</td>
</tr>
	</table>
</div>
