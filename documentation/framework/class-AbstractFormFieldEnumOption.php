<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractFormFieldEnumOption.php" class="cssmenu-title">AbstractFormFieldEnumOption</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractFormFieldEnumOption</h2></header>
		<div class="content">
...
<b><span>AbstractFormFieldEnumOption</span></b>					
					 implements 
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-FormFieldRadioChoiceOption.php">FormFieldRadioChoiceOption</a>, 
					<a href="class-FormFieldSelectChoiceGroupOption.php">FormFieldSelectChoiceGroupOption</a>, 
					<a href="class-FormFieldSelectChoiceOption.php">FormFieldSelectChoiceOption</a>
			</div>
...
<a href="source-class-AbstractFormFieldEnumOption.php#34-40" title="Go to source code">get_label</a>( )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><code><a href="class-FormFieldEnumOption.php#_get_label">FormFieldEnumOption::get_label()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractFormFieldEnumOption.php#42-48" title="Go to source code">set_label</a>( <span> <var>$label</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FormFieldEnumOption.php#_set_label">FormFieldEnumOption::set_label()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_raw_value" id="_get_raw_value">
...
<a href="source-class-AbstractFormFieldEnumOption.php#50-56" title="Go to source code">get_raw_value</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FormFieldEnumOption.php#_get_raw_value">FormFieldEnumOption::get_raw_value()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="set_raw_value" id="_set_raw_value">
...
<a href="source-class-AbstractFormFieldEnumOption.php#58-64" title="Go to source code">set_raw_value</a>( <span> <var>$value</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FormFieldEnumOption.php#_set_raw_value">FormFieldEnumOption::set_raw_value()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractFormFieldEnumOption.php#66-72" title="Go to source code">get_field</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FormFieldEnumOption.php#_get_field">FormFieldEnumOption::get_field()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="set_field" id="_set_field">
...
<a href="source-class-AbstractFormFieldEnumOption.php#74-77" title="Go to source code">set_field</a>( <span><code><a href="class-FormField.php">FormField</a></code> <var>$field</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FormFieldEnumOption.php#_set_field">FormFieldEnumOption::set_field()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="set_active" id="_set_active">
...
<a href="source-class-AbstractFormFieldEnumOption.php#79-82" title="Go to source code">set_active</a>( <span> <var>$value</var> = <span class="php-keyword1">true</span></span> )
			...
			<tr data-order="is_active" id="_is_active">
...
<a href="source-class-AbstractFormFieldEnumOption.php#84-94" title="Go to source code">is_active</a>( )
			...
			<tr data-order="set_disable" id="_set_disable">
...
<a href="source-class-AbstractFormFieldEnumOption.php#96-99" title="Go to source code">set_disable</a>( <span> <var>$value</var> = <span class="php-keyword1">false</span></span> )
			...
			<tr data-order="is_disable" id="_is_disable">
...
<a href="source-class-AbstractFormFieldEnumOption.php#101-104" title="Go to source code">is_disable</a>( )
			...
			<tr data-order="get_field_id" id="_get_field_id">
...
<a href="source-class-AbstractFormFieldEnumOption.php#116-129" title="Go to source code">get_option</a>( <span> <var>$raw_value</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FormFieldEnumOption.php#_get_option">FormFieldEnumOption::get_option()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractFormFieldEnumOption.php#131-146" title="Go to source code">compute_options</a>( <span>array <var>&amp; $field_choice_options</var></span> )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-FormFieldEnumOption.php#methods">FormFieldEnumOption</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-FormFieldEnumOption.php#_display">display()</a>
							</code>
						</td>
					</tr>
				</table>
