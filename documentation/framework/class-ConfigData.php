<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ConfigData.php" class="cssmenu-title">ConfigData</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ConfigData</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This interface represents configuration data which are stored automatically by the
config manager. The storage mode is very powerful, it uses a two-level cache and the database.</p>
...
<b><span>ConfigData</span></b>					
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractConfigData.php">AbstractConfigData</a>
			</div>
...
<a href="source-class-ConfigData.php#34-38" title="Go to source code">set_default_values</a>( )
							...
							<div class="description short">
								<p>Sets the default value to avoid having unexisting values when we use it.
...
If some entries doesn't exist, they can be created here.</p>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-CacheData.php#methods">CacheData</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-CacheData.php#_synchronize">synchronize()</a>
							</code>
						</td>
					</tr>
				</table>
