		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Theme.php" class="cssmenu-title">Theme</a></li>
...
<a href="source-class-Theme.php#55-58" title="Go to source code">get_columns_disabled</a>( )
			...
			<tr data-order="set_customize_interface" id="_set_customize_interface">
...
<a href="source-class-Theme.php#60-63" title="Go to source code">set_customize_interface</a>( <span><code><a href="class-CustomizeInterface.php">CustomizeInterface</a></code> <var>$customize_interface</var></span> )
			...
			<tr data-order="get_customize_interface" id="_get_customize_interface">
			...
			<tr data-order="get_configuration" id="_get_configuration">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-ThemeConfiguration.php">ThemeConfiguration</a></code>
...
<a href="source-class-Theme.php#83-90" title="Go to source code">check_auth</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="ACCES_THEME" id="ACCES_THEME">
						...
						<td class="value">
							<div>
								<a href="#ACCES_THEME" class="anchor">#</a>
