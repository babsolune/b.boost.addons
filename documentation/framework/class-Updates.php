		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Updates.php" class="cssmenu-title">Updates</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Update.php">Update</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 12 24
						</span>
						<span class="infos-options">
							<b>Since:</b>
...
<a href="source-class-Updates.php#27-36" title="Go to source code">__construct</a>( <span> <var>$checks</var> = CHECK_ALL_UPDATES</span> )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="PHPBOOST_OFFICIAL_REPOSITORY" id="PHPBOOST_OFFICIAL_REPOSITORY">
						...
						<td class="value">
							<div>
								<a href="#PHPBOOST_OFFICIAL_REPOSITORY" class="anchor">#</a>
								<code><span class="php-quote">'https://www.phpboost.com/repository/main.xml'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PHP_MIN_VERSION_UPDATES" id="PHP_MIN_VERSION_UPDATES">
						...
						<td class="value">
							<div>
								<a href="#PHP_MIN_VERSION_UPDATES" class="anchor">#</a>
								<code><span class="php-quote">'5'</span></code>
							</div>
						</td>
					</tr>
				</table>
