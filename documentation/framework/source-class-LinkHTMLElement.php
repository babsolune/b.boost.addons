...
</span><span id="15" class="l"><span class="php-keyword1">class</span> LinkHTMLElement <span class="php-keyword1">extends</span> AbstractHTMLElement
</span><span id="16" class="l">{
</span><span id="17" class="l">    <span class="php-keyword1">private</span> <span class="php-var">$url</span>;
</span><span id="18" class="l">    <span class="php-keyword1">private</span> <span class="php-var">$content</span>;
</span><span id="19" class="l">    <span class="php-keyword1">private</span> <span class="php-var">$attributs</span> = <span class="php-keyword1">array</span>();
</span><span id="20" class="l">
</span><span id="21" class="l">    <span class="php-keyword1">public</span> <span class="php-keyword1">function</span> __construct(<span class="php-var">$url</span>, <span class="php-var">$content</span>, <span class="php-var">$attributs</span> = <span class="php-keyword1">array</span>(), <span class="php-var">$css_class</span> = <span class="php-quote">''</span>)
</span><span id="22" class="l">    {
</span><span id="23" class="l">        <span class="php-keyword1">if</span> (<span class="php-var">$url</span> <span class="php-keyword1">instanceof</span> Url)
</span><span id="24" class="l">        {
</span><span id="25" class="l">            <span class="php-var">$url</span> = <span class="php-var">$url</span>-&gt;rel();
</span><span id="26" class="l">        }
</span><span id="27" class="l">
</span><span id="28" class="l">        <span class="php-var">$this</span>-&gt;url = <span class="php-var">$url</span>;
</span><span id="29" class="l">        <span class="php-var">$this</span>-&gt;content = <span class="php-var">$content</span>;
</span><span id="30" class="l">        <span class="php-var">$this</span>-&gt;attributs = <span class="php-var">$attributs</span>;
</span><span id="31" class="l">        <span class="php-var">$this</span>-&gt;css_class = <span class="php-var">$css_class</span>;
...
</span><span id="36" class="l">        <span class="php-var">$tpl</span> = <span class="php-keyword1">new</span> FileTemplate(<span class="php-quote">'framework/builder/element/LinkHTMLElement.tpl'</span>);
</span><span id="37" class="l">
</span><span id="38" class="l">        <span class="php-var">$tpl</span>-&gt;put_all(<span class="php-keyword1">array</span>(
</span><span id="39" class="l">            <span class="php-quote">'C_HAS_CSS_CLASSES'</span> =&gt; <span class="php-var">$this</span>-&gt;has_css_class(),
</span><span id="40" class="l">            <span class="php-quote">'CSS_CLASSES'</span> =&gt; <span class="php-var">$this</span>-&gt;get_css_class(),
</span><span id="41" class="l">            <span class="php-quote">'URL'</span> =&gt; <span class="php-var">$this</span>-&gt;url,
</span><span id="42" class="l">            <span class="php-quote">'CONTENT'</span> =&gt; <span class="php-var">$this</span>-&gt;content,
</span><span id="43" class="l">        ));
</span><span id="44" class="l">
</span><span id="45" class="l">        <span class="php-keyword1">foreach</span> (<span class="php-var">$this</span>-&gt;attributs <span class="php-keyword1">as</span> <span class="php-var">$type</span> =&gt; <span class="php-var">$value</span>)
</span><span id="46" class="l">        {
</span><span id="47" class="l">            <span class="php-var">$tpl</span>-&gt;assign_block_vars(<span class="php-quote">'attributs'</span>, <span class="php-keyword1">array</span>(
</span><span id="48" class="l">                <span class="php-quote">'TYPE'</span> =&gt; <span class="php-var">$type</span>,
</span><span id="49" class="l">                <span class="php-quote">'VALUE'</span> =&gt; <span class="php-var">$value</span>
</span><span id="50" class="l">            ));
</span><span id="51" class="l">        }
</span><span id="52" class="l">
</span><span id="53" class="l">        <span class="php-keyword1">return</span> <span class="php-var">$tpl</span>-&gt;render();
