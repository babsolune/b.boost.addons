		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-User.php" class="cssmenu-title">User</a></li>
		...
		<div class="content">
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-CurrentUser.php">CurrentUser</a>
			</div>
...
<a href="source-class-User.php#51-54" title="Go to source code">get_id</a>( )
			...
			<tr data-order="set_level" id="_set_level">
...
<a href="source-class-User.php#56-59" title="Go to source code">set_level</a>( <span> <var>$level</var></span> )
			...
			<tr data-order="get_level" id="_get_level">
...
<a href="source-class-User.php#61-64" title="Go to source code">get_level</a>( )
			...
			<tr data-order="is_guest" id="_is_guest">
...
<a href="source-class-User.php#66-69" title="Go to source code">is_guest</a>( )
			...
			<tr data-order="is_robot" id="_is_robot">
...
<a href="source-class-User.php#71-74" title="Go to source code">is_robot</a>( )
			...
			<tr data-order="is_moderator" id="_is_moderator">
...
<a href="source-class-User.php#81-84" title="Go to source code">is_admin</a>( )
			...
			<tr data-order="set_groups" id="_set_groups">
...
<a href="source-class-User.php#94-97" title="Go to source code">get_groups</a>( )
			...
			<tr data-order="set_display_name" id="_set_display_name">
...
<a href="source-class-User.php#99-102" title="Go to source code">set_display_name</a>( <span> <var>$display_name</var></span> )
			...
			<tr data-order="get_display_name" id="_get_display_name">
...
<a href="source-class-User.php#104-107" title="Go to source code">get_display_name</a>( )
			...
			<tr data-order="set_email" id="_set_email">
...
<a href="source-class-User.php#109-112" title="Go to source code">set_email</a>( <span> <var>$email</var></span> )
			...
			<tr data-order="get_email" id="_get_email">
...
<a href="source-class-User.php#114-117" title="Go to source code">get_email</a>( )
			...
			<tr data-order="set_show_email" id="_set_show_email">
...
<a href="source-class-User.php#119-122" title="Go to source code">set_show_email</a>( <span> <var>$show_email</var></span> )
			...
			<tr data-order="get_show_email" id="_get_show_email">
...
<a href="source-class-User.php#124-127" title="Go to source code">get_show_email</a>( )
			...
			<tr data-order="set_unread_pm" id="_set_unread_pm">
...
<a href="source-class-User.php#129-132" title="Go to source code">set_unread_pm</a>( <span> <var>$unread_pm</var></span> )
			...
			<tr data-order="get_unread_pm" id="_get_unread_pm">
...
<a href="source-class-User.php#134-137" title="Go to source code">get_unread_pm</a>( )
			...
			<tr data-order="set_locale" id="_set_locale">
...
<a href="source-class-User.php#139-142" title="Go to source code">set_locale</a>( <span> <var>$locale</var></span> )
			...
			<tr data-order="get_locale" id="_get_locale">
...
<a href="source-class-User.php#144-151" title="Go to source code">get_locale</a>( )
			...
			<tr data-order="set_theme" id="_set_theme">
...
<a href="source-class-User.php#153-156" title="Go to source code">set_theme</a>( <span> <var>$theme</var></span> )
			...
			<tr data-order="get_theme" id="_get_theme">
...
<a href="source-class-User.php#158-165" title="Go to source code">get_theme</a>( )
			...
			<tr data-order="set_timezone" id="_set_timezone">
...
<a href="source-class-User.php#167-170" title="Go to source code">set_timezone</a>( <span> <var>$timezone</var></span> )
			...
			<tr data-order="get_timezone" id="_get_timezone">
...
<a href="source-class-User.php#172-179" title="Go to source code">get_timezone</a>( )
			...
			<tr data-order="set_editor" id="_set_editor">
...
<a href="source-class-User.php#181-184" title="Go to source code">set_editor</a>( <span> <var>$editor</var></span> )
			...
			<tr data-order="get_editor" id="_get_editor">
...
<a href="source-class-User.php#186-193" title="Go to source code">get_editor</a>( )
			...
			<tr data-order="set_warning_percentage" id="_set_warning_percentage">
...
<a href="source-class-User.php#195-198" title="Go to source code">set_warning_percentage</a>( <span> <var>$warning_percentage</var></span> )
			...
			<tr data-order="get_warning_percentage" id="_get_warning_percentage">
...
<a href="source-class-User.php#200-203" title="Go to source code">get_warning_percentage</a>( )
			...
			<tr data-order="set_delay_banned" id="_set_delay_banned">
...
<a href="source-class-User.php#205-208" title="Go to source code">set_delay_banned</a>( <span> <var>$delay_banned</var></span> )
			...
			<tr data-order="get_delay_banned" id="_get_delay_banned">
...
<a href="source-class-User.php#210-213" title="Go to source code">get_delay_banned</a>( )
			...
			<tr data-order="is_banned" id="_is_banned">
...
<a href="source-class-User.php#215-218" title="Go to source code">is_banned</a>( )
			...
			<tr data-order="set_delay_readonly" id="_set_delay_readonly">
...
<a href="source-class-User.php#220-223" title="Go to source code">set_delay_readonly</a>( <span> <var>$delay_readonly</var></span> )
			...
			<tr data-order="get_delay_readonly" id="_get_delay_readonly">
...
<a href="source-class-User.php#230-233" title="Go to source code">is_readonly</a>( )
			...
			<tr data-order="get_group_color" id="_get_group_color">
...
<a href="source-class-User.php#255-273" title="Go to source code">set_properties</a>( <span>array <var>$properties</var></span> )
			...
			<tr data-order="init_robot_user" id="_init_robot_user">
...
<a href="source-class-User.php#275-278" title="Go to source code">init_robot_user</a>( <span> <var>$robot_name</var></span> )
			...
			<tr data-order="init_visitor_user" id="_init_visitor_user">
...
<a href="source-class-User.php#280-283" title="Go to source code">init_visitor_user</a>( )
			...
			<tr data-order="get_visitor_properties" id="_get_visitor_properties">
...
<a href="source-class-User.php#285-305" title="Go to source code">get_visitor_properties</a>( <span> <var>$display_name</var> = <span class="php-keyword1">null</span></span>, <span> <var>$level</var> = self::VISITOR_LEVEL</span> )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="ROBOT_LEVEL" id="ROBOT_LEVEL">
						...
						<td class="value">
							<div>
								<a href="#ROBOT_LEVEL" class="anchor">#</a>
								<code>-<span class="php-num">2</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="VISITOR_LEVEL" id="VISITOR_LEVEL">
						...
						<td class="value">
							<div>
								<a href="#VISITOR_LEVEL" class="anchor">#</a>
								<code>-<span class="php-num">1</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="MEMBER_LEVEL" id="MEMBER_LEVEL">
						...
						<td class="value">
							<div>
								<a href="#MEMBER_LEVEL" class="anchor">#</a>
								<code><span class="php-num">0</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="MODERATOR_LEVEL" id="MODERATOR_LEVEL">
						...
						<td class="value">
							<div>
								<a href="#MODERATOR_LEVEL" class="anchor">#</a>
								<code><span class="php-num">1</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="ADMIN_LEVEL" id="ADMIN_LEVEL">
						...
						<td class="value">
							<div>
								<a href="#ADMIN_LEVEL" class="anchor">#</a>
								<code><span class="php-num">2</span></code>
							</div>
						</td>
					</tr>
			...
			<tr data-order="groups" id="$groups">
				...
				<td class="value">
					<div>
						<a href="#$groups" class="anchor">#</a>
						<code><span class="php-keyword1">array</span>()</code>
					</div>
				</td>
			</tr>
			<tr data-order="display_name" id="$display_name">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$display_name" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			...
			<tr data-order="show_email" id="$show_email">
				<td class="attributes">
					<code>
						protected  
						boolean
				...
				<td class="value">
					<div>
						<a href="#$show_email" class="anchor">#</a>
						<code><span class="php-keyword1">false</span></code>
					</div>
				</td>
			</tr>
			<tr data-order="unread_pm" id="$unread_pm">
				<td class="attributes">
					<code>
						protected  
						integer
				...
				<td class="value">
					<div>
						<a href="#$unread_pm" class="anchor">#</a>
						<code><span class="php-num">0</span></code>
					</div>
				</td>
			</tr>
			...
			<tr data-order="editor" id="$editor">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$editor" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="delay_banned" id="$delay_banned">
				<td class="attributes">
					<code>
						protected  
						integer
				...
				<td class="value">
					<div>
						<a href="#$delay_banned" class="anchor">#</a>
						<code><span class="php-num">0</span></code>
					</div>
				</td>
			</tr>
			<tr data-order="delay_readonly" id="$delay_readonly">
				<td class="attributes">
					<code>
						protected  
						integer
				...
				<td class="value">
					<div>
						<a href="#$delay_readonly" class="anchor">#</a>
						<code><span class="php-num">0</span></code>
					</div>
				</td>
			</tr>
			<tr data-order="warning_percentage" id="$warning_percentage">
				<td class="attributes">
					<code>
						protected  
						integer
				...
				<td class="value">
					<div>
						<a href="#$warning_percentage" class="anchor">#</a>
						<code><span class="php-num">0</span></code>
					</div>
				</td>
			</tr>
