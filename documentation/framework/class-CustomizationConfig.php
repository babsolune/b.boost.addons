		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CustomizationConfig.php" class="cssmenu-title">CustomizationConfig</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CustomizationConfig</h2></header>
		<div class="content">
...
<b><span>CustomizationConfig</span></b>					
		...
		<div class="content">
			...
			<tr data-order="get_favicon_path" id="_get_favicon_path">
...
<a href="source-class-CustomizationConfig.php#18-21" title="Go to source code">get_favicon_path</a>( )
			...
			<tr data-order="set_favicon_path" id="_set_favicon_path">
...
<a href="source-class-CustomizationConfig.php#23-26" title="Go to source code">set_favicon_path</a>( <span> <var>$path</var></span> )
			...
			<tr data-order="favicon_exists" id="_favicon_exists">
...
<a href="source-class-CustomizationConfig.php#28-32" title="Go to source code">favicon_exists</a>( )
			...
			<tr data-order="favicon_type" id="_favicon_type">
...
<a href="source-class-CustomizationConfig.php#34-42" title="Go to source code">favicon_type</a>( )
			...
			<tr data-order="set_header_logo_path_all_themes" id="_set_header_logo_path_all_themes">
...
<a href="source-class-CustomizationConfig.php#44-47" title="Go to source code">set_header_logo_path_all_themes</a>( <span> <var>$path</var></span> )
			...
			<tr data-order="remove_header_logo_path_all_themes" id="_remove_header_logo_path_all_themes">
...
<a href="source-class-CustomizationConfig.php#49-52" title="Go to source code">remove_header_logo_path_all_themes</a>( )
			...
			<tr data-order="get_header_logo_path_all_themes" id="_get_header_logo_path_all_themes">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-CustomizationConfig.php">CustomizationConfig</a></code>
...
<a href="source-class-CustomizationConfig.php#76-82" title="Go to source code">save</a>( )
							...
							<div class="description short">
								<p>Saves the configuration in the database.</p>
							</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="FAVICON_PATH" id="FAVICON_PATH">
						...
						<td class="value">
							<div>
								<a href="#FAVICON_PATH" class="anchor">#</a>
								<code><span class="php-quote">'favicon_path'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="HEADER_LOGO_PATH_ALL_THEMES" id="HEADER_LOGO_PATH_ALL_THEMES">
						...
						<td class="value">
							<div>
								<a href="#HEADER_LOGO_PATH_ALL_THEMES" class="anchor">#</a>
								<code><span class="php-quote">'header_logo_path_all_themes'</span></code>
							</div>
						</td>
					</tr>
				</table>
