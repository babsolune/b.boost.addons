		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTMLTableBeginsWithTextSQLFilter.php" class="cssmenu-title">HTMLTableBeginsWithTextSQLFilter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLTableBeginsWithTextSQLFilter</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Table.php">Table</a>\<a href="package-Builder.Table.filter.php">filter</a>\<a href="package-Builder.Table.filter.sql.php">sql</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-HTMLTableBeginsWithTextSQLFilter.php#3-22" title="Go to source code">builder/table/filter/sql/HTMLTableBeginsWithTextSQLFilter.class.php</a></span>
			</div>
			...
			<dl class="tree">
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
					<a href="class-HTMLTableLikeTextSQLFilter.php"><span>HTMLTableLikeTextSQLFilter</span></a>
				...
				<dd style="padding-left:90px">
					<img src="resources/inherit.png" alt="Extended by">
					<a href="class-HTMLTableEscapedLikeTextSQLFilter.php"><span>HTMLTableEscapedLikeTextSQLFilter</span></a>
				...
				<dd style="padding-left:120px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>HTMLTableBeginsWithTextSQLFilter</span></b>					
			...
			<tr data-order="get_value" id="_get_value">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableBeginsWithTextSQLFilter.php#15-21" title="Go to source code">get_value</a>( )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractHTMLTableFilter.php#_get_value">AbstractHTMLTableFilter::get_value()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-HTMLTableEscapedLikeTextSQLFilter.php#methods">HTMLTableEscapedLikeTextSQLFilter</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-HTMLTableEscapedLikeTextSQLFilter.php#_set_value">set_value()</a>
							</code>
						</td>
					</tr>
				</table>
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-HTMLTableLikeTextSQLFilter.php#methods">HTMLTableLikeTextSQLFilter</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-HTMLTableLikeTextSQLFilter.php#___construct">__construct()</a>, 
									<a href="class-HTMLTableLikeTextSQLFilter.php#_get_sql">get_sql()</a>, 
									<a href="class-HTMLTableLikeTextSQLFilter.php#_get_sql_value_parameter_prefix">get_sql_value_parameter_prefix()</a>, 
									<a href="class-HTMLTableLikeTextSQLFilter.php#_is_value_allowed">is_value_allowed()</a>
							</code>
						</td>
					</tr>
				</table>
