		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AdminController.php" class="cssmenu-title">AdminController</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AdminController</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-MVC.php">MVC</a>\<a href="package-MVC.Controller.php">Controller</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-AdminController.php#3-26" title="Go to source code">mvc/controller/AdminController.class.php</a></span>
			</div>
			...
			<tr data-order="get_right_controller_regarding_authorizations" id="_get_right_controller_regarding_authorizations">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AdminController.php#18-25" title="Go to source code">get_right_controller_regarding_authorizations</a>( )
						</code>
