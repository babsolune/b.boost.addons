		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MenuStringFilter.php" class="cssmenu-title">MenuStringFilter</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MenuStringFilter</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Menu.php">Menu</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-MenuStringFilter.php#3-32" title="Go to source code">phpboost/menu/MenuStringFilter.class.php</a></span>
			</div>

			<div class="description">
				<p>This class represents a filter based on string comparison</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-Filter.php"><span>Filter</span></a>
...
<b><span>MenuStringFilter</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MenuStringFilter.php#18-21" title="Go to source code">__construct</a>( <span>string <var>$pattern</var></span> )
						</code>

							<div class="description short">
								<p>Build a filter based on the given pattern</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Build a filter based on the given pattern</p>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Filter.php#___construct">Filter::__construct()</a></code></div>
			...
			<tr data-order="match" id="_match">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MenuStringFilter.php#23-31" title="Go to source code">match</a>( )
						</code>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-Filter.php#methods">Filter</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-Filter.php#_get_pattern">get_pattern()</a>, 
									<a href="class-Filter.php#_set_pattern">set_pattern()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-Filter.php#properties">Filter</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-Filter.php#$pattern"><var>$pattern</var></a>
							</code>
						</td>
					</tr>
				</table>
