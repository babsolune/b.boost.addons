		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Element.php">Element</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-ImgHTMLElement.php#4-52" title="Go to source code">builder/element/ImgHTMLElement.class.php</a></span>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-ImgHTMLElement.php#20-30" title="Go to source code">__construct</a>( <span> <var>$url</var></span>, <span> <var>$attributs</var> = <span class="php-keyword1">array</span>()</span>, <span> <var>$css_class</var> = <span class="php-quote">''</span></span> )
						</code>
			...
			<tr data-order="display" id="_display">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-ImgHTMLElement.php#32-51" title="Go to source code">display</a>( )
						</code>
