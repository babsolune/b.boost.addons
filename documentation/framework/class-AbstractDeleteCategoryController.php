		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AbstractDeleteCategoryController.php" class="cssmenu-title">AbstractDeleteCategoryController</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractDeleteCategoryController</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Category.php">Category</a>\<a href="package-Content.Category.bridges.php">bridges</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 10 29
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<dl class="tree">
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>AbstractDeleteCategoryController</span></b>					
...
<a href="source-class-AbstractDeleteCategoryController.php#164-170" title="Go to source code">get_success_message</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>delete success message
								</div>
...
<a href="source-class-AbstractDeleteCategoryController.php#172-178" title="Go to source code">clear_cache</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									Clear<br>elements cache if any
								</div>
