<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ModuleMenus.php" class="cssmenu-title">ModuleMenus</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ModuleMenus</h2></header>
		<div class="content">
...
<b><span>ModuleMenus</span></b>					
					 implements 
						<a href="class-MenusExtensionPoint.php"><span>MenusExtensionPoint</span></a>
...
<a href="source-class-ModuleMenus.php#22-25" title="Go to source code">get_menus</a>( )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><code><a href="class-MenusExtensionPoint.php#_get_menus">MenusExtensionPoint::get_menus()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-MenusExtensionPoint.php#constants">MenusExtensionPoint</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-MenusExtensionPoint.php#EXTENSION_POINT"><b>EXTENSION_POINT</b></a>
							</code>
						</td>
					</tr>
				</table>
