<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FormattingParser.php" class="cssmenu-title">FormattingParser</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormattingParser</h2></header>
		<div class="content">
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractParser.php">AbstractParser</a>
			</div>
