<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FileTemplateLoadingException.php" class="cssmenu-title">FileTemplateLoadingException</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FileTemplateLoadingException</h2></header>
		<div class="content">
...
<span>Throwable</span>
				...
				<dd style="padding-left:30px">
					...
					<a href="class-TemplateLoadingException.php"><span>TemplateLoadingException</span></a>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>FileTemplateLoadingException</span></b>					
...
<a href="source-class-FileTemplateLoadingException.php#16-25" title="Go to source code">__construct</a>( <span> <var>$message</var></span>, <span> <var>$reason</var>,…</span> )
						...
						<div class="description detailed hidden">
							<p>Constructs</p>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-TemplateLoadingException.php#___construct">TemplateLoadingException::__construct()</a></code></div>
