		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-DispatchManager.php" class="cssmenu-title">DispatchManager</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DispatchManager</h2></header>
		<div class="content">
		...
		<div class="content">
			...
			<tr data-order="dispatch" id="_dispatch">
...
<a href="source-class-DispatchManager.php#18-33" title="Go to source code">dispatch</a>( <span><code><a href="class-UrlControllerMapper.php">UrlControllerMapper</a>[]</code> <var>$url_controller_mappers</var></span> )
							...
							<div class="description short">
								<p>Redirect the request to the right controller using the url controller mappes list</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Redirect the request to the right controller using the url controller mappes list</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$url_controller_mappers</var></dt>
									<dd>the url controllers mapper list</dd>
								</dl></div>
...
<a href="source-class-DispatchManager.php#35-48" title="Go to source code">redirect</a>( <span><code><a href="class-Controller.php">Controller</a></code> <var>$controller</var></span> )
							...
							<div class="description short">
								<p>Cleans the output buffer and execute the given controller before exiting</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Cleans the output buffer and execute the given controller before exiting</p>
								...
								<div class="list"><dl>
									...
									<dd>the controller to execute</dd>
								</dl></div>
...
<a href="source-class-DispatchManager.php#50-86" title="Go to source code">get_url</a>( <span>string <var>$path</var></span>, <span>string <var>$url</var></span>, <span>boolean <var>$not_rewriting_url_forced</var> = <span class="php-keyword1">false</span></span> )
							...
							<div class="description short">
								<p>Returns an url object from the dispatcher path with the $url param
dispatcher must be in the index.php file</p>
							</div>
...
dispatcher must be in the index.php file</p>
								...
								<div class="list"><dl>
									<dt><var>$path</var></dt>
									<dd>the url to apply the rewrite form on</dd>
									<dt><var>$url</var></dt>
									<dd>the url to apply the rewrite form on</dd>
									<dt><var>$not_rewriting_url_forced</var></dt>
									<dd>forced to have a non-rewritten url</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-Url.php">Url</a></code><br>an url object relative to the current script path
								</div>
