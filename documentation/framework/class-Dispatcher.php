		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Dispatcher.php" class="cssmenu-title">Dispatcher</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>Dispatcher</h2></header>
		<div class="content">
...
<a href="source-class-Dispatcher.php#25-34" title="Go to source code">__construct</a>( <span>&lt;code&gt;UrlControllerMapper[]&lt;/code&gt; <var>$url_controller_mappers</var></span> )
							...
							<div class="description short">
								<p>build a new Dispatcher from a UrlDispatcherItem List</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>build a new Dispatcher from a UrlDispatcherItem List</p>
								...
								<div class="list"><dl>
									...
									<dd><p>the list of the</p>

<pre>UrlControllerMapper</pre>

<p>that could be applied on an url for that module</p></dd>
								</dl></div>
...
<a href="source-class-Dispatcher.php#36-55" title="Go to source code">dispatch</a>( )
							...
							<div class="description short">
								<p>dispatch the current url argument to the first method matching
in the</p>

<pre>UrlControllerMapper</pre>

<p>list of the controller object</p>
							</div>
...
<p>list of the controller object</p>
								...
								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-NoUrlMatchException.php">NoUrlMatchException</a></code>
								</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="URL_PARAM_NAME" id="URL_PARAM_NAME">
						...
						<td class="value">
							<div>
								<a href="#URL_PARAM_NAME" class="anchor">#</a>
								<code><span class="php-quote">'url'</span></code>
							</div>
						</td>
					</tr>
				</table>
