		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HomePageExtensionPoint.php" class="cssmenu-title">HomePageExtensionPoint</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HomePageExtensionPoint</h2></header>
		<div class="content">
			...
			<tr data-order="get_home_page" id="_get_home_page">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-HomePage.php">HomePage</a></code>
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'home_page'</span></code>
							</div>
						</td>
					</tr>
				</table>
