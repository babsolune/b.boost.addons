		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-InvalidTemplateFunctionCallException.php" class="cssmenu-title">InvalidTemplateFunctionCallException</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>InvalidTemplateFunctionCallException</h2></header>
		<div class="content">
...
<span>Throwable</span>
				...
				<dd style="padding-left:30px">
					...
					<a href="class-TemplateRenderingException.php"><span>TemplateRenderingException</span></a>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>InvalidTemplateFunctionCallException</span></b>					
		...
		<div class="content">
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-TemplateRenderingException.php#methods">TemplateRenderingException</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-TemplateRenderingException.php#___construct">__construct()</a>
							</code>
						</td>
					</tr>
				</table>
