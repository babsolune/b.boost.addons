<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractResponse.php" class="cssmenu-title">AbstractResponse</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractResponse</h2></header>
		<div class="content">
...
<b><span>AbstractResponse</span></b>					
					 implements 
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-AdminDisplayFrameResponse.php">AdminDisplayFrameResponse</a>, 
					<a href="class-AdminDisplayResponse.php">AdminDisplayResponse</a>, 
					<a href="class-AdminMenuDisplayResponse.php">AdminMenuDisplayResponse</a>, 
					<a href="class-AdminNodisplayResponse.php">AdminNodisplayResponse</a>, 
					<a href="class-SiteDisplayFrameResponse.php">SiteDisplayFrameResponse</a>, 
					<a href="class-SiteDisplayResponse.php">SiteDisplayResponse</a>, 
					<a href="class-SiteNodisplayResponse.php">SiteNodisplayResponse</a>
			</div>
			...
			<tr data-order="send" id="_send">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-AbstractResponse.php#_send">AbstractResponse::send()</a></code>
...
<a href="source-class-AbstractResponse.php#47-50" title="Go to source code">send</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-AbstractResponse.php#_send">AbstractResponse::send()</a></code><br>the response to the browser
								</div>
								...
								<div class="list"><code><a href="class-Response.php#_send">Response::send()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
