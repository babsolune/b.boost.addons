<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DBMSUtils.php" class="cssmenu-title">DBMSUtils</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
		...
		<div class="content">
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-MySQLDBMSUtils.php">MySQLDBMSUtils</a>
			</div>
...
<a href="source-class-DBMSUtils.php#53" title="Go to source code">parse_file</a>( <span><code><a href="class-File.php">File</a></code> <var>$file</var></span>, <span> <var>$prefix</var> = <span class="php-quote">''</span></span> )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="DUMP_STRUCTURE" id="DUMP_STRUCTURE">
						...
						<td class="value">
							<div>
								<a href="#DUMP_STRUCTURE" class="anchor">#</a>
								<code><span class="php-num">1</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="DUMP_DATA" id="DUMP_DATA">
						...
						<td class="value">
							<div>
								<a href="#DUMP_DATA" class="anchor">#</a>
								<code><span class="php-num">2</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="DUMP_STRUCTURE_AND_DATA" id="DUMP_STRUCTURE_AND_DATA">
						...
						<td class="value">
							<div>
								<a href="#DUMP_STRUCTURE_AND_DATA" class="anchor">#</a>
