		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SiteNodisplayGraphicalEnvironment.php" class="cssmenu-title">SiteNodisplayGraphicalEnvironment</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SiteNodisplayGraphicalEnvironment</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Environment.php">Environment</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-SiteNodisplayGraphicalEnvironment.php#3-27" title="Go to source code">phpboost/environment/SiteNodisplayGraphicalEnvironment.class.php</a></span>
			</div>
...
<b><span>SiteNodisplayGraphicalEnvironment</span></b>					
			...
			<tr data-order="display" id="_display">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-SiteNodisplayGraphicalEnvironment.php#16-26" title="Go to source code">display</a>( <span> <var>$content</var></span> )
						</code>
