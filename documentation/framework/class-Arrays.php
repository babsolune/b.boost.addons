<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-Arrays.php" class="cssmenu-title">Arrays</a></li>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Util.php">Util</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-Arrays.php#3-44" title="Go to source code">util/Arrays.class.php</a></span>
			</div>
			...
			<tr data-order="find" id="_find">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-Arrays.php#14-35" title="Go to source code">find</a>( <span>mixed <var>$key</var></span>, <span>array <var>$values</var></span>, <span>mixed <var>$default</var> = <span class="php-keyword1">null</span></span> )
						</code>

							<div class="description short">
								<p>searches for $key in $values keys and returns the associated value.
If it doesn't exist, it will return the $default value if it is not null. Otherwise a
TokenNotFoundException will be thrown</p>
							</div>
...
TokenNotFoundException will be thrown</p>
								...
								<div class="list"><dl>
									...
									<dd>the availables values</dd>
									<dt><var>$default</var></dt>
									<dd>the default value to return if the $key is not found</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									mixed<br>the corresponding value
								</div>
			...
			<tr data-order="remove_key" id="_remove_key">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_remove_key">#</a>
						<code>
<a href="source-class-Arrays.php#37-43" title="Go to source code">remove_key</a>( <span> <var>$key</var></span>, <span>array <var>&amp; $values</var></span> )
						</code>
