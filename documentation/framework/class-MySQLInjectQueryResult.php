		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MySQLInjectQueryResult.php" class="cssmenu-title">MySQLInjectQueryResult</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MySQLInjectQueryResult</h2></header>
		<div class="content">
...
<b><span>MySQLInjectQueryResult</span></b>					
					 implements 
						<a href="class-InjectQueryResult.php"><span>InjectQueryResult</span></a>
...
<a href="source-class-MySQLInjectQueryResult.php#43-46" title="Go to source code">__destruct</a>( )
			...
			<tr data-order="get_affected_rows" id="_get_affected_rows">
...
<a href="source-class-MySQLInjectQueryResult.php#48-51" title="Go to source code">get_affected_rows</a>( )
							...
							<div class="description short">
								<p>returns the number of affected rows by this query</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>returns the number of affected rows by this query</p>
								...
								<h6>Returns</h6>
								<div class="list">
									integer<br>the number of affected rows by this query
								</div>
								...
								<div class="list"><code><a href="class-InjectQueryResult.php#_get_affected_rows">InjectQueryResult::get_affected_rows()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_last_inserted_id" id="_get_last_inserted_id">
...
<a href="source-class-MySQLInjectQueryResult.php#53-56" title="Go to source code">get_last_inserted_id</a>( )
							...
							<div class="description short">
								<p>returns the primary key value generated by the last insert query</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>returns the primary key value generated by the last insert query</p>
								...
								<h6>Returns</h6>
								<div class="list">
									integer<br>the primary key value generated by the last insert query
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-InjectQueryResult.php#_get_last_inserted_id">InjectQueryResult::get_last_inserted_id()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
