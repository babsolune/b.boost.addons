...
<section id="content">
	<header>
		<h1>Package <a href="package-Doctrine.php">Doctrine</a>\<a href="package-Doctrine.DBAL.php">DBAL</a>\Plateform</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-Doctrine.php">Doctrine</a>\<a href="package-Doctrine.DBAL.php">DBAL</a>\Plateform</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-AbstractPlatform.php">AbstractPlatform</a></td>
	<td class="ellipsis"><p>Base class for all DatabasePlatforms. The DatabasePlatforms are the central
point of abstraction of platform-specific behaviors, features and SQL dialects.
They are a passive source of information.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-MySqlPlatform.php">MySqlPlatform</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-PostgreSqlPlatform.php">PostgreSqlPlatform</a></td>
	<td class="ellipsis">PostgreSqlPlatform.</td>
</tr>
<tr>
	<td class="name"><a href="class-SqlitePlatform.php">SqlitePlatform</a></td>
	<td class="ellipsis"><p>The SqlitePlatform class describes the specifics and dialects of the SQLite
database platform.</p></td>
</tr>
	</table>
</div>
