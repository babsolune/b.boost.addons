...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\Config</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\Config</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-CommentsConfig.php">CommentsConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ContentFormattingConfig.php">ContentFormattingConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ContentManagementConfig.php">ContentManagementConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-CookieBarConfig.php">CookieBarConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-CSSCacheConfig.php">CSSCacheConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-CustomizationConfig.php">CustomizationConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-FileUploadConfig.php">FileUploadConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-GeneralConfig.php">GeneralConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-GraphicalEnvironmentConfig.php">GraphicalEnvironmentConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-LangsConfig.php">LangsConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-LastUseDateConfig.php">LastUseDateConfig</a></td>
	<td class="ellipsis"><p>This class contains the date of the last day where PHPBoost was used.
It's useful to know when to launch daily tasks.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-MailServiceConfig.php">MailServiceConfig</a></td>
	<td class="ellipsis">This class contains the configuration of PHPBoost's mail service.</td>
</tr>
<tr>
	<td class="name"><a href="class-MaintenanceConfig.php">MaintenanceConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ModulesConfig.php">ModulesConfig</a></td>
	<td class="ellipsis">This class contains the cache data of the modules which module users having common criteria.</td>
</tr>
<tr>
	<td class="name"><a href="class-SecurityConfig.php">SecurityConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ServerEnvironmentConfig.php">ServerEnvironmentConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-SessionsConfig.php">SessionsConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ThemesConfig.php">ThemesConfig</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-UserAccountsConfig.php">UserAccountsConfig</a></td>
	<td class="ellipsis">This class contains all the data related to the user accounts configuration.</td>
</tr>
<tr>
	<td class="name"><a href="class-WritingPadConfig.php">WritingPadConfig</a></td>
	<td class="ellipsis"><p>This class contains the content of the writing pad which is on the home page
of the administration panel.</p></td>
</tr>
	</table>
</div>
