		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-DecimalType.php" class="cssmenu-title">DecimalType</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DecimalType</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>Type that maps an SQL DECIMAL to a PHP double.</p>
			</div>
