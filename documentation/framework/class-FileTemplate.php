		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FileTemplate.php" class="cssmenu-title">FileTemplate</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FileTemplate</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FileTemplate.php#3-69" title="Go to source code">io/template/FileTemplate.class.php</a></span>
			</div>

			<div class="description">
				<p>This class allows you to handle a template file.
...
otherwise /templates/default/framework/package/file.tpl will be used.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractTemplate.php"><span>AbstractTemplate</span></a>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FileTemplate.php#36-49" title="Go to source code">__construct</a>( <span>string <var>$file_identifier</var></span> )
						</code>

							<div class="description short">
								<p>Builds a FileTemplate object</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Builds a FileTemplate object</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$file_identifier</var></dt>
									<dd><p>The identifier of the file you want to load (see this class' description)
to know how to compose a indentifier.</p></dd>
								</dl></div>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractTemplate.php#___construct">AbstractTemplate::__construct()</a></code></div>
			...
			<tr data-order="render" id="_render">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FileTemplate.php#51-68" title="Go to source code">render</a>( )
						</code>
						...
						<div class="description detailed hidden">
							<p>Returns a string representation of the view.</p>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractTemplate.php#_render">AbstractTemplate::render()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractTemplate.php#methods">AbstractTemplate</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractTemplate.php#___clone">__clone()</a>, 
									<a href="class-AbstractTemplate.php#_add_lang">add_lang()</a>, 
									<a href="class-AbstractTemplate.php#_add_subtemplate">add_subtemplate()</a>, 
									<a href="class-AbstractTemplate.php#_assign_block_vars">assign_block_vars()</a>, 
									<a href="class-AbstractTemplate.php#_assign_vars">assign_vars()</a>, 
									<a href="class-AbstractTemplate.php#_disable_strict_mode">disable_strict_mode()</a>, 
									<a href="class-AbstractTemplate.php#_display">display()</a>, 
									<a href="class-AbstractTemplate.php#_enable_strict_mode">enable_strict_mode()</a>, 
									<a href="class-AbstractTemplate.php#_get_data">get_data()</a>, 
									<a href="class-AbstractTemplate.php#_get_pictures_data_path">get_pictures_data_path()</a>, 
									<a href="class-AbstractTemplate.php#_put">put()</a>, 
									<a href="class-AbstractTemplate.php#_put_all">put_all()</a>, 
									<a href="class-AbstractTemplate.php#_set_data">set_data()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-AbstractTemplate.php#properties">AbstractTemplate</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractTemplate.php#$data"><var>$data</var></a>, 
									<a href="class-AbstractTemplate.php#$loader"><var>$loader</var></a>, 
									<a href="class-AbstractTemplate.php#$renderer"><var>$renderer</var></a>
							</code>
						</td>
					</tr>
				</table>
