<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ModuleTreeLinksExtensionPoint.php" class="cssmenu-title">ModuleTreeLinksExtensionPoint</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ModuleTreeLinksExtensionPoint</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Module.php">Module</a>\<a href="package-PHPBoost.Module.tree.links.php">tree-links</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-ModuleTreeLinksExtensionPoint.php#3-21" title="Go to source code">phpboost/module/tree-links/ModuleTreeLinksExtensionPoint.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>ModuleTreeLinksExtensionPoint</span></b>					
					 implements 
		...
		<div class="content">
			...
			<tr data-order="get_actions_tree_links" id="_get_actions_tree_links">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-ModuleTreeLinks.php">ModuleTreeLinks</a></code>
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_get_actions_tree_links">#</a>
						<code>
<a href="source-class-ModuleTreeLinksExtensionPoint.php#17-20" title="Go to source code">get_actions_tree_links</a>( )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-ModuleTreeLinks.php">ModuleTreeLinks</a></code><br>class containing the tree links different as possible actions in the module (addition, configuration, etc).
								</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="name">
							<code>
								<a href="source-class-ModuleTreeLinksExtensionPoint.php#15" title="Go to source code"><b>EXTENSION_POINT</b></a>
							</code>
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'tree_links'</span></code>
							</div>
						</td>
					</tr>
				</table>
