...
<section id="content">
	<header>
		<h1>Package <a href="package-Content.php">Content</a>\Formatting</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-Content.php">Content</a>\Formatting</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-Content.Formatting.editor.php">Content\Formatting\editor</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-Content.Formatting.extension.point.php">Content\Formatting\extension-point</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-Content.Formatting.parser.php">Content\Formatting\parser</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-ContentFormattingProvidersService.php">ContentFormattingProvidersService</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ContentFormattingService.php">ContentFormattingService</a></td>
	<td class="ellipsis"><p>This class contains the default content formatting factory that must be used if you want
a formatting factory having the default settings.</p></td>
</tr>
	</table>
</div>
