		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-InjectQueryResult.php" class="cssmenu-title">InjectQueryResult</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>InjectQueryResult</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>this class encapsulate an inject query result</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>InjectQueryResult</span></b>					
					 implements 
