		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-TimeType.php" class="cssmenu-title">TimeType</a></li>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Doctrine.php">Doctrine</a>\<a href="package-Doctrine.DBAL.php">DBAL</a>\<a href="package-Doctrine.DBAL.Types.php">Types</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-TimeType.php#3-49" title="Go to source code">io/db/dbms/Doctrine/DBAL/Types/TimeType.php</a></span>
			</div>

			<div class="description">
				<p>Type that maps an SQL TIME to a PHP DateTime object.</p>
			</div>
			...
			<tr data-order="getName" id="_getName">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-TimeType.php#15-18" title="Go to source code">getName</a>( )
						</code>
			...
			<tr data-order="getSqlDeclaration" id="_getSqlDeclaration">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-TimeType.php#20-26" title="Go to source code">getSqlDeclaration</a>( <span>array <var>$fieldDeclaration</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
			...
			<tr data-order="convertToDatabaseValue" id="_convertToDatabaseValue">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-TimeType.php#28-37" title="Go to source code">convertToDatabaseValue</a>( <span>mixed <var>$value</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
			...
			<tr data-order="convertToPHPValue" id="_convertToPHPValue">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-TimeType.php#39-48" title="Go to source code">convertToPHPValue</a>( <span>mixed <var>$value</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
