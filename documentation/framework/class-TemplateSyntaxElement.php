<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-TemplateSyntaxElement.php" class="cssmenu-title">TemplateSyntaxElement</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>TemplateSyntaxElement</h2></header>
		<div class="content">
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractTemplateSyntaxElement.php">AbstractTemplateSyntaxElement</a>
			</div>
					...
					<tr data-order="RESULT" id="RESULT">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'$_result'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="DATA" id="DATA">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'$_data'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="FUNCTIONS" id="FUNCTIONS">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'$_functions'</span></code>
							</div>
						</td>
					</tr>
				</table>
