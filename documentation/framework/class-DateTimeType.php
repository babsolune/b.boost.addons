		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-DateTimeType.php" class="cssmenu-title">DateTimeType</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DateTimeType</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Doctrine.php">Doctrine</a>\<a href="package-Doctrine.DBAL.php">DBAL</a>\<a href="package-Doctrine.DBAL.Types.php">Types</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2013 01 01
						</span>
						<span class="infos-options">
							<b>Since:</b>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-DateTimeType.php#3-36" title="Go to source code">io/db/dbms/Doctrine/DBAL/Types/DateTimeType.php</a></span>
			</div>

			<div class="description">
				<p>Type that maps an SQL DATETIME/TIMESTAMP to a PHP DateTime object.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-Type.php"><span>Type</span></a>
			...
			<tr data-order="getName" id="_getName">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DateTimeType.php#15-18" title="Go to source code">getName</a>( )
						</code>
			...
			<tr data-order="getSqlDeclaration" id="_getSqlDeclaration">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DateTimeType.php#20-23" title="Go to source code">getSqlDeclaration</a>( <span>array <var>$fieldDeclaration</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
						...
						<div class="description detailed hidden">
							<p>Gets the SQL declaration snippet for a field of this type.</p>
								...
								<div class="list"><dl>
									...
									<dd>The field declaration.</dd>
									<dt><var>$platform</var></dt>
									<dd>The currently used database platform.</dd>
								</dl></div>
			...
			<tr data-order="convertToDatabaseValue" id="_convertToDatabaseValue">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DateTimeType.php#25-29" title="Go to source code">convertToDatabaseValue</a>( <span>mixed <var>$value</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
...
of this type.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									mixed<br>The database representation of the value.
								</div>



								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Type.php#_convertToDatabaseValue">Type::convertToDatabaseValue()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="convertToPHPValue" id="_convertToPHPValue">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DateTimeType.php#31-35" title="Go to source code">convertToPHPValue</a>( <span>mixed <var>$value</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
...
of this type.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									mixed<br>The PHP representation of the value.
								</div>



								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Type.php#_convertToPHPValue">Type::convertToPHPValue()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-Type.php#methods">Type</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-Type.php#___construct">__construct()</a>, 
									<a href="class-Type.php#_addType">addType()</a>, 
									<a href="class-Type.php#_getDefaultLength">getDefaultLength()</a>, 
									<a href="class-Type.php#_getType">getType()</a>, 
									<a href="class-Type.php#_getTypeCode">getTypeCode()</a>, 
									<a href="class-Type.php#_hasType">hasType()</a>, 
									<a href="class-Type.php#_overrideType">overrideType()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-Type.php#constants">Type</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-Type.php#CODE_BOOL"><b>CODE_BOOL</b></a>, 
									<a href="class-Type.php#CODE_INT"><b>CODE_INT</b></a>, 
									<a href="class-Type.php#CODE_LOB"><b>CODE_LOB</b></a>, 
									<a href="class-Type.php#CODE_NULL"><b>CODE_NULL</b></a>, 
									<a href="class-Type.php#CODE_STR"><b>CODE_STR</b></a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-Type.php#properties">Type</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-Type.php#$_typeObjects"><var>$_typeObjects</var></a>
							</code>
						</td>
					</tr>
				</table>
