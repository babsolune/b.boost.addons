...
<section id="content">
	<header>
		<h1>Package <a href="package-Content.php">Content</a>\Comments</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-Content.php">Content</a>\Comments</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-Content.Comments.controllers.php">Content\Comments\controllers</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-Content.Comments.extension.point.php">Content\Comments\extension-point</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-Content.Comments.form.php">Content\Comments\form</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-CommentsAuthorizations.php">CommentsAuthorizations</a></td>
	<td class="ellipsis">This class could be used to specified comments authorizations (access, read, post, moderation)</td>
</tr>
<tr>
	<td class="name"><a href="class-CommentsDAO.php">CommentsDAO</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-CommentsManager.php">CommentsManager</a></td>
	<td class="ellipsis">This class manage comments with different functions</td>
</tr>
<tr>
	<td class="name"><a href="class-CommentsService.php">CommentsService</a></td>
	<td class="ellipsis">This class allows you to use a comments system</td>
</tr>
<tr>
	<td class="name"><a href="class-CommentsTopic.php">CommentsTopic</a></td>
	<td class="ellipsis"><p>This class represents the comments topic</p>

<div class="message-helper notice">Do not use this class, but one of its children like for your module</div></td>
</tr>
<tr>
	<td class="name"><a href="class-CommentsTopicDAO.php">CommentsTopicDAO</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-CommentsTopicEvents.php">CommentsTopicEvents</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-CommentsUrlBuilder.php">CommentsUrlBuilder</a></td>
	<td class="ellipsis"><p>This class represents the comments topic</p>
