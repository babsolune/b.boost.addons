		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormConstraintFieldsInequality.php" class="cssmenu-title">FormConstraintFieldsInequality</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormConstraintFieldsInequality</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a>\<a href="package-Builder.Form.constraint.php">constraint</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormConstraintFieldsInequality.php#3-74" title="Go to source code">builder/form/constraint/FormConstraintFieldsInequality.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>FormConstraintFieldsInequality</span></b>					
					 implements 
			...
			<tr data-order="validate" id="_validate">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormConstraintFieldsInequality.php#44-56" title="Go to source code">validate</a>( )
						</code>
			...
			<tr data-order="get_js_validation" id="_get_js_validation">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormConstraintFieldsInequality.php#58-62" title="Go to source code">get_js_validation</a>( )
						</code>
			...
			<tr data-order="get_validation_error_message" id="_get_validation_error_message">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormConstraintFieldsInequality.php#64-68" title="Go to source code">get_validation_error_message</a>( )
						</code>
			...
			<tr data-order="get_related_fields" id="_get_related_fields">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormConstraintFieldsInequality.php#70-73" title="Go to source code">get_related_fields</a>( )
						</code>
