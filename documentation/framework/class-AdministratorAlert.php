<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AdministratorAlert.php" class="cssmenu-title">AdministratorAlert</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AdministratorAlert</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class represents an alert which must be sent to the administrator.
It allows to the module developers to handle the administrator alerts.
The administrator alerts can be in the administration panel and can be used when you want to signal an important event to the administrator(s).</p>
			</div>
...
<b><span>AdministratorAlert</span></b>					
...
<a href="source-class-AdministratorAlert.php#48-56" title="Go to source code">__construct</a>( )
							...
							<div class="description short">
								<p>Builds an AdministratorAlert object.</p>
							</div>
...
<a href="source-class-AdministratorAlert.php#58-76" title="Go to source code">build</a>( <span>integer <var>$id</var></span>, <span>string <var>$entitled</var></span>, <span>string <var>$properties</var></span>, <span>string <var>$fixing_url</var></span>, <span>integer <var>$current_status</var></span>, <span><code><a href="class-Date.php">Date</a></code> <var>$creation_date</var></span>, <span>integer <var>$id_in_module</var></span>, <span>string <var>$identifier</var></span>, <span>string <var>$type</var></span>, <span>integer <var>$priority</var></span> )
							...
							<div class="description short">
								<p>Builds an alert from its whole parameters.</p>
							</div>
			...
			<tr data-order="get_priority" id="_get_priority">
...
<a href="source-class-AdministratorAlert.php#78-92" title="Go to source code">get_priority</a>( )
							...
							<div class="description short">
								<p>Gets the priority of the alert.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Gets the priority of the alert.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									integer<br><p>One of those values:</p>
...
<ul>
 ...
 <li>AdministratorAlert::ADMIN_ALERT_VERY_HIGH_PRIORITY Very high priority</li>
			...
			<tr data-order="get_properties" id="_get_properties">
...
<a href="source-class-AdministratorAlert.php#94-101" title="Go to source code">get_properties</a>( )
			...
			<tr data-order="set_priority" id="_set_priority">
...
<a href="source-class-AdministratorAlert.php#103-125" title="Go to source code">set_priority</a>( <span>integer <var>$priority</var></span> )
							...
							<div class="description short">
								<p>Sets the priority of the alert.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Sets the priority of the alert.</p>
								...
								<div class="list"><dl>
									<dt><var>$priority</var></dt>
									<dd><p>The priority, it must be one of those values:</p>
...
<ul>
 ...
 <li>AdministratorAlert::ADMIN_ALERT_VERY_HIGH_PRIORITY Very high priority</li>
			...
			<tr data-order="set_properties" id="_set_properties">
...
<a href="source-class-AdministratorAlert.php#127-138" title="Go to source code">set_properties</a>( <span>string <var>$properties</var></span> )
							...
							<div class="description short">
								<p>Sets the properties of the alert.</p>
							</div>
			...
			<tr data-order="get_priority_name" id="_get_priority_name">
...
<a href="source-class-AdministratorAlert.php#140-167" title="Go to source code">get_priority_name</a>( )
							...
							<div class="description short">
								<p>Gets the priority name. It's automatically translater to the user language, ready to be displayed.</p>
							</div>
					...
					<tr>
						<td>
							<code>
									...
									<a href="class-Event.php#_get_status_name">get_status_name()</a>, 
									...
									<a href="class-Event.php#_set_status">set_status()</a>, 
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="ADMIN_ALERT_VERY_LOW_PRIORITY" id="ADMIN_ALERT_VERY_LOW_PRIORITY">
						...
						<td class="value">
							<div>
								<a href="#ADMIN_ALERT_VERY_LOW_PRIORITY" class="anchor">#</a>
								<code><span class="php-num">1</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="ADMIN_ALERT_LOW_PRIORITY" id="ADMIN_ALERT_LOW_PRIORITY">
						...
						<td class="value">
							<div>
								<a href="#ADMIN_ALERT_LOW_PRIORITY" class="anchor">#</a>
								<code><span class="php-num">2</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="ADMIN_ALERT_MEDIUM_PRIORITY" id="ADMIN_ALERT_MEDIUM_PRIORITY">
						...
						<td class="value">
							<div>
								<a href="#ADMIN_ALERT_MEDIUM_PRIORITY" class="anchor">#</a>
								<code><span class="php-num">3</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="ADMIN_ALERT_HIGH_PRIORITY" id="ADMIN_ALERT_HIGH_PRIORITY">
						...
						<td class="value">
							<div>
								<a href="#ADMIN_ALERT_HIGH_PRIORITY" class="anchor">#</a>
								<code><span class="php-num">4</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="ADMIN_ALERT_VERY_HIGH_PRIORITY" id="ADMIN_ALERT_VERY_HIGH_PRIORITY">
						...
						<td class="value">
							<div>
								<a href="#ADMIN_ALERT_VERY_HIGH_PRIORITY" class="anchor">#</a>
								<code><span class="php-num">5</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="ADMIN_ALERT_STATUS_UNREAD" id="ADMIN_ALERT_STATUS_UNREAD">
						...
						<td class="value">
							<div>
								<a href="#ADMIN_ALERT_STATUS_UNREAD" class="anchor">#</a>
								<code>Event::EVENT_STATUS_UNREAD</code>
							</div>
						</td>
					</tr>
					<tr data-order="ADMIN_ALERT_STATUS_PROCESSED" id="ADMIN_ALERT_STATUS_PROCESSED">
						...
						<td class="value">
							<div>
								<a href="#ADMIN_ALERT_STATUS_PROCESSED" class="anchor">#</a>
								<code>Event::EVENT_STATUS_PROCESSED</code>
							</div>
						</td>
					</tr>
				</table>
