		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AuthenticationService.php" class="cssmenu-title">AuthenticationService</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AuthenticationService</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.User.php">User</a>\<a href="package-PHPBoost.User.authentication.php">authentication</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 04 10
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<div class="description">
				<p>This class manages the authentication mecanism. Several authentication methods could be used.
If the authentication by the selected method successful, the user session is started.</p>
			</div>
...
<a href="source-class-AuthenticationService.php#41-61" title="Go to source code">authenticate</a>( <span><code><a href="class-AuthenticationMethod.php">AuthenticationMethod</a></code> <var>$authentication</var></span>, <span>boolean <var>$autoconnect</var> = <span class="php-keyword1">false</span></span> )
							...
							<div class="description short">
								<p>Tries to authenticate the user using the given authentication method.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Tries to authenticate the user using the given authentication method.</p>
								...
								<div class="list"><dl>
									<dt><var>$authentication</var></dt>
									<dd>the authentication method to use</dd>
									<dt><var>$autoconnect</var></dt>
									<dd>If true, an autoconnect cookie will be created</dd>
								</dl></div>
			...
			<tr data-order="get_user_types_authentication" id="_get_user_types_authentication">
...
<a href="source-class-AuthenticationService.php#63-74" title="Go to source code">get_user_types_authentication</a>( <span> <var>$user_id</var></span> )
			...
			<tr data-order="get_external_auth_activated" id="_get_external_auth_activated">
...
<a href="source-class-AuthenticationService.php#78-85" title="Go to source code">get_external_auth_activated</a>( <span> <var>$identifier</var></span> )
			...
			<tr data-order="external_auth_is_activated" id="_external_auth_is_activated">
...
<a href="source-class-AuthenticationService.php#87-90" title="Go to source code">external_auth_is_activated</a>( <span> <var>$id</var></span> )
			...
			<tr data-order="get_external_auths_activated" id="_get_external_auths_activated">
