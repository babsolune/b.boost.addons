		...
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					...
					<tr>
						<td class="name"><a href="package-Content.Category.bridges.php">Content\Category\bridges</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-CategoriesCache.php">CategoriesCache</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-CategoriesItemsParameters.php">CategoriesItemsParameters</a></td>
	<td class="ellipsis">This class allows you to inquire the table that stores the items and the database field that contains the ID of the category in which it is located</td>
</tr>
<tr>
	<td class="name"><a href="class-CategoriesManager.php">CategoriesManager</a></td>
	<td class="ellipsis"><p>This class allows you to easily integrate a complete system of categories in its script.
It needs to have its first instantiation of a parameter child object CategoriesCache and as the second parameter to have a CategoriesItemsParameters object.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-Category.php">Category</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-FormFieldCategoriesSelect.php">FormFieldCategoriesSelect</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-RichCategory.php">RichCategory</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-RichRootCategory.php">RichRootCategory</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-RootCategory.php">RootCategory</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-SearchCategoryChildrensOptions.php">SearchCategoryChildrensOptions</a></td>
	<td class="ellipsis"><p>This class allows you to manage options of children used in CategoriesManager::get_children() and CategoriesManager::get_select_categories_form_field().
You will be able to manage one or more permission bits, exclude certain categories disable recursive search of one, several or all categories</p></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-CategoryNotFoundException.php">CategoryNotFoundException</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
