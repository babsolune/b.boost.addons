...
<section>
	<header>
		<h1>File builder/ajax/controllers/AjaxImagePreviewController.class.php</h1>
	</header>
	<article>
		<header><h2>File builder/ajax/controllers/AjaxImagePreviewController.class.php</h2></header>
		<div class="content">
...
</span></span><span id="11" class="l"><span class="php-comment"> * @version     PHPBoost 5.2 - last update: 2016 04 28
</span></span><span id="12" class="l"><span class="php-comment"> * @since       PHPBoost 3.0 - 2012 06 25
</span></span><span id="13" class="l"><span class="php-comment"> */</span>
</span><span id="14" class="l">
</span><span id="15" class="l"><span class="php-keyword1">class</span> AjaxImagePreviewController <span class="php-keyword1">extends</span> AbstractController
...
</span><span id="19" class="l">        <span class="php-var">$url</span> = <span class="php-quote">''</span>;
</span><span id="20" class="l">        <span class="php-var">$image</span> = <span class="php-keyword1">new</span> Url(<span class="php-var">$request</span>-&gt;get_string(<span class="php-quote">'image'</span>, <span class="php-quote">''</span>));
</span><span id="21" class="l">
</span><span id="22" class="l">        <span class="php-keyword1">if</span> (Url::check_url_validity(<span class="php-var">$image</span>))
</span><span id="23" class="l">            <span class="php-var">$url</span> = <span class="php-var">$image</span>-&gt;rel();
</span><span id="24" class="l">
</span><span id="25" class="l">        <span class="php-keyword1">return</span> <span class="php-keyword1">new</span> JSONResponse(<span class="php-keyword1">array</span>(<span class="php-quote">'url'</span> =&gt; <span class="php-var">$url</span>));
