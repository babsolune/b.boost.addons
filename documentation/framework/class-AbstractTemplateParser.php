<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractTemplateParser.php" class="cssmenu-title">AbstractTemplateParser</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractTemplateParser</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This is an abstract implementation of the <code><a href="class-TemplateParser.php">TemplateParser</a></code> interface.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>AbstractTemplateParser</span></b>					
					 implements 
...
<a href="source-class-AbstractTemplateParser.php#21-29" title="Go to source code">parse</a>( <span>string <var>$content</var></span> )
			...
			<tr data-order="do_parse" id="_do_parse">
...
<a href="source-class-AbstractTemplateParser.php#33-40" title="Go to source code">clean</a>( )
			...
			<tr data-order="get_getvar_method_name" id="_get_getvar_method_name">
