		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-LinksMenuElement.php" class="cssmenu-title">LinksMenuElement</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>LinksMenuElement</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>A LinksMenuElement contains a Title, an url, and an image url</p>
...
<b><span>LinksMenuElement</span></b>					
...
<a href="source-class-LinksMenuElement.php#47-60" title="Go to source code">__construct</a>( <span> <var>$title</var></span>, <span> <var>$url</var></span>, <span> <var>$image</var> = <span class="php-quote">''</span></span>, <span>integer <var>$id</var>,…</span> )
							...
							<div class="description short">
								<p>Build a LinksMenuElement object</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Build a LinksMenuElement object</p>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Menu.php#___construct">Menu::__construct()</a></code></div>
						...
						<div class="description detailed hidden">
							<p>Assign tpl vars</p>
								...
								<div class="list"><dl>
									...
									<dt><var>$mode</var></dt>
									<dd><p>in LinksMenuElement::LINKS_MENU_ELEMENT__CLASSIC_DISPLAYING mode, the links menu is
...
also shown.</p></dd>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Menu.php#__assign">Menu::_assign()</a></code></div>
...
<a href="source-class-LinksMenuElement.php#151-158" title="Go to source code">_parent</a>( <span> <var>$type</var></span> )
			...
			<tr data-order="set_image" id="_set_image">
...
<a href="source-class-LinksMenuElement.php#161-167" title="Go to source code">set_image</a>( <span>string <var>$image</var></span> )
			...
			<tr data-order="set_url" id="_set_url">
...
<a href="source-class-LinksMenuElement.php#168-174" title="Go to source code">set_url</a>( <span>string <var>$url</var></span> )
			...
			<tr data-order="get_uid" id="_get_uid">
...
<a href="source-class-LinksMenuElement.php#185-191" title="Go to source code">update_uid</a>( )
			...
			<tr data-order="get_url" id="_get_url">
...
<a href="source-class-LinksMenuElement.php#192-199" title="Go to source code">get_url</a>( <span>boolean <var>$compute_relative_url</var> = <span class="php-keyword1">true</span></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$compute_relative_url</var></dt>
									<dd>If true, computes relative urls to the website root</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>the link $url
								</div>
			...
			<tr data-order="get_image" id="_get_image">
...
<a href="source-class-LinksMenuElement.php#201-208" title="Go to source code">get_image</a>( <span>boolean <var>$compute_relative_url</var> = <span class="php-keyword1">true</span></span> )
					...
					<tr>
						<td>
							<code>
									...
									<a href="class-Menu.php#_display">display()</a>, 
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="LINKS_MENU_ELEMENT__CLASS" id="LINKS_MENU_ELEMENT__CLASS">
						...
						<td class="value">
							<div>
								<a href="#LINKS_MENU_ELEMENT__CLASS" class="anchor">#</a>
								<code><span class="php-quote">'LinksMenuElement'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="LINKS_MENU_ELEMENT__FULL_DISPLAYING" id="LINKS_MENU_ELEMENT__FULL_DISPLAYING">
						...
						<td class="value">
							<div>
								<a href="#LINKS_MENU_ELEMENT__FULL_DISPLAYING" class="anchor">#</a>
								<code><span class="php-keyword1">true</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="LINKS_MENU_ELEMENT__CLASSIC_DISPLAYING" id="LINKS_MENU_ELEMENT__CLASSIC_DISPLAYING">
						...
						<td class="value">
							<div>
								<a href="#LINKS_MENU_ELEMENT__CLASSIC_DISPLAYING" class="anchor">#</a>
