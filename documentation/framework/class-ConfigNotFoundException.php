<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ConfigNotFoundException.php" class="cssmenu-title">ConfigNotFoundException</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ConfigNotFoundException</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This exception is raised when a configuration entry is load whereas it doesn't exists in the
database.</p>
			</div>
...
<b><span>ConfigNotFoundException</span></b>					
