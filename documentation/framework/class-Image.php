<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-Image.php" class="cssmenu-title">Image</a></li>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>This class allows you to obtain informations on an image.</p>
			</div>
...
<a href="source-class-Image.php#20-24" title="Go to source code">__construct</a>( <span>string <var>$path</var></span> )
							...
							<div class="description short">
								<p>Builds a FileSystemElement object from the path of the element.</p>
							</div>
...
<a href="source-class-Image.php#35-38" title="Go to source code">get_path</a>( )
							...
							<div class="description short">
								<p>Returns the element full path.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the element full path.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>The element full path.
								</div>



								<h6>Overrides</h6>
								<div class="list"><code><a href="class-FileSystemElement.php#_get_path">FileSystemElement::get_path()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_width" id="_get_width">
...
<a href="source-class-Image.php#40-43" title="Go to source code">get_width</a>( )
			...
			<tr data-order="get_height" id="_get_height">
...
<a href="source-class-Image.php#45-48" title="Go to source code">get_height</a>( )
			...
			<tr data-order="get_mime_type" id="_get_mime_type">
...
<a href="source-class-Image.php#55-62" title="Go to source code">get_size</a>( )
			...
			<tr data-order="get_name_and_extension" id="_get_name_and_extension">
...
<a href="source-class-Image.php#76-80" title="Go to source code">get_name</a>( )
						...
						<div class="description detailed hidden">
							<p>Returns the element name.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>The element name.
								</div>



								<h6>Overrides</h6>
								<div class="list"><code><a href="class-FileSystemElement.php#_get_name">FileSystemElement::get_name()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_folder_image" id="_get_folder_image">
