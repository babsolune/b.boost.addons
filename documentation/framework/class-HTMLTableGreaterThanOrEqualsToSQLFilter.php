		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTMLTableGreaterThanOrEqualsToSQLFilter.php" class="cssmenu-title">HTMLTableGreaterThanOrEqualsToSQLFilter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLTableGreaterThanOrEqualsToSQLFilter</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Table.php">Table</a>\<a href="package-Builder.Table.filter.php">filter</a>\<a href="package-Builder.Table.filter.sql.php">sql</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-HTMLTableGreaterThanOrEqualsToSQLFilter.php#3-19" title="Go to source code">builder/table/filter/sql/HTMLTableGreaterThanOrEqualsToSQLFilter.class.php</a></span>
			</div>
			...
			<dl class="tree">
				...
				<dd style="padding-left:30px">
					...
					<a href="class-HTMLTableNumberComparatorSQLFilter.php"><span>HTMLTableNumberComparatorSQLFilter</span></a>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>HTMLTableGreaterThanOrEqualsToSQLFilter</span></b>					
			...
			<tr data-order="get_sql_comparator_symbol" id="_get_sql_comparator_symbol">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableGreaterThanOrEqualsToSQLFilter.php#15-18" title="Go to source code">get_sql_comparator_symbol</a>( )
						</code>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-HTMLTableNumberComparatorSQLFilter.php#methods">HTMLTableNumberComparatorSQLFilter</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-HTMLTableNumberComparatorSQLFilter.php#___construct">__construct()</a>, 
									<a href="class-HTMLTableNumberComparatorSQLFilter.php#_check_interval">check_interval()</a>, 
									<a href="class-HTMLTableNumberComparatorSQLFilter.php#_get_number">get_number()</a>, 
									<a href="class-HTMLTableNumberComparatorSQLFilter.php#_get_sql">get_sql()</a>, 
									<a href="class-HTMLTableNumberComparatorSQLFilter.php#_get_sql_value_parameter_prefix">get_sql_value_parameter_prefix()</a>, 
									<a href="class-HTMLTableNumberComparatorSQLFilter.php#_is_value_allowed">is_value_allowed()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-HTMLTableNumberComparatorSQLFilter.php#constants">HTMLTableNumberComparatorSQLFilter</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-HTMLTableNumberComparatorSQLFilter.php#NOT_BOUNDED"><b>NOT_BOUNDED</b></a>
							</code>
						</td>
					</tr>
				</table>
