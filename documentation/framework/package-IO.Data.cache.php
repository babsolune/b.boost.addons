...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Data.php">Data</a>\cache</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Data.php">Data</a>\cache</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-CacheManager.php">CacheManager</a></td>
	<td class="ellipsis"><p>This class manages cache. It makes a two-level lazy loading:</p>
...
<tr>
	<td class="name"><a href="class-CacheService.php">CacheService</a></td>
...
<tr>
	<td class="name"><a href="class-CacheData.php">CacheData</a></td>
	<td class="ellipsis"><p>This interface represents data which are stored automatically by the cache manager.
...
in a map associating a value to a property</p></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-CacheDataNotFoundException.php">CacheDataNotFoundException</a></td>
	<td class="ellipsis">This exception is raised when you are asking a cache entry that doesn't exist.</td>
</tr>
	</table>
</div>
