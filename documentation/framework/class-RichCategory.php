		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-RichCategory.php" class="cssmenu-title">RichCategory</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>RichCategory</h2></header>
		<div class="content">
...
<b><span>RichCategory</span></b>					
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-RichRootCategory.php">RichRootCategory</a>
			</div>
...
<a href="source-class-RichCategory.php#42-48" title="Go to source code">get_properties</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Category.php#_get_properties">Category::get_properties()</a></code></div>
...
<a href="source-class-RichCategory.php#50-55" title="Go to source code">set_properties</a>( <span>array <var>$properties</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Category.php#_set_properties">Category::set_properties()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="create_categories_table" id="_create_categories_table">
...
<a href="source-class-RichCategory.php#57-75" title="Go to source code">create_categories_table</a>( <span> <var>$table_name</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Category.php#_create_categories_table">Category::create_categories_table()</a></code></div>
