		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MySQLDBFactory.php" class="cssmenu-title">MySQLDBFactory</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MySQLDBFactory</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a>\<a href="package-IO.DB.factory.php">factory</a></span>
						...
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2009 11 09
						</span>
					<span class="infos-options"><b>Located at:</b> <a href="source-class-MySQLDBFactory.php#3-36" title="Go to source code">io/db/factory/MySQLDBFactory.class.php</a></span>
			</div>

			<div class="description">
				<p>This factory provides the</p>

<pre>DBConnection</pre>

<p>and the</p>

<pre>SQLQuerier</pre>

<p>for the right sgbd.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>MySQLDBFactory</span></b>					
					 implements 
						<a href="class-DBMSFactory.php"><span>DBMSFactory</span></a>
		...
		<div class="content">
			...
			<tr data-order="new_db_connection" id="_new_db_connection">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-DBConnection.php">DBConnection</a></code>
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MySQLDBFactory.php#17-20" title="Go to source code">new_db_connection</a>( )
						</code>

							<div class="description short">
								<p>returns the opened</p>

<pre>DBConnection</pre>

<p>. If not yet opened, opens it</p>
							</div>
...
<p>. If not yet opened, opens it</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-DBConnection.php">DBConnection</a></code><br><p>the opened</p>
...
<p>. If not yet opened, opens it</p>
								...
								<div class="list"><code><a href="class-DBMSFactory.php#_new_db_connection">DBMSFactory::new_db_connection()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="new_sql_querier" id="_new_sql_querier">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-SQLQuerier.php">SQLQuerier</a></code>
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MySQLDBFactory.php#22-25" title="Go to source code">new_sql_querier</a>( <span><code><a href="class-DBConnection.php">DBConnection</a></code> <var>$db_connection</var></span> )
						</code>
...
<p>instance</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$db_connection</var></dt>
									<dd><p>the db connection that the</p>
...
<p>will use</p></dd>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-SQLQuerier.php">SQLQuerier</a></code><br><p>a new</p>
...
<p>instance</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DBMSFactory.php#_new_sql_querier">DBMSFactory::new_sql_querier()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="new_dbms_util" id="_new_dbms_util">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-DBMSUtils.php">DBMSUtils</a></code>
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MySQLDBFactory.php#27-30" title="Go to source code">new_dbms_util</a>( <span><code><a href="class-SQLQuerier.php">SQLQuerier</a></code> <var>$querier</var></span> )
						</code>
...
<p>will use</p></dd>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-DBMSUtils.php">DBMSUtils</a></code><br><p>a new</p>
...
<p>instance</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DBMSFactory.php#_new_dbms_util">DBMSFactory::new_dbms_util()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
