<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractPHPMailerMailService.php" class="cssmenu-title">AbstractPHPMailerMailService</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractPHPMailerMailService</h2></header>
		<div class="content">
...
<b><span>AbstractPHPMailerMailService</span></b>					
					 implements 
						<a href="class-MailService.php"><span>MailService</span></a>
...
<a href="source-class-AbstractPHPMailerMailService.php#26-39" title="Go to source code">send</a>( <span><code><a href="class-Mail.php">Mail</a></code> <var>$mail</var></span> )
						...
						<div class="description detailed hidden">
							<p>Sends the mail. Throws an exception if the mail cannot be sent.</p>
								...
								<div class="list"><code><a href="class-MailService.php#_send">MailService::send()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
it only returns false.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-MailService.php#_try_to_send">MailService::try_to_send()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractPHPMailerMailService.php#54-70" title="Go to source code">send_from_properties</a>( <span>string <var>$mail_to</var></span>, <span>string <var>$mail_subject</var></span>, <span>string <var>$mail_content</var></span>, <span>string <var>$mail_from</var> = <span class="php-quote">''</span></span>, <span>string <var>$sender_name</var> = <span class="php-keyword2">Mail</span>::SENDER_ADMIN</span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-MailService.php#_send_from_properties">MailService::send_from_properties()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="set_send_settings" id="_set_send_settings">
...
<a href="source-class-AbstractPHPMailerMailService.php#74-77" title="Go to source code">is_mail_valid</a>( <span>string <var>$mail_address</var></span> )
						...
						<div class="description detailed hidden">
							<p>Check whether the mail address is valid, it respects the mail RFC</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-MailService.php#_is_mail_valid">MailService::is_mail_valid()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractPHPMailerMailService.php#79-82" title="Go to source code">get_mail_checking_regex</a>( )
						...
						<div class="description detailed hidden">
							<p>Return the RFC mail regex.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-MailService.php#_get_mail_checking_regex">MailService::get_mail_checking_regex()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractPHPMailerMailService.php#84-87" title="Go to source code">get_mail_checking_raw_regex</a>( )
						...
						<div class="description detailed hidden">
							<p>Return the RFC mail regex without delimiters, it's commonly used for compatibility with javascript regex.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-MailService.php#_get_mail_checking_raw_regex">MailService::get_mail_checking_raw_regex()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
