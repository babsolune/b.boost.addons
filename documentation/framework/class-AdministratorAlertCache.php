<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AdministratorAlertCache.php" class="cssmenu-title">AdministratorAlertCache</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AdministratorAlertCache</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Cache.php">Cache</a></span>
						...
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2010 08 10
						</span>
					<span class="infos-options"><b>Located at:</b> <a href="source-class-AdministratorAlertCache.php#3-62" title="Go to source code">phpboost/cache/AdministratorAlertCache.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>AdministratorAlertCache</span></b>					
					 implements 
			...
			<tr data-order="synchronize" id="_synchronize">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AdministratorAlertCache.php#18-34" title="Go to source code">synchronize</a>( )
						</code>
...
For instance,</p>
			...
			<tr data-order="get_all_alerts_number" id="_get_all_alerts_number">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_get_all_alerts_number">#</a>
						<code>
<a href="source-class-AdministratorAlertCache.php#36-39" title="Go to source code">get_all_alerts_number</a>( )
						</code>
			...
			<tr data-order="get_unread_alerts_number" id="_get_unread_alerts_number">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_get_unread_alerts_number">#</a>
						<code>
<a href="source-class-AdministratorAlertCache.php#41-44" title="Go to source code">get_unread_alerts_number</a>( )
						</code>
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-AdministratorAlertCache.php">AdministratorAlertCache</a></code>
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AdministratorAlertCache.php#46-53" title="Go to source code">load</a>( )
						</code>

							<div class="description short">
								<p>Loads and returns the administrator alert cached data.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads and returns the administrator alert cached data.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-AdministratorAlertCache.php">AdministratorAlertCache</a></code><br>The cached data
								</div>
			...
			<tr data-order="invalidate" id="_invalidate">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AdministratorAlertCache.php#55-61" title="Go to source code">invalidate</a>( )
						</code>

							<div class="description short">
								<p>Invalidates the current administrator alert cached data.</p>
							</div>
