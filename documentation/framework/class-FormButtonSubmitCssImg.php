		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormButtonSubmitCssImg.php" class="cssmenu-title">FormButtonSubmitCssImg</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormButtonSubmitCssImg</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a>\<a href="package-Builder.Form.button.php">button</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormButtonSubmitCssImg.php#3-22" title="Go to source code">builder/form/button/FormButtonSubmitCssImg.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractFormButton.php"><span>AbstractFormButton</span></a>
					
					 implements 
						<a href="class-FormButton.php"><span>FormButton</span></a>
					
					
				</dd>
				<dd style="padding-left:30px">
					<img src="resources/inherit.png" alt="Extended by">
					<a href="class-FormButtonSubmit.php"><span>FormButtonSubmit</span></a>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>FormButtonSubmitCssImg</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormButtonSubmitCssImg.php#17-21" title="Go to source code">__construct</a>( <span> <var>$value</var></span>, <span> <var>$css_class_image</var></span>, <span> <var>$name</var></span>, <span> <var>$onclick_action</var> = <span class="php-quote">''</span></span>, <span> <var>$data_confirmation</var> = <span class="php-quote">''</span></span>, <span> <var>$form_id</var> = <span class="php-quote">''</span></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-FormButtonSubmit.php#___construct">FormButtonSubmit::__construct()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-FormButtonSubmit.php#methods">FormButtonSubmit</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-FormButtonSubmit.php#_has_been_submited">has_been_submited()</a>
							</code>
						</td>
					</tr>
				</table>
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractFormButton.php#methods">AbstractFormButton</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractFormButton.php#_display">display()</a>, 
									<a href="class-AbstractFormButton.php#_get_css_class">get_css_class()</a>, 
									<a href="class-AbstractFormButton.php#_get_data_confirmation">get_data_confirmation()</a>, 
									<a href="class-AbstractFormButton.php#_get_html_name">get_html_name()</a>, 
									<a href="class-AbstractFormButton.php#_get_label">get_label()</a>, 
									<a href="class-AbstractFormButton.php#_get_name">get_name()</a>, 
									<a href="class-AbstractFormButton.php#_get_template">get_template()</a>, 
									<a href="class-AbstractFormButton.php#_set_css_class">set_css_class()</a>, 
									<a href="class-AbstractFormButton.php#_set_data_confirmation">set_data_confirmation()</a>, 
									<a href="class-AbstractFormButton.php#_set_form_id">set_form_id()</a>, 
									<a href="class-AbstractFormButton.php#_set_label">set_label()</a>, 
									<a href="class-AbstractFormButton.php#_set_name">set_name()</a>
							</code>
						</td>
					</tr>
				</table>
