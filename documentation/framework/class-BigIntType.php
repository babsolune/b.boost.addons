		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-BigIntType.php" class="cssmenu-title">BigIntType</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>BigIntType</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>Type that maps a database BIGINT to a PHP string.</p>
			</div>
