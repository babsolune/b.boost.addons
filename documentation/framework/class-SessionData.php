		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SessionData.php" class="cssmenu-title">SessionData</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SessionData</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class manages all sessions for the users.</p>
			</div>
...
<a href="source-class-SessionData.php#39-43" title="Go to source code">__construct</a>( <span> <var>$user_id</var></span>, <span> <var>$session_id</var></span> )
			...
			<tr data-order="get_user_id" id="_get_user_id">
...
<a href="source-class-SessionData.php#45-48" title="Go to source code">get_user_id</a>( )
			...
			<tr data-order="get_session_id" id="_get_session_id">
...
<a href="source-class-SessionData.php#50-53" title="Go to source code">get_session_id</a>( )
			...
			<tr data-order="get_token" id="_get_token">
...
<a href="source-class-SessionData.php#55-58" title="Go to source code">get_token</a>( )
			...
			<tr data-order="get_expiry_date" id="_get_expiry_date">
...
<a href="source-class-SessionData.php#65-68" title="Go to source code">get_timestamp</a>( )
			...
			<tr data-order="get_ip" id="_get_ip">
...
<a href="source-class-SessionData.php#70-73" title="Go to source code">get_ip</a>( )
			...
			<tr data-order="get_location_script" id="_get_location_script">
...
<a href="source-class-SessionData.php#75-78" title="Go to source code">get_location_script</a>( )
			...
			<tr data-order="get_location_title" id="_get_location_title">
...
<a href="source-class-SessionData.php#80-83" title="Go to source code">get_location_title</a>( )
			...
			<tr data-order="get_location_id" id="_get_location_id">
...
<a href="source-class-SessionData.php#85-88" title="Go to source code">get_location_id</a>( )
			...
			<tr data-order="get_all_cached_data" id="_get_all_cached_data">
...
<a href="source-class-SessionData.php#90-93" title="Go to source code">get_all_cached_data</a>( )
			...
			<tr data-order="has_cached_data" id="_has_cached_data">
...
<a href="source-class-SessionData.php#95-98" title="Go to source code">has_cached_data</a>( <span> <var>$key</var></span> )
			...
			<tr data-order="get_cached_data" id="_get_cached_data">
...
<a href="source-class-SessionData.php#100-107" title="Go to source code">get_cached_data</a>( <span> <var>$key</var></span>, <span> <var>$default</var> = <span class="php-keyword1">null</span></span> )
			...
			<tr data-order="add_cached_data" id="_add_cached_data">
...
<a href="source-class-SessionData.php#109-113" title="Go to source code">add_cached_data</a>( <span> <var>$key</var></span>, <span> <var>$value</var></span> )
			...
			<tr data-order="remove_cached_data" id="_remove_cached_data">
...
<a href="source-class-SessionData.php#115-119" title="Go to source code">remove_cached_data</a>( <span> <var>$key</var></span> )
			...
			<tr data-order="get_all_data" id="_get_all_data">
...
<a href="source-class-SessionData.php#121-124" title="Go to source code">get_all_data</a>( )
			...
			<tr data-order="has_data" id="_has_data">
...
<a href="source-class-SessionData.php#131-138" title="Go to source code">get_data</a>( <span> <var>$key</var></span> )
			...
			<tr data-order="add_data" id="_add_data">
...
<a href="source-class-SessionData.php#140-144" title="Go to source code">add_data</a>( <span> <var>$key</var></span>, <span> <var>$value</var></span> )
			...
			<tr data-order="remove_data" id="_remove_data">
...
<a href="source-class-SessionData.php#146-150" title="Go to source code">remove_data</a>( <span> <var>$key</var></span> )
			...
			<tr data-order="recheck_cached_data" id="_recheck_cached_data">
...
<a href="source-class-SessionData.php#186-190" title="Go to source code">delete</a>( )
			...
			<tr data-order="no_session_location" id="_no_session_location">
...
<a href="source-class-SessionData.php#229-237" title="Go to source code">no_session_location</a>( )
			...
			<tr data-order="location_id_already_exists" id="_location_id_already_exists">
...
<a href="source-class-SessionData.php#239-246" title="Go to source code">location_id_already_exists</a>( <span> <var>$location_id</var></span> )
			...
			<tr data-order="get_user_on_location_id" id="_get_user_on_location_id">
...
<a href="source-class-SessionData.php#248-257" title="Go to source code">get_user_on_location_id</a>( <span> <var>$location_id</var></span> )
			...
			<tr data-order="admin_session" id="_admin_session">
...
<a href="source-class-SessionData.php#264-270" title="Go to source code">gc</a>( )
			...
			<tr data-order="create_visitor" id="_create_visitor">

				<td class="attributes">
					<code>
						 public static

						<code><a href="class-SessionData.php">SessionData</a></code>
...
<a href="source-class-SessionData.php#272-279" title="Go to source code">create_visitor</a>( )
			...
			<tr data-order="create_from_user_id" id="_create_from_user_id">
...
<a href="source-class-SessionData.php#281-305" title="Go to source code">create_from_user_id</a>( <span>integer <var>$user_id</var></span> )
			...
			<tr data-order="add_in_visit_counter" id="_add_in_visit_counter">
...
<a href="source-class-SessionData.php#307-327" title="Go to source code">add_in_visit_counter</a>( )
			...
			<tr data-order="update_location" id="_update_location">
...
<a href="source-class-SessionData.php#329-352" title="Go to source code">update_location</a>( <span> <var>$title_page</var></span>, <span> <var>$location_id</var> = <span class="php-quote">''</span></span> )
			...
			<tr data-order="recheck_cached_data_from_user_id" id="_recheck_cached_data_from_user_id">
...
<a href="source-class-SessionData.php#354-361" title="Go to source code">recheck_cached_data_from_user_id</a>( <span> <var>$user_id</var></span> )
			...
			<tr data-order="from_cookie" id="_from_cookie">
...
<a href="source-class-SessionData.php#419-447" title="Go to source code">from_cookie</a>( <span>string <var>$cookie_content</var></span> )
			...
			<tr data-order="update_user_info" id="_update_user_info">
...
<a href="source-class-SessionData.php#485-488" title="Go to source code">update_user_info</a>( <span> <var>$user_id</var></span> )
			...
			<tr data-order="csrf_post_protect" id="_csrf_post_protect">
...
<a href="source-class-SessionData.php#490-498" title="Go to source code">csrf_post_protect</a>( )
							...
							<div class="description short">
								<p>Check the session against CSRF attacks by POST. Checks that POSTs are done with the token of the current session.
If the token of the request doesn't match the token of the current session, this method will consider that it's a CSRF attack.</p>
							</div>
...
If the token of the request doesn't match the token of the current session, this method will consider that it's a CSRF attack.</p>
			...
			<tr data-order="csrf_get_protect" id="_csrf_get_protect">
...
<a href="source-class-SessionData.php#500-507" title="Go to source code">csrf_get_protect</a>( )
							...
							<div class="description short">
								<p>Check the session against CSRF attacks by GET. Checks that GETs are done with the token of the current session.
If the token of the request doesn't match the token of the current session, this method will consider that it's a CSRF attack.</p>
							</div>
...
If the token of the request doesn't match the token of the current session, this method will consider that it's a CSRF attack.</p>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="DEFAULT_VISITOR_DISPLAY_NAME" id="DEFAULT_VISITOR_DISPLAY_NAME">
						...
						<td class="value">
							<div>
								<a href="#DEFAULT_VISITOR_DISPLAY_NAME" class="anchor">#</a>
								<code><span class="php-quote">'visitor'</span></code>
							</div>
						</td>
					</tr>
				</table>
			...
			<tr data-order="user_id" id="$user_id">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$user_id" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="session_id" id="$session_id">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$session_id" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="token" id="$token">
				<td class="attributes">
					<code>
						protected  
			...
			<tr data-order="location_script" id="$location_script">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$location_script" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="location_title" id="$location_title">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$location_title" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="location_id" id="$location_id">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$location_id" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="cached_data" id="$cached_data">
				<td class="attributes">
					<code>
						protected  
						array
				...
				<td class="value">
					<div>
						<a href="#$cached_data" class="anchor">#</a>
			...
			<tr data-order="cached_data_modified" id="$cached_data_modified">
				<td class="attributes">
					<code>
						protected  
						boolean
				...
				<td class="value">
					<div>
						<a href="#$cached_data_modified" class="anchor">#</a>
						<code><span class="php-keyword1">false</span></code>
					</div>
				</td>
			</tr>
			<tr data-order="data_modified" id="$data_modified">
				<td class="attributes">
					<code>
						protected  
						boolean
				...
				<td class="value">
					<div>
						<a href="#$data_modified" class="anchor">#</a>
						<code><span class="php-keyword1">false</span></code>
					</div>
				</td>
			</tr>
