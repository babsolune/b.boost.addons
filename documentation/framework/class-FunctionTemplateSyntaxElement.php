		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FunctionTemplateSyntaxElement.php" class="cssmenu-title">FunctionTemplateSyntaxElement</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FunctionTemplateSyntaxElement</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\<a href="package-IO.Template.parser.php">parser</a>\<a href="package-IO.Template.parser.syntax.php">syntax</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FunctionTemplateSyntaxElement.php#3-98" title="Go to source code">io/template/parser/syntax/FunctionTemplateSyntaxElement.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractTemplateSyntaxElement.php"><span>AbstractTemplateSyntaxElement</span></a>
...
<b><span>FunctionTemplateSyntaxElement</span></b>					
		...
		<div class="content">
			...
			<tr data-order="is_element" id="_is_element">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FunctionTemplateSyntaxElement.php#17-20" title="Go to source code">is_element</a>( <span><code><a href="class-StringInputStream.php">StringInputStream</a></code> <var>$input</var></span> )
						</code>
...
<a href="source-class-FunctionTemplateSyntaxElement.php#22-39" title="Go to source code">parse</a>( <span><code><a href="class-TemplateSyntaxParserContext.php">TemplateSyntaxParserContext</a></code> <var>$context</var></span>, <span><code><a href="class-StringInputStream.php">StringInputStream</a></code> <var>$input</var></span>, <span><code><a href="class-StringOutputStream.php">StringOutputStream</a></code> <var>$output</var></span> )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractTemplateSyntaxElement.php#methods">AbstractTemplateSyntaxElement</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractTemplateSyntaxElement.php#_parse_elt">parse_elt()</a>, 
									<a href="class-AbstractTemplateSyntaxElement.php#_register">register()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-AbstractTemplateSyntaxElement.php#properties">AbstractTemplateSyntaxElement</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractTemplateSyntaxElement.php#$context"><var>$context</var></a>, 
									<a href="class-AbstractTemplateSyntaxElement.php#$input"><var>$input</var></a>, 
									<a href="class-AbstractTemplateSyntaxElement.php#$output"><var>$output</var></a>
							</code>
						</td>
					</tr>
				</table>
