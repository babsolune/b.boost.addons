		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MailToPHPMailerConverter.php" class="cssmenu-title">MailToPHPMailerConverter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MailToPHPMailerConverter</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Mail.php">Mail</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-MailToPHPMailerConverter.php#21-85" title="Go to source code">io/mail/MailToPHPMailerConverter.class.php</a></span>
			</div>
		...
		<div class="content">
			...
			<tr data-order="convert" id="_convert">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailToPHPMailerConverter.php#32-43" title="Go to source code">convert</a>( <span><code><a href="class-Mail.php">Mail</a></code> <var>$mail</var></span> )
						</code>
