<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractScheduledJobExtensionPoint.php" class="cssmenu-title">AbstractScheduledJobExtensionPoint</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractScheduledJobExtensionPoint</h2></header>
		<div class="content">
...
<b><span>AbstractScheduledJobExtensionPoint</span></b>					
					 implements 
						<a href="class-ScheduledJobExtensionPoint.php"><span>ScheduledJobExtensionPoint</span></a>
		...
		<div class="content">
			...
			<tr data-order="on_changeday" id="_on_changeday">
...
<a href="source-class-AbstractScheduledJobExtensionPoint.php#14-17" title="Go to source code">on_changeday</a>( <span><code><a href="class-Date.php">Date</a></code> <var>$yesterday</var></span>, <span><code><a href="class-Date.php">Date</a></code> <var>$today</var></span> )
							...
							<div class="description short">
								<p>Execute daily commands. This extension point is called by the first request of the day.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Execute daily commands. This extension point is called by the first request of the day.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$yesterday</var></dt>
									<dd>date representing yesterday</dd>
									<dt><var>$today</var></dt>
									<dd>date representing today</dd>
								</dl></div>
								...
								<div class="list"><code><a href="class-ScheduledJobExtensionPoint.php#_on_changeday">ScheduledJobExtensionPoint::on_changeday()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="on_changepage" id="_on_changepage">
...
<a href="source-class-AbstractScheduledJobExtensionPoint.php#19" title="Go to source code">on_changepage</a>( )
							...
							<div class="description short">
								<p>Execute commands to change page.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Execute commands to change page.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ScheduledJobExtensionPoint.php#_on_changepage">ScheduledJobExtensionPoint::on_changepage()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="on_new_session" id="_on_new_session">
...
<a href="source-class-AbstractScheduledJobExtensionPoint.php#21" title="Go to source code">on_new_session</a>( <span>boolean <var>$new_visitor</var></span>, <span>boolean <var>$is_robot</var></span> )
							...
							<div class="description short">
								<p>Execute commands to new session start.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Execute commands to new session start.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$new_visitor</var></dt>
									<dd>true if the new session start with a new visitor</dd>
									<dt><var>$is_robot</var></dt>
									<dd>true if the new session start with a robot visitor</dd>
								</dl></div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ScheduledJobExtensionPoint.php#_on_new_session">ScheduledJobExtensionPoint::on_new_session()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-ScheduledJobExtensionPoint.php#constants">ScheduledJobExtensionPoint</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-ScheduledJobExtensionPoint.php#EXTENSION_POINT"><b>EXTENSION_POINT</b></a>
							</code>
						</td>
					</tr>
				</table>
