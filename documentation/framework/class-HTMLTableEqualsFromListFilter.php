		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTMLTableEqualsFromListFilter.php" class="cssmenu-title">HTMLTableEqualsFromListFilter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLTableEqualsFromListFilter</h2></header>
		<div class="content">
...
<b><span>HTMLTableEqualsFromListFilter</span></b>					
