		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ContentFormattingService.php" class="cssmenu-title">ContentFormattingService</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ContentFormattingService</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class contains the default content formatting factory that must be used if you want
a formatting factory having the default settings.</p>
			</div>
		...
		<div class="content">
			...
			<tr data-order="get_default_factory" id="_get_default_factory">
...
<a href="source-class-ContentFormattingService.php#23-34" title="Go to source code">get_default_factory</a>( )
							...
							<div class="description short">
								<p>Returns the content formatting factory corresponding to the default configuration</p>
							</div>
			...
			<tr data-order="create_factory" id="_create_factory">
...
<a href="source-class-ContentFormattingService.php#36-45" title="Go to source code">create_factory</a>( <span>string <var>$language</var> = <span class="php-quote">''</span></span> )
							...
							<div class="description short">
								<p>Creates a factory for the given language</p>
							</div>
			...
			<tr data-order="get_user_editor" id="_get_user_editor">
...
<a href="source-class-ContentFormattingService.php#47-54" title="Go to source code">get_user_editor</a>( )
							...
							<div class="description short">
								<p>Returns the name of the editor of the current user (chosen in its profile).</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the name of the editor of the current user (chosen in its profile).</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>The editor used by the current user.
								</div>
			...
			<tr data-order="get_default_parser" id="_get_default_parser">
...
<a href="source-class-ContentFormattingService.php#56-63" title="Go to source code">get_default_parser</a>( )
							...
							<div class="description short">
								<p>Returns the parser to use in the default configuration</p>
							</div>
			...
			<tr data-order="get_default_unparser" id="_get_default_unparser">
...
<a href="source-class-ContentFormattingService.php#65-72" title="Go to source code">get_default_unparser</a>( )
							...
							<div class="description short">
								<p>Returns the unparser to use in the default configuration</p>
							</div>
			...
			<tr data-order="get_default_second_parser" id="_get_default_second_parser">
...
<a href="source-class-ContentFormattingService.php#74-81" title="Go to source code">get_default_second_parser</a>( )
							...
							<div class="description short">
								<p>Returns the second parser to use in the default configuration</p>
							</div>
...
<a href="source-class-ContentFormattingService.php#83-91" title="Go to source code">get_default_editor</a>( )
							...
							<div class="description short">
								<p>Returns the editor displayer that you have to display beside the associated HTML textarea
if you use the default configuration.</p>
							</div>
...
if you use the default configuration.</p>
			...
			<tr data-order="get_editors_identifier" id="_get_editors_identifier">
...
<a href="source-class-ContentFormattingService.php#109-112" title="Go to source code">get_editors_identifier</a>( )
			...
			<tr data-order="get_available_editors" id="_get_available_editors">
...
<a href="source-class-ContentFormattingService.php#114-122" title="Go to source code">get_available_editors</a>( )
			...
			<tr data-order="uninstall_editor" id="_uninstall_editor">
...
<a href="source-class-ContentFormattingService.php#124-149" title="Go to source code">uninstall_editor</a>( <span>string <var>$id_module</var></span> )
			...
			<tr data-order="get_available_tags" id="_get_available_tags">
...
<a href="source-class-ContentFormattingService.php#151-203" title="Go to source code">get_available_tags</a>( )
							...
							<div class="description short">
								<p>Returns the map of all the formatting types supported by the PHPBoost formatting editors and parsers.
The keys of the map are the tags identifiers and the values the tags names.</p>
							</div>
