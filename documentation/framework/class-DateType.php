		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-DateType.php" class="cssmenu-title">DateType</a></li>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Doctrine.php">Doctrine</a>\<a href="package-Doctrine.DBAL.php">DBAL</a>\<a href="package-Doctrine.DBAL.Types.php">Types</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-DateType.php#3-36" title="Go to source code">io/db/dbms/Doctrine/DBAL/Types/DateType.php</a></span>
			</div>

			<div class="description">
				<p>Type that maps an SQL DATE to a PHP Date object.</p>
			</div>
			...
			<tr data-order="getName" id="_getName">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DateType.php#15-18" title="Go to source code">getName</a>( )
						</code>
			...
			<tr data-order="getSqlDeclaration" id="_getSqlDeclaration">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DateType.php#20-23" title="Go to source code">getSqlDeclaration</a>( <span>array <var>$fieldDeclaration</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
			...
			<tr data-order="convertToDatabaseValue" id="_convertToDatabaseValue">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DateType.php#25-29" title="Go to source code">convertToDatabaseValue</a>( <span>mixed <var>$value</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
			...
			<tr data-order="convertToPHPValue" id="_convertToPHPValue">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DateType.php#31-35" title="Go to source code">convertToPHPValue</a>( <span>mixed <var>$value</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
