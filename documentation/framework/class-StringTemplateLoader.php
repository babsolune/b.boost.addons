		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-StringTemplateLoader.php" class="cssmenu-title">StringTemplateLoader</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>StringTemplateLoader</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This loader is a very simple one. Its input is a string containing the template source.
It doesn't supports caching so it always parses the input source.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>StringTemplateLoader</span></b>					
					 implements 
...
<a href="source-class-StringTemplateLoader.php#29-37" title="Go to source code">__construct</a>( <span>string <var>$content</var></span> )
							...
							<div class="description short">
								<p>Constructs the <code><a href="class-StringTemplateLoader.php">StringTemplateLoader</a></code> from the input source.</p>
							</div>
...
<a href="source-class-StringTemplateLoader.php#72-78" title="Go to source code">supports_caching</a>( )
							...
							<div class="description short">
								<p>Tells whether the loader supports caching. If it supports it, its <code><a href="class-StringTemplateLoader.php#_get_cache_file_path">StringTemplateLoader::get_cache_file_path()</a></code>
 will have to return a non-empty value.</p>
							</div>

						<div class="description detailed hidden">
							<p>Tells whether the loader supports caching. If it supports it, its <code><a href="class-StringTemplateLoader.php#_get_cache_file_path">StringTemplateLoader::get_cache_file_path()</a></code> will have to return a non-empty value.</p>
...
This method must be called only if the loader supports caching, the <code><a href="class-StringTemplateLoader.php#_supports_caching">StringTemplateLoader::supports_caching()</a></code>
