		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-TemplateSyntaxParserContext.php" class="cssmenu-title">TemplateSyntaxParserContext</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>TemplateSyntaxParserContext</h2></header>
		<div class="content">
		...
		<div class="content">
			...
			<tr data-order="enter_loop" id="_enter_loop">
...
<a href="source-class-TemplateSyntaxParserContext.php#17-20" title="Go to source code">enter_loop</a>( <span> <var>$name</var></span> )
			...
			<tr data-order="exit_loop" id="_exit_loop">
...
<a href="source-class-TemplateSyntaxParserContext.php#22-25" title="Go to source code">exit_loop</a>( )
			...
			<tr data-order="is_in_loop" id="_is_in_loop">
...
<a href="source-class-TemplateSyntaxParserContext.php#27-30" title="Go to source code">is_in_loop</a>( <span> <var>$name</var></span> )
			...
			<tr data-order="loops_scopes" id="_loops_scopes">
