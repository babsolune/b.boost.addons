<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FormButtonButton.php" class="cssmenu-title">FormButtonButton</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormButtonButton</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormButtonButton.php#3-21" title="Go to source code">builder/form/button/FormButtonButton.class.php</a></span>
			</div>
...
<b><span>FormButtonButton</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormButtonButton.php#17-20" title="Go to source code">__construct</a>( <span> <var>$value</var></span>, <span> <var>$onclick_action</var> = <span class="php-quote">''</span></span>, <span> <var>$name</var> = <span class="php-quote">''</span></span>, <span> <var>$css_class</var> = <span class="php-quote">''</span></span>, <span> <var>$data_confirmation</var> = <span class="php-quote">''</span></span>, <span> <var>$form_id</var> = <span class="php-quote">''</span></span> )
						</code>
