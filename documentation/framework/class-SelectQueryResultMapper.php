		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SelectQueryResultMapper.php" class="cssmenu-title">SelectQueryResultMapper</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SelectQueryResultMapper</h2></header>
		<div class="content">
...
<b><span>SelectQueryResultMapper</span></b>					
					 implements 
						<a href="class-SelectQueryResult.php"><span>SelectQueryResult</span></a>
...
<a href="source-class-SelectQueryResultMapper.php#25-34" title="Go to source code">__construct</a>( <span><code><a href="class-QueryResult.php">QueryResult</a></code> <var>$query_result</var></span>, <span><code><a href="class-MappingModel.php">MappingModel</a></code> <var>$model</var></span> )
						...
						<div class="description detailed hidden">
							<p>initialize the dao</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$query_result</var></dt>
									<dd>$querier the querier that will be used to interact with the database</dd>
									<dt><var>$model</var></dt>
									<dd>the model on which rely to provides services</dd>
								</dl></div>
			...
			<tr data-order="get_query" id="_get_query">
...
<a href="source-class-SelectQueryResultMapper.php#36-39" title="Go to source code">get_query</a>( )
							...
							<div class="description short">
								<p>Returns the executed query converted to dbms dialect</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the executed query converted to dbms dialect</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>the executed query converted to dbms dialect
								</div>
								...
								<div class="list"><code><a href="class-QueryResult.php#_get_query">QueryResult::get_query()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_parameters" id="_get_parameters">
...
<a href="source-class-SelectQueryResultMapper.php#41-44" title="Go to source code">get_parameters</a>( )
							...
							<div class="description short">
								<p>Returns the parameters injected in the query</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the parameters injected in the query</p>
								...
								<h6>Returns</h6>
								<div class="list">
									mixed[string]<br>the parameters injected in the query
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-QueryResult.php#_get_parameters">QueryResult::get_parameters()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="set_fetch_mode" id="_set_fetch_mode">
...
<a href="source-class-SelectQueryResultMapper.php#46-49" title="Go to source code">set_fetch_mode</a>( <span> <var>$fetch_mode</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-SelectQueryResult.php#_set_fetch_mode">SelectQueryResult::set_fetch_mode()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_rows_count" id="_get_rows_count">
...
<a href="source-class-SelectQueryResultMapper.php#51-54" title="Go to source code">get_rows_count</a>( )
							...
							<div class="description short">
								<p>returns the number of returned rows by this query</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>returns the number of returned rows by this query</p>
								...
								<h6>Returns</h6>
								<div class="list">
									integer<br>the number of returned rows by this query
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-SelectQueryResult.php#_get_rows_count">SelectQueryResult::get_rows_count()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-SelectQueryResultMapper.php#56-59" title="Go to source code">__destruct</a>( )
			...
			<tr data-order="has_next" id="_has_next">
...
<a href="source-class-SelectQueryResultMapper.php#61-64" title="Go to source code">has_next</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-SelectQueryResult.php#_has_next">SelectQueryResult::has_next()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-SelectQueryResultMapper.php#66-69" title="Go to source code">fetch</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-SelectQueryResult.php#_fetch">SelectQueryResult::fetch()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-SelectQueryResultMapper.php#96-99" title="Go to source code">dispose</a>( )
							...
							<div class="description short">
								<p>free the resource. If not done manually, this is done in the destructor</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>free the resource. If not done manually, this is done in the destructor</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-SelectQueryResult.php#_dispose">SelectQueryResult::dispose()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-SelectQueryResult.php#constants">SelectQueryResult</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-SelectQueryResult.php#FETCH_ASSOC"><b>FETCH_ASSOC</b></a>, 
									<a href="class-SelectQueryResult.php#FETCH_NUM"><b>FETCH_NUM</b></a>
							</code>
						</td>
					</tr>
				</table>
			...
			<tr data-order="query_result" id="$query_result">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$query_result" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
