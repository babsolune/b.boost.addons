<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractCategoriesFormController.php" class="cssmenu-title">AbstractCategoriesFormController</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractCategoriesFormController</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Category.php">Category</a>\<a href="package-Content.Category.bridges.php">bridges</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 11 06
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 4.0 - 2013 02 06
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
			...
			<dl class="tree">
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>AbstractCategoriesFormController</span></b>					
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-AbstractRichCategoriesFormController.php">AbstractRichCategoriesFormController</a>
			</div>
...
<a href="source-class-AbstractCategoriesFormController.php#36-58" title="Go to source code">execute</a>( <span><code><a href="class-HTTPRequestCustom.php">HTTPRequestCustom</a></code> <var>$request</var></span> )
			...
			<tr data-order="build_form" id="_build_form">
...
<a href="source-class-AbstractCategoriesFormController.php#163-166" title="Go to source code">get_options_fields</a>( <span><code><a href="class-FormFieldset.php">FormFieldset</a></code> <var>$fieldset</var></span> )
			...
			<tr data-order="get_category" id="_get_category">

				<td class="attributes">
					<code>
						 protected 

						<code><a href="class-Category.php">Category</a></code>
...
<a href="source-class-AbstractCategoriesFormController.php#221-227" title="Go to source code">get_title</a>( )
			...
			<tr data-order="get_success_message" id="_get_success_message">
...
<a href="source-class-AbstractCategoriesFormController.php#229-235" title="Go to source code">get_success_message</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>the appropriate success message
								</div>
...
<a href="source-class-AbstractCategoriesFormController.php#237-255" title="Go to source code">generate_response</a>( <span><code><a href="class-View.php">View</a></code> <var>$view</var></span> )
			...
			<tr data-order="get_id_category" id="_get_id_category">
...
<a href="source-class-AbstractCategoriesFormController.php#257-260" title="Go to source code">get_id_category</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>id of the category to edit / delete
								</div>
			...
			<tr data-order="get_categories_manager" id="_get_categories_manager">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-CategoriesManager.php">CategoriesManager</a></code>
...
<a href="source-class-AbstractCategoriesFormController.php#267-270" title="Go to source code">get_categories_management_url</a>( )
			...
			<tr data-order="get_add_category_url" id="_get_add_category_url">
...
<a href="source-class-AbstractCategoriesFormController.php#293-296" title="Go to source code">check_authorizations</a>( )
			...
			<tr data-order="form" id="$form">
				<td class="attributes">
					<code>
						protected  
						<code><a href="class-HTMLForm.php">HTMLForm</a></code>
					</code>
				</td>
			...
			<tr data-order="submit_button" id="$submit_button">
				<td class="attributes">
					<code>
						protected  
						<code><a href="class-FormButtonSubmit.php">FormButtonSubmit</a></code>
					</code>
				</td>
				...
				<td class="value">
					<div>
						<a href="#$submit_button" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			...
			<tr data-order="common_lang" id="$common_lang">
				<td class="attributes">
					<code>
						protected static 
				...
				<td class="value">
					<div>
						<a href="#$common_lang" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="is_new_category" id="$is_new_category">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$is_new_category" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
