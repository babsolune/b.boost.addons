		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-IntegerType.php" class="cssmenu-title">IntegerType</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>IntegerType</h2></header>
		<div class="content">
...
<a href="source-class-IntegerType.php#34-37" title="Go to source code">getTypeCode</a>( )
						...
						<div class="description detailed hidden">
							<p>Gets the type code of this type.</p>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Type.php#_getTypeCode">Type::getTypeCode()</a></code></div>
