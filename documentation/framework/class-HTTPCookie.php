<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-HTTPCookie.php" class="cssmenu-title">HTTPCookie</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTTPCookie</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>Manages cookies via the HTTP protocol</p>
			</div>
...
<a href="source-class-HTTPCookie.php#26-48" title="Go to source code">__construct</a>( <span> <var>$name</var></span>, <span> <var>$value</var></span>, <span> <var>$timestamp</var> = <span class="php-keyword1">null</span></span> )
			...
			<tr data-order="set_expiration_date" id="_set_expiration_date">
...
<a href="source-class-HTTPCookie.php#50-60" title="Go to source code">set_expiration_date</a>( <span>integer <var>$timestamp</var></span> )
							...
							<div class="description short">
								<p>The time the cookie expires. This is a Unix timestamp so is
in number of seconds since the epoch. In other words, you'll
most likely set this with the time function
plus the number of seconds before you want it to expire.</p>
							</div>
...
plus the number of seconds before you want it to expire.</p>
			...
			<tr data-order="set_path" id="_set_path">
...
<a href="source-class-HTTPCookie.php#62-71" title="Go to source code">set_path</a>( <span>string <var>$path</var></span> )
							...
							<div class="description short">
								<p>The path on the server in which the cookie will be available on.
If set to '/' (default value), the cookie will be available
within the entire domain.</p>
							</div>
...
within the entire domain.</p>
			...
			<tr data-order="set_domain" id="_set_domain">
...
<a href="source-class-HTTPCookie.php#73-80" title="Go to source code">set_domain</a>( <span>string <var>$domain</var></span> )
							...
							<div class="description short">
								<p>The domain that the cookie is available.</p>
							</div>
			...
			<tr data-order="set_secure" id="_set_secure">
...
<a href="source-class-HTTPCookie.php#82-94" title="Go to source code">set_secure</a>( <span>boolean <var>$secure</var></span> )
							...
							<div class="description short">
								<p>Indicates that the cookie should only be transmitted over a
...
$_SERVER["HTTPS"]).</p>
			...
			<tr data-order="set_httponly" id="_set_httponly">
...
<a href="source-class-HTTPCookie.php#96-107" title="Go to source code">set_httponly</a>( <span>boolean <var>$httponly</var></span> )
							...
							<div class="description short">
								<p>When true the cookie will be made accessible only through the HTTP
...
not supported by all browsers). Added in PHP 5.2.0.</p>
							</div>
...
<a href="source-class-HTTPCookie.php#114-117" title="Go to source code">get_value</a>( )
			...
			<tr data-order="get_expiration_date" id="_get_expiration_date">
...
<a href="source-class-HTTPCookie.php#124-127" title="Go to source code">get_path</a>( )
			...
			<tr data-order="get_domain" id="_get_domain">
...
<a href="source-class-HTTPCookie.php#129-132" title="Go to source code">get_domain</a>( )
			...
			<tr data-order="get_secure" id="_get_secure">
...
<a href="source-class-HTTPCookie.php#134-137" title="Go to source code">get_secure</a>( )
			...
			<tr data-order="get_httponly" id="_get_httponly">
