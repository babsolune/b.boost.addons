<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-LangLoader.php" class="cssmenu-title">LangLoader</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>LangLoader</h2></header>
		<div class="content">
...
<a href="source-class-LangLoader.php#32-39" title="Go to source code">get_locale</a>( )
							...
							<div class="description short">
								<p>Returns the current language locale</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the current language locale</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>the current language locale
								</div>
			...
			<tr data-order="get_available_langs" id="_get_available_langs">
...
<a href="source-class-LangLoader.php#61-77" title="Go to source code">get_message</a>( <span>string <var>$message_id</var></span>, <span>string <var>$filename</var></span>, <span>string <var>$module</var> = <span class="php-quote">''</span></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$message_id</var></dt>
									<dd>the language message identifier</dd>
									<dt><var>$filename</var></dt>
									<dd>the language filename</dd>
									<dt><var>$module</var></dt>
									<dd>the module to look for languages files in</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>the localized message
								</div>
...
<a href="source-class-LangLoader.php#79-93" title="Go to source code">get</a>( <span>string <var>$filename</var></span>, <span>string <var>$module</var> = <span class="php-quote">''</span></span>, <span>string <var>$forced_file</var> = <span class="php-quote">''</span></span> )
							...
							<div class="description short">
								<p>Retrieves the language file</p>

<pre><span class="php-var">$filename</span></pre>

<p>in</p>

<pre>/<span class="php-var">$module</span>/lang/<span class="php-var">$locale</span>/<span class="php-var">$filename</span>.php</pre>

<p>If module is empty, the kernel lang folder will be used</p>
							</div>
...
<p>If module is empty, the kernel lang folder will be used</p>
								...
								<div class="list"><dl>
									...
									<dt><var>$module</var></dt>
									<dd>the module to look for languages files in</dd>
									<dt><var>$forced_file</var></dt>
									<dd>the language filename to return inevitably</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string[string]<br><p>the lang array which keys are languages identifiers and values the
translated messages</p>
			...
			<tr data-order="clear_lang_cache" id="_clear_lang_cache">
...
<a href="source-class-LangLoader.php#164-171" title="Go to source code">clear_lang_cache</a>( )
							...
							<div class="description short">
								<p>clear the lang cache (for unit test only)</p>
							</div>
