<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-TemplateParser.php" class="cssmenu-title">TemplateParser</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>TemplateParser</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This interfaces represents a class that is able to parse a template source and transform it
to a syntax that the PHP engine is able to run.</p>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractTemplateParser.php">AbstractTemplateParser</a>, 
					<a href="class-TemplateSyntaxParser.php">TemplateSyntaxParser</a>
			</div>
