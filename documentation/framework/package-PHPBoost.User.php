...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\User</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\User</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-PHPBoost.User.authentication.php">PHPBoost\User\authentication</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-PHPBoost.User.session.php">PHPBoost\User\session</a></td>
					</tr>
				</table>
			</div>
...
<tr>
	<td class="name"><a href="class-CurrentUser.php">CurrentUser</a></td>
	<td class="ellipsis">This class represente the current user</td>
</tr>
<tr>
	<td class="name"><a href="class-User.php">User</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-UserService.php">UserService</a></td>
	<td class="ellipsis">This class manage users</td>
</tr>
	</table>
</div>
