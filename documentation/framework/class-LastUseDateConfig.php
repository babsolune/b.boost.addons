		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-LastUseDateConfig.php" class="cssmenu-title">LastUseDateConfig</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>LastUseDateConfig</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Config.php">Config</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 02 08
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<div class="description">
				<p>This class contains the date of the last day where PHPBoost was used.
It's useful to know when to launch daily tasks.</p>
			</div>
...
<b><span>LastUseDateConfig</span></b>					
		...
		<div class="content">
			...
			<tr data-order="set_last_use_date" id="_set_last_use_date">
...
<a href="source-class-LastUseDateConfig.php#18-27" title="Go to source code">set_last_use_date</a>( <span><code><a href="class-Date.php">Date</a></code> <var>$date</var></span> )
							...
							<div class="description short">
								<p>Sets the date of the last time PHPBoost executed the daily tasks.</p>
							</div>
			...
			<tr data-order="get_last_use_date" id="_get_last_use_date">
...
<a href="source-class-LastUseDateConfig.php#29-47" title="Go to source code">get_last_use_date</a>( )
							...
							<div class="description short">
								<p>Returns the date of the last time PHPBoost executed the daily tasks.</p>
							</div>
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-LastUseDateConfig.php">LastUseDateConfig</a></code>
