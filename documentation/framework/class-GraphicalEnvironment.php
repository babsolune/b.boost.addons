<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-GraphicalEnvironment.php" class="cssmenu-title">GraphicalEnvironment</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>GraphicalEnvironment</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class is used to represent the bread crumb displayed on each page of the website.
...
Third level category >> .. >> My page >> Edition</p>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractGraphicalEnvironment.php">AbstractGraphicalEnvironment</a>
			</div>
