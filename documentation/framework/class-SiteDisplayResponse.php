		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SiteDisplayResponse.php" class="cssmenu-title">SiteDisplayResponse</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SiteDisplayResponse</h2></header>
		<div class="content">
...
<b><span>SiteDisplayResponse</span></b>					
