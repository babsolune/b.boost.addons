		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HtaccessFileCache.php" class="cssmenu-title">HtaccessFileCache</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HtaccessFileCache</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Cache.php">Cache</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 11 10
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2009 10 22
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
			...
			<div class="description">
				<p>This class contains the cache data of the .htaccess file which is located at the root of the site
and is used to change the Apache configuration only in the PHPBoost folder.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>HtaccessFileCache</span></b>					
					 implements 
...
For instance,</p>
			...
			<tr data-order="get_htaccess_file_content" id="_get_htaccess_file_content">
...
<a href="source-class-HtaccessFileCache.php#512-519" title="Go to source code">get_htaccess_file_content</a>( )
							...
							<div class="description short">
								<p>Returns the content of the .htaccess file</p>
							</div>
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-HtaccessFileCache.php">HtaccessFileCache</a></code>
...
<a href="source-class-HtaccessFileCache.php#521-528" title="Go to source code">load</a>( )
						...
						<div class="description detailed hidden">
							<p>Loads and returns the groups cached data.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-HtaccessFileCache.php">HtaccessFileCache</a></code><br>The cached data
								</div>
...
<a href="source-class-HtaccessFileCache.php#530-536" title="Go to source code">invalidate</a>( )
			...
			<tr data-order="regenerate" id="_regenerate">
...
<a href="source-class-HtaccessFileCache.php#538-545" title="Go to source code">regenerate</a>( )
							...
							<div class="description short">
								<p>Regenerates the .htaccess file</p>
							</div>
