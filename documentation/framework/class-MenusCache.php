		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MenusCache.php" class="cssmenu-title">MenusCache</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MenusCache</h2></header>
		<div class="content">
...
For instance,</p>
			...
			<tr data-order="get_menus" id="_get_menus">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-MenusCache.php">MenusCache</a></code>
...
<a href="source-class-MenusCache.php#39-46" title="Go to source code">load</a>( )
							...
							<div class="description short">
								<p>Loads and returns the menus cached data.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads and returns the menus cached data.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-MenusCache.php">MenusCache</a></code><br>The cached data
								</div>
...
<a href="source-class-MenusCache.php#48-54" title="Go to source code">invalidate</a>( )
							...
							<div class="description short">
								<p>Invalidates the current menus cached data.</p>
							</div>
