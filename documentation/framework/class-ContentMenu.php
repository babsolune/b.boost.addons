<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ContentMenu.php" class="cssmenu-title">ContentMenu</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ContentMenu</h2></header>
		<div class="content">
...
<a href="source-class-ContentMenu.php#35-67" title="Go to source code">display</a>( )
						...
						<div class="description detailed hidden">
							<p>Display the content menu.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									a<br>string of the parsed template ready to be displayed
								</div>
			...
			<tr data-order="set_display_title" id="_set_display_title">
...
<a href="source-class-ContentMenu.php#70-73" title="Go to source code">set_display_title</a>( <span>boolean <var>$display_title</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$display_title</var></dt>
									<dd>if false, the title won't be displayed</dd>
								</dl></div>
			...
			<tr data-order="set_content" id="_set_content">
...
<a href="source-class-ContentMenu.php#75-78" title="Go to source code">set_content</a>( <span>string <var>$content</var></span> )
			...
			<tr data-order="get_display_title" id="_get_display_title">
...
<a href="source-class-ContentMenu.php#81-85" title="Go to source code">get_display_title</a>( )
							...
							<div class="description short">
								<p>Returns true if the title will be displayed</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns true if the title will be displayed</p>
								...
								<h6>Returns</h6>
								<div class="list">
									boolean<br>true if the title will be displayed
								</div>
			...
			<tr data-order="get_content" id="_get_content">
...
<a href="source-class-ContentMenu.php#87-90" title="Go to source code">get_content</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="CONTENT_MENU__CLASS" id="CONTENT_MENU__CLASS">
						...
						<td class="value">
							<div>
								<a href="#CONTENT_MENU__CLASS" class="anchor">#</a>
								<code><span class="php-quote">'ContentMenu'</span></code>
							</div>
						</td>
					</tr>
				</table>
			...
			<tr data-order="display_title" id="$display_title">
				<td class="attributes">
					<code>
						public  
						boolean
				...
				<td class="value">
					<div>
						<a href="#$display_title" class="anchor">#</a>
