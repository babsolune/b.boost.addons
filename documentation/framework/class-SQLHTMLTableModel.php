		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SQLHTMLTableModel.php" class="cssmenu-title">SQLHTMLTableModel</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SQLHTMLTableModel</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Table.php">Table</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 06 10
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 4.1 - 2015 01 19
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
			...
			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-HTMLTableModel.php"><span>HTMLTableModel</span></a>
...
<b><span>SQLHTMLTableModel</span></b>					
...
<a href="source-class-SQLHTMLTableModel.php#19-23" title="Go to source code">__construct</a>( <span> <var>$table</var></span>, <span> <var>$id</var></span>, <span>array <var>$columns</var></span>, <span><code><a href="class-HTMLTableSortingRule.php">HTMLTableSortingRule</a></code> <var>$default_sorting_rule</var></span>, <span> <var>$rows_per_page</var> = self::DEFAULT_PAGINATION</span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-HTMLTableModel.php#___construct">HTMLTableModel::__construct()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_number_of_matching_rows" id="_get_number_of_matching_rows">
...
<a href="source-class-SQLHTMLTableModel.php#25-28" title="Go to source code">get_number_of_matching_rows</a>( )
			...
			<tr data-order="get_sql_results" id="_get_sql_results">
...
<a href="source-class-SQLHTMLTableModel.php#30-46" title="Go to source code">get_sql_results</a>( <span> <var>$sql_join</var> = <span class="php-keyword1">false</span></span>, <span> <var>$select</var> = <span class="php-keyword1">array</span>(<span class="php-quote">'*'</span>)</span> )
			...
			<tr data-order="get_sql_from" id="_get_sql_from">
...
<a href="source-class-SQLHTMLTableModel.php#48-55" title="Go to source code">get_sql_from</a>( <span> <var>$sql_join</var></span> )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-HTMLTableModel.php#methods">HTMLTableModel</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-HTMLTableModel.php#_add_filter">add_filter()</a>, 
									<a href="class-HTMLTableModel.php#_add_footer_css_class">add_footer_css_class()</a>, 
									<a href="class-HTMLTableModel.php#_add_permanent_filter">add_permanent_filter()</a>, 
									<a href="class-HTMLTableModel.php#_default_sort_rule">default_sort_rule()</a>, 
									<a href="class-HTMLTableModel.php#_delete_last_column">delete_last_column()</a>, 
									<a href="class-HTMLTableModel.php#_get_caption">get_caption()</a>, 
									<a href="class-HTMLTableModel.php#_get_columns">get_columns()</a>, 
									<a href="class-HTMLTableModel.php#_get_filter">get_filter()</a>, 
									<a href="class-HTMLTableModel.php#_get_filters">get_filters()</a>, 
									<a href="class-HTMLTableModel.php#_get_footer_css_class">get_footer_css_class()</a>, 
									<a href="class-HTMLTableModel.php#_get_id">get_id()</a>, 
									<a href="class-HTMLTableModel.php#_get_nb_rows_options">get_nb_rows_options()</a>, 
									<a href="class-HTMLTableModel.php#_get_nb_rows_per_page">get_nb_rows_per_page()</a>, 
									<a href="class-HTMLTableModel.php#_get_permanent_filter">get_permanent_filter()</a>, 
									<a href="class-HTMLTableModel.php#_get_permanent_filters">get_permanent_filters()</a>, 
									<a href="class-HTMLTableModel.php#_has_caption">has_caption()</a>, 
									<a href="class-HTMLTableModel.php#_has_footer_css_class">has_footer_css_class()</a>, 
									<a href="class-HTMLTableModel.php#_has_id">has_id()</a>, 
									<a href="class-HTMLTableModel.php#_has_nb_rows_options">has_nb_rows_options()</a>, 
									<a href="class-HTMLTableModel.php#_hide_footer">hide_footer()</a>, 
									<a href="class-HTMLTableModel.php#_is_filter_allowed">is_filter_allowed()</a>, 
									<a href="class-HTMLTableModel.php#_is_footer_displayed">is_footer_displayed()</a>, 
									<a href="class-HTMLTableModel.php#_is_pagination_activated">is_pagination_activated()</a>, 
									<a href="class-HTMLTableModel.php#_is_sort_parameter_allowed">is_sort_parameter_allowed()</a>, 
									<a href="class-HTMLTableModel.php#_set_caption">set_caption()</a>, 
									<a href="class-HTMLTableModel.php#_set_footer_css_class">set_footer_css_class()</a>, 
									<a href="class-HTMLTableModel.php#_set_html_table">set_html_table()</a>, 
									<a href="class-HTMLTableModel.php#_set_id">set_id()</a>, 
									<a href="class-HTMLTableModel.php#_set_nb_rows_options">set_nb_rows_options()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-HTMLTableModel.php#constants">HTMLTableModel</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-HTMLTableModel.php#DEFAULT_PAGINATION"><b>DEFAULT_PAGINATION</b></a>, 
									<a href="class-HTMLTableModel.php#NO_PAGINATION"><b>NO_PAGINATION</b></a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-HTMLTableModel.php#properties">HTMLTableModel</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-HTMLTableModel.php#$html_table"><var>$html_table</var></a>
							</code>
						</td>
					</tr>
				</table>
