		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FeedsList.php" class="cssmenu-title">FeedsList</a></li>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>This class contains an agregation of differents feeds</p>
			</div>
		...
		<div class="content">
			...
			<tr data-order="add_feed" id="_add_feed">
...
<a href="source-class-FeedsList.php#18-26" title="Go to source code">add_feed</a>( <span><code><a href="class-FeedsCat.php">FeedsCat</a></code> <var>$cat_tree</var></span>, <span>string <var>$feed_type</var></span> )
							...
							<div class="description short">
								<p>Adds the FeedsCat $cat_tree to the current feeds list</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Adds the FeedsCat $cat_tree to the current feeds list</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$cat_tree</var></dt>
									<dd>The feed to add to the list</dd>
									<dt><var>$feed_type</var></dt>
									<dd>The feed category name</dd>
								</dl></div>
			...
			<tr data-order="get_feeds_list" id="_get_feeds_list">
...
<a href="source-class-FeedsList.php#28-35" title="Go to source code">get_feeds_list</a>( )
						...
						<div class="description detailed hidden">
							<p>Returns the feeds list</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-FeedsCat.php">FeedsCat</a>[]</code><br>the feeds list
								</div>
