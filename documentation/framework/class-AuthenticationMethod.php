<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AuthenticationMethod.php" class="cssmenu-title">AuthenticationMethod</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AuthenticationMethod</h2></header>
		<div class="content">
...
implementations of this class to support LDAP authentication, OpenID, Facebook connect and more...</p>
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-PHPBoostAuthenticationMethod.php">PHPBoostAuthenticationMethod</a>
			</div>
...
<a href="source-class-AuthenticationMethod.php#37-41" title="Go to source code">authenticate</a>( )
			...
			<tr data-order="has_error" id="_has_error">
...
<a href="source-class-AuthenticationMethod.php#43-46" title="Go to source code">has_error</a>( )
			...
			<tr data-order="get_error_msg" id="_get_error_msg">
...
<a href="source-class-AuthenticationMethod.php#48-51" title="Go to source code">get_error_msg</a>( )
			...
			<tr data-order="check_user_bannishment" id="_check_user_bannishment">
...
<a href="source-class-AuthenticationMethod.php#53-99" title="Go to source code">check_user_bannishment</a>( <span> <var>$user_id</var></span> )
			...
			<tr data-order="update_user_last_connection_date" id="_update_user_last_connection_date">
