<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-Controller.php" class="cssmenu-title">Controller</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>Controller</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This interface declares the minimalist controler pattern</p>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractController.php">AbstractController</a>
			</div>
