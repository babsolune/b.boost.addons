<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ExtensionPoint.php" class="cssmenu-title">ExtensionPoint</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ExtensionPoint</h2></header>
		<div class="content">
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-Captcha.php">Captcha</a>, 
					<a href="class-CommentsExtensionPoint.php">CommentsExtensionPoint</a>, 
					<a href="class-ScheduledJobExtensionPoint.php">ScheduledJobExtensionPoint</a>, 
					<a href="class-SearchableExtensionPoint.php">SearchableExtensionPoint</a>, 
					<a href="class-UrlMappingsExtensionPoint.php">UrlMappingsExtensionPoint</a>, 
					<a href="class-ContentFormattingExtensionPoint.php">ContentFormattingExtensionPoint</a>, 
					<a href="class-ContentSharingActionsMenuLinksExtensionPoint.php">ContentSharingActionsMenuLinksExtensionPoint</a>, 
					<a href="class-CssFilesExtensionPoint.php">CssFilesExtensionPoint</a>, 
					<a href="class-ExtendedFieldExtensionPoint.php">ExtendedFieldExtensionPoint</a>, 
					<a href="class-ExternalAuthenticationsExtensionPoint.php">ExternalAuthenticationsExtensionPoint</a>, 
					<a href="class-FeedProvider.php">FeedProvider</a>, 
					<a href="class-MenusExtensionPoint.php">MenusExtensionPoint</a>, 
					<a href="class-ModuleTreeLinksExtensionPoint.php">ModuleTreeLinksExtensionPoint</a>
			</div>

			<div>
				<h6>Indirect known implementers</h6>
					<a href="class-AbstractCommentsExtensionPoint.php">AbstractCommentsExtensionPoint</a>, 
					<a href="class-AbstractContentFormattingExtensionPoint.php">AbstractContentFormattingExtensionPoint</a>, 
					<a href="class-AbstractScheduledJobExtensionPoint.php">AbstractScheduledJobExtensionPoint</a>, 
					<a href="class-AbstractSearchableExtensionPoint.php">AbstractSearchableExtensionPoint</a>, 
					<a href="class-CommentsTopics.php">CommentsTopics</a>, 
					<a href="class-ExtendedFields.php">ExtendedFields</a>, 
					<a href="class-ModuleCssFiles.php">ModuleCssFiles</a>, 
					<a href="class-ModuleMenus.php">ModuleMenus</a>, 
					<a href="class-UrlMappings.php">UrlMappings</a>
			</div>
