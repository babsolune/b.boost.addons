		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ExceptionHandler.php" class="cssmenu-title">ExceptionHandler</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ExceptionHandler</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Core.php">Core</a>\<a href="package-Core.Error.php">Error</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 11 10
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2009 12 08
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
...
<a href="source-class-ExceptionHandler.php#22-36" title="Go to source code">handle</a>( <span>Exception <var>$exception</var></span> )
							...
							<div class="description short">
								<p>The user function needs to accept two parameters: the error code, and a string
