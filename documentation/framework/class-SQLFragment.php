<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-SQLFragment.php" class="cssmenu-title">SQLFragment</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SQLFragment</h2></header>
		<div class="content">
...
<a href="source-class-SQLFragment.php#32-38" title="Go to source code">get_parameters</a>( )
			...
			<tr data-order="add_parameters_to_map" id="_add_parameters_to_map">
...
<a href="source-class-SQLFragment.php#40-50" title="Go to source code">add_parameters_to_map</a>( <span>array <var>&amp; $parameters</var></span> )
							...
							<div class="description short">
								<p>Adds the fragment parameters to the</p>

<pre><span class="php-var">$parameters</span></pre>
...
<p>map</p>
								...
								<div class="list"><dl>
									...
									<dd>the parameters that will be filled</dd>
								</dl></div>
