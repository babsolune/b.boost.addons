		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FeedItemEnclosure.php" class="cssmenu-title">FeedItemEnclosure</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FeedItemEnclosure</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>Contains meta-informations and informations about a feed item enclosure</p>
			</div>
		...
		<div class="content">
			...
			<tr data-order="set_lenght" id="_set_lenght">
...
<a href="source-class-FeedItemEnclosure.php#20-27" title="Go to source code">set_lenght</a>( <span>integer <var>$lenght</var></span> )
							...
							<div class="description short">
								<p>Defines the lenght (in bytes) of the media file</p>
							</div>
			...
			<tr data-order="get_lenght" id="_get_lenght">
...
<a href="source-class-FeedItemEnclosure.php#34-41" title="Go to source code">set_type</a>( <span>string <var>$type</var></span> )
							...
							<div class="description short">
								<p>Defines the type of media file</p>
							</div>
...
<a href="source-class-FeedItemEnclosure.php#48-59" title="Go to source code">set_url</a>( <span>mixed <var>$url</var></span> )
							...
							<div class="description short">
								<p>Defines the URL to the media file</p>
							</div>
