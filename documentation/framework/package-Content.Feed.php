...
<section id="content">
	<header>
		<h1>Package <a href="package-Content.php">Content</a>\Feed</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-Content.php">Content</a>\Feed</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-ATOM.php">ATOM</a></td>
	<td class="ellipsis"><p>This class could load a feed by its url or by a FeedData element and
export it to the ATOM format</p></td>
</tr>
<tr>
	<td class="name"><a href="class-Feed.php">Feed</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-FeedData.php">FeedData</a></td>
	<td class="ellipsis">Contains meta-informations about a feed with its entries</td>
</tr>
<tr>
	<td class="name"><a href="class-FeedItem.php">FeedItem</a></td>
	<td class="ellipsis">Contains meta-informations and informations about a feed entry / item</td>
</tr>
<tr>
	<td class="name"><a href="class-FeedItemEnclosure.php">FeedItemEnclosure</a></td>
	<td class="ellipsis">Contains meta-informations and informations about a feed item enclosure</td>
</tr>
<tr>
	<td class="name"><a href="class-FeedsCat.php">FeedsCat</a></td>
	<td class="ellipsis">Describes a feed by building a category tree</td>
</tr>
<tr>
	<td class="name"><a href="class-FeedsList.php">FeedsList</a></td>
	<td class="ellipsis">This class contains an agregation of differents feeds</td>
</tr>
<tr>
	<td class="name"><a href="class-RSS.php">RSS</a></td>
	<td class="ellipsis"><p>This class could load a feed by its url or by a FeedData element and
export it to the RSS format</p></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-FeedProvider.php">FeedProvider</a></td>
	<td class="ellipsis"></td>
</tr>
	</table>
</div>
