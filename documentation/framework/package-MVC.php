...
<section id="content">
	...
	<article>
		<header><h2>Package MVC</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-MVC.Controller.php">MVC\Controller</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-MVC.Dispatcher.php">MVC\Dispatcher</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-MVC.Model.php">MVC\Model</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-MVC.Response.php">MVC\Response</a></td>
					</tr>
				</table>
			</div>
