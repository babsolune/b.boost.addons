		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-RolesAuthorizations.php" class="cssmenu-title">RolesAuthorizations</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>RolesAuthorizations</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class stores different roles which are authorized for a given action.</p>
			</div>
...
<a href="source-class-RolesAuthorizations.php#29-41" title="Go to source code">build_auth_array</a>( )
							...
							<div class="description short">
								<p>Returns the array authorization formatted at the legacy format in which all authorizations
are on the first bit.</p>
							</div>
...
<a href="source-class-RolesAuthorizations.php#84-94" title="Go to source code">build_from_auth_array</a>( <span>array <var>$auth_array</var></span> )
							...
							<div class="description short">
								<p>Sets the authorizations from the legacy style formatted array.</p>
							</div>
