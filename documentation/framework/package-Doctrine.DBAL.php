...
<section id="content">
	<header>
		<h1>Package <a href="package-Doctrine.php">Doctrine</a>\DBAL</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-Doctrine.php">Doctrine</a>\DBAL</h2></header>
		<div class="content">
			<div class="responsive-table">
				<table class="summary" id="packages">
					<caption>Packages summary</caption>
					<tr>
						<td class="name"><a href="package-Doctrine.DBAL.Plateform.php">Doctrine\DBAL\Plateform</a></td>
					</tr>
					<tr>
						<td class="name"><a href="package-Doctrine.DBAL.Types.php">Doctrine\DBAL\Types</a></td>
					</tr>
				</table>
			</div>
