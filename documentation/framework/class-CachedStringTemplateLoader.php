<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-CachedStringTemplateLoader.php" class="cssmenu-title">CachedStringTemplateLoader</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CachedStringTemplateLoader</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This loader is to use when you load a template whose source is directly a PHP string
and not a file. It supports caching and saves cache files in the /cache/tpl directory, using
a md5 hash to distinguish eache string input.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>CachedStringTemplateLoader</span></b>					
					 implements 
...
<a href="source-class-CachedStringTemplateLoader.php#21-29" title="Go to source code">__construct</a>( <span>string <var>$content</var></span> )
							...
							<div class="description short">
								<p>Constructs a <code><a href="class-CachedStringTemplateLoader.php">CachedStringTemplateLoader</a></code> from the source string.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Constructs a <code><a href="class-CachedStringTemplateLoader.php">CachedStringTemplateLoader</a></code> from the source string.</p>
								...
								<div class="list"><dl>
									...
									<dd>The template's source as a string.</dd>
								</dl></div>
...
<a href="source-class-CachedStringTemplateLoader.php#80-86" title="Go to source code">supports_caching</a>( )
							...
							<div class="description short">
								<p>Tells whether the loader supports caching. If it supports it, its <code><a href="class-CachedStringTemplateLoader.php#_get_cache_file_path">CachedStringTemplateLoader::get_cache_file_path()</a></code>
 will have to return a non-empty value.</p>
							</div>

						<div class="description detailed hidden">
							<p>Tells whether the loader supports caching. If it supports it, its <code><a href="class-CachedStringTemplateLoader.php#_get_cache_file_path">CachedStringTemplateLoader::get_cache_file_path()</a></code> will have to return a non-empty value.</p>
...
This method must be called only if the loader supports caching, the <code><a href="class-CachedStringTemplateLoader.php#_supports_caching">CachedStringTemplateLoader::supports_caching()</a></code>
