<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractHTMLElement.php" class="cssmenu-title">AbstractHTMLElement</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractHTMLElement</h2></header>
		<div class="content">
...
<b><span>AbstractHTMLElement</span></b>					
					 implements 
		...
		<div class="content">
			...
			<tr data-order="has_css_style" id="_has_css_style">
...
<a href="source-class-AbstractHTMLElement.php#20-23" title="Go to source code">has_css_style</a>( )
			...
			<tr data-order="get_css_style" id="_get_css_style">
...
<a href="source-class-AbstractHTMLElement.php#25-28" title="Go to source code">get_css_style</a>( )
			...
			<tr data-order="set_css_style" id="_set_css_style">
...
<a href="source-class-AbstractHTMLElement.php#30-33" title="Go to source code">set_css_style</a>( <span> <var>$style</var></span> )
			...
			<tr data-order="add_css_style" id="_add_css_style">
...
<a href="source-class-AbstractHTMLElement.php#50-53" title="Go to source code">set_css_class</a>( <span> <var>$class</var></span> )
			...
			<tr data-order="add_css_class" id="_add_css_class">
...
<a href="source-class-AbstractHTMLElement.php#75" title="Go to source code">display</a>( )
			...
			<tr data-order="css_style" id="$css_style">
				<td class="attributes">
					<code>
						protected  
						string
				...
				<td class="value">
					<div>
						<a href="#$css_style" class="anchor">#</a>
						<code><span class="php-quote">''</span></code>
					</div>
				</td>
			</tr>
