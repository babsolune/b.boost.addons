<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FeedProvider.php" class="cssmenu-title">FeedProvider</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FeedProvider</h2></header>
		<div class="content">
...
<a href="source-class-FeedProvider.php#17" title="Go to source code">get_feeds_list</a>( )
			...
			<tr data-order="get_feed_data_struct" id="_get_feed_data_struct">
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'feeds'</span></code>
							</div>
						</td>
					</tr>
				</table>
