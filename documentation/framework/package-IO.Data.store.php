...
<section id="content">
	<header>
		<h1>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Data.php">Data</a>\store</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-IO.php">IO</a>\<a href="package-IO.Data.php">Data</a>\store</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-APCDataStore.php">APCDataStore</a></td>
	<td class="ellipsis"><p>This data store is not already available, the APC PHP extension must be enabled for you yo use it.
...
This is very efficient and has an infinite life span (in fact it's the Web server's one).</p></td>
</tr>
<tr>
	<td class="name"><a href="class-DataStoreFactory.php">DataStoreFactory</a></td>
	<td class="ellipsis">This factory returns you the data store that are the best for your requirements.</td>
</tr>
<tr>
	<td class="name"><a href="class-FileSystemDataStore.php">FileSystemDataStore</a></td>
	<td class="ellipsis"><p>This data store is not very efficient but is the only one which has an infinite life span
when APC is not available.
It stores data in the /cache folder.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-RAMDataStore.php">RAMDataStore</a></td>
	<td class="ellipsis"><p>This is a very efficient data store, but its principal weakness is that it's life span
...
<tr>
	<td class="name"><a href="class-DataStore.php">DataStore</a></td>
	<td class="ellipsis"><p>This interface represents a data store. Its different implementations store data in
...
identifier must be a string with only letters and digits.</p></td>
</tr>
	</table>
</div>
...
<tr>
	<td class="name"><a href="class-DataStoreException.php">DataStoreException</a></td>
