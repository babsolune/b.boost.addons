<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DefaultModuleSetup.php" class="cssmenu-title">DefaultModuleSetup</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DefaultModuleSetup</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Module.php">Module</a></span>
						...
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 2.0 - 2009 01 16
						</span>
					<span class="infos-options"><b>Located at:</b> <a href="source-class-DefaultModuleSetup.php#3-46" title="Go to source code">phpboost/module/DefaultModuleSetup.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>DefaultModuleSetup</span></b>					
					 implements 
						<a href="class-ModuleSetup.php"><span>ModuleSetup</span></a>
		...
		<div class="content">
			...
			<tr data-order="check_environment" id="_check_environment">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-ValidationResult.php">ValidationResult</a></code>
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultModuleSetup.php#18-21" title="Go to source code">check_environment</a>( )
						</code>

							<div class="description short">
								<p>Returns a validation result containing environment errors</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns a validation result containing environment errors</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-ValidationResult.php">ValidationResult</a></code><br>a validation result containing environment errors
								</div>
								...
								<div class="list"><code><a href="class-ModuleSetup.php#_check_environment">ModuleSetup::check_environment()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="install" id="_install">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultModuleSetup.php#26-29" title="Go to source code">install</a>( )
						</code>
						...
						<div class="description detailed hidden">
							<p>Install the module</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ModuleSetup.php#_install">ModuleSetup::install()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="uninstall" id="_uninstall">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultModuleSetup.php#34-37" title="Go to source code">uninstall</a>( )
						</code>

							<div class="description short">
								<p>Uninstall the module</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Uninstall the module</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>error if module uninstall failled
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ModuleSetup.php#_uninstall">ModuleSetup::uninstall()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="upgrade" id="_upgrade">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DefaultModuleSetup.php#42-45" title="Go to source code">upgrade</a>( <span> <var>$installed_version</var></span> )
						</code>

							<div class="description short">
								<p>Upgrade the module</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Upgrade the module</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ModuleSetup.php#_upgrade">ModuleSetup::upgrade()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
