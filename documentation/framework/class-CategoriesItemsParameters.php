		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CategoriesItemsParameters.php" class="cssmenu-title">CategoriesItemsParameters</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CategoriesItemsParameters</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class allows you to inquire the table that stores the items and the database field that contains the ID of the category in which it is located</p>
			</div>
		...
		<div class="content">
			...
			<tr data-order="set_table_name_contains_items" id="_set_table_name_contains_items">
...
<a href="source-class-CategoriesItemsParameters.php#22-25" title="Go to source code">set_table_name_contains_items</a>( <span> <var>$table_name</var></span> )
			...
			<tr data-order="get_table_name_contains_items" id="_get_table_name_contains_items">
...
<a href="source-class-CategoriesItemsParameters.php#27-30" title="Go to source code">get_table_name_contains_items</a>( )
			...
			<tr data-order="set_field_name_id_category" id="_set_field_name_id_category">
...
<a href="source-class-CategoriesItemsParameters.php#32-35" title="Go to source code">set_field_name_id_category</a>( <span> <var>$field_name</var></span> )
			...
			<tr data-order="get_field_name_id_category" id="_get_field_name_id_category">
...
<a href="source-class-CategoriesItemsParameters.php#37-40" title="Go to source code">get_field_name_id_category</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="DEFAULT_FIELD_NAME" id="DEFAULT_FIELD_NAME">
						...
						<td class="value">
							<div>
								<a href="#DEFAULT_FIELD_NAME" class="anchor">#</a>
								<code><span class="php-quote">'id_category'</span></code>
							</div>
						</td>
					</tr>
				</table>
