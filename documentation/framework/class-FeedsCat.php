		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FeedsCat.php" class="cssmenu-title">FeedsCat</a></li>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>Describes a feed by building a category tree</p>
			</div>
						...
						<div class="description detailed hidden">
							<p>Builds a FeedsCat Object</p>
								...
								<div class="list"><dl>
									...
									<dd>the feed module id</dd>
									<dt><var>$category_id</var></dt>
									<dd>the category id</dd>
									<dt><var>$category_name</var></dt>
...
<a href="source-class-FeedsCat.php#34-43" title="Go to source code">get_url</a>( <span>string <var>$feed_type</var> = <span class="php-quote">''</span></span> )
						...
						<div class="description detailed hidden">
							<p>Returns the feed url</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$feed_type</var></dt>
									<dd>The feed type</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>the feed url
								</div>
...
<a href="source-class-FeedsCat.php#45-52" title="Go to source code">get_module_id</a>( )
			...
			<tr data-order="get_category_id" id="_get_category_id">
...
<a href="source-class-FeedsCat.php#55-62" title="Go to source code">get_category_id</a>( )
			...
			<tr data-order="get_category_name" id="_get_category_name">
...
<a href="source-class-FeedsCat.php#64-71" title="Go to source code">get_category_name</a>( )
			...
			<tr data-order="add_child" id="_add_child">
...
<a href="source-class-FeedsCat.php#73-80" title="Go to source code">add_child</a>( <span><code><a href="class-FeedsCat.php">FeedsCat</a></code> <var>$child</var></span> )
							...
							<div class="description short">
								<p>Adds a FeedsCat child to the current FeedsCat object</p>
							</div>
			...
			<tr data-order="get_children" id="_get_children">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-FeedsCat.php">FeedsCat</a>[]</code>
...
<a href="source-class-FeedsCat.php#82-89" title="Go to source code">get_children</a>( )
							...
							<div class="description short">
								<p>Returns the current category children</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the current category children</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-FeedsCat.php">FeedsCat</a>[]</code><br>The current category children
								</div>
