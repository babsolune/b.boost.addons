		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SQLQueryVars.php" class="cssmenu-title">SQLQueryVars</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SQLQueryVars</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-SQLQueryVars.php#3-52" title="Go to source code">io/db/SQLQueryVars.class.php</a></span>
			</div>

			<div class="description">
				<p>implements the query var replacement method</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-StringVars.php"><span>StringVars</span></a>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-SQLQueryVars.php#21-26" title="Go to source code">__construct</a>( <span><code><a href="class-AbstractSQLQuerier.php">AbstractSQLQuerier</a></code> <var>$querier</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-StringVars.php#___construct">StringVars::__construct()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="set_var" id="_set_var">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-SQLQueryVars.php#28-51" title="Go to source code">set_var</a>( <span> <var>$parameter</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-StringVars.php#_set_var">StringVars::set_var()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-StringVars.php#methods">StringVars</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-StringVars.php#_replace">replace()</a>, 
									<a href="class-StringVars.php#_replace_vars">replace_vars()</a>
							</code>
						</td>
					</tr>
				</table>
