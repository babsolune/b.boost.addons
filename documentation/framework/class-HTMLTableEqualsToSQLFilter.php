		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTMLTableEqualsToSQLFilter.php" class="cssmenu-title">HTMLTableEqualsToSQLFilter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLTableEqualsToSQLFilter</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Table.php">Table</a>\<a href="package-Builder.Table.filter.php">filter</a>\<a href="package-Builder.Table.filter.sql.php">sql</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-HTMLTableEqualsToSQLFilter.php#3-19" title="Go to source code">builder/table/filter/sql/HTMLTableEqualsToSQLFilter.class.php</a></span>
			</div>
			...
			<dl class="tree">
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>HTMLTableEqualsToSQLFilter</span></b>					
			...
			<tr data-order="get_sql_comparator_symbol" id="_get_sql_comparator_symbol">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableEqualsToSQLFilter.php#15-18" title="Go to source code">get_sql_comparator_symbol</a>( )
						</code>
