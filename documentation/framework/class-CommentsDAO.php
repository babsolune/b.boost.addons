		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CommentsDAO.php" class="cssmenu-title">CommentsDAO</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CommentsDAO</h2></header>
		<div class="content">
...
<a href="source-class-CommentsDAO.php#18-22" title="Go to source code">__static</a>( )
			...
			<tr data-order="delete_comments_by_topic" id="_delete_comments_by_topic">
