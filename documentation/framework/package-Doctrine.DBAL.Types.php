...
<section id="content">
	<header>
		<h1>Package <a href="package-Doctrine.php">Doctrine</a>\<a href="package-Doctrine.DBAL.php">DBAL</a>\Types</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-Doctrine.php">Doctrine</a>\<a href="package-Doctrine.DBAL.php">DBAL</a>\Types</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-ArrayType.php">ArrayType</a></td>
	<td class="ellipsis">Type that maps a PHP array to a clob SQL type.</td>
</tr>
<tr>
	<td class="name"><a href="class-BigIntType.php">BigIntType</a></td>
	<td class="ellipsis">Type that maps a database BIGINT to a PHP string.</td>
</tr>
<tr>
	<td class="name"><a href="class-BooleanType.php">BooleanType</a></td>
	<td class="ellipsis">Type that maps an SQL boolean to a PHP boolean.</td>
</tr>
<tr>
	<td class="name"><a href="class-DateTimeType.php">DateTimeType</a></td>
	<td class="ellipsis">Type that maps an SQL DATETIME/TIMESTAMP to a PHP DateTime object.</td>
</tr>
<tr>
	<td class="name"><a href="class-DateType.php">DateType</a></td>
	<td class="ellipsis">Type that maps an SQL DATE to a PHP Date object.</td>
</tr>
<tr>
	<td class="name"><a href="class-DecimalType.php">DecimalType</a></td>
	<td class="ellipsis">Type that maps an SQL DECIMAL to a PHP double.</td>
</tr>
<tr>
	<td class="name"><a href="class-FloatType.php">FloatType</a></td>
	<td class="ellipsis">Type that maps an SQL FLOAT to a PHP double.</td>
</tr>
<tr>
	<td class="name"><a href="class-IntegerType.php">IntegerType</a></td>
	<td class="ellipsis"></td>
</tr>
<tr>
	<td class="name"><a href="class-ObjectType.php">ObjectType</a></td>
	<td class="ellipsis">Type that maps a PHP object to a clob SQL type.</td>
</tr>
<tr>
	<td class="name"><a href="class-SmallIntType.php">SmallIntType</a></td>
	<td class="ellipsis">Type that maps a database SMALLINT to a PHP integer.</td>
</tr>
<tr>
	<td class="name"><a href="class-StringType.php">StringType</a></td>
	<td class="ellipsis">Type that maps an SQL VARCHAR to a PHP string.</td>
</tr>
<tr>
	<td class="name"><a href="class-TextType.php">TextType</a></td>
	<td class="ellipsis">Type that maps an SQL CLOB to a PHP string.</td>
</tr>
<tr>
	<td class="name"><a href="class-TimeType.php">TimeType</a></td>
	<td class="ellipsis">Type that maps an SQL TIME to a PHP DateTime object.</td>
</tr>
<tr>
	<td class="name"><a href="class-Type.php">Type</a></td>
	<td class="ellipsis"><p>The base class for so-called Doctrine mapping types.
A Type object is obtained by calling the static <code><a href="class-Type.php#_getType">Type::getType()</a></code> method.</p></td>
</tr>
	</table>
</div>
