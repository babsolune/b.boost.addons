		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-GroupsCache.php" class="cssmenu-title">GroupsCache</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>GroupsCache</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Cache.php">Cache</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2017 05 28
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2009 09 29
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
			...
			<div class="description">
				<p>This class contains the cache data of the groups which group users having common criteria.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>GroupsCache</span></b>					
					 implements 
...
<a href="source-class-GroupsCache.php#43-50" title="Go to source code">get_groups</a>( )
							...
							<div class="description short">
								<p>Returns the list of the groups</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the list of the groups</p>
								...
								<h6>Returns</h6>
								<div class="list">
									array<br>id_group => group properties (map)
								</div>
			...
			<tr data-order="group_exists" id="_group_exists">
...
<a href="source-class-GroupsCache.php#52-55" title="Go to source code">group_exists</a>( <span> <var>$group_id</var></span> )
			...
			<tr data-order="group_name_exists" id="_group_name_exists">
...
<a href="source-class-GroupsCache.php#57-65" title="Go to source code">group_name_exists</a>( <span> <var>$group_name</var></span> )
			...
			<tr data-order="get_group" id="_get_group">
...
<a href="source-class-GroupsCache.php#67-75" title="Go to source code">get_group</a>( <span> <var>$group_id</var></span> )
						...
						<div class="description detailed hidden">
							<p>Returns a group</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string[]<br>A map of the properties of the group
								</div>
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-GroupsCache.php">GroupsCache</a></code>
...
<a href="source-class-GroupsCache.php#86-93" title="Go to source code">load</a>( )
							...
							<div class="description short">
								<p>Loads and returns the groups cached data.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads and returns the groups cached data.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-GroupsCache.php">GroupsCache</a></code><br>The cached data
								</div>
...
<a href="source-class-GroupsCache.php#95-101" title="Go to source code">invalidate</a>( )
							...
							<div class="description short">
								<p>Invalidates the current groups cached data.</p>
							</div>
