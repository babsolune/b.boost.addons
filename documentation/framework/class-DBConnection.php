<?php require_once('../documentation_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DBConnection.php" class="cssmenu-title">DBConnection</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DBConnection</h2></header>
		<div class="content">
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-MySQLDBConnection.php">MySQLDBConnection</a>, 
					<a href="class-PDODBConnection.php">PDODBConnection</a>
			</div>
