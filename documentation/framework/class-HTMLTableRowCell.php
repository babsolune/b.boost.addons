		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTMLTableRowCell.php" class="cssmenu-title">HTMLTableRowCell</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLTableRowCell</h2></header>
		<div class="content">
...
<b><span>HTMLTableRowCell</span></b>					
...
<a href="source-class-HTMLTableRowCell.php#32-35" title="Go to source code">get_value</a>( )
			...
			<tr data-order="is_multi_column" id="_is_multi_column">
...
<a href="source-class-HTMLTableRowCell.php#37-40" title="Go to source code">is_multi_column</a>( )
			...
			<tr data-order="get_colspan" id="_get_colspan">
...
<a href="source-class-HTMLTableRowCell.php#42-45" title="Go to source code">get_colspan</a>( )
			...
			<tr data-order="set_colspan" id="_set_colspan">
