		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTMLTableEndsWithTextSQLFilter.php" class="cssmenu-title">HTMLTableEndsWithTextSQLFilter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLTableEndsWithTextSQLFilter</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Table.php">Table</a>\<a href="package-Builder.Table.filter.php">filter</a>\<a href="package-Builder.Table.filter.sql.php">sql</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-HTMLTableEndsWithTextSQLFilter.php#3-22" title="Go to source code">builder/table/filter/sql/HTMLTableEndsWithTextSQLFilter.class.php</a></span>
			</div>
			...
			<dl class="tree">
				...
				<dd style="padding-left:120px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>HTMLTableEndsWithTextSQLFilter</span></b>					
			...
			<tr data-order="get_value" id="_get_value">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableEndsWithTextSQLFilter.php#15-21" title="Go to source code">get_value</a>( )
						</code>
