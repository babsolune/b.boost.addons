		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Path.php" class="cssmenu-title">Path</a></li>
...
<section id="content" class="class">
	...
	<article>
		...
		<div class="content">
			...
			<tr data-order="phpboost_path" id="_phpboost_path">
...
<a href="source-class-Path.php#19-30" title="Go to source code">phpboost_path</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>the phpboost home directory path
								</div>
			...
			<tr data-order="get_package" id="_get_package">
...
<a href="source-class-Path.php#32-41" title="Go to source code">get_package</a>( <span>string <var>$class_file</var></span> )
						...
						<div class="description detailed hidden">
							<p>Returns the class package</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$class_file</var></dt>
									<dd>the class file</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br><p>the class package
The package is under the form </code>'package/subpackage/../sub..subpackage'</code></p>
								</div>
			...
			<tr data-order="get_path_from_root" id="_get_path_from_root">
...
<a href="source-class-Path.php#43-56" title="Go to source code">get_path_from_root</a>( <span>string <var>$path</var></span> )
							...
							<div class="description short">
								<p>Returns the path from the phpboost root directory</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the path from the phpboost root directory</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br><p>the path from the phpboost root directory beginning by</p>
...
<pre><span class="php-quote">'/'</span></pre>
			...
			<tr data-order="get_classname" id="_get_classname">
...
<a href="source-class-Path.php#58-75" title="Go to source code">get_classname</a>( <span>string <var>$class_file</var></span> )
							...
							<div class="description short">
								<p>Deduces the classname regarding the filename</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Deduces the classname regarding the filename</p>
								...
								<div class="list"><dl>
									<dt><var>$class_file</var></dt>
									<dd>the class file path or filename</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>the classname
								</div>
			...
			<tr data-order="real_path" id="_real_path">
...
<a href="source-class-Path.php#77-86" title="Go to source code">real_path</a>( <span>string <var>$path</var></span> )
							...
							<div class="description short">
								<p>Uniformizes the path getting its real path (absolute one) and replacing all</p>
...
<pre><span class="php-quote">'/'</span></pre>
								...
								<div class="list"><dl>
									<dt><var>$path</var></dt>
									<dd>the path to uniformize</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>the absolute path
								</div>
			...
			<tr data-order="uniformize_path" id="_uniformize_path">
...
<a href="source-class-Path.php#88-96" title="Go to source code">uniformize_path</a>( <span>string <var>$path</var></span> )
							...
							<div class="description short">
								<p>Uniformizes the path replacing all</p>
...
<pre><span class="php-quote">'/'</span></pre>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>the uniformized path
								</div>
