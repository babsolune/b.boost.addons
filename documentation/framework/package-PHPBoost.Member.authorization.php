...
<section id="content">
	<header>
		<h1>Package <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Member.php">Member</a>\authorization</h1>
	</header>
	<article>
		<header><h2>Package <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Member.php">Member</a>\authorization</h2></header>
		<div class="content">
...
<tr>
	<td class="name"><a href="class-ActionAuthorization.php">ActionAuthorization</a></td>
	<td class="ellipsis"><p>This class represents the authorizations for an action. It's associated to a label,
...
to use. It's recommanded to begin with 1 (2^0 = 1) then 2 (2^1 = 2) then 4 (2^2 = 4) etc...</p></td>
</tr>
<tr>
	<td class="name"><a href="class-Authorizations.php" class="deprecated">Authorizations</a></td>
	<td class="ellipsis">This class contains only static methods, it souldn't be instantiated.</td>
</tr>
<tr>
	<td class="name"><a href="class-AuthorizationsSettings.php">AuthorizationsSettings</a></td>
	<td class="ellipsis"><p>This class manages authorizations settings which deals with all the actions for which you want
to restrict access. You can choose who can access to between the different roles existing in PHPBoost:</p>
...
<p>This class contains a list of <code><a href="class-ActionAuthorization.php">ActionAuthorization</a></code> that correspond to each action with the
associated authorizations.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-MemberDisabledActionAuthorization.php">MemberDisabledActionAuthorization</a></td>
	<td class="ellipsis"><p>This class represents the authorizations for an action. It's associated to a label,
a description, the bit in which flags are saved, and obviously the authorization array which is
encapsulated in the RolesAuthorizations class.
The bit which is used to store the authorization is 2^n where n is the number of the place you want
to use. It's recommanded to begin with 1 (2^0 = 1) then 2 (2^1 = 2) then 4 (2^2 = 4) etc...
In this class the select of Visitor and Member level is not possible.</p></td>
</tr>
<tr>
	<td class="name"><a href="class-RolesAuthorizations.php">RolesAuthorizations</a></td>
	<td class="ellipsis">This class stores different roles which are authorized for a given action.</td>
</tr>
<tr>
	<td class="name"><a href="class-VisitorDisabledActionAuthorization.php">VisitorDisabledActionAuthorization</a></td>
	<td class="ellipsis"><p>This class represents the authorizations for an action. It's associated to a label,
a description, the bit in which flags are saved, and obviously the authorization array which is
encapsulated in the RolesAuthorizations class.
The bit which is used to store the authorization is 2^n where n is the number of the place you want
to use. It's recommanded to begin with 1 (2^0 = 1) then 2 (2^1 = 2) then 4 (2^2 = 4) etc...
In this class the select of Visitor level is not possible.</p></td>
</tr>
	</table>
</div>
