		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-RegexHelper.php" class="cssmenu-title">RegexHelper</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>RegexHelper</h2></header>
		<div class="content">
		...
		<div class="content">
			...
			<tr data-order="set_subregex_multiplicity" id="_set_subregex_multiplicity">
...
<a href="source-class-RegexHelper.php#22-54" title="Go to source code">set_subregex_multiplicity</a>( <span>string <var>$sub_regex</var></span>, <span>integer <var>$multiplicity_option</var></span> )
							...
							<div class="description short">
								<p>Returns the sub-regex with its multiplicity option</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the sub-regex with its multiplicity option</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$sub_regex</var></dt>
									<dd>the sub-regex on which add the multiplicity</dd>
									<dt><var>$multiplicity_option</var></dt>
									<dd>$occurence REGEX_MULTIPLICITY_OPTION</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>the subregex with its multiplicity option
								</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="REGEX_MULTIPLICITY_NOT_USED" id="REGEX_MULTIPLICITY_NOT_USED">
						...
						<td class="value">
							<div>
								<a href="#REGEX_MULTIPLICITY_NOT_USED" class="anchor">#</a>
								<code><span class="php-num">0x01</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="REGEX_MULTIPLICITY_OPTIONNAL" id="REGEX_MULTIPLICITY_OPTIONNAL">
						...
						<td class="value">
							<div>
								<a href="#REGEX_MULTIPLICITY_OPTIONNAL" class="anchor">#</a>
								<code><span class="php-num">0x02</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="REGEX_MULTIPLICITY_REQUIRED" id="REGEX_MULTIPLICITY_REQUIRED">
						...
						<td class="value">
							<div>
								<a href="#REGEX_MULTIPLICITY_REQUIRED" class="anchor">#</a>
								<code><span class="php-num">0x03</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="REGEX_MULTIPLICITY_AT_LEAST_ONE" id="REGEX_MULTIPLICITY_AT_LEAST_ONE">
						...
						<td class="value">
							<div>
								<a href="#REGEX_MULTIPLICITY_AT_LEAST_ONE" class="anchor">#</a>
								<code><span class="php-num">0x04</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="REGEX_MULTIPLICITY_ALL" id="REGEX_MULTIPLICITY_ALL">
						...
						<td class="value">
							<div>
								<a href="#REGEX_MULTIPLICITY_ALL" class="anchor">#</a>
