		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-VisitorDisabledActionAuthorization.php" class="cssmenu-title">VisitorDisabledActionAuthorization</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>VisitorDisabledActionAuthorization</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Member.php">Member</a>\<a href="package-PHPBoost.Member.authorization.php">authorization</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-VisitorDisabledActionAuthorization.php#3-32" title="Go to source code">phpboost/member/authorization/VisitorDisabledActionAuthorization.class.php</a></span>
			</div>
...
In this class the select of Visitor level is not possible.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-ActionAuthorization.php"><span>ActionAuthorization</span></a>
...
<b><span>VisitorDisabledActionAuthorization</span></b>					
...
<a href="source-class-VisitorDisabledActionAuthorization.php#21-31" title="Go to source code">__construct</a>( <span>string <var>$label</var></span>, <span>integer <var>$bit</var></span>, <span>string <var>$description</var> = <span class="php-quote">''</span></span>, <span><code><a href="class-RolesAuthorizations.php">RolesAuthorizations</a></code> <var>$roles</var> = <span class="php-keyword1">null</span></span> )
						...
						<div class="description detailed hidden">
							<p>Builds an ActionAuthorization from its properties</p>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-ActionAuthorization.php#___construct">ActionAuthorization::__construct()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-ActionAuthorization.php#methods">ActionAuthorization</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-ActionAuthorization.php#_build_auth_array">build_auth_array()</a>, 
									<a href="class-ActionAuthorization.php#_build_from_auth_array">build_from_auth_array()</a>, 
									<a href="class-ActionAuthorization.php#_get_bit">get_bit()</a>, 
									<a href="class-ActionAuthorization.php#_get_description">get_description()</a>, 
									<a href="class-ActionAuthorization.php#_get_disabled_ranks">get_disabled_ranks()</a>, 
									<a href="class-ActionAuthorization.php#_get_label">get_label()</a>, 
									<a href="class-ActionAuthorization.php#_get_roles_auths">get_roles_auths()</a>, 
									<a href="class-ActionAuthorization.php#_set_bit">set_bit()</a>, 
									<a href="class-ActionAuthorization.php#_set_description">set_description()</a>, 
									<a href="class-ActionAuthorization.php#_set_disabled_ranks">set_disabled_ranks()</a>, 
									<a href="class-ActionAuthorization.php#_set_label">set_label()</a>, 
									<a href="class-ActionAuthorization.php#_set_roles_auths">set_roles_auths()</a>
							</code>
						</td>
					</tr>
				</table>
