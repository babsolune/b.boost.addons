<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractParser.php" class="cssmenu-title">AbstractParser</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractParser</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class is the basis of all the formatting processings that exist in PHPBoost.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>AbstractParser</span></b>					
					 implements 
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-BBCodeHighlighter.php">BBCodeHighlighter</a>, 
					<a href="class-ContentFormattingParser.php">ContentFormattingParser</a>, 
					<a href="class-ContentFormattingUnparser.php">ContentFormattingUnparser</a>, 
					<a href="class-ContentSecondParser.php">ContentSecondParser</a>, 
					<a href="class-PlainCodeHighlighter.php">PlainCodeHighlighter</a>, 
					<a href="class-TemplateHighlighter.php">TemplateHighlighter</a>
			</div>
...
<a href="source-class-AbstractParser.php#54-60" title="Go to source code">get_content</a>( )
							...
							<div class="description short">
								<p>Returns the content of the parser. If you called a method which parses the content, this content will be parsed.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the content of the parser. If you called a method which parses the content, this content will be parsed.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>The content of the parser.
								</div>
								...
								<div class="list"><code><a href="class-FormattingParser.php#_get_content">FormattingParser::get_content()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractParser.php#62-68" title="Go to source code">set_content</a>( <span>string <var>$content</var></span> )
							...
							<div class="description short">
								<p>Sets the content of the parser. When you will call a parse method, it will deal with this content.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Sets the content of the parser. When you will call a parse method, it will deal with this content.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FormattingParser.php#_set_content">FormattingParser::set_content()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="set_path_to_root" id="_set_path_to_root">
...
<a href="source-class-AbstractParser.php#70-76" title="Go to source code">set_path_to_root</a>( <span>string <var>$path</var></span> )
							...
							<div class="description short">
								<p>Sets the reference path for relative URL</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Sets the reference path for relative URL</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FormattingParser.php#_set_path_to_root">FormattingParser::set_path_to_root()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_path_to_root" id="_get_path_to_root">
...
<a href="source-class-AbstractParser.php#78-84" title="Go to source code">get_path_to_root</a>( )
							...
							<div class="description short">
								<p>Returns the path to root attribute.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the path to root attribute.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FormattingParser.php#_get_path_to_root">FormattingParser::get_path_to_root()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="set_page_path" id="_set_page_path">
...
<a href="source-class-AbstractParser.php#86-92" title="Go to source code">set_page_path</a>( <span>string <var>$page_path</var></span> )
						...
						<div class="description detailed hidden">
							<p>Sets the page path</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FormattingParser.php#_set_page_path">FormattingParser::set_page_path()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_page_path" id="_get_page_path">
...
<a href="source-class-AbstractParser.php#94-100" title="Go to source code">get_page_path</a>( )
						...
						<div class="description detailed hidden">
							<p>Returns the page path</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-FormattingParser.php#_get_page_path">FormattingParser::get_page_path()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="add_module_special_tag" id="_add_module_special_tag">
...
<a href="source-class-AbstractParser.php#102-108" title="Go to source code">add_module_special_tag</a>( <span> <var>$pattern</var></span>, <span> <var>$replacement</var></span> )
			...
			<tr data-order="get_module_special_tags" id="_get_module_special_tags">
...
<a href="source-class-AbstractParser.php#110-116" title="Go to source code">get_module_special_tags</a>( )
			...
			<tr data-order="_parse_imbricated" id="__parse_imbricated">
...
<a href="source-class-AbstractParser.php#118-131" title="Go to source code">_parse_imbricated</a>( <span>string <var>$match</var></span>, <span>string <var>$regex</var></span>, <span>string <var>$replace</var></span> )
						...
						<div class="description detailed hidden">
							<p>Parses a nested tag</p>
								...
								<div class="list"><dl>
									<dt><var>$match</var></dt>
									<dd>The regular expression which matches the tag to replace</dd>
									<dt><var>$regex</var></dt>
									<dd>The regular expression which matches the replacement</dd>
									<dt><var>$replace</var></dt>
									<dd>The replacement syntax.</dd>
								</dl></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-FormattingParser.php#methods">FormattingParser</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-FormattingParser.php#_parse">parse()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="PICK_UP" id="PICK_UP">
						...
						<td class="value">
							<div>
								<a href="#PICK_UP" class="anchor">#</a>
								<code><span class="php-keyword1">true</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="REIMPLANT" id="REIMPLANT">
						...
						<td class="value">
							<div>
								<a href="#REIMPLANT" class="anchor">#</a>
			...
			<tr data-order="array_tags" id="$array_tags">
				<td class="attributes">
					<code>
						protected  
						string[]
				...
				<td class="value">
					<div>
						<a href="#$array_tags" class="anchor">#</a>
						<code><span class="php-keyword1">array</span>()</code>
					</div>
				</td>
			</tr>
			<tr data-order="path_to_root" id="$path_to_root">
				<td class="attributes">
					<code>
						protected  
						string
				...
				<td class="value">
					<div>
						<a href="#$path_to_root" class="anchor">#</a>
						<code>PATH_TO_ROOT</code>
					</div>
				</td>
			</tr>
			<tr data-order="page_path" id="$page_path">
				<td class="attributes">
					<code>
						protected  
						string
				...
				<td class="value">
					<div>
						<a href="#$page_path" class="anchor">#</a>
						<code><span class="php-quote">''</span></code>
					</div>
				</td>
			</tr>
			<tr data-order="module_special_tags" id="$module_special_tags">
				<td class="attributes">
					<code>
						protected  
						string[]
				...
				<td class="value">
					<div>
						<a href="#$module_special_tags" class="anchor">#</a>
						<code><span class="php-keyword1">array</span>()</code>
					</div>
				</td>
			</tr>
