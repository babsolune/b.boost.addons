<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FileReader.php" class="cssmenu-title">FileReader</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FileReader</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Filesystem.php">Filesystem</a>\<a href="package-IO.Filesystem.stream.php">stream</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FileReader.php#3-18" title="Go to source code">io/filesystem/stream/FileReader.class.php</a></span>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-BufferedFileReader.php">BufferedFileReader</a>
			</div>
			...
			<tr data-order="read_all" id="_read_all">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FileReader.php#15" title="Go to source code">read_all</a>( )
						</code>
			...
			<tr data-order="read_line" id="_read_line">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FileReader.php#17" title="Go to source code">read_line</a>( )
						</code>
