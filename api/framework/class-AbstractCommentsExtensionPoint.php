<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractCommentsExtensionPoint.php" class="cssmenu-title">AbstractCommentsExtensionPoint</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractCommentsExtensionPoint</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Comments.php">Comments</a>\<a href="package-Content.Comments.extension.point.php">extension-point</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-AbstractCommentsExtensionPoint.php#3-18" title="Go to source code">content/comments/extension-point/AbstractCommentsExtensionPoint.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>AbstractCommentsExtensionPoint</span></b>					
					 implements 
						<a href="class-CommentsExtensionPoint.php"><span>CommentsExtensionPoint</span></a>
		...
		<div class="content">
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-CommentsExtensionPoint.php#constants">CommentsExtensionPoint</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-CommentsExtensionPoint.php#EXTENSION_POINT"><b>EXTENSION_POINT</b></a>
							</code>
						</td>
					</tr>
				</table>
