		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Session.php" class="cssmenu-title">Session</a></li>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>This class manages all sessions for the users.
Session::gc();
Session::start();</p>
			</div>
...
<a href="source-class-Session.php#83-91" title="Go to source code">delete</a>( <span><code><a href="class-SessionData.php">SessionData</a></code> <var>$session</var></span> )
							...
							<div class="description short">
								<p>Delete the session in database. The current session stays alive for the rest of the
request and a visitor session will be created at the next request.</p>
							</div>
...
request and a visitor session will be created at the next request.</p>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="VISITOR_SESSION_ID" id="VISITOR_SESSION_ID">
						...
						<td class="value">
							<div>
								<a href="#VISITOR_SESSION_ID" class="anchor">#</a>
			...
			<tr data-order="DATA_COOKIE_NAME" id="$DATA_COOKIE_NAME">
				<td class="attributes">
					<code>
						public static 
				...
				<td class="value">
					<div>
						<a href="#$DATA_COOKIE_NAME" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="AUTOCONNECT_COOKIE_NAME" id="$AUTOCONNECT_COOKIE_NAME">
				<td class="attributes">
					<code>
						public static 
				...
				<td class="value">
					<div>
						<a href="#$AUTOCONNECT_COOKIE_NAME" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
