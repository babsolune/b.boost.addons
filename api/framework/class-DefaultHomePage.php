<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DefaultHomePage.php" class="cssmenu-title">DefaultHomePage</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DefaultHomePage</h2></header>
		<div class="content">
...
<b><span>DefaultHomePage</span></b>					
					 implements 
						<a href="class-HomePage.php"><span>HomePage</span></a>
...
<a href="source-class-DefaultHomePage.php#24-27" title="Go to source code">get_title</a>( )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><code><a href="class-HomePage.php#_get_title">HomePage::get_title()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-DefaultHomePage.php#29-32" title="Go to source code">get_view</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-HomePage.php#_get_view">HomePage::get_view()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
