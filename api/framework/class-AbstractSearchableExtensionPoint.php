<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractSearchableExtensionPoint.php" class="cssmenu-title">AbstractSearchableExtensionPoint</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractSearchableExtensionPoint</h2></header>
		<div class="content">
...
<b><span>AbstractSearchableExtensionPoint</span></b>					
					 implements 
						<a href="class-SearchableExtensionPoint.php"><span>SearchableExtensionPoint</span></a>
...
<p>if special search options could be applied to this module</p>
								...
								<div class="list"><code><a href="class-SearchableExtensionPoint.php#_has_search_options">SearchableExtensionPoint::has_search_options()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractSearchableExtensionPoint.php#32-35" title="Go to source code">has_customized_results</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-SearchableExtensionPoint.php#_has_customized_results">SearchableExtensionPoint::has_customized_results()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-SearchableExtensionPoint.php#methods">SearchableExtensionPoint</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-SearchableExtensionPoint.php#_get_search_request">get_search_request()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-SearchableExtensionPoint.php#constants">SearchableExtensionPoint</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-SearchableExtensionPoint.php#EXTENSION_POINT"><b>EXTENSION_POINT</b></a>
							</code>
						</td>
					</tr>
				</table>
