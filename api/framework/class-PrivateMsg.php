		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-PrivateMsg.php" class="cssmenu-title">PrivateMsg</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>PrivateMsg</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class provides methods to manage private message.</p>
			</div>
...
<a href="source-class-PrivateMsg.php#26-29" title="Go to source code">__static</a>( )
			...
			<tr data-order="count_conversations" id="_count_conversations">
...
<a href="source-class-PrivateMsg.php#31-58" title="Go to source code">count_conversations</a>( <span>integer <var>$userid</var></span> )
							...
							<div class="description short">
								<p>Counts the user's number of conversation.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Counts the user's number of conversation.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									integer<br>number of user conversation.
								</div>
			...
			<tr data-order="start_conversation" id="_start_conversation">
...
<a href="source-class-PrivateMsg.php#61-87" title="Go to source code">start_conversation</a>( <span>integer <var>$pm_to</var></span>, <span>string <var>$pm_objet</var></span>, <span>string <var>$pm_contents</var></span>, <span>integer <var>$pm_from</var></span>, <span>boolean <var>$system_pm</var> = <span class="php-keyword1">false</span></span> )
							...
							<div class="description short">
								<p>Starts a conversation with another member.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Starts a conversation with another member.</p>
								...
								<div class="list"><dl>
									<dt><var>$pm_to</var></dt>
									<dd>The member's user id destination.</dd>
									<dt><var>$pm_objet</var></dt>
									<dd>The object of the conversation.</dd>
									<dt><var>$pm_contents</var></dt>
									<dd>The content of the conversation.</dd>
									<dt><var>$pm_from</var></dt>
									<dd>The member's user id author.</dd>
									<dt><var>$system_pm</var></dt>
									<dd>If true, the conversation has been started by the system, and not by the private message interface.</dd>
								</dl></div>
...
<a href="source-class-PrivateMsg.php#89-123" title="Go to source code">send</a>( <span>integer <var>$pm_to</var></span>, <span>integer <var>$pm_idconvers</var></span>, <span>string <var>$pm_contents</var></span>, <span>integer <var>$pm_from</var></span>, <span>integer <var>$pm_status</var></span>, <span>boolean <var>$check_pm_before_send</var> = <span class="php-keyword1">true</span></span> )
						...
						<div class="description detailed hidden">
							<p>Answers to a conversation</p>
								...
								<div class="list"><dl>
									<dt><var>$pm_to</var></dt>
									<dd>The member's user id destination.</dd>
									<dt><var>$pm_idconvers</var></dt>
									<dd></dd>
									<dt><var>$pm_contents</var></dt>
									<dd>The content of the answer.</dd>
									<dt><var>$pm_from</var></dt>
									<dd>The member's user id author.</dd>
									<dt><var>$pm_status</var></dt>
									<dd></dd>
									<dt><var>$check_pm_before_send</var></dt>
									<dd></dd>
								</dl></div>
			...
			<tr data-order="delete_conversation" id="_delete_conversation">
...
<a href="source-class-PrivateMsg.php#125-164" title="Go to source code">delete_conversation</a>( <span>integer <var>$pm_userid</var></span>, <span>integer <var>$pm_idconvers</var></span>, <span>integer <var>$pm_expd</var></span>, <span>boolean <var>$pm_del</var></span>, <span>boolean <var>$pm_update</var></span> )
						...
						<div class="description detailed hidden">
							<p>Deletes a conversation.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$pm_userid</var></dt>
									<dd></dd>
									<dt><var>$pm_idconvers</var></dt>
									<dd></dd>
									<dt><var>$pm_expd</var></dt>
									<dd></dd>
									<dt><var>$pm_del</var></dt>
									<dd></dd>
									<dt><var>$pm_update</var></dt>
									<dd></dd>
								</dl></div>
...
<a href="source-class-PrivateMsg.php#166-193" title="Go to source code">delete</a>( <span>integer <var>$pm_to</var></span>, <span>integer <var>$pm_idmsg</var></span>, <span>integer <var>$pm_idconvers</var></span> )
							...
							<div class="description short">
								<p>Deletes a private message, until the recipient has not read it.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Deletes a private message, until the recipient has not read it.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									integer<br>The previous message id.
								</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="NOCHECK_PM_BOX" id="NOCHECK_PM_BOX">
						...
						<td class="value">
							<div>
								<a href="#NOCHECK_PM_BOX" class="anchor">#</a>
								<code><span class="php-keyword1">false</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="CHECK_PM_BOX" id="CHECK_PM_BOX">
						...
						<td class="value">
							<div>
								<a href="#CHECK_PM_BOX" class="anchor">#</a>
								<code><span class="php-keyword1">true</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="SYSTEM_PM" id="SYSTEM_PM">
						...
						<td class="value">
							<div>
								<a href="#SYSTEM_PM" class="anchor">#</a>
								<code><span class="php-keyword1">true</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="DEL_PM_CONVERS" id="DEL_PM_CONVERS">
						...
						<td class="value">
							<div>
								<a href="#DEL_PM_CONVERS" class="anchor">#</a>
								<code><span class="php-keyword1">true</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="UPDATE_MBR_PM" id="UPDATE_MBR_PM">
						...
						<td class="value">
							<div>
								<a href="#UPDATE_MBR_PM" class="anchor">#</a>
								<code><span class="php-keyword1">false</span></code>
							</div>
						</td>
					</tr>
