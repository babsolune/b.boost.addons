		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CSSFileOptimizer.php" class="cssmenu-title">CSSFileOptimizer</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CSSFileOptimizer</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Optimization.php">Optimization</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 06 14
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2011 03 29
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
...
<a href="source-class-CSSFileOptimizer.php#33-37" title="Go to source code">__construct</a>( )
			...
			<tr data-order="add_file" id="_add_file">
...
<a href="source-class-CSSFileOptimizer.php#39-45" title="Go to source code">add_file</a>( <span> <var>$path_file</var></span> )
							...
							<div class="description short">
								<p>This class allows you to add file to optimize. Required path file</p>
							</div>
			...
			<tr data-order="add_script" id="_add_script">
...
<a href="source-class-CSSFileOptimizer.php#47-56" title="Go to source code">add_script</a>( <span> <var>$script</var></span> )
							...
							<div class="description short">
								<p>This class allows you to add script to optimize. Required script value</p>
							</div>
...
<a href="source-class-CSSFileOptimizer.php#58-80" title="Go to source code">optimize</a>( <span> <var>$intensity</var> = self::HIGH_OPTIMIZATION</span> )
							...
							<div class="description short">
								<p>This class optimize your code. Parameter $intensity serves to configuration highlest</p>
							</div>
...
<a href="source-class-CSSFileOptimizer.php#82-85" title="Go to source code">export</a>( )
			...
			<tr data-order="export_to_file" id="_export_to_file">
...
<a href="source-class-CSSFileOptimizer.php#87-103" title="Go to source code">export_to_file</a>( <span> <var>$location</var></span> )
							...
							<div class="description short">
								<p>Exports optimized content to a file.</p>
							</div>
...
<a href="source-class-CSSFileOptimizer.php#105-111" title="Go to source code">get_files</a>( )
							...
							<div class="description short">
								<p>This class return Array files</p>
							</div>
			...
			<tr data-order="get_scripts" id="_get_scripts">
...
<a href="source-class-CSSFileOptimizer.php#113-119" title="Go to source code">get_scripts</a>( )
							...
							<div class="description short">
								<p>This class return Array scripts</p>
							</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="HIGH_OPTIMIZATION" id="HIGH_OPTIMIZATION">
						...
						<td class="name">
							...
							<div class="description short">
								<p>Const Delete comments, tabulations, spaces and newline</p>
							</div>
						...
						<td class="value">
							<div>
								<a href="#HIGH_OPTIMIZATION" class="anchor">#</a>
								<code><span class="php-quote">'high'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="LOW_OPTIMIZATION" id="LOW_OPTIMIZATION">
						...
						<td class="name">
							...
							<div class="description short">
								<p>Const Delete comments, tabulations and spaces</p>
							</div>
						...
						<td class="value">
							<div>
								<a href="#LOW_OPTIMIZATION" class="anchor">#</a>
								<code><span class="php-quote">'low'</span></code>
							</div>
						</td>
					</tr>
				</table>
			...
			<tr data-order="regex_search_files_path" id="$regex_search_files_path">
				<td class="attributes">
					<code>
						protected  
						string
				...
				<td class="value">
					<div>
						<a href="#$regex_search_files_path" class="anchor">#</a>
						<code><span class="php-quote">''</span></code>
					</div>
				</td>
			</tr>
			<tr data-order="replace_value_files_path" id="$replace_value_files_path">
				<td class="attributes">
					<code>
						protected  
						string
				...
				<td class="value">
					<div>
						<a href="#$replace_value_files_path" class="anchor">#</a>
						<code><span class="php-quote">''</span></code>
					</div>
				</td>
			</tr>
