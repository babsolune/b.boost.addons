		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-PDOQuerier.php" class="cssmenu-title">PDOQuerier</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>PDOQuerier</h2></header>
		<div class="content">
			...
			<div class="responsive-table">
				<table class="summary inherited">
					...
					<tr>
						<td>
							<code>
									<a href="class-AbstractSQLQuerier.php#___construct">__construct()</a>, 
