<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ContentFormattingProvidersService.php" class="cssmenu-title">ContentFormattingProvidersService</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ContentFormattingProvidersService</h2></header>
		<div class="content">
...
<a href="source-class-ContentFormattingProvidersService.php#20-27" title="Go to source code">get_editor</a>( <span> <var>$id</var></span> )
			...
			<tr data-order="get_editors" id="_get_editors">
