		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-UrlControllerMapper.php" class="cssmenu-title">UrlControllerMapper</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>UrlControllerMapper</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-MVC.php">MVC</a>\<a href="package-MVC.Dispatcher.php">Dispatcher</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-UrlControllerMapper.php#3-72" title="Go to source code">mvc/dispatcher/UrlControllerMapper.class.php</a></span>
			</div>

			<div class="description">
				<p>Call the controller method matching an url</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractUrlMapper.php"><span>AbstractUrlMapper</span></a>
					
					 implements 
						<a href="class-UrlMapper.php"><span>UrlMapper</span></a>
					
					
				</dd>
				<dd style="padding-left:30px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>UrlControllerMapper</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-UrlControllerMapper.php#20-33" title="Go to source code">__construct</a>( <span>string <var>$classname</var></span>, <span>string <var>$capture_regex</var> = <span class="php-quote">'`^/?$`u'</span></span>, <span>string <var>$parameters_names</var> = <span class="php-keyword1">array</span>()</span> )
						</code>

							<div class="description short">
								<p>build a new UrlDispatcherItem</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>build a new UrlDispatcherItem</p>
								...
								<div class="list"><dl>
									...
									<dd>$classpath the controller classname</dd>
									<dt><var>$capture_regex</var></dt>
									<dd><p>the regular expression matching the url
and capturing the controller method parameters. By default, match the empty url</p>

<pre>/</pre></dd>
									<dt><var>$parameters_names</var></dt>
									<dd>the names of the parameters in the capture order</dd>
								</dl></div>


								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-NoSuchControllerException.php">NoSuchControllerException</a></code>
								</div>


								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractUrlMapper.php#___construct">AbstractUrlMapper::__construct()</a></code></div>
			...
			<tr data-order="call" id="_call">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-UrlControllerMapper.php#35-42" title="Go to source code">call</a>( )
						</code>

							<div class="description short">
								<p>Call the controller method if the url match and if the method exists</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Call the controller method if the url match and if the method exists</p>
								...
								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-NoUrlMatchException.php">NoUrlMatchException</a></code><br>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractUrlMapper.php#methods">AbstractUrlMapper</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractUrlMapper.php#_get_captured_parameters">get_captured_parameters()</a>, 
									<a href="class-AbstractUrlMapper.php#_match">match()</a>
							</code>
						</td>
					</tr>
				</table>
