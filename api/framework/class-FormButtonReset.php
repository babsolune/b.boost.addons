		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormButtonReset.php" class="cssmenu-title">FormButtonReset</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormButtonReset</h2></header>
		<div class="content">
