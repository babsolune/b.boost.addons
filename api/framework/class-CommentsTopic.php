		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CommentsTopic.php" class="cssmenu-title">CommentsTopic</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CommentsTopic</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Comments.php">Comments</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 08 16
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<div class="description">
				<p>This class represents the comments topic</p>
...
<a href="source-class-CommentsTopic.php#31-37" title="Go to source code">get_authorizations</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									class<br>CommentsAuthorizations
								</div>
...
<a href="source-class-CommentsTopic.php#47-53" title="Go to source code">get_number_comments_display</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									integer<br>number comments display default
								</div>
			...
			<tr data-order="get_events" id="_get_events">
...
<a href="source-class-CommentsTopic.php#93-96" title="Go to source code">get_url</a>( )
			...
			<tr data-order="get_path" id="_get_path">
...
<a href="source-class-CommentsTopic.php#98-101" title="Go to source code">get_path</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="DEFAULT_TOPIC_IDENTIFIER" id="DEFAULT_TOPIC_IDENTIFIER">
						...
						<td class="value">
							<div>
								<a href="#DEFAULT_TOPIC_IDENTIFIER" class="anchor">#</a>
