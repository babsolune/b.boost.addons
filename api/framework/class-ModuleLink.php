		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ModuleLink.php" class="cssmenu-title">ModuleLink</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ModuleLink</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Module.php">Module</a>\<a href="package-PHPBoost.Module.tree.links.php">tree-links</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2017 05 30
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-AdminModuleLink.php">AdminModuleLink</a>
			</div>
...
<a href="source-class-ModuleLink.php#47-50" title="Go to source code">get_url</a>( )
			...
			<tr data-order="add_sub_link" id="_add_sub_link">
...
<a href="source-class-ModuleLink.php#52-55" title="Go to source code">add_sub_link</a>( <span><code><a href="class-ModuleLink.php">ModuleLink</a></code> <var>$sub_link</var></span> )
			...
			<tr data-order="get_sub_link" id="_get_sub_link">
...
<a href="source-class-ModuleLink.php#57-60" title="Go to source code">get_sub_link</a>( )
			...
			<tr data-order="has_sub_link" id="_has_sub_link">
...
<a href="source-class-ModuleLink.php#62-65" title="Go to source code">has_sub_link</a>( )
			...
			<tr data-order="set_visibility" id="_set_visibility">
...
<a href="source-class-ModuleLink.php#67-70" title="Go to source code">set_visibility</a>( <span> <var>$visibility</var></span> )
			...
			<tr data-order="is_visible" id="_is_visible">
...
<a href="source-class-ModuleLink.php#82-105" title="Go to source code">export</a>( )
			...
			<tr data-order="sub_link" id="$sub_link">
				<td class="attributes">
					<code>
						protected  
						array
				...
				<td class="value">
					<div>
						<a href="#$sub_link" class="anchor">#</a>
						<code><span class="php-keyword1">array</span>()</code>
					</div>
				</td>
			</tr>
			<tr data-order="visibility" id="$visibility">
				<td class="attributes">
					<code>
						protected  
						boolean
				...
				<td class="value">
					<div>
						<a href="#$visibility" class="anchor">#</a>
