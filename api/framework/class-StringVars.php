		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-StringVars.php" class="cssmenu-title">StringVars</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>StringVars</h2></header>
		<div class="content">
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-SQLQueryVars.php">SQLQueryVars</a>
			</div>
		...
		<div class="content">
			...
			<tr data-order="replace_vars" id="_replace_vars">
