<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AjaxKeywordsAutoCompleteController.php" class="cssmenu-title">AjaxKeywordsAutoCompleteController</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AjaxKeywordsAutoCompleteController</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Keyword.php">Keyword</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 07 07
						</span>
						<span class="infos-options">
							<b>Since:</b>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-AjaxKeywordsAutoCompleteController.php#3-33" title="Go to source code">content/keyword/AjaxKeywordsAutoCompleteController.class.php</a></span>
			</div>
...
<b><span>AjaxKeywordsAutoCompleteController</span></b>					
			...
			<tr data-order="execute" id="_execute">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AjaxKeywordsAutoCompleteController.php#16-32" title="Go to source code">execute</a>( <span><code><a href="class-HTTPRequestCustom.php">HTTPRequestCustom</a></code> <var>$request</var></span> )
						</code>
