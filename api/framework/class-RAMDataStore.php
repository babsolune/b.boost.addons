		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-RAMDataStore.php" class="cssmenu-title">RAMDataStore</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>RAMDataStore</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This is a very efficient data store, but its principal weakness is that it's life span
...
the page execution.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>RAMDataStore</span></b>					
					 implements 
