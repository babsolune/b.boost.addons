		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ExtensionPointProviderService.php" class="cssmenu-title">ExtensionPointProviderService</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ExtensionPointProviderService</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class is a ExtensionPointProvider factory providing some services like
mass operations (on several modules at the same time) or identifications
methods to get all ExtensionPointProvider that provide a given extension point</p>
			</div>
...
<a href="source-class-ExtensionPointProviderService.php#27-37" title="Go to source code">__construct</a>( )
							...
							<div class="description short">
								<p>Builds a new ExtensionPointProvider factory</p>
							</div>
			...
			<tr data-order="get_extension_point" id="_get_extension_point">
...
<a href="source-class-ExtensionPointProviderService.php#39-55" title="Go to source code">get_extension_point</a>( <span>string <var>$extension_point</var></span>, <span>string[] <var>$authorized_providers_ids</var> = <span class="php-keyword1">null</span></span> )
							...
							<div class="description short">
								<p>Returns all extension point</p>

<pre><span class="php-var">$extension_point</span></pre>

<p>registered implementations</p>
							</div>
...
<p>registered implementations</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$extension_point</var></dt>
									<dd>the requested extension point</dd>
									<dt><var>$authorized_providers_ids</var></dt>
									<dd><p>the extension point providers that are allowed
to provide the extension point. If not specified, all providers are allowed</p></dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									Object[string]<br>the requested extension point implementations
								</div>
			...
			<tr data-order="get_providers" id="_get_providers">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-ExtensionPointProvider.php">ExtensionPointProvider</a>[]</code>
...
<a href="source-class-ExtensionPointProviderService.php#57-82" title="Go to source code">get_providers</a>( <span>string <var>$extension_point</var></span>, <span><code><a href="class-ExtensionPointProvider.php">ExtensionPointProvider</a>[]</code> <var>$authorized_providers_ids</var> = <span class="php-keyword1">null</span></span> )
							...
							<div class="description short">
								<p>Returns the ExtensionPointProvider list.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the ExtensionPointProvider list.</p>
								...
								<div class="list"><dl>
									<dt><var>$extension_point</var></dt>
									<dd><p>the extension point name. By default, returns
all availables modules interfaces.</p></dd>
									<dt><var>$authorized_providers_ids</var></dt>
									<dd><p>$providersList If specified, only keep modules
interfaces having the requested extension point. Else, search in all
availables modules interfaces.</p></dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-ExtensionPointProvider.php">ExtensionPointProvider</a>[]</code><br>the ExtensionPointProvider list.
								</div>
			...
			<tr data-order="get_provider" id="_get_provider">
...
<a href="source-class-ExtensionPointProviderService.php#84-102" title="Go to source code">get_provider</a>( <span>string <var>$provider_id</var></span> )
							...
							<div class="description short">
								<p>Returns the ExtensionPointProvider of the provider which id is $provider_id.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the ExtensionPointProvider of the provider which id is $provider_id.</p>
								...
								<div class="list"><dl>
									...
									<dd>The provider id.</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-ExtensionPointProvider.php">ExtensionPointProvider</a></code><br>The corresponding ExtensionPointProvider.
								</div>

								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-UnexistingExtensionPointProviderException.php">UnexistingExtensionPointProviderException</a></code>
								</div>
			...
			<tr data-order="provider_exists" id="_provider_exists">
...
<a href="source-class-ExtensionPointProviderService.php#104-134" title="Go to source code">provider_exists</a>( <span>string <var>$provider_id</var></span>, <span>mixed <var>$extensions_points</var> = <span class="php-keyword1">null</span></span> )
							...
							<div class="description short">
								<p>Returns true if the provider exists and has all the requested extensions points.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns true if the provider exists and has all the requested extensions points.</p>
								...
								<div class="list"><dl>
									<dt><var>$provider_id</var></dt>
									<dd>the provider id</dd>
									<dt><var>$extensions_points</var></dt>
									<dd><p>$extension_points the extension point list that the provider must provides.</p>

<ul>
    <li>If <pre><span class="php-keyword1">null</span></pre>, nothing will be checked.</li>
    ...
    <li>If it's an array, it will check that all given extensions points are provided by the provider.</li>
								...
								<h6>Returns</h6>
								<div class="list">
									boolean<br>true if the provider exists
								</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="EXTENSION_POINT_PROVIDER_SUFFIX" id="EXTENSION_POINT_PROVIDER_SUFFIX">
						...
						<td class="value">
							<div>
								<a href="#EXTENSION_POINT_PROVIDER_SUFFIX" class="anchor">#</a>
								<code><span class="php-quote">'ExtensionPointProvider'</span></code>
							</div>
						</td>
					</tr>
				</table>
