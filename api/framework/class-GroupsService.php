<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-GroupsService.php" class="cssmenu-title">GroupsService</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>GroupsService</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Member.php">Member</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 12 18
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 1.6 - 2007 05 18
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
...
<a href="source-class-GroupsService.php#25-28" title="Go to source code">__static</a>( )
			...
			<tr data-order="add_member" id="_add_member">
...
<a href="source-class-GroupsService.php#30-67" title="Go to source code">add_member</a>( <span>integer <var>$user_id</var></span>, <span>integer <var>$idgroup</var></span> )
						...
						<div class="description detailed hidden">
							<p>Adds a member in a group</p>
								...
								<div class="list"><dl>
									...
									<dd>User id</dd>
									<dt><var>$idgroup</var></dt>
									<dd>Group id</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									boolean<br>True if the member has been succefully added.
								</div>
			...
			<tr data-order="edit_member" id="_edit_member">
...
<a href="source-class-GroupsService.php#69-99" title="Go to source code">edit_member</a>( <span>integer <var>$user_id</var></span>, <span>array <var>$array_user_groups</var></span> )
							...
							<div class="description short">
								<p>Edits the user groups, compute difference between previous and new groups.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Edits the user groups, compute difference between previous and new groups.</p>
								...
								<div class="list"><dl>
									<dt><var>$user_id</var></dt>
									<dd>The user id</dd>
									<dt><var>$array_user_groups</var></dt>
									<dd>The new array of groups.</dd>
								</dl></div>
			...
			<tr data-order="get_groups_names" id="_get_groups_names">
...
<a href="source-class-GroupsService.php#101-118" title="Go to source code">get_groups_names</a>( )
							...
							<div class="description short">
								<p>Returns the list of the names of the groups, array: id => name</p>
							</div>
...
<a href="source-class-GroupsService.php#120-133" title="Go to source code">get_groups</a>( )
			...
			<tr data-order="remove_member" id="_remove_member">
...
<a href="source-class-GroupsService.php#135-166" title="Go to source code">remove_member</a>( <span>integer <var>$user_id</var></span>, <span>integer <var>$idgroup</var></span> )
							...
							<div class="description short">
								<p>Removes a member in a group.</p>
							</div>
