		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-GeneralConfig.php" class="cssmenu-title">GeneralConfig</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>GeneralConfig</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Config.php">Config</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 09 26
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2010 07 05
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
...
<b><span>GeneralConfig</span></b>					
		...
		<div class="content">
			...
			<tr data-order="get_site_url" id="_get_site_url">
...
<a href="source-class-GeneralConfig.php#28-31" title="Go to source code">get_site_url</a>( )
			...
			<tr data-order="get_complete_site_url" id="_get_complete_site_url">
...
<a href="source-class-GeneralConfig.php#33-36" title="Go to source code">get_complete_site_url</a>( )
			...
			<tr data-order="is_site_url_https" id="_is_site_url_https">
...
<a href="source-class-GeneralConfig.php#38-41" title="Go to source code">is_site_url_https</a>( )
			...
			<tr data-order="set_site_url" id="_set_site_url">
...
<a href="source-class-GeneralConfig.php#43-49" title="Go to source code">set_site_url</a>( <span>string <var>$url</var></span> )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><dl>
									<dt><var>$url</var></dt>
									<dd>The URL must begin with a protocol (for instance http://) and must not end with a slash.</dd>
								</dl></div>
			...
			<tr data-order="get_site_path" id="_get_site_path">
...
<a href="source-class-GeneralConfig.php#51-54" title="Go to source code">get_site_path</a>( )
			...
			<tr data-order="set_site_path" id="_set_site_path">
...
<a href="source-class-GeneralConfig.php#56-62" title="Go to source code">set_site_path</a>( <span>string <var>$path</var></span> )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><dl>
									<dt><var>$path</var></dt>
									<dd>$url The URL must begin with a slash but must not end with a slash.</dd>
								</dl></div>
			...
			<tr data-order="get_phpboost_major_version" id="_get_phpboost_major_version">
...
<a href="source-class-GeneralConfig.php#64-67" title="Go to source code">get_phpboost_major_version</a>( )
			...
			<tr data-order="set_phpboost_major_version" id="_set_phpboost_major_version">
...
<a href="source-class-GeneralConfig.php#69-72" title="Go to source code">set_phpboost_major_version</a>( <span> <var>$version</var></span> )
			...
			<tr data-order="get_site_install_date" id="_get_site_install_date">
...
<a href="source-class-GeneralConfig.php#74-80" title="Go to source code">get_site_install_date</a>( )
			...
			<tr data-order="set_site_install_date" id="_set_site_install_date">
...
<a href="source-class-GeneralConfig.php#82-85" title="Go to source code">set_site_install_date</a>( <span><code><a href="class-Date.php">Date</a></code> <var>$date</var></span> )
			...
			<tr data-order="get_site_timezone" id="_get_site_timezone">
...
<a href="source-class-GeneralConfig.php#87-90" title="Go to source code">get_site_timezone</a>( )
			...
			<tr data-order="set_site_timezone" id="_set_site_timezone">
...
<a href="source-class-GeneralConfig.php#97-117" title="Go to source code">get_default_values</a>( )
			...
			<tr data-order="get_default_site_url" id="_get_default_site_url">
...
<a href="source-class-GeneralConfig.php#119-122" title="Go to source code">get_default_site_url</a>( )
			...
			<tr data-order="get_default_site_path" id="_get_default_site_path">
...
<a href="source-class-GeneralConfig.php#124-132" title="Go to source code">get_default_site_path</a>( )
			...
			<tr data-order="get_site_name" id="_get_site_name">
...
<a href="source-class-GeneralConfig.php#151-154" title="Go to source code">get_site_name</a>( )
			...
			<tr data-order="set_site_name" id="_set_site_name">
...
<a href="source-class-GeneralConfig.php#156-159" title="Go to source code">set_site_name</a>( <span> <var>$site_name</var></span> )
			...
			<tr data-order="get_site_slogan" id="_get_site_slogan">
...
<a href="source-class-GeneralConfig.php#161-164" title="Go to source code">get_site_slogan</a>( )
			...
			<tr data-order="set_site_slogan" id="_set_site_slogan">
...
<a href="source-class-GeneralConfig.php#166-169" title="Go to source code">set_site_slogan</a>( <span> <var>$site_slogan</var></span> )
			...
			<tr data-order="get_site_description" id="_get_site_description">
...
<a href="source-class-GeneralConfig.php#171-174" title="Go to source code">get_site_description</a>( )
			...
			<tr data-order="set_site_description" id="_set_site_description">
...
<a href="source-class-GeneralConfig.php#176-179" title="Go to source code">set_site_description</a>( <span> <var>$site_description</var></span> )
			...
			<tr data-order="get_module_home_page" id="_get_module_home_page">
...
<a href="source-class-GeneralConfig.php#181-184" title="Go to source code">get_module_home_page</a>( )
			...
			<tr data-order="set_module_home_page" id="_set_module_home_page">
...
<a href="source-class-GeneralConfig.php#186-189" title="Go to source code">set_module_home_page</a>( <span> <var>$start_page</var></span> )
			...
			<tr data-order="get_other_home_page" id="_get_other_home_page">
...
<a href="source-class-GeneralConfig.php#191-194" title="Go to source code">get_other_home_page</a>( )
			...
			<tr data-order="set_other_home_page" id="_set_other_home_page">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-GeneralConfig.php">GeneralConfig</a></code>
...
<a href="source-class-GeneralConfig.php#210-216" title="Go to source code">save</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="SITE_URL" id="SITE_URL">
						...
						<td class="value">
							<div>
								<a href="#SITE_URL" class="anchor">#</a>
								<code><span class="php-quote">'site_url'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="SITE_PATH" id="SITE_PATH">
						...
						<td class="value">
							<div>
								<a href="#SITE_PATH" class="anchor">#</a>
								<code><span class="php-quote">'site_path'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="SITE_NAME" id="SITE_NAME">
						...
						<td class="value">
							<div>
								<a href="#SITE_NAME" class="anchor">#</a>
								<code><span class="php-quote">'site_name'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="SITE_SLOGAN" id="SITE_SLOGAN">
						...
						<td class="value">
							<div>
								<a href="#SITE_SLOGAN" class="anchor">#</a>
								<code><span class="php-quote">'site_slogan'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="SITE_DESCRIPTION" id="SITE_DESCRIPTION">
						...
						<td class="value">
							<div>
								<a href="#SITE_DESCRIPTION" class="anchor">#</a>
								<code><span class="php-quote">'site_description'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="MODULE_HOME_PAGE" id="MODULE_HOME_PAGE">
						...
						<td class="value">
							<div>
								<a href="#MODULE_HOME_PAGE" class="anchor">#</a>
								<code><span class="php-quote">'module_home_page'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="OTHER_HOME_PAGE" id="OTHER_HOME_PAGE">
						...
						<td class="value">
							<div>
								<a href="#OTHER_HOME_PAGE" class="anchor">#</a>
								<code><span class="php-quote">'other_home_page'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PHPBOOST_VERSION" id="PHPBOOST_VERSION">
						...
						<td class="value">
							<div>
								<a href="#PHPBOOST_VERSION" class="anchor">#</a>
								<code><span class="php-quote">'phpboost_version'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="SITE_INSTALL_DATE" id="SITE_INSTALL_DATE">
						...
						<td class="value">
							<div>
								<a href="#SITE_INSTALL_DATE" class="anchor">#</a>
								<code><span class="php-quote">'site_install_date'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="SITE_TIMEZONE" id="SITE_TIMEZONE">
						...
						<td class="value">
							<div>
								<a href="#SITE_TIMEZONE" class="anchor">#</a>
								<code><span class="php-quote">'timezone'</span></code>
							</div>
						</td>
					</tr>
				</table>
