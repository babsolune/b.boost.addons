		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FileSystemDataStore.php" class="cssmenu-title">FileSystemDataStore</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FileSystemDataStore</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This data store is not very efficient but is the only one which has an infinite life span
when APC is not available.
It stores data in the /cache folder.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>FileSystemDataStore</span></b>					
					 implements 
						<a href="class-DataStore.php"><span>DataStore</span></a>
...
<a href="source-class-FileSystemDataStore.php#31-41" title="Go to source code">get</a>( <span>string <var>$id</var></span> )
							...
							<div class="description short">
								<p>Returns the data stored in the $id key.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the data stored in the $id key.</p>
								...
								<div class="list"><dl>
									<dt><var>$id</var></dt>
									<dd>The key (must be a string with only letters and digits)</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									mixed<br>The data that is stored
								</div>

								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-DataStoreException.php">DataStoreException</a></code><br>If data cannot be found.
								</div>



								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DataStore.php#_get">DataStore::get()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-FileSystemDataStore.php#51-57" title="Go to source code">contains</a>( <span>string <var>$id</var></span> )
							...
							<div class="description short">
								<p>Tells whether the container contains the data at the key $id.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Tells whether the container contains the data at the key $id.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									boolean<br>true if the container contains it, false otherwise
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DataStore.php#_contains">DataStore::contains()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-FileSystemDataStore.php#59-72" title="Go to source code">store</a>( <span>string <var>$id</var></span>, <span>mixed <var>$data</var></span> )
						...
						<div class="description detailed hidden">
							<p>Stores data.</p>
								...
								<div class="list"><dl>
									<dt><var>$id</var></dt>
									<dd>The key corresponding to what you store.</dd>
									<dt><var>$data</var></dt>
									<dd>$object The data you want to store</dd>
								</dl></div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DataStore.php#_store">DataStore::store()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-FileSystemDataStore.php#74-86" title="Go to source code">delete</a>( <span>string <var>$id</var></span> )
							...
							<div class="description short">
								<p>Deletes the data you had stored.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Deletes the data you had stored.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DataStore.php#_delete">DataStore::delete()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-FileSystemDataStore.php#88-99" title="Go to source code">clear</a>( )
						...
						<div class="description detailed hidden">
							<p>Clears all data</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DataStore.php#_clear">DataStore::clear()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
