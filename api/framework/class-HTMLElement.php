<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-HTMLElement.php" class="cssmenu-title">HTMLElement</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLElement</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 01 19
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2009 12 21
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
			...
			<div class="description">
				<p>This class allows you to manage easily html elements.</p>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractHTMLElement.php">AbstractHTMLElement</a>, 
					<a href="class-FormElement.php">FormElement</a>, 
					<a href="class-HTMLForm.php">HTMLForm</a>
			</div>

			<div>
				<h6>Indirect known implementers</h6>
					<a href="class-AbstractFormButton.php">AbstractFormButton</a>, 
					<a href="class-AbstractFormField.php">AbstractFormField</a>, 
					<a href="class-FormButtonButtonCssImg.php">FormButtonButtonCssImg</a>, 
					<a href="class-FormButtonDefaultSubmit.php">FormButtonDefaultSubmit</a>, 
					<a href="class-FormButtonLink.php">FormButtonLink</a>, 
					<a href="class-FormButtonLinkCssImg.php">FormButtonLinkCssImg</a>, 
					<a href="class-FormButtonReset.php">FormButtonReset</a>, 
					<a href="class-FormButtonSubmit.php">FormButtonSubmit</a>, 
					<a href="class-FormButtonSubmitCssImg.php">FormButtonSubmitCssImg</a>, 
					<a href="class-FormButtonSubmitImg.php">FormButtonSubmitImg</a>, 
					<a href="class-FormField.php">FormField</a>, 
					...
					<a href="class-AbstractFormFieldset.php">AbstractFormFieldset</a>, 
					...
					<a href="class-BrHTMLElement.php">BrHTMLElement</a>, 
					...
					<a href="class-DivHTMLElement.php">DivHTMLElement</a>, 
					...
					<a href="class-FormFieldset.php">FormFieldset</a>, 
					<a href="class-FormButton.php">FormButton</a>, 
					...
					<a href="class-FormButtonAjax.php">FormButtonAjax</a>, 
					...
					<a href="class-HTMLTable.php">HTMLTable</a>, 
					<a href="class-HTMLTableColumn.php">HTMLTableColumn</a>, 
					<a href="class-HTMLTableRow.php">HTMLTableRow</a>, 
					<a href="class-HTMLTableRowCell.php">HTMLTableRowCell</a>, 
					<a href="class-ImgHTMLElement.php">ImgHTMLElement</a>, 
					<a href="class-FormButtonAjaxCssImg.php">FormButtonAjaxCssImg</a>, 
					<a href="class-LinkHTMLElement.php">LinkHTMLElement</a>, 
					<a href="class-SpanHTMLElement.php">SpanHTMLElement</a>, 
					<a href="class-FormButtonButton.php">FormButtonButton</a>
			</div>
