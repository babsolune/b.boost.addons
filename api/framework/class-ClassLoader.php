		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ClassLoader.php" class="cssmenu-title">ClassLoader</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ClassLoader</h2></header>
		<div class="content">
		...
		<div class="content">
			...
			<tr data-order="init_autoload" id="_init_autoload">
...
<a href="source-class-ClassLoader.php#26-36" title="Go to source code">init_autoload</a>( )
							...
							<div class="description short">
								<p>initializes the autoload class list</p>
							</div>
...
<a href="source-class-ClassLoader.php#38-53" title="Go to source code">autoload</a>( <span>string <var>$classname</var></span> )
							...
							<div class="description short">
								<p>tries to autoload the given</p>

<pre><span class="php-var">$classname</span></pre>

<p>else, a fatal error is raised</p>
							</div>
...
<p>else, a fatal error is raised</p>
								...
								<div class="list"><dl>
									...
									<dd>the name of the class to load</dd>
								</dl></div>
			...
			<tr data-order="is_class_registered_and_valid" id="_is_class_registered_and_valid">
...
<a href="source-class-ClassLoader.php#55-70" title="Go to source code">is_class_registered_and_valid</a>( <span> <var>$classname</var></span> )
			...
			<tr data-order="generate_classlist" id="_generate_classlist">
...
<a href="source-class-ClassLoader.php#72-98" title="Go to source code">generate_classlist</a>( )
							...
							<div class="description short">
								<p>Generates the autoload cache file by exploring phpboost folders</p>
							</div>
