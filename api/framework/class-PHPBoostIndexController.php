<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-PHPBoostIndexController.php" class="cssmenu-title">PHPBoostIndexController</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>PHPBoostIndexController</h2></header>
		<div class="content">
...
<b><span>PHPBoostIndexController</span></b>					
