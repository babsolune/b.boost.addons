<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-TemplateRenderer.php" class="cssmenu-title">TemplateRenderer</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>TemplateRenderer</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>Represents a template renderer as its names shows. Its able to get the result of the template
interpration from a TemplateLoader which gives it the template source and a TemplateData which
contains the data to assign in the template.</p>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-DefaultTemplateRenderer.php">DefaultTemplateRenderer</a>
			</div>
