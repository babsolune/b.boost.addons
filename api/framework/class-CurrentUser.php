<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-CurrentUser.php" class="cssmenu-title">CurrentUser</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CurrentUser</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.User.php">User</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 11 22
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2012 03 31
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
			...
			<div class="description">
				<p>This class represente the current user</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-User.php"><span>User</span></a>
...
<a href="source-class-CurrentUser.php#26-49" title="Go to source code">__construct</a>( <span><code><a href="class-SessionData.php">SessionData</a></code> <var>$session</var></span> )
			...
			<tr data-order="build_groups" id="_build_groups">
...
<a href="source-class-CurrentUser.php#51-62" title="Go to source code">build_groups</a>( <span><code><a href="class-SessionData.php">SessionData</a></code> <var>$session</var></span> )
			...
			<tr data-order="check_level" id="_check_level">
...
<a href="source-class-CurrentUser.php#69-85" title="Go to source code">check_auth</a>( <span> <var>$array_auth_groups</var></span>, <span> <var>$authorization_bit</var></span> )
			...
			<tr data-order="check_max_value" id="_check_max_value">
...
<a href="source-class-CurrentUser.php#87-110" title="Go to source code">check_max_value</a>( <span> <var>$key_auth</var></span>, <span> <var>$max_value_compare</var> = <span class="php-num">0</span></span> )
			...
			<tr data-order="update_theme" id="_update_theme">
...
<a href="source-class-CurrentUser.php#112-130" title="Go to source code">update_theme</a>( <span>string <var>$theme</var></span> )
							...
							<div class="description short">
								<p>Modify the theme for guest in the database (sessions table).</p>
							</div>
			...
			<tr data-order="update_lang" id="_update_lang">
...
<a href="source-class-CurrentUser.php#132-150" title="Go to source code">update_lang</a>( <span>string <var>$lang</var></span> )
							...
							<div class="description short">
								<p>Modify the lang for guest in the database (sessions table).</p>
							</div>
			...
			<tr data-order="update_visitor_display_name" id="_update_visitor_display_name">
...
<a href="source-class-CurrentUser.php#152-156" title="Go to source code">update_visitor_display_name</a>( )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-User.php#methods">User</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-User.php#_get_delay_banned">get_delay_banned()</a>, 
									<a href="class-User.php#_get_delay_readonly">get_delay_readonly()</a>, 
									<a href="class-User.php#_get_display_name">get_display_name()</a>, 
									<a href="class-User.php#_get_editor">get_editor()</a>, 
									<a href="class-User.php#_get_email">get_email()</a>, 
									<a href="class-User.php#_get_group_color">get_group_color()</a>, 
									<a href="class-User.php#_get_groups">get_groups()</a>, 
									<a href="class-User.php#_get_id">get_id()</a>, 
									<a href="class-User.php#_get_level">get_level()</a>, 
									<a href="class-User.php#_get_locale">get_locale()</a>, 
									<a href="class-User.php#_get_show_email">get_show_email()</a>, 
									<a href="class-User.php#_get_theme">get_theme()</a>, 
									<a href="class-User.php#_get_timezone">get_timezone()</a>, 
									<a href="class-User.php#_get_unread_pm">get_unread_pm()</a>, 
									<a href="class-User.php#_get_visitor_properties">get_visitor_properties()</a>, 
									<a href="class-User.php#_get_warning_percentage">get_warning_percentage()</a>, 
									<a href="class-User.php#_init_robot_user">init_robot_user()</a>, 
									<a href="class-User.php#_init_visitor_user">init_visitor_user()</a>, 
									<a href="class-User.php#_is_admin">is_admin()</a>, 
									<a href="class-User.php#_is_banned">is_banned()</a>, 
									<a href="class-User.php#_is_guest">is_guest()</a>, 
									<a href="class-User.php#_is_moderator">is_moderator()</a>, 
									<a href="class-User.php#_is_readonly">is_readonly()</a>, 
									<a href="class-User.php#_is_robot">is_robot()</a>, 
									<a href="class-User.php#_set_delay_banned">set_delay_banned()</a>, 
									<a href="class-User.php#_set_delay_readonly">set_delay_readonly()</a>, 
									<a href="class-User.php#_set_display_name">set_display_name()</a>, 
									<a href="class-User.php#_set_editor">set_editor()</a>, 
									<a href="class-User.php#_set_email">set_email()</a>, 
									<a href="class-User.php#_set_groups">set_groups()</a>, 
									<a href="class-User.php#_set_id">set_id()</a>, 
									<a href="class-User.php#_set_level">set_level()</a>, 
									<a href="class-User.php#_set_locale">set_locale()</a>, 
									<a href="class-User.php#_set_properties">set_properties()</a>, 
									<a href="class-User.php#_set_show_email">set_show_email()</a>, 
									<a href="class-User.php#_set_theme">set_theme()</a>, 
									<a href="class-User.php#_set_timezone">set_timezone()</a>, 
									<a href="class-User.php#_set_unread_pm">set_unread_pm()</a>, 
									<a href="class-User.php#_set_warning_percentage">set_warning_percentage()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-User.php#constants">User</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-User.php#ADMIN_LEVEL"><b>ADMIN_LEVEL</b></a>, 
									<a href="class-User.php#MEMBER_LEVEL"><b>MEMBER_LEVEL</b></a>, 
									<a href="class-User.php#MODERATOR_LEVEL"><b>MODERATOR_LEVEL</b></a>, 
									<a href="class-User.php#ROBOT_LEVEL"><b>ROBOT_LEVEL</b></a>, 
									<a href="class-User.php#VISITOR_LEVEL"><b>VISITOR_LEVEL</b></a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-User.php#properties">User</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-User.php#$delay_banned"><var>$delay_banned</var></a>, 
									<a href="class-User.php#$delay_readonly"><var>$delay_readonly</var></a>, 
									<a href="class-User.php#$display_name"><var>$display_name</var></a>, 
									<a href="class-User.php#$editor"><var>$editor</var></a>, 
									<a href="class-User.php#$email"><var>$email</var></a>, 
									<a href="class-User.php#$groups"><var>$groups</var></a>, 
									<a href="class-User.php#$id"><var>$id</var></a>, 
									<a href="class-User.php#$level"><var>$level</var></a>, 
									<a href="class-User.php#$locale"><var>$locale</var></a>, 
									<a href="class-User.php#$show_email"><var>$show_email</var></a>, 
									<a href="class-User.php#$theme"><var>$theme</var></a>, 
									<a href="class-User.php#$timezone"><var>$timezone</var></a>, 
									<a href="class-User.php#$unread_pm"><var>$unread_pm</var></a>, 
									<a href="class-User.php#$warning_percentage"><var>$warning_percentage</var></a>
							</code>
						</td>
					</tr>
				</table>
