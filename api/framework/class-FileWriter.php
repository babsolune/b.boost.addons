		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FileWriter.php" class="cssmenu-title">FileWriter</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FileWriter</h2></header>
		<div class="content">
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-BufferedFileWriter.php">BufferedFileWriter</a>
			</div>
