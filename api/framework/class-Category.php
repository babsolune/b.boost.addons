		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Category.php" class="cssmenu-title">Category</a></li>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Category.php">Category</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2016 10 30
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-RichCategory.php">RichCategory</a>, 
					<a href="class-RootCategory.php">RootCategory</a>
			</div>
...
<a href="source-class-Category.php#50-53" title="Go to source code">set_name</a>( <span> <var>$name</var></span> )
			...
			<tr data-order="get_rewrited_name" id="_get_rewrited_name">
...
<a href="source-class-Category.php#55-58" title="Go to source code">get_rewrited_name</a>( )
			...
			<tr data-order="set_rewrited_name" id="_set_rewrited_name">
...
<a href="source-class-Category.php#60-63" title="Go to source code">set_rewrited_name</a>( <span> <var>$rewrited_name</var></span> )
			...
			<tr data-order="rewrited_name_is_personalized" id="_rewrited_name_is_personalized">
...
<a href="source-class-Category.php#65-68" title="Go to source code">rewrited_name_is_personalized</a>( )
			...
			<tr data-order="get_order" id="_get_order">
...
<a href="source-class-Category.php#70-73" title="Go to source code">get_order</a>( )
			...
			<tr data-order="set_order" id="_set_order">
...
<a href="source-class-Category.php#75-78" title="Go to source code">set_order</a>( <span> <var>$order</var></span> )
			...
			<tr data-order="incremente_order" id="_incremente_order">
...
<a href="source-class-Category.php#80-83" title="Go to source code">incremente_order</a>( )
			...
			<tr data-order="has_special_authorizations" id="_has_special_authorizations">
...
<a href="source-class-Category.php#85-88" title="Go to source code">has_special_authorizations</a>( )
			...
			<tr data-order="set_special_authorizations" id="_set_special_authorizations">
...
<a href="source-class-Category.php#100-103" title="Go to source code">set_authorizations</a>( <span>array <var>$auth</var></span> )
			...
			<tr data-order="auth_is_empty" id="_auth_is_empty">
...
<a href="source-class-Category.php#105-108" title="Go to source code">auth_is_empty</a>( )
			...
			<tr data-order="auth_is_equals" id="_auth_is_equals">
...
<a href="source-class-Category.php#110-113" title="Go to source code">auth_is_equals</a>( <span>array <var>$auth</var></span> )
			...
			<tr data-order="get_id_parent" id="_get_id_parent">
...
<a href="source-class-Category.php#115-118" title="Go to source code">get_id_parent</a>( )
			...
			<tr data-order="set_id_parent" id="_set_id_parent">
...
<a href="source-class-Category.php#120-123" title="Go to source code">set_id_parent</a>( <span> <var>$id_parent</var></span> )
			...
			<tr data-order="get_elements_number" id="_get_elements_number">
...
<a href="source-class-Category.php#125-128" title="Go to source code">get_elements_number</a>( )
			...
			<tr data-order="set_elements_number" id="_set_elements_number">
...
<a href="source-class-Category.php#130-133" title="Go to source code">set_elements_number</a>( <span> <var>$elements_number</var></span> )
			...
			<tr data-order="is_allowed_to_have_childs" id="_is_allowed_to_have_childs">
...
<a href="source-class-Category.php#169-185" title="Go to source code">create_categories_table</a>( <span> <var>$table_name</var></span> )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="READ_AUTHORIZATIONS" id="READ_AUTHORIZATIONS">
						...
						<td class="value">
							<div>
								<a href="#READ_AUTHORIZATIONS" class="anchor">#</a>
								<code><span class="php-num">1</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="WRITE_AUTHORIZATIONS" id="WRITE_AUTHORIZATIONS">
						...
						<td class="value">
							<div>
								<a href="#WRITE_AUTHORIZATIONS" class="anchor">#</a>
								<code><span class="php-num">2</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="CONTRIBUTION_AUTHORIZATIONS" id="CONTRIBUTION_AUTHORIZATIONS">
						...
						<td class="value">
							<div>
								<a href="#CONTRIBUTION_AUTHORIZATIONS" class="anchor">#</a>
								<code><span class="php-num">4</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="MODERATION_AUTHORIZATIONS" id="MODERATION_AUTHORIZATIONS">
						...
						<td class="value">
							<div>
								<a href="#MODERATION_AUTHORIZATIONS" class="anchor">#</a>
								<code><span class="php-num">8</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="CATEGORIES_MANAGEMENT_AUTHORIZATIONS" id="CATEGORIES_MANAGEMENT_AUTHORIZATIONS">
						...
						<td class="value">
							<div>
								<a href="#CATEGORIES_MANAGEMENT_AUTHORIZATIONS" class="anchor">#</a>
								<code><span class="php-num">16</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="ROOT_CATEGORY" id="ROOT_CATEGORY">
						...
						<td class="value">
							<div>
								<a href="#ROOT_CATEGORY" class="anchor">#</a>
			...
			<tr data-order="rewrited_name" id="$rewrited_name">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$rewrited_name" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="order" id="$order">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$order" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="special_authorizations" id="$special_authorizations">
				<td class="attributes">
					<code>
						protected  
						boolean
				...
				<td class="value">
					<div>
						<a href="#$special_authorizations" class="anchor">#</a>
			...
			<tr data-order="id_parent" id="$id_parent">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$id_parent" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="elements_number" id="$elements_number">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$elements_number" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="allowed_to_have_childs" id="$allowed_to_have_childs">
				<td class="attributes">
					<code>
						protected  
						boolean
				...
				<td class="value">
					<div>
						<a href="#$allowed_to_have_childs" class="anchor">#</a>
