<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-SearchableExtensionPoint.php" class="cssmenu-title">SearchableExtensionPoint</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SearchableExtensionPoint</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Search.php">Search</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-SearchableExtensionPoint.php#3-35" title="Go to source code">content/search/SearchableExtensionPoint.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>SearchableExtensionPoint</span></b>					
					 implements 
		...
		<div class="content">
			...
			<tr data-order="get_search_request" id="_get_search_request">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_get_search_request">#</a>
						<code>
<a href="source-class-SearchableExtensionPoint.php#17" title="Go to source code">get_search_request</a>( <span> <var>$args</var></span> )
						</code>
			...
			<tr data-order="has_search_options" id="_has_search_options">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-SearchableExtensionPoint.php#19-23" title="Go to source code">has_search_options</a>( )
						</code>
...
<p>if special search options could be applied to this module</p>
							</div>
...
<p>if special search options could be applied to this module</p>
			...
			<tr data-order="has_customized_results" id="_has_customized_results">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-SearchableExtensionPoint.php#25" title="Go to source code">has_customized_results</a>( )
						</code>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="name">
							<code>
								<a href="source-class-SearchableExtensionPoint.php#15" title="Go to source code"><b>EXTENSION_POINT</b></a>
							</code>
