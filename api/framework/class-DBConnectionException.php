<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DBConnectionException.php" class="cssmenu-title">DBConnectionException</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DBConnectionException</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-DBConnectionException.php#3-13" title="Go to source code">io/db/DBConnectionException.class.php</a></span>
			</div>
...
<b><span>DBConnectionException</span></b>					
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-MySQLDBConnectionException.php">MySQLDBConnectionException</a>, 
					<a href="class-PDODBConnectionException.php">PDODBConnectionException</a>, 
					<a href="class-UnexistingDatabaseException.php">UnexistingDatabaseException</a>
			</div>

			<div>
				<h6>Indirect known subclasses</h6>
					<a href="class-MySQLUnexistingDatabaseException.php">MySQLUnexistingDatabaseException</a>
			</div>
