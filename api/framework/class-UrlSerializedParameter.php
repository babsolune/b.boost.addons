		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-UrlSerializedParameter.php" class="cssmenu-title">UrlSerializedParameter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>UrlSerializedParameter</h2></header>
		<div class="content">
...
<a href="source-class-UrlSerializedParameter.php#27-30" title="Go to source code">get_parameters</a>( )
			...
			<tr data-order="set_parameters" id="_set_parameters">
