<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FormFieldConstraint.php" class="cssmenu-title">FormFieldConstraint</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormFieldConstraint</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a>\<a href="package-Builder.Form.field.php">field</a>\<a href="package-Builder.Form.field.constraint.php">constraint</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormFieldConstraint.php#3-25" title="Go to source code">builder/form/field/constraint/FormFieldConstraint.class.php</a></span>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractFormFieldConstraint.php">AbstractFormFieldConstraint</a>
			</div>

			<div>
				<h6>Indirect known implementers</h6>
					<a href="class-FormFieldConstraintAntiFlood.php">FormFieldConstraintAntiFlood</a>, 
					<a href="class-FormFieldConstraintDate.php">FormFieldConstraintDate</a>, 
					<a href="class-FormFieldConstraintMailAddress.php">FormFieldConstraintMailAddress</a>, 
					<a href="class-FormFieldConstraintMailExist.php">FormFieldConstraintMailExist</a>, 
					<a href="class-FormFieldConstraintMaxLinks.php">FormFieldConstraintMaxLinks</a>, 
					<a href="class-FormFieldConstraintNotEmpty.php">FormFieldConstraintNotEmpty</a>, 
					<a href="class-FormFieldConstraintPasswordStrength.php">FormFieldConstraintPasswordStrength</a>, 
					<a href="class-FormFieldConstraintPHPBoostAuthLoginExists.php">FormFieldConstraintPHPBoostAuthLoginExists</a>, 
					<a href="class-FormFieldConstraintPictureFile.php">FormFieldConstraintPictureFile</a>, 
					<a href="class-FormFieldConstraintRegex.php">FormFieldConstraintRegex</a>, 
					<a href="class-FormFieldConstraintTel.php">FormFieldConstraintTel</a>, 
					<a href="class-FormFieldConstraintUrl.php">FormFieldConstraintUrl</a>, 
					<a href="class-FormFieldConstraintDisplayNameExists.php">FormFieldConstraintDisplayNameExists</a>, 
					<a href="class-FormFieldConstraintUrlExists.php">FormFieldConstraintUrlExists</a>, 
					<a href="class-FormFieldConstraintUserExist.php">FormFieldConstraintUserExist</a>, 
					<a href="class-FormFieldConstraintFileExtension.php">FormFieldConstraintFileExtension</a>, 
					<a href="class-FormFieldConstraintIntegerMax.php">FormFieldConstraintIntegerMax</a>, 
					<a href="class-FormFieldConstraintIntegerMin.php">FormFieldConstraintIntegerMin</a>, 
					<a href="class-FormFieldConstraintIntegerRange.php">FormFieldConstraintIntegerRange</a>, 
					<a href="class-FormFieldConstraintLengthMax.php">FormFieldConstraintLengthMax</a>, 
					<a href="class-FormFieldConstraintLengthMin.php">FormFieldConstraintLengthMin</a>, 
					<a href="class-FormFieldConstraintLengthRange.php">FormFieldConstraintLengthRange</a>
			</div>
			...
			<tr data-order="validate" id="_validate">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldConstraint.php#18" title="Go to source code">validate</a>( <span><code><a href="class-FormField.php">FormField</a></code> <var>$field</var></span> )
						</code>
			...
			<tr data-order="get_js_validation" id="_get_js_validation">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldConstraint.php#20" title="Go to source code">get_js_validation</a>( <span><code><a href="class-FormField.php">FormField</a></code> <var>$field</var></span> )
						</code>
			...
			<tr data-order="get_validation_error_message" id="_get_validation_error_message">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldConstraint.php#22" title="Go to source code">get_validation_error_message</a>( )
						</code>
			...
			<tr data-order="set_validation_error_message" id="_set_validation_error_message">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldConstraint.php#24" title="Go to source code">set_validation_error_message</a>( <span> <var>$error_message</var></span> )
						</code>
