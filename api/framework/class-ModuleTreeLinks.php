		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ModuleTreeLinks.php" class="cssmenu-title">ModuleTreeLinks</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ModuleTreeLinks</h2></header>
		<div class="content">
...
<a href="source-class-ModuleTreeLinks.php#22-25" title="Go to source code">get_links</a>( )
			...
			<tr data-order="has_links" id="_has_links">
...
<a href="source-class-ModuleTreeLinks.php#27-30" title="Go to source code">has_links</a>( )
			...
			<tr data-order="has_visible_links" id="_has_visible_links">
