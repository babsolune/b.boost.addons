		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ExternalAuthenticationsExtensionPoint.php" class="cssmenu-title">ExternalAuthenticationsExtensionPoint</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ExternalAuthenticationsExtensionPoint</h2></header>
		<div class="content">
...
<b><span>ExternalAuthenticationsExtensionPoint</span></b>					
					 implements 
...
<a href="source-class-ExternalAuthenticationsExtensionPoint.php#19-25" title="Go to source code">__construct</a>( <span>array <var>$external_authentications</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$external_authentications</var></dt>
									<dd>a table with instances of the class ExternalAuthentication</dd>
								</dl></div>
			...
			<tr data-order="get_external_authentications" id="_get_external_authentications">
...
<a href="source-class-ExternalAuthenticationsExtensionPoint.php#27-33" title="Go to source code">get_external_authentications</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									array<br>Contains a table with instances of the class ExternalAuthentication
								</div>
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'external_authentications'</span></code>
							</div>
						</td>
					</tr>
				</table>
			...
			<tr data-order="external_authentications" id="$external_authentications">
				<td class="attributes">
					<code>
						protected  
						array
				...
				<td class="value">
					<div>
						<a href="#$external_authentications" class="anchor">#</a>
