<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FormBuilderDisabledFieldException.php" class="cssmenu-title">FormBuilderDisabledFieldException</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormBuilderDisabledFieldException</h2></header>
		<div class="content">
...
<span>Throwable</span>
				...
				<dd style="padding-left:30px">
					...
					<a href="class-FormBuilderException.php"><span>FormBuilderException</span></a>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>FormBuilderDisabledFieldException</span></b>					
...
<a href="source-class-FormBuilderDisabledFieldException.php#18-22" title="Go to source code">__construct</a>( <span> <var>$field</var></span>, <span> <var>$value</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-FormBuilderException.php#___construct">FormBuilderException::__construct()</a></code></div>
