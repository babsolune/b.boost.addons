		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ContentSecondParser.php" class="cssmenu-title">ContentSecondParser</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ContentSecondParser</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Formatting.php">Formatting</a>\<a href="package-Content.Formatting.parser.php">parser</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 12 06
						</span>
						<span class="infos-options">
							<b>Since:</b>
			...
			<div class="description">
				<p>This class ensures the real time processing of the content. The major part of the processing is saved in the database to minimize as much as possible the treatment
...
The content you put in that parser must come from a ContentFormattingParser class (BBCodeParser or TinyMCEParser) (it can have been saved in a database between the first parsing and the real time parsing).</p>
			</div>
...
<b><span>ContentSecondParser</span></b>					
...
<a href="source-class-ContentSecondParser.php#30-36" title="Go to source code">__construct</a>( )
							...
							<div class="description short">
								<p>Builds a ContentSecondParser object</p>
							</div>
...
<a href="source-class-ContentSecondParser.php#38-82" title="Go to source code">parse</a>( )
							...
							<div class="description short">
								<p>Parses the content of the parser. The result will be ready to be displayed.</p>
							</div>
			...
			<tr data-order="export_html_text" id="_export_html_text">
...
<a href="source-class-ContentSecondParser.php#84-107" title="Go to source code">export_html_text</a>( <span>string <var>$html_content</var></span> )
							...
							<div class="description short">
								<p>Transforms a PHPBoost HTML content to make it exportable and usable every where in the web.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Transforms a PHPBoost HTML content to make it exportable and usable every where in the web.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$html_content</var></dt>
									<dd>$html Content to transform</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>The exportable content
								</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="MAX_CODE_LENGTH" id="MAX_CODE_LENGTH">
						...
						<td class="name">
							...
							<div class="description short">
								<p>Maximal number of characters that can be inserted in the [code] tag. After that, GeSHi has many difficulties to highligth and has the PHP execution stop (error 500).</p>
							</div>
						...
						<td class="value">
							<div>
								<a href="#MAX_CODE_LENGTH" class="anchor">#</a>
								<code><span class="php-num">40000</span></code>
							</div>
						</td>
					</tr>
				</table>
