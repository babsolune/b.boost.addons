		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTMLTableDateComparatorSQLFilter.php" class="cssmenu-title">HTMLTableDateComparatorSQLFilter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTMLTableDateComparatorSQLFilter</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Table.php">Table</a>\<a href="package-Builder.Table.filter.php">filter</a>\<a href="package-Builder.Table.filter.sql.php">sql</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-HTMLTableDateComparatorSQLFilter.php#3-64" title="Go to source code">builder/table/filter/sql/HTMLTableDateComparatorSQLFilter.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractHTMLTableFilter.php"><span>AbstractHTMLTableFilter</span></a>
					
					 implements 
						<a href="class-HTMLTableFilter.php"><span>HTMLTableFilter</span></a>
					
					
				</dd>
				<dd style="padding-left:30px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>HTMLTableDateComparatorSQLFilter</span></b>					
					 implements 
						<a href="class-SQLFragmentBuilder.php"><span>SQLFragmentBuilder</span></a>
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-HTMLTableDateGreaterThanOrEqualsToSQLFilter.php">HTMLTableDateGreaterThanOrEqualsToSQLFilter</a>, 
					<a href="class-HTMLTableDateLessThanOrEqualsToSQLFilter.php">HTMLTableDateLessThanOrEqualsToSQLFilter</a>, 
					<a href="class-HTMLTableDateTimeGreaterThanOrEqualsToSQLFilter.php">HTMLTableDateTimeGreaterThanOrEqualsToSQLFilter</a>, 
					<a href="class-HTMLTableDateTimeLessThanOrEqualsToSQLFilter.php">HTMLTableDateTimeLessThanOrEqualsToSQLFilter</a>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableDateComparatorSQLFilter.php#19-25" title="Go to source code">__construct</a>( <span> <var>$db_field</var></span>, <span> <var>$name</var></span>, <span> <var>$label</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractHTMLTableFilter.php#___construct">AbstractHTMLTableFilter::__construct()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_sql" id="_get_sql">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-SQLFragment.php">SQLFragment</a></code>
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableDateComparatorSQLFilter.php#27-36" title="Go to source code">get_sql</a>( )
						</code>
						...
						<div class="description detailed hidden">
								...
								<div class="list"><code><a href="class-SQLFragmentBuilder.php#_get_sql">SQLFragmentBuilder::get_sql()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="is_value_allowed" id="_is_value_allowed">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableDateComparatorSQLFilter.php#38-49" title="Go to source code">is_value_allowed</a>( <span> <var>$value</var></span> )
						</code>
			...
			<tr data-order="get_sql_value_parameter_prefix" id="_get_sql_value_parameter_prefix">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableDateComparatorSQLFilter.php#51-54" title="Go to source code">get_sql_value_parameter_prefix</a>( )
						</code>
			...
			<tr data-order="get_sql_comparator_symbol" id="_get_sql_comparator_symbol">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableDateComparatorSQLFilter.php#56" title="Go to source code">get_sql_comparator_symbol</a>( )
						</code>
			...
			<tr data-order="get_form_field_class" id="_get_form_field_class">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableDateComparatorSQLFilter.php#58" title="Go to source code">get_form_field_class</a>( )
						</code>
			...
			<tr data-order="get_timestamp" id="_get_timestamp">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableDateComparatorSQLFilter.php#60-63" title="Go to source code">get_timestamp</a>( <span> <var>$value</var></span> )
						</code>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractHTMLTableFilter.php#methods">AbstractHTMLTableFilter</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractHTMLTableFilter.php#_get_form_field">get_form_field()</a>, 
									<a href="class-AbstractHTMLTableFilter.php#_get_id">get_id()</a>, 
									<a href="class-AbstractHTMLTableFilter.php#_get_value">get_value()</a>, 
									<a href="class-AbstractHTMLTableFilter.php#_set_value">set_value()</a>
							</code>
						</td>
					</tr>
				</table>
