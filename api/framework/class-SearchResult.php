		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SearchResult.php" class="cssmenu-title">SearchResult</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SearchResult</h2></header>
		<div class="content">
...
<p>object</p>
								...
								<div class="list"><dl>
									<dt><var>$id</var></dt>
									<dd>the element identifier in its own module</dd>
									<dt><var>$title</var></dt>
									<dd>the element title</dd>
									<dt><var>$link</var></dt>
									<dd>a link to a page that will display the element</dd>
									<dt><var>$relevance</var></dt>
									<dd>the relevance of the element within the current search</dd>
								</dl></div>
...
<a href="source-class-SearchResult.php#45-48" title="Go to source code">get_link</a>( )
			...
			<tr data-order="get_relevance" id="_get_relevance">
