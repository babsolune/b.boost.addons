<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractFormButton.php" class="cssmenu-title">AbstractFormButton</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractFormButton</h2></header>
		<div class="content">
...
<b><span>AbstractFormButton</span></b>					
					 implements 
...
<a href="source-class-AbstractFormButton.php#53-56" title="Go to source code">get_name</a>( )
			...
			<tr data-order="get_html_name" id="_get_html_name">
...
<a href="source-class-AbstractFormButton.php#88-91" title="Go to source code">get_css_class</a>( )
			...
			<tr data-order="set_data_confirmation" id="_set_data_confirmation">
...
<a href="source-class-AbstractFormButton.php#93-96" title="Go to source code">set_data_confirmation</a>( <span> <var>$data_confirmation</var></span> )
			...
			<tr data-order="get_data_confirmation" id="_get_data_confirmation">
