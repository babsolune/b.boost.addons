<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-UploadedFileTooLargeException.php" class="cssmenu-title">UploadedFileTooLargeException</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>UploadedFileTooLargeException</h2></header>
		<div class="content">
...
<b><span>UploadedFileTooLargeException</span></b>					
