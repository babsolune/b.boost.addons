<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DAO.php" class="cssmenu-title">DAO</a></li>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>Describes a simple way to interact with a table</p>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-SQLDAO.php">SQLDAO</a>
			</div>
...
<pre><span class="php-var">$criteria</span></pre></dd>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="FIND_ALL" id="FIND_ALL">
						...
						<td class="value">
							<div>
								<a href="#FIND_ALL" class="anchor">#</a>
								<code><span class="php-num">0</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="WHERE_ALL" id="WHERE_ALL">
						...
						<td class="value">
							<div>
								<a href="#WHERE_ALL" class="anchor">#</a>
								<code><span class="php-quote">'WHERE 1'</span></code>
							</div>
						</td>
					</tr>
				</table>
