<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractCommentsBuildForm.php" class="cssmenu-title">AbstractCommentsBuildForm</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractCommentsBuildForm</h2></header>
		<div class="content">
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-AddCommentBuildForm.php">AddCommentBuildForm</a>, 
					<a href="class-EditCommentBuildForm.php">EditCommentBuildForm</a>
			</div>
...
<a href="source-class-AbstractCommentsBuildForm.php#38-41" title="Go to source code">set_form</a>( <span><code><a href="class-HTMLForm.php">HTMLForm</a></code> <var>$form</var></span> )
			...
			<tr data-order="set_submit_button" id="_set_submit_button">
