		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ModuleConfigurationManager.php" class="cssmenu-title">ModuleConfigurationManager</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ModuleConfigurationManager</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Module.php">Module</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-ModuleConfigurationManager.php#3-91" title="Go to source code">phpboost/module/ModuleConfigurationManager.class.php</a></span>
			</div>
			...
			<tr data-order="get" id="_get">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-ModuleConfigurationManager.php#21-35" title="Go to source code">get</a>( <span>string <var>$module_id</var></span> )
						</code>

							<div class="description short">
								<p>Returns the</p>

<pre><span class="php-var">$module_id</span></pre>
...
<p>ModuleConfiguration</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-ModuleConfiguration.php">ModuleConfiguration</a></code><br>the module configuration
								</div>
