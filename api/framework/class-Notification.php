		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Notification.php" class="cssmenu-title">Notification</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>Notification</h2></header>
		<div class="content">
...
<a href="source-class-Notification.php#46-53" title="Go to source code">set_module_id</a>( <span>string <var>$module_id</var></span> )
							...
							<div class="description short">
								<p>Sets the module id from which the notification.</p>
							</div>
...
<a href="source-class-Notification.php#67-77" title="Go to source code">set_auth</a>( <span>mixed[] <var>$auth</var></span> )
							...
							<div class="description short">
								<p>Sets the authorization of the notification. It will determines who can read notifications.</p>
							</div>
...
<a href="source-class-Notification.php#79-86" title="Go to source code">get_module_id</a>( )
							...
							<div class="description short">
								<p>Gets the module from which the notification.</p>
							</div>
...
<a href="source-class-Notification.php#88-95" title="Go to source code">get_auth</a>( )
							...
							<div class="description short">
								<p>Gets permission to read this notification</p>
							</div>
...
<a href="source-class-Notification.php#97-113" title="Go to source code">get_module_name</a>( )
							...
							<div class="description short">
								<p>Gets the name of the module from which the notification.</p>
							</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="NOTIFICATION_AUTH_BIT" id="NOTIFICATION_AUTH_BIT">
						...
						<td class="value">
							<div>
								<a href="#NOTIFICATION_AUTH_BIT" class="anchor">#</a>
								<code><span class="php-num">1</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="NOTIFICATION_ALERT_LOW_PRIORITY" id="NOTIFICATION_ALERT_LOW_PRIORITY">
						...
						<td class="value">
							<div>
								<a href="#NOTIFICATION_ALERT_LOW_PRIORITY" class="anchor">#</a>
								<code><span class="php-num">2</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="NOTIFICATION_ALERT_MEDIUM_PRIORITY" id="NOTIFICATION_ALERT_MEDIUM_PRIORITY">
						...
						<td class="value">
							<div>
								<a href="#NOTIFICATION_ALERT_MEDIUM_PRIORITY" class="anchor">#</a>
								<code><span class="php-num">3</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="NOTIFICATION_ALERT_HIGH_PRIORITY" id="NOTIFICATION_ALERT_HIGH_PRIORITY">
						...
						<td class="value">
							<div>
								<a href="#NOTIFICATION_ALERT_HIGH_PRIORITY" class="anchor">#</a>
