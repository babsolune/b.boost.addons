		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormFieldSelectChoiceGroupOption.php" class="cssmenu-title">FormFieldSelectChoiceGroupOption</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormFieldSelectChoiceGroupOption</h2></header>
		<div class="content">
...
<b><span>FormFieldSelectChoiceGroupOption</span></b>					
...
<a href="source-class-FormFieldSelectChoiceGroupOption.php#20-28" title="Go to source code">__construct</a>( <span>string <var>$label</var></span>, <span>array <var>$options</var></span> )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><dl>
									<dt><var>$label</var></dt>
									<dd>string The label</dd>
									<dt><var>$options</var></dt>
									<dd>The group's options</dd>
								</dl></div>
...
<a href="source-class-FormFieldSelectChoiceGroupOption.php#30-37" title="Go to source code">set_field</a>( <span><code><a href="class-FormField.php">FormField</a></code> <var>$field</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractFormFieldEnumOption.php#_set_field">AbstractFormFieldEnumOption::set_field()</a></code></div>
...
<a href="source-class-FormFieldSelectChoiceGroupOption.php#57-70" title="Go to source code">get_option</a>( <span> <var>$raw_value</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractFormFieldEnumOption.php#_get_option">AbstractFormFieldEnumOption::get_option()</a></code></div>
