<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FormatingHelper.php" class="cssmenu-title">FormatingHelper</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormatingHelper</h2></header>
		<div class="content">
		...
		<div class="content">
			...
			<tr data-order="strparse" id="_strparse">
...
<a href="source-class-FormatingHelper.php#19-48" title="Go to source code">strparse</a>( <span>string <var>$content</var></span>, <span>string[] <var>$forbidden_tags</var> = <span class="php-keyword1">array</span>()</span>, <span>boolean <var>$addslashes</var> = <span class="php-keyword1">true</span></span> )
							...
							<div class="description short">
								<p>Parses a string with several default parameters. This methods exists to lighten the number of lines written.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Parses a string with several default parameters. This methods exists to lighten the number of lines written.</p>
								...
								<div class="list"><dl>
									...
									<dd>Content to parse</dd>
									<dt><var>$forbidden_tags</var></dt>
									<dd>List of the forbidden formatting tags</dd>
									<dt><var>$addslashes</var></dt>
									<dd>if true, the parsed string will be escaped.</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>The parsed string.
								</div>
			...
			<tr data-order="unparse" id="_unparse">
...
<a href="source-class-FormatingHelper.php#50-63" title="Go to source code">unparse</a>( <span>string <var>$content</var></span> )
							...
							<div class="description short">
								<p>Unparses a string with several default parameters. This methods exists to lighten the number of lines written.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Unparses a string with several default parameters. This methods exists to lighten the number of lines written.</p>
								...
								<div class="list"><dl>
									<dt><var>$content</var></dt>
									<dd>Content to unparse</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>The unparsed string.
								</div>


								<h6>See</h6>
								<div class="list">
										<code><a href="class-ContentFormattingUnparser.php">ContentFormattingUnparser</a></code><br>
								</div>
			...
			<tr data-order="second_parse" id="_second_parse">
...
<a href="source-class-FormatingHelper.php#65-78" title="Go to source code">second_parse</a>( <span>string <var>$content</var></span> )
							...
							<div class="description short">
								<p>Second parses a string with several default parameters. This methods exists to lighten the number of lines written.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Second parses a string with several default parameters. This methods exists to lighten the number of lines written.</p>
								...
								<div class="list"><dl>
									<dt><var>$content</var></dt>
									<dd>Content to second parse</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>The second parsed string.
								</div>


								<h6>See</h6>
								<div class="list">
										<code><a href="class-ContentSecondParser.php">ContentSecondParser</a></code><br>
								</div>
			...
			<tr data-order="second_parse_url" id="_second_parse_url">
...
<a href="source-class-FormatingHelper.php#80-90" title="Go to source code">second_parse_url</a>( <span>string <var>$url</var></span> )
							...
							<div class="description short">
								<p>Second parses relative urls to absolute urls.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Second parses relative urls to absolute urls.</p>
								...
								<div class="list"><dl>
									<dt><var>$url</var></dt>
									<dd>Url to second parse</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>The second parsed url.
								</div>


								<h6>See</h6>
								<div class="list">
										<code><a href="class-Url.php">Url</a></code><br>
								</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="NO_EDITOR_UNPARSE" id="NO_EDITOR_UNPARSE">
						...
						<td class="value">
							<div>
								<a href="#NO_EDITOR_UNPARSE" class="anchor">#</a>
