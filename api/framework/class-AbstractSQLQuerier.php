		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-AbstractSQLQuerier.php" class="cssmenu-title">AbstractSQLQuerier</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractSQLQuerier</h2></header>
		<div class="content">
...
<b><span>AbstractSQLQuerier</span></b>					
					 implements 
...
<a href="source-class-AbstractSQLQuerier.php#67-70" title="Go to source code">get_link</a>( )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-SQLQuerier.php#methods">SQLQuerier</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-SQLQuerier.php#_inject">inject()</a>, 
									<a href="class-SQLQuerier.php#_select">select()</a>
							</code>
						</td>
					</tr>
				</table>
