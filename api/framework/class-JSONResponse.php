		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-JSONResponse.php" class="cssmenu-title">JSONResponse</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>JSONResponse</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-MVC.php">MVC</a>\<a href="package-MVC.Response.php">Response</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2017 07 01
						</span>
						<span class="infos-options">
							<b>Since:</b>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-JSONResponse.php#3-31" title="Go to source code">mvc/response/JSONResponse.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>JSONResponse</span></b>					
					 implements 
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-JSONResponse.php#18-23" title="Go to source code">__construct</a>( <span>array <var>$json_object</var></span> )
						</code>
			...
			<tr data-order="send" id="_send">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-JSONResponse.php#_send">JSONResponse::send()</a></code>
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-JSONResponse.php#25-30" title="Go to source code">send</a>( )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-JSONResponse.php#_send">JSONResponse::send()</a></code><br>the response to the browser
								</div>
