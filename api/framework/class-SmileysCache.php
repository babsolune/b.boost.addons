		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SmileysCache.php" class="cssmenu-title">SmileysCache</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SmileysCache</h2></header>
		<div class="content">
...
For instance,</p>
			...
			<tr data-order="get_smileys" id="_get_smileys">
...
<a href="source-class-SmileysCache.php#39-42" title="Go to source code">get_smileys</a>( )
			...
			<tr data-order="get_url_smiley" id="_get_url_smiley">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-SmileysCache.php">SmileysCache</a></code>
...
<a href="source-class-SmileysCache.php#49-56" title="Go to source code">load</a>( )
							...
							<div class="description short">
								<p>Loads and returns the smileys cached data.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads and returns the smileys cached data.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-SmileysCache.php">SmileysCache</a></code><br>The cached data
								</div>
...
<a href="source-class-SmileysCache.php#58-64" title="Go to source code">invalidate</a>( )
							...
							<div class="description short">
								<p>Invalidates the current smileys cached data.</p>
							</div>
