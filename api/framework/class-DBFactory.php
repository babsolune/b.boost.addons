<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DBFactory.php" class="cssmenu-title">DBFactory</a></li>
...
<a href="source-class-DBFactory.php#34-37" title="Go to source code">__static</a>( )
			...
			<tr data-order="load_prefix" id="_load_prefix">
...
<a href="source-class-DBFactory.php#39-42" title="Go to source code">load_prefix</a>( )
			...
			<tr data-order="init_factory" id="_init_factory">
...
<a href="source-class-DBFactory.php#44-57" title="Go to source code">init_factory</a>( <span> <var>$dbms</var></span> )
			...
			<tr data-order="get_db_connection" id="_get_db_connection">
...
<a href="source-class-DBFactory.php#59-74" title="Go to source code">get_db_connection</a>( )
							...
							<div class="description short">
								<p>returns the currently opened</p>

<pre>DBConnection</pre>

<p>instance or if none,
creates a new one</p>
							</div>
...
creates a new one</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-DBConnection.php">DBConnection</a></code><br><p>the currently opened</p>
...
<p>instance</p>
			...
			<tr data-order="close_db_connection" id="_close_db_connection">
...
<a href="source-class-DBFactory.php#76-82" title="Go to source code">close_db_connection</a>( )
			...
			<tr data-order="reset_db_connection" id="_reset_db_connection">
...
<a href="source-class-DBFactory.php#84-87" title="Go to source code">reset_db_connection</a>( )
			...
			<tr data-order="set_db_connection" id="_set_db_connection">
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="MYSQL" id="MYSQL">
						...
						<td class="value">
							<div>
								<a href="#MYSQL" class="anchor">#</a>
								<code><span class="php-num">0x01</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PDO_MYSQL" id="PDO_MYSQL">
						...
						<td class="value">
							<div>
								<a href="#PDO_MYSQL" class="anchor">#</a>
								<code><span class="php-num">0x11</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PDO_SQLITE" id="PDO_SQLITE">
						...
						<td class="value">
							<div>
								<a href="#PDO_SQLITE" class="anchor">#</a>
								<code><span class="php-num">0x12</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PDO_POSTGRESQL" id="PDO_POSTGRESQL">
						...
						<td class="value">
							<div>
								<a href="#PDO_POSTGRESQL" class="anchor">#</a>
								<code><span class="php-num">0x13</span></code>
							</div>
						</td>
					</tr>
				</table>
