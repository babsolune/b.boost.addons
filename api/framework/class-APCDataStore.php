<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-APCDataStore.php" class="cssmenu-title">APCDataStore</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>APCDataStore</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This data store is not already available, the APC PHP extension must be enabled for you yo use it.
...
This is very efficient and has an infinite life span (in fact it's the Web server's one).</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>APCDataStore</span></b>					
					 implements 
						...
						<div class="description detailed hidden">
							<p>Stores data.</p>
								...
								<div class="list"><dl>
									...
									<dd>The data you want to store</dd>
								</dl></div>
