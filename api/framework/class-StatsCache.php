		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-StatsCache.php" class="cssmenu-title">StatsCache</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>StatsCache</h2></header>
		<div class="content">
...
For instance,</p>
			...
			<tr data-order="get_stats" id="_get_stats">
...
<a href="source-class-StatsCache.php#37-40" title="Go to source code">get_stats</a>( )
			...
			<tr data-order="get_stats_properties" id="_get_stats_properties">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-StatsCache.php">StatsCache</a></code>
...
<a href="source-class-StatsCache.php#51-58" title="Go to source code">load</a>( )
							...
							<div class="description short">
								<p>Loads and returns the stats cached data.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads and returns the stats cached data.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-StatsCache.php">StatsCache</a></code><br>The cached data
								</div>
...
<a href="source-class-StatsCache.php#60-66" title="Go to source code">invalidate</a>( )
							...
							<div class="description short">
								<p>Invalidates the current stats cached data.</p>
							</div>
