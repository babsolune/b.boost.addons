		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-TemplateHighlighter.php" class="cssmenu-title">TemplateHighlighter</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>TemplateHighlighter</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This is a syntax highlighter for the PHPBoost template syntax.</p>
			</div>
...
<b><span>TemplateHighlighter</span></b>					
...
<a href="source-class-TemplateHighlighter.php#24-30" title="Go to source code">__construct</a>( )
							...
							<div class="description short">
								<p>Build a TemplateHighlighter object.</p>
							</div>
...
<a href="source-class-TemplateHighlighter.php#32-81" title="Go to source code">parse</a>( <span>integer <var>$line_number</var> = GESHI_NO_LINE_NUMBERS</span>, <span>boolean <var>$inline_code</var> = <span class="php-keyword1">false</span></span> )
							...
							<div class="description short">
								<p>Highlights the code. It uses the geshi HTML syntax highlighter and then it highlights the specific template syntax.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Highlights the code. It uses the geshi HTML syntax highlighter and then it highlights the specific template syntax.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$line_number</var></dt>
									<dd>GESHI_NO_LINE_NUMBERS => no line numbers, GESHI_NORMAL_LINE_NUMBERS line numbers.</dd>
									<dt><var>$inline_code</var></dt>
									<dd>true if it's a sigle line code, otherwise false.</dd>
								</dl></div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="TPL_BRACES_STYLE" id="TPL_BRACES_STYLE">
						...
						<td class="value">
							<div>
								<a href="#TPL_BRACES_STYLE" class="anchor">#</a>
								<code><span class="php-quote">'color:#7F3300;'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="TPL_VARIABLE_STYLE" id="TPL_VARIABLE_STYLE">
						...
						<td class="value">
							<div>
								<a href="#TPL_VARIABLE_STYLE" class="anchor">#</a>
								<code><span class="php-quote">'color:#FF6600; font-weight: bold;'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="TPL_NESTED_VARIABLE_STYLE" id="TPL_NESTED_VARIABLE_STYLE">
						...
						<td class="value">
							<div>
								<a href="#TPL_NESTED_VARIABLE_STYLE" class="anchor">#</a>
								<code><span class="php-quote">'color:#8F5211;'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="TPL_SHARP_STYLE" id="TPL_SHARP_STYLE">
						...
						<td class="value">
							<div>
								<a href="#TPL_SHARP_STYLE" class="anchor">#</a>
								<code><span class="php-quote">'color:#9915AF; font-weight: bold;'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="TPL_KEYWORD_STYLE" id="TPL_KEYWORD_STYLE">
						...
						<td class="value">
							<div>
								<a href="#TPL_KEYWORD_STYLE" class="anchor">#</a>
								<code><span class="php-quote">'color:#000066; font-weight: bold;'</span></code>
							</div>
						</td>
					</tr>
				</table>
