		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ThemeConfigurationManager.php" class="cssmenu-title">ThemeConfigurationManager</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ThemeConfigurationManager</h2></header>
		<div class="content">
