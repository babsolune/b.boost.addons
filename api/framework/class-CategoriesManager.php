		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CategoriesManager.php" class="cssmenu-title">CategoriesManager</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CategoriesManager</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class allows you to easily integrate a complete system of categories in its script.
It needs to have its first instantiation of a parameter child object CategoriesCache and as the second parameter to have a CategoriesItemsParameters object.</p>
			</div>
...
<a href="source-class-CategoriesManager.php#47-59" title="Go to source code">__construct</a>( <span><code><a href="class-CategoriesCache.php">CategoriesCache</a></code> <var>$categories_cache</var></span>, <span><code><a href="class-CategoriesItemsParameters.php">CategoriesItemsParameters</a></code> <var>$categories_items_parameters</var></span> )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><dl>
									...
									<dd>A child object of the class CategoriesCache</dd>
									<dt><var>$categories_items_parameters</var></dt>
									<dd></dd>
								</dl></div>
...
<a href="source-class-CategoriesManager.php#102-124" title="Go to source code">update</a>( <span><code><a href="class-Category.php">Category</a></code> <var>$category</var></span> )
			...
			<tr data-order="move_into_another" id="_move_into_another">
...
<a href="source-class-CategoriesManager.php#126-199" title="Go to source code">move_into_another</a>( <span><code><a href="class-Category.php">Category</a></code> <var>$category</var></span>, <span>integer <var>$id_parent</var></span>, <span>integer <var>$position</var> = <span class="php-num">0</span></span> )
							...
							<div class="description short">
								<p>Moves a category and items into another category. You can specify its future position in its future parent category.</p>
							</div>
			...
			<tr data-order="move_items_into_another" id="_move_items_into_another">
...
<a href="source-class-CategoriesManager.php#201-212" title="Go to source code">move_items_into_another</a>( <span><code><a href="class-Category.php">Category</a></code> <var>$category</var></span>, <span>integer <var>$id_parent</var></span> )
							...
							<div class="description short">
								<p>Moves items into another category.</p>
							</div>
			...
			<tr data-order="update_position" id="_update_position">
...
<a href="source-class-CategoriesManager.php#214-245" title="Go to source code">update_position</a>( <span><code><a href="class-Category.php">Category</a></code> <var>$category</var></span>, <span>integer <var>$id_parent</var></span>, <span>integer <var>$position</var></span> )
							...
							<div class="description short">
								<p>Update category and items position.</p>
							</div>
...
<a href="source-class-CategoriesManager.php#247-272" title="Go to source code">delete</a>( <span>integer <var>$id</var></span> )
							...
							<div class="description short">
								<p>Deletes a category and items.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Deletes a category and items.</p>
								...
								<div class="list"><dl>
									<dt><var>$id</var></dt>
									<dd>Id of the category to delete.</dd>
								</dl></div>
...
<a href="source-class-CategoriesManager.php#274-304" title="Go to source code">get_children</a>( <span>integer <var>$id_category</var></span>, <span><code><a href="class-SearchCategoryChildrensOptions.php">SearchCategoryChildrensOptions</a></code> <var>$search_category_children_options</var></span>, <span> <var>$add_this</var> = <span class="php-keyword1">false</span></span> )
							...
							<div class="description short">
								<p>Category[string] the children Categories map (id => category) for category id</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Category[string] the children Categories map (id => category) for category id</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$id_category</var></dt>
									<dd></dd>
									<dt><var>$search_category_children_options</var></dt>
									<dd></dd>
									<dt><var>$add_this</var></dt>
									<dd></dd>
								</dl></div>
			...
			<tr data-order="get_parents" id="_get_parents">
...
<a href="source-class-CategoriesManager.php#306-343" title="Go to source code">get_parents</a>( <span>integer <var>$id_category</var></span>, <span>boolean <var>$add_this</var> = <span class="php-keyword1">false</span></span> )
							...
							<div class="description short">
								<p>Category[string] the parents Categories map (id => category) for category id</p>
							</div>
			...
			<tr data-order="get_heritated_authorizations" id="_get_heritated_authorizations">
...
<a href="source-class-CategoriesManager.php#345-368" title="Go to source code">get_heritated_authorizations</a>( <span>integer <var>$id_category</var></span>, <span>integer <var>$bit</var></span>, <span>integer <var>$mode</var></span> )
							...
							<div class="description short">
								<p>Computes the global authorization level of the whole parent categories. The result corresponds to all the category's parents merged.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Computes the global authorization level of the whole parent categories. The result corresponds to all the category's parents merged.</p>
								...
								<div class="list"><dl>
									<dt><var>$id_category</var></dt>
									<dd>Id of the category for which you want to know what is the global authorization</dd>
									<dt><var>$bit</var></dt>
									<dd>The autorization bit you want to check</dd>
									<dt><var>$mode</var></dt>
									<dd>Merge mode. If it corresponds to a read autorization, use Authorizations::AUTH_PARENT_PRIORITY which will disallow for example all the subcategories of a category to which you can't access, or Authorizations::AUTH_CHILD_PRIORITY if you want to work in write mode, each child will be able to redifine the authorization.</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									mixed[]<br>The merged array that you can use only for the bit $bit.
								</div>
			...
			<tr data-order="get_select_categories_form_field" id="_get_select_categories_form_field">
...
<a href="source-class-CategoriesManager.php#370-373" title="Go to source code">get_select_categories_form_field</a>( <span> <var>$id</var></span>, <span> <var>$label</var></span>, <span> <var>$value</var></span>, <span><code><a href="class-SearchCategoryChildrensOptions.php">SearchCategoryChildrensOptions</a></code> <var>$search_category_children_options</var></span>, <span>array <var>$field_options</var> = <span class="php-keyword1">array</span>()</span> )
			...
			<tr data-order="get_feeds_categories_module" id="_get_feeds_categories_module">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-FeedsCategoriesModule.php">FeedsCategoriesModule</a></code>
...
<a href="source-class-CategoriesManager.php#375-381" title="Go to source code">get_feeds_categories_module</a>( )
			...
			<tr data-order="regenerate_cache" id="_regenerate_cache">
...
<a href="source-class-CategoriesManager.php#383-387" title="Go to source code">regenerate_cache</a>( )
			...
			<tr data-order="get_categories_cache" id="_get_categories_cache">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-CategoriesCache.php">CategoriesCache</a></code>
...
<a href="source-class-CategoriesManager.php#394-397" title="Go to source code">get_module_id</a>( )
			...
			<tr data-order="get_categories_items_parameters" id="_get_categories_items_parameters">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-CategoriesItemsParameters.php">CategoriesItemsParameters</a></code>
...
<a href="source-class-CategoriesManager.php#399-402" title="Go to source code">get_categories_items_parameters</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="STANDARD_CATEGORY_CLASS" id="STANDARD_CATEGORY_CLASS">
						...
						<td class="value">
							<div>
								<a href="#STANDARD_CATEGORY_CLASS" class="anchor">#</a>
								<code><span class="php-quote">'Category'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="RICH_CATEGORY_CLASS" id="RICH_CATEGORY_CLASS">
						...
						<td class="value">
							<div>
								<a href="#RICH_CATEGORY_CLASS" class="anchor">#</a>
								<code><span class="php-quote">'RichCategory'</span></code>
							</div>
						</td>
					</tr>
				</table>
