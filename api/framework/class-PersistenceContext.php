		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-PersistenceContext.php" class="cssmenu-title">PersistenceContext</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>PersistenceContext</h2></header>
		<div class="content">
...
<a href="source-class-PersistenceContext.php#30-41" title="Go to source code">get_querier</a>( )
			...
			<tr data-order="get_dbms_utils" id="_get_dbms_utils">
