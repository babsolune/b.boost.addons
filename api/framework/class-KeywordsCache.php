		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-KeywordsCache.php" class="cssmenu-title">KeywordsCache</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>KeywordsCache</h2></header>
		<div class="content">
...
<a href="source-class-KeywordsCache.php#36" title="Go to source code">get_module_identifier</a>( )
			...
			<tr data-order="get_keywords" id="_get_keywords">
...
<a href="source-class-KeywordsCache.php#38-45" title="Go to source code">get_keywords</a>( <span> <var>$id_in_module</var></span> )
			...
			<tr data-order="has_keywords" id="_has_keywords">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-KeywordsCache.php">KeywordsCache</a></code>
...
<a href="source-class-KeywordsCache.php#52-59" title="Go to source code">load</a>( )
							...
							<div class="description short">
								<p>Loads and returns the keywords cached data.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads and returns the keywords cached data.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-KeywordsCache.php">KeywordsCache</a></code><br>The cached data
								</div>
...
<a href="source-class-KeywordsCache.php#61-67" title="Go to source code">invalidate</a>( )
							...
							<div class="description short">
								<p>Invalidates keywords cached data.</p>
							</div>
...
<a href="source-class-KeywordsCache.php#69-73" title="Go to source code">get_class</a>( )
			...
			<tr data-order="keywords" id="$keywords">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$keywords" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
