<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractTemplate.php" class="cssmenu-title">AbstractTemplate</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractTemplate</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class is a default implementation of the Template interface using a TemplateLoader,
a TemplateData and a TemplateParser.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>AbstractTemplate</span></b>					
					 implements 
						<a href="class-Template.php"><span>Template</span></a>
...
<a href="source-class-AbstractTemplate.php#34-45" title="Go to source code">__construct</a>( <span><code><a href="class-TemplateLoader.php">TemplateLoader</a></code> <var>$loader</var></span>, <span><code><a href="class-TemplateRenderer.php">TemplateRenderer</a></code> <var>$renderer</var></span>, <span><code><a href="class-TemplateData.php">TemplateData</a></code> <var>$data</var></span> )
							...
							<div class="description short">
								<p>Builds an AbstractTemplate from the different services it has to use.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Builds an AbstractTemplate from the different services it has to use.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$loader</var></dt>
									<dd>The loader</dd>
									<dt><var>$renderer</var></dt>
									<dd>The renderer</dd>
									<dt><var>$data</var></dt>
									<dd>The data</dd>
								</dl></div>
  ...
  then an exception will be raised.</p>
						...
						<div class="description detailed hidden">
							<p>Enables the strict mode. If a variable that does not exist in the object is requested, then an exception will be raised.</p>
								...
								<div class="list"><code><a href="class-Template.php#_enable_strict_mode">Template::enable_strict_mode()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
  ...
  then an empty value will be returned.</p>
						...
						<div class="description detailed hidden">
							<p>Disables the strict mode. If a variable that does not exist in the object is requested, then an empty value will be returned.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-Template.php#_disable_strict_mode">Template::disable_strict_mode()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<pre><span class="php-var">$key</span></pre>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-Template.php#_put">Template::put()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<pre><span class="php-var">$key</span></pre></dd>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-Template.php#_put_all">Template::put_all()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="assign_vars" id="_assign_vars">
...
<a href="source-class-AbstractTemplate.php#91-98" title="Go to source code">assign_vars</a>( <span>array <var>$array_vars</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-Template.php#_assign_vars">Template::assign_vars()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
To know what syntax to use to browse a loop, see the class description, there are examples.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-Template.php#_assign_block_vars">Template::assign_block_vars()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="add_subtemplate" id="_add_subtemplate">
...
<a href="source-class-AbstractTemplate.php#109-116" title="Go to source code">add_subtemplate</a>( <span>string <var>$identifier</var></span>, <span><code><a href="class-Template.php">Template</a></code> <var>$template</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-Template.php#_add_subtemplate">Template::add_subtemplate()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="__clone" id="___clone">
...
<a href="source-class-AbstractTemplate.php#126-132" title="Go to source code">render</a>( )
							...
							<div class="description short">
								<p>Returns a string representation of the view.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns a string representation of the view.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>a string representation of the view
								</div>

								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-TemplateRenderingException.php">TemplateRenderingException</a></code>
								</div>



								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-View.php#_render">View::render()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractTemplate.php#134-143" title="Go to source code">display</a>( <span> <var>$reorder_js</var> = <span class="php-keyword1">false</span></span> )
						...
						<div class="description detailed hidden">
							<p>Displays the template.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-Template.php#_display">Template::display()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractTemplate.php#185-191" title="Go to source code">add_lang</a>( <span>array <var>$lang</var></span> )
						...
						<div class="description detailed hidden">
							<p>Adds a lang map to the template map list in which template variables beginning by L_ will be searched for of not already registered</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-Template.php#_add_lang">Template::add_lang()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractTemplate.php#193-199" title="Go to source code">set_data</a>( <span><code><a href="class-TemplateData.php">TemplateData</a></code> <var>$data</var></span> )
						...
						<div class="description detailed hidden">
							<p>Inject data into the template. This is for internal use only.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-Template.php#_set_data">Template::set_data()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractTemplate.php#201-207" title="Go to source code">get_data</a>( )
						...
						<div class="description detailed hidden">
							<p>Returns the template data</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-Template.php#_get_data">Template::get_data()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-AbstractTemplate.php#209-214" title="Go to source code">get_pictures_data_path</a>( )
						...
						<div class="description detailed hidden">
							<p>Returns the pictures data path</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-Template.php#_get_pictures_data_path">Template::get_pictures_data_path()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			...
			<tr data-order="loader" id="$loader">
				<td class="attributes">
					<code>
						protected  
						<code><a href="class-TemplateLoader.php">TemplateLoader</a></code>
					</code>
				</td>
			...
			<tr data-order="renderer" id="$renderer">
				<td class="attributes">
					<code>
						protected  
						<code><a href="class-TemplateRenderer.php">TemplateRenderer</a></code>
					</code>
				</td>
				...
				<td class="value">
					<div>
						<a href="#$renderer" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
