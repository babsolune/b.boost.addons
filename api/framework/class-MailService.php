<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-MailService.php" class="cssmenu-title">MailService</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MailService</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Mail.php">Mail</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-MailService.php#3-60" title="Go to source code">io/mail/MailService.class.php</a></span>
			</div>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractPHPMailerMailService.php">AbstractPHPMailerMailService</a>
			</div>

			<div>
				<h6>Indirect known implementers</h6>
					<a href="class-DefaultMailService.php">DefaultMailService</a>, 
					<a href="class-SMTPMailService.php">SMTPMailService</a>
			</div>
			...
			<tr data-order="send" id="_send">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailService.php#15-20" title="Go to source code">send</a>( <span><code><a href="class-Mail.php">Mail</a></code> <var>$mail</var></span> )
						</code>

							<div class="description short">
								<p>Sends the mail. Throws an exception if the mail cannot be sent.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Sends the mail. Throws an exception if the mail cannot be sent.</p>
								...
								<div class="list"><dl>
									<dt><var>$mail</var></dt>
									<dd>The mail to send</dd>
								</dl></div>


								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-IOException.php">IOException</a></code><br>if the mail couldn't be sent
								</div>
			...
			<tr data-order="try_to_send" id="_try_to_send">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailService.php#22-28" title="Go to source code">try_to_send</a>( <span><code><a href="class-Mail.php">Mail</a></code> <var>$mail</var></span> )
						</code>

							<div class="description short">
								<p>Tries to send the mail but doesn't throw any error whether the mail cannot be sent,
it only returns false.</p>
							</div>
...
it only returns false.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									boolean<br>True if the mail could be sent, false otherwise.
								</div>
			...
			<tr data-order="send_from_properties" id="_send_from_properties" class="deprecated">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailService.php#30-40" title="Go to source code">send_from_properties</a>( <span>string <var>$mail_to</var></span>, <span>string <var>$mail_subject</var></span>, <span>string <var>$mail_content</var></span>, <span>string <var>$mail_from</var> = <span class="php-quote">''</span></span>, <span>string <var>$sender_name</var> = <span class="php-quote">'admin'</span></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$mail_to</var></dt>
									<dd>The mail recipients' address.</dd>
									<dt><var>$mail_subject</var></dt>
									<dd>The mail subject.</dd>
									<dt><var>$mail_content</var></dt>
									<dd>content of the mail</dd>
									<dt><var>$mail_from</var></dt>
									<dd>The mail sender's address.</dd>
									<dt><var>$sender_name</var></dt>
									<dd>The mail sender's name. If you don't use this parameter, the name of the site administrator will be taken.</dd>
								</dl></div>
			...
			<tr data-order="is_mail_valid" id="_is_mail_valid">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailService.php#42-47" title="Go to source code">is_mail_valid</a>( <span>string <var>$mail_address</var></span> )
						</code>

							<div class="description short">
								<p>Check whether the mail address is valid, it respects the mail RFC</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Check whether the mail address is valid, it respects the mail RFC</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$mail_address</var></dt>
									<dd></dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									boolean<br>true if the mail is valid, false otherwise
								</div>
			...
			<tr data-order="get_mail_checking_regex" id="_get_mail_checking_regex">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailService.php#49-53" title="Go to source code">get_mail_checking_regex</a>( )
						</code>

							<div class="description short">
								<p>Return the RFC mail regex.</p>
							</div>
			...
			<tr data-order="get_mail_checking_raw_regex" id="_get_mail_checking_raw_regex">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailService.php#55-59" title="Go to source code">get_mail_checking_raw_regex</a>( )
						</code>

							<div class="description short">
								<p>Return the RFC mail regex without delimiters, it's commonly used for compatibility with javascript regex.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Return the RFC mail regex without delimiters, it's commonly used for compatibility with javascript regex.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>the mail regex without delimiters
								</div>
