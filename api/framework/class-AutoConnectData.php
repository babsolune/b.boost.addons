<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AutoConnectData.php" class="cssmenu-title">AutoConnectData</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AutoConnectData</h2></header>
		<div class="content">
...
<a href="source-class-AutoConnectData.php#22-25" title="Go to source code">__static</a>( )
			...
			<tr data-order="get_user_id_from_cookie" id="_get_user_id_from_cookie">
...
<a href="source-class-AutoConnectData.php#27-40" title="Go to source code">get_user_id_from_cookie</a>( <span> <var>$cookie_content</var></span> )
			...
			<tr data-order="create_cookie" id="_create_cookie">
...
<a href="source-class-AutoConnectData.php#42-62" title="Go to source code">create_cookie</a>( <span> <var>$user_id</var></span> )
			...
			<tr data-order="change_key" id="_change_key">
