		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-QueryResult.php" class="cssmenu-title">QueryResult</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>QueryResult</h2></header>
		<div class="content">
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractQueryResult.php">AbstractQueryResult</a>, 
					<a href="class-InjectQueryResult.php">InjectQueryResult</a>, 
					<a href="class-SelectQueryResult.php">SelectQueryResult</a>
			</div>

			<div>
				<h6>Indirect known implementers</h6>
					<a href="class-AbstractSelectQueryResult.php">AbstractSelectQueryResult</a>, 
					<a href="class-MySQLInjectQueryResult.php">MySQLInjectQueryResult</a>, 
					<a href="class-MySQLSelectQueryResult.php">MySQLSelectQueryResult</a>, 
					<a href="class-PDOInjectQueryResult.php">PDOInjectQueryResult</a>, 
