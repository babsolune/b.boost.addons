		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-StringType.php" class="cssmenu-title">StringType</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>StringType</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Doctrine.php">Doctrine</a>\<a href="package-Doctrine.DBAL.php">DBAL</a>\<a href="package-Doctrine.DBAL.Types.php">Types</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-StringType.php#3-32" title="Go to source code">io/db/dbms/Doctrine/DBAL/Types/StringType.php</a></span>
			</div>

			<div class="description">
				<p>Type that maps an SQL VARCHAR to a PHP string.</p>
			</div>
			...
			<tr data-order="getSqlDeclaration" id="_getSqlDeclaration">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-StringType.php#15-19" title="Go to source code">getSqlDeclaration</a>( <span>array <var>$fieldDeclaration</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
			...
			<tr data-order="getDefaultLength" id="_getDefaultLength">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-StringType.php#21-25" title="Go to source code">getDefaultLength</a>( <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Type.php#_getDefaultLength">Type::getDefaultLength()</a></code></div>
			...
			<tr data-order="getName" id="_getName">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-StringType.php#27-31" title="Go to source code">getName</a>( )
						</code>
					...
					<tr>
						<td>
							<code>
									...
									<a href="class-Type.php#_convertToPHPValue">convertToPHPValue()</a>, 
