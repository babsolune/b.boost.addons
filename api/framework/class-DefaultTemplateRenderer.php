<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DefaultTemplateRenderer.php" class="cssmenu-title">DefaultTemplateRenderer</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DefaultTemplateRenderer</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This template renderer is able to deal with both loader which cache and don't cache.
When the loader supports caching, it includes the cached file to use APC's optimization, but
if it doesn't support it, it simply evals the template code.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>DefaultTemplateRenderer</span></b>					
					 implements 
						<a href="class-TemplateRenderer.php"><span>TemplateRenderer</span></a>
...
<a href="source-class-DefaultTemplateRenderer.php#30-43" title="Go to source code">render</a>( <span><code><a href="class-TemplateData.php">TemplateData</a></code> <var>$data</var></span>, <span><code><a href="class-TemplateLoader.php">TemplateLoader</a></code> <var>$loader</var></span> )
							...
							<div class="description short">
								<p>Returns the result of the interpretation of a template</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the result of the interpretation of a template</p>
								...
								<div class="list"><dl>
									...
									<dd>The loader to use</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>The parsed template
								</div>
								...
								<div class="list"><code><a href="class-TemplateRenderer.php#_render">TemplateRenderer::render()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-DefaultTemplateRenderer.php#45-51" title="Go to source code">add_lang</a>( <span>array <var>$lang</var></span> )
						...
						<div class="description detailed hidden">
							<p>Adds a lang map to the template map list in which template variables beginning by L_ will be searched for of not already registered</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-TemplateRenderer.php#_add_lang">TemplateRenderer::add_lang()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
