		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-NumberHelper.php" class="cssmenu-title">NumberHelper</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>NumberHelper</h2></header>
		<div class="content">
...
<a href="source-class-NumberHelper.php#16-39" title="Go to source code">numeric</a>( <span>string <var>$var</var></span>, <span>string <var>$type</var> = <span class="php-quote">'int'</span></span> )
						...
						<div class="description detailed hidden">
							<p>Converts a string to a numeric value.</p>
								...
								<div class="list"><dl>
									<dt><var>$var</var></dt>
									<dd>The value you want to convert.</dd>
									<dt><var>$type</var></dt>
									<dd>'int' if you want to convert to an integer value, 'float' if you want a floating value.</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									mixed<br>The integer or floating value (according to the type you chose).
								</div>
						...
						<div class="description detailed hidden">
							<p>Rounds a number</p>
								...
								<div class="list"><dl>
									...
									<dd>Number to round</dd>
									<dt><var>$dec</var></dt>
									<dd>The number of decilam points</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>The rounded number.
								</div>
