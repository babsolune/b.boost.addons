<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractTemplateSyntaxElement.php" class="cssmenu-title">AbstractTemplateSyntaxElement</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractTemplateSyntaxElement</h2></header>
		<div class="content">
...
<b><span>AbstractTemplateSyntaxElement</span></b>					
					 implements 
						<a href="class-TemplateSyntaxElement.php"><span>TemplateSyntaxElement</span></a>
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-ArrayContentTemplateSyntaxElement.php">ArrayContentTemplateSyntaxElement</a>, 
					<a href="class-ArrayTemplateSyntaxElement.php">ArrayTemplateSyntaxElement</a>, 
					<a href="class-LoopTemplateSyntaxElement.php">LoopTemplateSyntaxElement</a>, 
					<a href="class-LoopVarTemplateSyntaxElement.php">LoopVarTemplateSyntaxElement</a>, 
					<a href="class-ParametersTemplateSyntaxElement.php">ParametersTemplateSyntaxElement</a>, 
					<a href="class-PHPTemplateSyntaxElement.php">PHPTemplateSyntaxElement</a>, 
					<a href="class-SimpleVarTemplateSyntaxElement.php">SimpleVarTemplateSyntaxElement</a>, 
					<a href="class-TextTemplateSyntaxElement.php">TextTemplateSyntaxElement</a>, 
					<a href="class-VariableExpressionTemplateSyntaxElement.php">VariableExpressionTemplateSyntaxElement</a>, 
					<a href="class-VariableTemplateSyntaxElement.php">VariableTemplateSyntaxElement</a>, 
					<a href="class-ConditionTemplateSyntaxElement.php">ConditionTemplateSyntaxElement</a>, 
					<a href="class-ConstantTemplateSyntaxElement.php">ConstantTemplateSyntaxElement</a>, 
					<a href="class-ExpressionContentTemplateSyntaxElement.php">ExpressionContentTemplateSyntaxElement</a>, 
					<a href="class-ExpressionTemplateSyntaxElement.php">ExpressionTemplateSyntaxElement</a>, 
					<a href="class-FunctionCallTemplateSyntaxElement.php">FunctionCallTemplateSyntaxElement</a>, 
					<a href="class-FunctionTemplateSyntaxElement.php">FunctionTemplateSyntaxElement</a>, 
					<a href="class-IncludeTemplateSyntaxElement.php">IncludeTemplateSyntaxElement</a>, 
					<a href="class-LangVarTemplateSyntaxElement.php">LangVarTemplateSyntaxElement</a>
			</div>
...
<a href="source-class-AbstractTemplateSyntaxElement.php#29-34" title="Go to source code">register</a>( <span><code><a href="class-TemplateSyntaxParserContext.php">TemplateSyntaxParserContext</a></code> <var>$context</var></span>, <span><code><a href="class-StringInputStream.php">StringInputStream</a></code> <var>$input</var></span>, <span><code><a href="class-StringOutputStream.php">StringOutputStream</a></code> <var>$output</var></span> )
			...
			<tr data-order="parse_elt" id="_parse_elt">
...
<a href="source-class-AbstractTemplateSyntaxElement.php#36-39" title="Go to source code">parse_elt</a>( <span><code><a href="class-TemplateSyntaxElement.php">TemplateSyntaxElement</a></code> <var>$element</var></span> )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-TemplateSyntaxElement.php#methods">TemplateSyntaxElement</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-TemplateSyntaxElement.php#_parse">parse()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-TemplateSyntaxElement.php#constants">TemplateSyntaxElement</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-TemplateSyntaxElement.php#DATA"><b>DATA</b></a>, 
									<a href="class-TemplateSyntaxElement.php#FUNCTIONS"><b>FUNCTIONS</b></a>, 
									<a href="class-TemplateSyntaxElement.php#RESULT"><b>RESULT</b></a>
							</code>
						</td>
					</tr>
				</table>
			...
			<tr data-order="context" id="$context">
				<td class="attributes">
					<code>
						protected  
						<code><a href="class-TemplateSyntaxParserContext.php">TemplateSyntaxParserContext</a></code>
					</code>
				</td>
			...
			<tr data-order="input" id="$input">
				<td class="attributes">
					<code>
						protected  
						<code><a href="class-StringInputStream.php">StringInputStream</a></code>
					</code>
				</td>
				...
				<td class="value">
					<div>
						<a href="#$input" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
			<tr data-order="output" id="$output">
				<td class="attributes">
					<code>
						protected  
						<code><a href="class-StringOutputStream.php">StringOutputStream</a></code>
					</code>
				</td>
