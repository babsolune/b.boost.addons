		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SecurityConfig.php" class="cssmenu-title">SecurityConfig</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SecurityConfig</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Config.php">Config</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2016 09 24
						</span>
						<span class="infos-options">
							<b>Since:</b>
...
<b><span>SecurityConfig</span></b>					
		...
		<div class="content">
			...
			<tr data-order="get_internal_password_min_length" id="_get_internal_password_min_length">
...
<a href="source-class-SecurityConfig.php#24-27" title="Go to source code">get_internal_password_min_length</a>( )
			...
			<tr data-order="set_internal_password_min_length" id="_set_internal_password_min_length">
...
<a href="source-class-SecurityConfig.php#29-32" title="Go to source code">set_internal_password_min_length</a>( <span> <var>$value</var></span> )
			...
			<tr data-order="get_internal_password_strength" id="_get_internal_password_strength">
...
<a href="source-class-SecurityConfig.php#34-37" title="Go to source code">get_internal_password_strength</a>( )
			...
			<tr data-order="set_internal_password_strength" id="_set_internal_password_strength">
...
<a href="source-class-SecurityConfig.php#39-42" title="Go to source code">set_internal_password_strength</a>( <span> <var>$value</var></span> )
			...
			<tr data-order="forbid_login_and_email_in_password" id="_forbid_login_and_email_in_password">
...
<a href="source-class-SecurityConfig.php#44-47" title="Go to source code">forbid_login_and_email_in_password</a>( )
			...
			<tr data-order="allow_login_and_email_in_password" id="_allow_login_and_email_in_password">
...
<a href="source-class-SecurityConfig.php#49-52" title="Go to source code">allow_login_and_email_in_password</a>( )
			...
			<tr data-order="are_login_and_email_forbidden_in_password" id="_are_login_and_email_forbidden_in_password">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-SecurityConfig.php">SecurityConfig</a></code>
...
<a href="source-class-SecurityConfig.php#80-86" title="Go to source code">save</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="INTERNAL_PASSWORD_MIN_LENGTH" id="INTERNAL_PASSWORD_MIN_LENGTH">
						...
						<td class="value">
							<div>
								<a href="#INTERNAL_PASSWORD_MIN_LENGTH" class="anchor">#</a>
								<code><span class="php-quote">'internal_password_min_length'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="INTERNAL_PASSWORD_STRENGTH" id="INTERNAL_PASSWORD_STRENGTH">
						...
						<td class="value">
							<div>
								<a href="#INTERNAL_PASSWORD_STRENGTH" class="anchor">#</a>
								<code><span class="php-quote">'internal_password_strength'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="LOGIN_AND_EMAIL_FORBIDDEN_IN_PASSWORD" id="LOGIN_AND_EMAIL_FORBIDDEN_IN_PASSWORD">
						...
						<td class="value">
							<div>
								<a href="#LOGIN_AND_EMAIL_FORBIDDEN_IN_PASSWORD" class="anchor">#</a>
								<code><span class="php-quote">'login_and_email_forbidden_in_password'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PASSWORD_STRENGTH_WEAK" id="PASSWORD_STRENGTH_WEAK">
						...
						<td class="value">
							<div>
								<a href="#PASSWORD_STRENGTH_WEAK" class="anchor">#</a>
								<code><span class="php-quote">'weak'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PASSWORD_STRENGTH_MEDIUM" id="PASSWORD_STRENGTH_MEDIUM">
						...
						<td class="value">
							<div>
								<a href="#PASSWORD_STRENGTH_MEDIUM" class="anchor">#</a>
								<code><span class="php-quote">'medium'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PASSWORD_STRENGTH_STRONG" id="PASSWORD_STRENGTH_STRONG">
						...
						<td class="value">
							<div>
								<a href="#PASSWORD_STRENGTH_STRONG" class="anchor">#</a>
								<code><span class="php-quote">'strong'</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="PASSWORD_STRENGTH_VERY_STRONG" id="PASSWORD_STRENGTH_VERY_STRONG">
						...
						<td class="value">
							<div>
								<a href="#PASSWORD_STRENGTH_VERY_STRONG" class="anchor">#</a>
								<code><span class="php-quote">'very_strong'</span></code>
							</div>
						</td>
					</tr>
				</table>
