<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FeedMenu.php" class="cssmenu-title">FeedMenu</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Menu.php">Menu</a>\<a href="package-PHPBoost.Menu.feed.php">feed</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2018 03 26
						</span>
						<span class="infos-options">
							<b>Since:</b>
...
<a href="source-class-FeedMenu.php#30-38" title="Go to source code">__construct</a>( <span>string <var>$title</var></span>, <span>integer <var>$module_id</var></span>, <span> <var>$category</var> = <span class="php-num">0</span></span>, <span> <var>$name</var> = Feed::DEFAULT_FEED_NAME</span>, <span> <var>$number</var> = <span class="php-num">10</span></span>, <span> <var>$begin_at</var> = <span class="php-num">0</span></span> )
						...
						<div class="description detailed hidden">
							<p>Build a Menu element.</p>
								...
								<div class="list"><dl>
									...
									<dd>$id its id in the database</dd>
			...
			<tr data-order="get_template" id="_get_template">
...
<a href="source-class-FeedMenu.php#40-60" title="Go to source code">get_template</a>( <span>string <var>$id</var></span>, <span>string <var>$name</var> = <span class="php-quote">''</span></span>, <span>string <var>$block_position</var> = Menu::BLOCK_POSITION__LEFT</span>, <span> <var>$hidden_with_small_screens</var> = <span class="php-keyword1">false</span></span> )
							...
							<div class="description short">
								<p>Returns the tpl to parse a feed</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the tpl to parse a feed</p>
								...
								<div class="list"><dl>
									...
									<dt><var>$name</var></dt>
									<dd>The feed name</dd>
									<dt><var>$block_position</var></dt>
									<dd>The indentifier block position defined in the inherit class menu</dd>
									<dt><var>$hidden_with_small_screens</var></dt>
									<dd></dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									the<br>tpl to parse a feed
								</div>
			...
			<tr data-order="get_module_id" id="_get_module_id">
...
<a href="source-class-FeedMenu.php#63-66" title="Go to source code">get_module_id</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>the feed menu module id
								</div>
...
<a href="source-class-FeedMenu.php#68-80" title="Go to source code">get_url</a>( <span>boolean <var>$relative</var> = <span class="php-keyword1">false</span></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$relative</var></dt>
									<dd>If false, compute the absolute url, else, returns the relative one</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									Return<br>the absolute feed Url
								</div>
			...
			<tr data-order="set_module_id" id="_set_module_id">
...
<a href="source-class-FeedMenu.php#83-86" title="Go to source code">set_module_id</a>( <span>string <var>$value</var></span> )
			...
			<tr data-order="set_cat" id="_set_cat">
...
<a href="source-class-FeedMenu.php#91-94" title="Go to source code">set_name</a>( <span>string <var>$value</var></span> )
			...
			<tr data-order="get_number" id="_get_number">
...
<a href="source-class-FeedMenu.php#96-102" title="Go to source code">get_number</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									Return<br>the number of elements displayed in the menu
								</div>
			...
			<tr data-order="set_number" id="_set_number">
...
<a href="source-class-FeedMenu.php#104-107" title="Go to source code">set_number</a>( <span>string <var>$value</var></span> )
						...
						<div class="description detailed hidden">
								...
								<div class="list"><dl>
									<dt><var>$value</var></dt>
									<dd>the number of elements displayed in the menu</dd>
								</dl></div>
...
<a href="source-class-FeedMenu.php#109-128" title="Go to source code">display</a>( )
			...
			<div class="responsive-table">
				<table class="summary inherited">
					...
					<tr>
						<td>
							<code>
									<a href="class-Menu.php#__assign">_assign()</a>, 
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="FEED_MENU__CLASS" id="FEED_MENU__CLASS">
						...
						<td class="value">
							<div>
								<a href="#FEED_MENU__CLASS" class="anchor">#</a>
								<code><span class="php-quote">'FeedMenu'</span></code>
							</div>
						</td>
					</tr>
				</table>
			...
			<tr data-order="module_id" id="$module_id">
				<td class="attributes">
					<code>
						public  
						string
				...
				<td class="value">
					<div>
						<a href="#$module_id" class="anchor">#</a>
						<code><span class="php-quote">''</span></code>
					</div>
				</td>
			</tr>
			...
			<tr data-order="category" id="$category">
				<td class="attributes">
					<code>
						public  
						integer
			...
			<tr data-order="number" id="$number">
				<td class="attributes">
					<code>
						public  
						integer
				...
				<td class="value">
					<div>
						<a href="#$number" class="anchor">#</a>
						<code><span class="php-num">10</span></code>
					</div>
				</td>
			</tr>
			<tr data-order="begin_at" id="$begin_at">
				<td class="attributes">
					<code>
						public  
						integer
				...
				<td class="value">
					<div>
						<a href="#$begin_at" class="anchor">#</a>
						<code><span class="php-num">0</span></code>
					</div>
				</td>
			</tr>
