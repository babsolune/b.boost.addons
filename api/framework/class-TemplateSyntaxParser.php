		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-TemplateSyntaxParser.php" class="cssmenu-title">TemplateSyntaxParser</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>TemplateSyntaxParser</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>template = (variableExpression | expression | condition | loop | include | text)*
...
<b><span>TemplateSyntaxParser</span></b>					
					 implements 
						<a href="class-TemplateParser.php"><span>TemplateParser</span></a>
						...
						<div class="description detailed hidden">
							<p>Parses the $content string.</p>
								...
								<div class="list"><dl>
									...
									<dd>The content to parse</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									The<br>parsed content
								</div>
								...
								<div class="list"><code><a href="class-TemplateParser.php#_parse">TemplateParser::parse()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
