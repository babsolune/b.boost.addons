		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-HTTPResponseCustom.php" class="cssmenu-title">HTTPResponseCustom</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>HTTPResponseCustom</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.HTTP.php">HTTP</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2017 03 23
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2010 01 23
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
			...
			<div class="description">
				<p>Manages response via the HTTP protocol</p>
			</div>
...
<a href="source-class-HTTPResponseCustom.php#69-76" title="Go to source code">set_header</a>( <span>string <var>$name</var></span>, <span> <var>$value</var></span> )
			...
			<tr data-order="set_default_attributes" id="_set_default_attributes">
...
<a href="source-class-HTTPResponseCustom.php#78-88" title="Go to source code">set_default_attributes</a>( <span>string <var>$url</var>,…</span> )
							...
							<div class="description short">
								<p>Set defaut headers for the response.</p>
							</div>
...
<a href="source-class-HTTPResponseCustom.php#90-111" title="Go to source code">redirect</a>( <span>string <var>$url</var></span>, <span> <var>$message</var> = <span class="php-quote">''</span></span>, <span> <var>$message_type</var> = MessageHelper::SUCCESS</span>, <span> <var>$message_duration</var> = <span class="php-num">5</span></span> )
							...
							<div class="description short">
								<p>Redirects the user to the URL and stops purely the script execution (database deconnexion...).</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Redirects the user to the URL and stops purely the script execution (database deconnexion...).</p>
								...
								<div class="list"><dl>
									<dt><var>$url</var></dt>
									<dd>URL at which you want to redirect the user.</dd>
									<dt><var>$message</var></dt>
									<dd></dd>
									<dt><var>$message_type</var></dt>
									<dd></dd>
									<dt><var>$message_duration</var></dt>
									<dd></dd>
								</dl></div>
			...
			<tr data-order="set_cookie" id="_set_cookie">
...
<a href="source-class-HTTPResponseCustom.php#113-120" title="Go to source code">set_cookie</a>( <span><code><a href="class-HTTPCookie.php">HTTPCookie</a></code> <var>$cookie</var></span> )
							...
							<div class="description short">
								<p>Set cookie for the application's client.</p>
							</div>
			...
			<tr data-order="delete_cookie" id="_delete_cookie">
...
<a href="source-class-HTTPResponseCustom.php#122-129" title="Go to source code">delete_cookie</a>( <span>string <var>$cookie_name</var></span> )
						...
						<div class="description detailed hidden">
							<p>Deletes the cookie</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$cookie_name</var></dt>
									<dd>the name of the cookie to delete</dd>
								</dl></div>
			...
			<tr data-order="clean_output" id="_clean_output">
...
<a href="source-class-HTTPResponseCustom.php#131-138" title="Go to source code">clean_output</a>( )
			...
			<tr data-order="get_previous_ob_content" id="_get_previous_ob_content">
...
<a href="source-class-HTTPResponseCustom.php#140-147" title="Go to source code">get_previous_ob_content</a>( )
							...
							<div class="description short">
								<p>Returns the previous output buffer content.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the previous output buffer content.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									string<br>the previous output buffer content.
								</div>
			...
			<tr data-order="set_status_code" id="_set_status_code">
					...
					<tr data-order="PROTOCOL" id="PROTOCOL">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'HTTP/1.1'</span></code>
							</div>
						</td>
					</tr>
				</table>
