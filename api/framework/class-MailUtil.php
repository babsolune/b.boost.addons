		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MailUtil.php" class="cssmenu-title">MailUtil</a></li>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Mail.php">Mail</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-MailUtil.php#3-48" title="Go to source code">io/mail/MailUtil.class.php</a></span>
			</div>

			<div class="description">
				<p>This class provides you utilities for emails.</p>
			</div>
			...
			<tr data-order="is_mail_valid" id="_is_mail_valid">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailUtil.php#21-29" title="Go to source code">is_mail_valid</a>( <span>string <var>$mail_address</var></span> )
						</code>
			...
			<tr data-order="get_mail_checking_regex" id="_get_mail_checking_regex">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailUtil.php#31-38" title="Go to source code">get_mail_checking_regex</a>( )
						</code>
			...
			<tr data-order="get_mail_checking_raw_regex" id="_get_mail_checking_raw_regex">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailUtil.php#40-47" title="Go to source code">get_mail_checking_raw_regex</a>( )
						</code>
