<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ATOM.php" class="cssmenu-title">ATOM</a></li>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Feed.php">Feed</a></span>
						...
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 2.0 - 2008 04 21
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
							mipel <a href="&#x6d;&#97;i&#x6c;&#116;o&#x3a;&#109;&#105;&#x70;&#101;&#108;&#x40;&#112;&#104;&#x70;&#x62;&#111;&#x6f;&#x73;&#116;&#x2e;&#x63;&#111;&#x6d;">&#109;&#105;&#x70;&#101;&#108;&#x40;&#112;&#104;&#x70;&#x62;&#111;&#x6f;&#x73;&#116;&#x2e;&#x63;&#111;&#x6d;</a>
						</span>
					<span class="infos-options"><b>Located at:</b> <a href="source-class-ATOM.php#3-79" title="Go to source code">content/feed/ATOM.class.php</a></span>
			</div>

			<div class="description">
				<p>This class could load a feed by its url or by a FeedData element and
export it to the ATOM format</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-Feed.php"><span>Feed</span></a>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-ATOM.php#21-31" title="Go to source code">__construct</a>( <span>string <var>$module_id</var></span>, <span>string <var>$feed_name</var> = Feed::DEFAULT_FEED_NAME</span>, <span>integer <var>$id_cat</var> = <span class="php-num">0</span></span> )
						</code>

							<div class="description short">
								<p>Builds a new ATOM object</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Builds a new ATOM object</p>
								...
								<div class="list"><dl>
									...
									<dd>its module_id</dd>
									<dt><var>$feed_name</var></dt>
									<dd>the feeds name / type. default is Feed::DEFAULT_FEED_NAME</dd>
									<dt><var>$id_cat</var></dt>
									<dd>the feed category id</dd>
								</dl></div>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Feed.php#___construct">Feed::__construct()</a></code></div>

						</div>
					</div>
				</td>
			</tr>
			<tr data-order="load_file" id="_load_file">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-ATOM.php#33-78" title="Go to source code">load_file</a>( <span>string <var>$url</var></span> )
						</code>

							<div class="description short">
								<p>Loads a feed by its url</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads a feed by its url</p>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-Feed.php#_load_file">Feed::load_file()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-Feed.php#methods">Feed</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-Feed.php#_cache">cache()</a>, 
									<a href="class-Feed.php#_clear_cache">clear_cache()</a>, 
									<a href="class-Feed.php#_export">export()</a>, 
									<a href="class-Feed.php#_get_cache_file_name">get_cache_file_name()</a>, 
									<a href="class-Feed.php#_get_feed_menu">get_feed_menu()</a>, 
									<a href="class-Feed.php#_get_parsed">get_parsed()</a>, 
									<a href="class-Feed.php#_is_in_cache">is_in_cache()</a>, 
									<a href="class-Feed.php#_load_data">load_data()</a>, 
									<a href="class-Feed.php#_read">read()</a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="DEFAULT_ATOM_TEMPLATE" id="DEFAULT_ATOM_TEMPLATE">

						<td class="attributes"><code>string</code></td>
						<td class="name">
							<code>
								<a href="source-class-ATOM.php#18" title="Go to source code"><b>DEFAULT_ATOM_TEMPLATE</b></a>
							</code>
						...
						<td class="value">
							<div>
								<a href="#DEFAULT_ATOM_TEMPLATE" class="anchor">#</a>
								<code><span class="php-quote">'framework/content/syndication/atom.tpl'</span></code>
							</div>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Constants inherited from <a href="class-Feed.php#constants">Feed</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-Feed.php#DEFAULT_FEED_NAME"><b>DEFAULT_FEED_NAME</b></a>
							</code>
						</td>
					</tr>
				</table>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Properties inherited from <a href="class-Feed.php#properties">Feed</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-Feed.php#$tpl"><var>$tpl</var></a>
							</code>
						</td>
					</tr>
				</table>
