		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SiteDisplayFrameGraphicalEnvironment.php" class="cssmenu-title">SiteDisplayFrameGraphicalEnvironment</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SiteDisplayFrameGraphicalEnvironment</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Environment.php">Environment</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2016 11 08
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 4.0 - 2014 06 21
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-SiteDisplayFrameGraphicalEnvironment.php#3-76" title="Go to source code">phpboost/environment/SiteDisplayFrameGraphicalEnvironment.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractGraphicalEnvironment.php"><span>AbstractGraphicalEnvironment</span></a>
					
					 implements 
						<a href="class-GraphicalEnvironment.php"><span>GraphicalEnvironment</span></a>
					
					
				</dd>
				<dd style="padding-left:30px">
					<img src="resources/inherit.png" alt="Extended by">
					<a href="class-AbstractDisplayGraphicalEnvironment.php"><span>AbstractDisplayGraphicalEnvironment</span></a>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>SiteDisplayFrameGraphicalEnvironment</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-SiteDisplayFrameGraphicalEnvironment.php#19-22" title="Go to source code">__construct</a>( )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractDisplayGraphicalEnvironment.php#___construct">AbstractDisplayGraphicalEnvironment::__construct()</a></code></div>
			...
			<tr data-order="display" id="_display">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-SiteDisplayFrameGraphicalEnvironment.php#24-70" title="Go to source code">display</a>( <span> <var>$content</var></span> )
						</code>

							<div class="description short">
								<p>Displays the environment with content of the page.</p>
							</div>
			...
			<tr data-order="display_css_login" id="_display_css_login">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_display_css_login">#</a>
						<code>
<a href="source-class-SiteDisplayFrameGraphicalEnvironment.php#72-75" title="Go to source code">display_css_login</a>( )
						</code>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractDisplayGraphicalEnvironment.php#methods">AbstractDisplayGraphicalEnvironment</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractDisplayGraphicalEnvironment.php#_display_kernel_message">display_kernel_message()</a>, 
									<a href="class-AbstractDisplayGraphicalEnvironment.php#_get_location_id">get_location_id()</a>, 
									<a href="class-AbstractDisplayGraphicalEnvironment.php#_get_modules_css_files_html_code">get_modules_css_files_html_code()</a>, 
									<a href="class-AbstractDisplayGraphicalEnvironment.php#_get_page_title">get_page_title()</a>, 
									<a href="class-AbstractDisplayGraphicalEnvironment.php#_get_seo_meta_data">get_seo_meta_data()</a>, 
									<a href="class-AbstractDisplayGraphicalEnvironment.php#_retrieve_kernel_message">retrieve_kernel_message()</a>, 
									<a href="class-AbstractDisplayGraphicalEnvironment.php#_set_location_id">set_location_id()</a>, 
									<a href="class-AbstractDisplayGraphicalEnvironment.php#_set_page_title">set_page_title()</a>, 
									<a href="class-AbstractDisplayGraphicalEnvironment.php#_set_seo_meta_data">set_seo_meta_data()</a>
							</code>
						</td>
					</tr>
				</table>
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractGraphicalEnvironment.php#methods">AbstractGraphicalEnvironment</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractGraphicalEnvironment.php#_no_session_location">no_session_location()</a>, 
									<a href="class-AbstractGraphicalEnvironment.php#_process_site_maintenance">process_site_maintenance()</a>, 
									<a href="class-AbstractGraphicalEnvironment.php#_set_page_localization">set_page_localization()</a>
							</code>
						</td>
					</tr>
				</table>
