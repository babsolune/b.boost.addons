		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MenusProvidersService.php" class="cssmenu-title">MenusProvidersService</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MenusProvidersService</h2></header>
		<div class="content">
...
<a href="source-class-MenusProvidersService.php#15-22" title="Go to source code">get_menus</a>( <span> <var>$module_id</var></span> )
			...
			<tr data-order="module_containing_extension_point" id="_module_containing_extension_point">
...
<a href="source-class-MenusProvidersService.php#24-27" title="Go to source code">module_containing_extension_point</a>( <span> <var>$module_id</var></span> )
			...
			<tr data-order="get_extension_point_ids" id="_get_extension_point_ids">
