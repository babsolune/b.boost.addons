		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-SQLQuerierException.php" class="cssmenu-title">SQLQuerierException</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>SQLQuerierException</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-SQLQuerierException.php#3-13" title="Go to source code">io/db/SQLQuerierException.class.php</a></span>
			</div>
...
<b><span>SQLQuerierException</span></b>					
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-MySQLQuerierException.php">MySQLQuerierException</a>, 
					<a href="class-NotASingleRowFoundException.php">NotASingleRowFoundException</a>, 
					<a href="class-PDOQuerierException.php">PDOQuerierException</a>, 
					<a href="class-RowNotFoundException.php">RowNotFoundException</a>
			</div>
