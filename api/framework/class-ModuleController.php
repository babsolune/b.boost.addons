		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ModuleController.php" class="cssmenu-title">ModuleController</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ModuleController</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-MVC.php">MVC</a>\<a href="package-MVC.Controller.php">Controller</a></span>
						...
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2009 12 14
						</span>
					<span class="infos-options"><b>Located at:</b> <a href="source-class-ModuleController.php#3-32" title="Go to source code">mvc/controller/ModuleController.class.php</a></span>
			</div>
...
<b><span>ModuleController</span></b>					
			...
			<tr data-order="get_right_controller_regarding_authorizations" id="_get_right_controller_regarding_authorizations">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-ModuleController.php#16-31" title="Go to source code">get_right_controller_regarding_authorizations</a>( )
						</code>
...
for the controller</p>
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractController.php#_get_right_controller_regarding_authorizations">AbstractController::get_right_controller_regarding_authorizations()</a></code></div>
