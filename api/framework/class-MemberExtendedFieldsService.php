		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MemberExtendedFieldsService.php" class="cssmenu-title">MemberExtendedFieldsService</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MemberExtendedFieldsService</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class is responsible for updated, displayed and registed of member extended fields.</p>
			</div>
...
<a href="source-class-MemberExtendedFieldsService.php#19-22" title="Go to source code">__construct</a>( <span><code><a href="class-HTMLForm.php">HTMLForm</a></code> <var>$form</var></span> )
			...
			<tr data-order="display_form_fields" id="_display_form_fields">
...
<a href="source-class-MemberExtendedFieldsService.php#24-45" title="Go to source code">display_form_fields</a>( <span>object <var>$user_id</var> = <span class="php-keyword1">null</span></span> )
							...
							<div class="description short">
								<p>This function displayed fields form</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>This function displayed fields form</p>
								...
								<div class="list"><dl>
									...
									<dd>$member_extended_field MemberExtendedField containing user_id and Template. If user is not registered, use object MemberExtendedField, and define user_id of null.</dd>
								</dl></div>
			...
			<tr data-order="display_profile_fields" id="_display_profile_fields">
...
<a href="source-class-MemberExtendedFieldsService.php#47-83" title="Go to source code">display_profile_fields</a>( <span>object <var>$user_id</var></span> )
							...
							<div class="description short">
								<p>This function displayed fields profile</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>This function displayed fields profile</p>
								...
								<div class="list"><dl>
									<dt><var>$user_id</var></dt>
									<dd>$member_extended_field MemberExtendedField containing user_id, Template and field_type.</dd>
								</dl></div>
...
<a href="source-class-MemberExtendedFieldsService.php#85-120" title="Go to source code">get_data</a>( <span>object <var>$user_id</var></span> )
							...
							<div class="description short">
								<p>This function register fields</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>This function register fields</p>
								...
								<div class="list"><dl>
									<dt><var>$user_id</var></dt>
									<dd>$member_extended_field MemberExtendedField</dd>
								</dl></div>
			...
			<tr data-order="delete_user_fields" id="_delete_user_fields">
...
<a href="source-class-MemberExtendedFieldsService.php#173-193" title="Go to source code">delete_user_fields</a>( <span>integer <var>$user_id</var></span> )
							...
							<div class="description short">
								<p>This function deletes the extended fields of the user</p>
							</div>
			...
			<tr data-order="return_field_member" id="_return_field_member">
...
<a href="source-class-MemberExtendedFieldsService.php#195-210" title="Go to source code">return_field_member</a>( <span> <var>$field_name</var></span>, <span> <var>$user_id</var></span>, <span> <var>$rewrite</var> = <span class="php-keyword1">false</span></span> )
							...
							<div class="description short">
								<p>This public function return the data sent by the user depending field_name</p>
							</div>
