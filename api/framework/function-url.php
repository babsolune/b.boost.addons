		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="function-url.php" class="cssmenu-title deprecated">url</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Helper.php">Helper</a></span>
						<span class="infos-options">
							<b>Deprecated:</b>
							<p>Adds the session ID to an URL if the user doesn't accepts cookies.
			...
			<div class="responsive-table">
				<table class="summary" id="parameters">
					...
					<tr id="$url">
						...
						<td class="value"><code><var>$url</var></code></td>
						<td>URL if the URL rewriting is disabled</td>
					</tr>
					<tr id="$mod_rewrite">
						<td class="name"><code>string</code></td>
						<td class="value"><code><var>$mod_rewrite</var> = <span class="php-quote">''</span></code></td>
						<td>URL if the URL rewriting is enabled</td>
					</tr>
					<tr id="$ampersand">
						<td class="name"><code>string</code></td>
						<td class="value"><code><var>$ampersand</var> = <span class="php-quote">'&amp;amp;'</span></code></td>
