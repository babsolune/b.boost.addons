<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractDisplayGraphicalEnvironment.php" class="cssmenu-title">AbstractDisplayGraphicalEnvironment</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractDisplayGraphicalEnvironment</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class contains the content of the writing pad which is on the home page
...
<b><span>AbstractDisplayGraphicalEnvironment</span></b>					
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-AdminDisplayFrameGraphicalEnvironment.php">AdminDisplayFrameGraphicalEnvironment</a>, 
					<a href="class-AdminDisplayGraphicalEnvironment.php">AdminDisplayGraphicalEnvironment</a>, 
					<a href="class-SiteDisplayFrameGraphicalEnvironment.php">SiteDisplayFrameGraphicalEnvironment</a>, 
					<a href="class-SiteDisplayGraphicalEnvironment.php">SiteDisplayGraphicalEnvironment</a>
			</div>
...
<a href="source-class-AbstractDisplayGraphicalEnvironment.php#26-29" title="Go to source code">__construct</a>( )
			...
			<tr data-order="get_modules_css_files_html_code" id="_get_modules_css_files_html_code">
...
<a href="source-class-AbstractDisplayGraphicalEnvironment.php#50-53" title="Go to source code">get_location_id</a>( )
			...
			<tr data-order="set_location_id" id="_set_location_id">
...
<a href="source-class-AbstractDisplayGraphicalEnvironment.php#55-58" title="Go to source code">set_location_id</a>( <span> <var>$location_id</var></span> )
			...
			<tr data-order="get_seo_meta_data" id="_get_seo_meta_data">
...
<a href="source-class-AbstractDisplayGraphicalEnvironment.php#60-63" title="Go to source code">get_seo_meta_data</a>( )
			...
			<tr data-order="set_seo_meta_data" id="_set_seo_meta_data">
...
<a href="source-class-AbstractDisplayGraphicalEnvironment.php#65-68" title="Go to source code">set_seo_meta_data</a>( <span><code><a href="class-SEOMetaData.php">SEOMetaData</a></code> <var>$seo_meta_data</var></span> )
			...
			<tr data-order="get_page_title" id="_get_page_title">
...
<a href="source-class-AbstractDisplayGraphicalEnvironment.php#70-73" title="Go to source code">get_page_title</a>( )
			...
			<tr data-order="set_page_title" id="_set_page_title">
...
<a href="source-class-AbstractDisplayGraphicalEnvironment.php#75-82" title="Go to source code">set_page_title</a>( <span> <var>$title</var></span>, <span> <var>$section</var> = <span class="php-quote">''</span></span>, <span> <var>$page</var> = <span class="php-num">1</span></span> )
			...
			<tr data-order="retrieve_kernel_message" id="_retrieve_kernel_message">
...
<a href="source-class-AbstractDisplayGraphicalEnvironment.php#84-106" title="Go to source code">retrieve_kernel_message</a>( )
			...
			<tr data-order="display_kernel_message" id="_display_kernel_message">
...
<a href="source-class-AbstractDisplayGraphicalEnvironment.php#108-115" title="Go to source code">display_kernel_message</a>( <span><code><a href="class-View.php">View</a></code> <var>$template</var></span> )
			...
			<div class="responsive-table">
				...
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-GraphicalEnvironment.php#methods">GraphicalEnvironment</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-GraphicalEnvironment.php#_display">display()</a>
							</code>
						</td>
					</tr>
				</table>
