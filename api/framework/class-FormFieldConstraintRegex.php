		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormFieldConstraintRegex.php" class="cssmenu-title">FormFieldConstraintRegex</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormFieldConstraintRegex</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a>\<a href="package-Builder.Form.field.php">field</a>\<a href="package-Builder.Form.field.constraint.php">constraint</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormFieldConstraintRegex.php#3-81" title="Go to source code">builder/form/field/constraint/FormFieldConstraintRegex.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractFormFieldConstraint.php"><span>AbstractFormFieldConstraint</span></a>
...
<b><span>FormFieldConstraintRegex</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldConstraintRegex.php#23-39" title="Go to source code">__construct</a>( <span> <var>$php_regex</var></span>, <span> <var>$js_regex</var> = <span class="php-quote">''</span></span>, <span> <var>$error_message</var> = <span class="php-quote">''</span></span> )
						</code>
			...
			<tr data-order="validate" id="_validate">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldConstraintRegex.php#60-74" title="Go to source code">validate</a>( <span><code><a href="class-FormField.php">FormField</a></code> <var>$field</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractFormFieldConstraint.php#_validate">AbstractFormFieldConstraint::validate()</a></code></div>
			...
			<tr data-order="get_js_validation" id="_get_js_validation">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldConstraintRegex.php#76-80" title="Go to source code">get_js_validation</a>( <span><code><a href="class-FormField.php">FormField</a></code> <var>$field</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractFormFieldConstraint.php#_get_js_validation">AbstractFormFieldConstraint::get_js_validation()</a></code></div>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractFormFieldConstraint.php#methods">AbstractFormFieldConstraint</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractFormFieldConstraint.php#_get_validation_error_message">get_validation_error_message()</a>, 
									<a href="class-AbstractFormFieldConstraint.php#_set_validation_error_message">set_validation_error_message()</a>
							</code>
						</td>
					</tr>
				</table>
