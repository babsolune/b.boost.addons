<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DataStore.php" class="cssmenu-title">DataStore</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>This interface represents a data store. Its different implementations store data in
...
identifier must be a string with only letters and digits.</p>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-APCDataStore.php">APCDataStore</a>, 
					<a href="class-FileSystemDataStore.php">FileSystemDataStore</a>, 
					<a href="class-RAMDataStore.php">RAMDataStore</a>
			</div>
