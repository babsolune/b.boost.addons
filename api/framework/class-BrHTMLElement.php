<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-BrHTMLElement.php" class="cssmenu-title">BrHTMLElement</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>BrHTMLElement</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Element.php">Element</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 11 12
						</span>
						<span class="infos-options">
							<b>Since:</b>
