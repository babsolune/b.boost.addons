<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-AbstractConfigData.php" class="cssmenu-title">AbstractConfigData</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>AbstractConfigData</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This is a default and minimal implementation of the ConfigData interface.</p>
			</div>

			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>AbstractConfigData</span></b>					
					 implements 
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-CommentsConfig.php">CommentsConfig</a>, 
					<a href="class-ContentFormattingConfig.php">ContentFormattingConfig</a>, 
					<a href="class-LastUseDateConfig.php">LastUseDateConfig</a>, 
					<a href="class-MailServiceConfig.php">MailServiceConfig</a>, 
					<a href="class-MaintenanceConfig.php">MaintenanceConfig</a>, 
					<a href="class-ModulesConfig.php">ModulesConfig</a>, 
					<a href="class-SecurityConfig.php">SecurityConfig</a>, 
					<a href="class-ServerEnvironmentConfig.php">ServerEnvironmentConfig</a>, 
					<a href="class-SessionsConfig.php">SessionsConfig</a>, 
					<a href="class-ThemesConfig.php">ThemesConfig</a>, 
					<a href="class-UserAccountsConfig.php">UserAccountsConfig</a>, 
					<a href="class-WritingPadConfig.php">WritingPadConfig</a>, 
					<a href="class-ContentManagementConfig.php">ContentManagementConfig</a>, 
					<a href="class-CookieBarConfig.php">CookieBarConfig</a>, 
					<a href="class-CSSCacheConfig.php">CSSCacheConfig</a>, 
					<a href="class-CustomizationConfig.php">CustomizationConfig</a>, 
					<a href="class-FileUploadConfig.php">FileUploadConfig</a>, 
					<a href="class-GeneralConfig.php">GeneralConfig</a>, 
					<a href="class-GraphicalEnvironmentConfig.php">GraphicalEnvironmentConfig</a>, 
					<a href="class-LangsConfig.php">LangsConfig</a>
			</div>
...
<a href="source-class-AbstractConfigData.php#18-23" title="Go to source code">__construct</a>( )
							...
							<div class="description short">
								<p>Constructs a AbstractConfigData object</p>
							</div>
...
<a href="source-class-AbstractConfigData.php#25-31" title="Go to source code">synchronize</a>( )
							...
							<div class="description short">
								<p>This method is not used in the configuration context.
...
For instance,</p>
			...
			<tr data-order="set_default_values" id="_set_default_values">
...
<a href="source-class-AbstractConfigData.php#33-44" title="Go to source code">set_default_values</a>( )
							...
							<div class="description short">
								<p>Redefine this method if you want to avoid getting errors while asking values.
Sets the default value to avoid having unexisting values when we use it.
If some entries doesn't exist, they can be created here.</p>
							</div>
...
If some entries doesn't exist, they can be created here.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ConfigData.php#_set_default_values">ConfigData::set_default_values()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="get_property" id="_get_property">
...
<a href="source-class-AbstractConfigData.php#46-59" title="Go to source code">get_property</a>( <span>string <var>$name</var></span> )
						...
						<div class="description detailed hidden">
							<p>Reads a property's value.</p>
								...
								<div class="list"><dl>
									<dt><var>$name</var></dt>
									<dd>Name of the property to read</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									string<br>the read value
								</div>

								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-PropertyNotFoundException.php">PropertyNotFoundException</a></code><br>If the property if not found
								</div>



								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ConfigData.php#_get_property">ConfigData::get_property()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="set_property" id="_set_property">
...
<a href="source-class-AbstractConfigData.php#74-80" title="Go to source code">set_property</a>( <span>string <var>$name</var></span>, <span>string <var>$value</var></span> )
							...
							<div class="description short">
								<p>Sets a property value. If the property exists, it overrides its value,
otherwise, it creates an entry for this property.</p>
							</div>
...
otherwise, it creates an entry for this property.</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-ConfigData.php#_set_property">ConfigData::set_property()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
