<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-ContentFormattingExtensionPoint.php" class="cssmenu-title">ContentFormattingExtensionPoint</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ContentFormattingExtensionPoint</h2></header>
		<div class="content">
...
<b><span>ContentFormattingExtensionPoint</span></b>					
					 implements 
						<a href="class-ExtensionPoint.php"><span>ExtensionPoint</span></a>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-AbstractContentFormattingExtensionPoint.php">AbstractContentFormattingExtensionPoint</a>
			</div>
...
<a href="source-class-ContentFormattingExtensionPoint.php#17" title="Go to source code">get_name</a>( )
			...
			<tr data-order="get_parser" id="_get_parser">

				<td class="attributes">
					<code>
						 public 

						<code><a href="class-FormattingParser.php">FormattingParser</a></code>
...
<a href="source-class-ContentFormattingExtensionPoint.php#19-23" title="Go to source code">get_parser</a>( )
							...
							<div class="description short">
								<p>Returns a parser which will work in the language you chose.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns a parser which will work in the language you chose.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-FormattingParser.php">FormattingParser</a></code><br>The parser to use to parse you formatting
								</div>
			...
			<tr data-order="get_unparser" id="_get_unparser">
...
<a href="source-class-ContentFormattingExtensionPoint.php#25-29" title="Go to source code">get_unparser</a>( )
							...
							<div class="description short">
								<p>Returns a unparser which will work in the language you chose.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns a unparser which will work in the language you chose.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-FormattingParser.php">FormattingParser</a></code><br>The unparser to use to unparse you formatting
								</div>
			...
			<tr data-order="get_second_parser" id="_get_second_parser">
...
<a href="source-class-ContentFormattingExtensionPoint.php#31-35" title="Go to source code">get_second_parser</a>( )
							...
							<div class="description short">
								<p>Returns a second parser which will work in the language you chose.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns a second parser which will work in the language you chose.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-FormattingParser.php">FormattingParser</a></code><br>The second parser to use just before displaying you formatted text
								</div>
			...
			<tr data-order="get_editor" id="_get_editor">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-ContentEditor.php">ContentEditor</a></code>
...
<a href="source-class-ContentFormattingExtensionPoint.php#37-41" title="Go to source code">get_editor</a>( )
							...
							<div class="description short">
								<p>Returns an editor object which will display the editor corresponding to the language you chose.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns an editor object which will display the editor corresponding to the language you chose.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-ContentEditor.php">ContentEditor</a></code><br>The editor to use.
								</div>
...
<a href="source-class-ContentFormattingExtensionPoint.php#65" title="Go to source code">get_html_auth</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="value">
							<div>
								<a href="#EXTENSION_POINT" class="anchor">#</a>
								<code><span class="php-quote">'content_formatting'</span></code>
							</div>
						</td>
					</tr>
				</table>
