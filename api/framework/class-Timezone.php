		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Timezone.php" class="cssmenu-title">Timezone</a></li>
...
<section id="content" class="class">
	...
	<article>
		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Util.php">Util</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2015 01 01
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2010 10 30
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
		...
		<div class="content">
			...
			<tr data-order="get_supported_timezones" id="_get_supported_timezones">
...
<a href="source-class-Timezone.php#28-44" title="Go to source code">get_timezone</a>( <span>integer <var>$timezone_code</var></span> )
							...
							<div class="description short">
								<p>Returns the PHP timezone corresponding to the timezone code</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the PHP timezone corresponding to the timezone code</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$timezone_code</var></dt>
									<dd>$timezone SERVER_TIMEZONE, SITE_TIMEZONE or USER_TIMEZONE</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									DateTimeZone<br>The PHP timezone
								</div>
			...
			<tr data-order="get_server_timezone" id="_get_server_timezone">
...
<a href="source-class-Timezone.php#55-62" title="Go to source code">get_site_timezone</a>( )
			...
			<tr data-order="get_user_timezone" id="_get_user_timezone">
...
<a href="source-class-Timezone.php#64-71" title="Go to source code">get_user_timezone</a>( )
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="SERVER_TIMEZONE" id="SERVER_TIMEZONE">
						...
						<td class="value">
							<div>
								<a href="#SERVER_TIMEZONE" class="anchor">#</a>
					...
					<tr data-order="USER_TIMEZONE" id="USER_TIMEZONE">
						...
						<td class="value">
							<div>
								<a href="#USER_TIMEZONE" class="anchor">#</a>
