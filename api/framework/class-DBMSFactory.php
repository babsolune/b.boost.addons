<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-DBMSFactory.php" class="cssmenu-title">DBMSFactory</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>DBMSFactory</h2></header>
		<div class="content">
...
<p>for the right sgbd.</p>
			...
			<div>
				<h6>Direct known implementers</h6>
					<a href="class-MySQLDBFactory.php">MySQLDBFactory</a>, 
					<a href="class-PDOMySQLDBFactory.php">PDOMySQLDBFactory</a>
			</div>
