<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-CommentsExtensionPoint.php" class="cssmenu-title">CommentsExtensionPoint</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CommentsExtensionPoint</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Comments.php">Comments</a>\<a href="package-Content.Comments.extension.point.php">extension-point</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2016 10 09
						</span>
						<span class="infos-options">
							<b>Since:</b>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-CommentsExtensionPoint.php#3-17" title="Go to source code">content/comments/extension-point/CommentsExtensionPoint.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
<b><span>CommentsExtensionPoint</span></b>					
					 implements 
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="name">
							<code>
								<a href="source-class-CommentsExtensionPoint.php#16" title="Go to source code"><b>EXTENSION_POINT</b></a>
							</code>
