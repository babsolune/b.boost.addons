		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-MemberDisabledActionAuthorization.php" class="cssmenu-title">MemberDisabledActionAuthorization</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MemberDisabledActionAuthorization</h2></header>
		<div class="content">
...
In this class the select of Visitor and Member level is not possible.</p>
			</div>
...
<b><span>MemberDisabledActionAuthorization</span></b>					
