		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormButtonLinkCssImg.php" class="cssmenu-title">FormButtonLinkCssImg</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormButtonLinkCssImg</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a>\<a href="package-Builder.Form.button.php">button</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormButtonLinkCssImg.php#3-31" title="Go to source code">builder/form/button/FormButtonLinkCssImg.class.php</a></span>
			</div>
...
<b><span>FormButtonLinkCssImg</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormButtonLinkCssImg.php#18-30" title="Go to source code">__construct</a>( <span> <var>$label</var></span>, <span> <var>$link</var></span>, <span> <var>$css_class_image</var> = <span class="php-quote">''</span></span>, <span> <var>$text_button</var> = <span class="php-quote">''</span></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Overrides</h6>
								<div class="list"><code><a href="class-AbstractFormButton.php#___construct">AbstractFormButton::__construct()</a></code></div>
