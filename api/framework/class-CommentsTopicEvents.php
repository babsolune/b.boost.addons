		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-CommentsTopicEvents.php" class="cssmenu-title">CommentsTopicEvents</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CommentsTopicEvents</h2></header>
		<div class="content">
...
<a href="source-class-CommentsTopicEvents.php#17-20" title="Go to source code">__construct</a>( <span><code><a href="class-CommentsTopic.php">CommentsTopic</a></code> <var>$comments_topic</var></span> )
			...
			<tr data-order="execute_add_comment_event" id="_execute_add_comment_event">
...
<a href="source-class-CommentsTopicEvents.php#22" title="Go to source code">execute_add_comment_event</a>( )
			...
			<tr data-order="get_comments_topic" id="_get_comments_topic">
...
<a href="source-class-CommentsTopicEvents.php#24-27" title="Go to source code">get_comments_topic</a>( )
			...
			<tr data-order="comments_topic" id="$comments_topic">
				<td class="attributes">
					<code>
						protected  
				...
				<td class="value">
					<div>
						<a href="#$comments_topic" class="anchor">#</a>
						<code></code>
					</div>
				</td>
			</tr>
