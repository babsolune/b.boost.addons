		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-UrlMappingsExtensionPoint.php" class="cssmenu-title">UrlMappingsExtensionPoint</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>UrlMappingsExtensionPoint</h2></header>
		<div class="content">
...
<b><span>UrlMappingsExtensionPoint</span></b>					
					 implements 
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'url_mappings'</span></code>
							</div>
						</td>
					</tr>
				</table>
