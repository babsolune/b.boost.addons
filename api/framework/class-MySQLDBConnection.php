<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-MySQLDBConnection.php" class="cssmenu-title">MySQLDBConnection</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>MySQLDBConnection</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a>\<a href="package-IO.DB.driver.php">driver</a>\<a href="package-IO.DB.driver.mysql.php">mysql</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2016 09 09
						</span>
						<span class="infos-options">
							<b>Since:</b>
...
<b><span>MySQLDBConnection</span></b>					
					 implements 
						<a href="class-DBConnection.php"><span>DBConnection</span></a>
...
<a href="source-class-MySQLDBConnection.php#26-51" title="Go to source code">connect</a>( <span>array <var>$db_connection_data</var></span> )
						...
						<div class="description detailed hidden">
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$db_connection_data</var></dt>
									<dd></dd>
								</dl></div>
								...
								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-DBConnectionException.php">DBConnectionException</a></code><br>
									<code><a href="class-UnexistingDatabaseException.php">UnexistingDatabaseException</a></code>
								</div>



								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DBConnection.php#_connect">DBConnection::connect()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-MySQLDBConnection.php#53-56" title="Go to source code">get_link</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									the<br>database link (mysql resource, pdo object, ... depends of the database)
								</div>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DBConnection.php#_get_link">DBConnection::get_link()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-MySQLDBConnection.php#58-71" title="Go to source code">disconnect</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DBConnection.php#_disconnect">DBConnection::disconnect()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
			<tr data-order="start_transaction" id="_start_transaction">
...
<a href="source-class-MySQLDBConnection.php#73-76" title="Go to source code">start_transaction</a>( )
							...
							<div class="description short">
								<p>start a new transaction. If a transaction has already been started,
no new transaction will be created, but the existing one will be used
(does not count in the requests count)</p>
							</div>
...
(does not count in the requests count)</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DBConnection.php#_start_transaction">DBConnection::start_transaction()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-MySQLDBConnection.php#78-81" title="Go to source code">commit</a>( )
							...
							<div class="description short">
								<p>commit the current transaction (does not count in the requests count)</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>commit the current transaction (does not count in the requests count)</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DBConnection.php#_commit">DBConnection::commit()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
...
<a href="source-class-MySQLDBConnection.php#83-86" title="Go to source code">rollback</a>( )
							...
							<div class="description short">
								<p>rollback the current transaction (does not count in the requests count)</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>rollback the current transaction (does not count in the requests count)</p>
								...
								<h6>Implementation of</h6>
								<div class="list"><code><a href="class-DBConnection.php#_rollback">DBConnection::rollback()</a></code></div>
						</div>
					</div>
				</td>
			</tr>
