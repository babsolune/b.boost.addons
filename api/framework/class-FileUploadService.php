<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FileUploadService.php" class="cssmenu-title">FileUploadService</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FileUploadService</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.HTTP.php">HTTP</a>\<a href="package-IO.HTTP.upload.php">upload</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FileUploadService.php#3-48" title="Go to source code">io/http/upload/FileUploadService.class.php</a></span>
			</div>

			<div class="description">
				<p>Manages the HTTP file upload</p>
			</div>
		...
		<div class="content">
			...
			<tr data-order="retrieve_file" id="_retrieve_file">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_retrieve_file">#</a>
						<code>
<a href="source-class-FileUploadService.php#16-39" title="Go to source code">retrieve_file</a>( <span>string <var>$varname</var></span> )
						</code>
						...
						<div class="description detailed hidden">
								...
								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-UploadedFileTooLargeException.php">UploadedFileTooLargeException</a></code><br>if the file is too big<br>
									Exception<br>if an unknown error occurs
								</div>
