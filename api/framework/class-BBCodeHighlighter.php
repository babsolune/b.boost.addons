		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-BBCodeHighlighter.php" class="cssmenu-title">BBCodeHighlighter</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>BBCodeHighlighter</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class is a highlighter for the PHPBoost BBCode language.
It supplies the highlighted code written in XHTML.</p>
			</div>
...
<b><span>BBCodeHighlighter</span></b>					
...
<a href="source-class-BBCodeHighlighter.php#39-46" title="Go to source code">__construct</a>( )
							...
							<div class="description short">
								<p>Builds a BBCodeHighlighter objet</p>
							</div>
...
<a href="source-class-BBCodeHighlighter.php#48-107" title="Go to source code">parse</a>( <span>boolean <var>$inline_code</var> = self::BBCODE_HIGHLIGHTER_BLOCK_CODE</span> )
							...
							<div class="description short">
								<p>Highlights the content of the parser.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Highlights the content of the parser.</p>
								...
								<div class="list"><dl>
									...
									<dd><p>If you want that the code make a new HTML paragraph, use BBCODE_HIGHLIGHTER_BLOCK_CODE
(default parameter) and if you want that it would be integrated in a line, use BBCODE_HIGHLIGHTER_INLINE_CODE</p></dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<br>You can get the result by calling the get_content method
								</div>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="BBCODE_HIGHLIGHTER_INLINE_CODE" id="BBCODE_HIGHLIGHTER_INLINE_CODE">
						...
						<td class="value">
							<div>
								<a href="#BBCODE_HIGHLIGHTER_INLINE_CODE" class="anchor">#</a>
								<code><span class="php-keyword1">true</span></code>
							</div>
						</td>
					</tr>
					<tr data-order="BBCODE_HIGHLIGHTER_BLOCK_CODE" id="BBCODE_HIGHLIGHTER_BLOCK_CODE">
						...
						<td class="value">
							<div>
								<a href="#BBCODE_HIGHLIGHTER_BLOCK_CODE" class="anchor">#</a>
