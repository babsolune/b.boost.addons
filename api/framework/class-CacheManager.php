<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-CacheManager.php" class="cssmenu-title">CacheManager</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>CacheManager</h2></header>
		<div class="content">
			...
			<div class="description">
				<p>This class manages cache. It makes a two-level lazy loading:</p>

<ul> <li>A top-level cache which avoids loading a data if it has already been done since the
beginning of the current page generation. This cache has a short life span: it's flushed
as of the PHP interpreter reaches the end of the page generation.</li> <li>A filesystem or shared RAM (via APC) cache to avoid querying the database every time to obtain the same value.
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-CacheData.php">CacheData</a></code>
...
<a href="source-class-CacheManager.php#58-82" title="Go to source code">load</a>( <span>string <var>$classname</var></span>, <span>string <var>$module_name</var></span>, <span>string <var>$entry_name</var> = <span class="php-quote">''</span></span> )
							...
							<div class="description short">
								<p>Loads the data which is identified by the parameters</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads the data which is identified by the parameters</p>
								...
								<div class="list"><dl>
									...
									<dd>Name of the class of which the result will be an instance</dd>
									<dt><var>$module_name</var></dt>
									<dd>Name of the module owning the entry to load</dd>
									<dt><var>$entry_name</var></dt>
									<dd><p>If the module wants to manage several entries,
it's the name of the entry you want to load</p></dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-CacheData.php">CacheData</a></code><br>The loaded data
								</div>
			...
			<tr data-order="try_load" id="_try_load">
...
<a href="source-class-CacheManager.php#84-110" title="Go to source code">try_load</a>( <span>string <var>$classname</var></span>, <span>string <var>$module_name</var></span>, <span>string <var>$entry_name</var></span> )
							...
							<div class="description short">
								<p>Tries to load the data which is identified by the parameters</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Tries to load the data which is identified by the parameters</p>
								...
								<div class="list"><dl>
									...
									<dt><var>$entry_name</var></dt>
									<dd>Name of the entry of the module</dd>
								</dl></div>
								...
								<h6>Throws</h6>
								<div class="list">
									<code><a href="class-CacheDataNotFoundException.php">CacheDataNotFoundException</a></code><br>if the cache doesn't exist
								</div>
...
<a href="source-class-CacheManager.php#112-124" title="Go to source code">invalidate</a>( <span>string <var>$module_name</var></span>, <span>string <var>$entry_name</var> = <span class="php-quote">''</span></span> )
							...
							<div class="description short">
								<p>Invalidates an entry which is cached. If the corresponding data are loaded agin,
they will be regenerated.</p>
							</div>
...
they will be regenerated.</p>
								...
								<div class="list"><dl>
									<dt><var>$module_name</var></dt>
									<dd>Name of the module owning the entry to invalidate</dd>
									<dt><var>$entry_name</var></dt>
									<dd><p>If the module wants to manage several entries,
it's the name of the entry you want to invalidate</p></dd>
								</dl></div>
...
<a href="source-class-CacheManager.php#126-133" title="Go to source code">clear</a>( )
							...
							<div class="description short">
								<p>Invalidates all the cached data</p>
							</div>
...
<a href="source-class-CacheManager.php#135-146" title="Go to source code">save</a>( <span>mixed <var>$data</var></span>, <span>string <var>$module_name</var></span>, <span>string <var>$entry_name</var> = <span class="php-quote">''</span></span> )
							...
							<div class="description short">
								<p>Caches the data corresponding to the given identifier</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Caches the data corresponding to the given identifier</p>
								...
								<div class="list"><dl>
									<dt><var>$data</var></dt>
									<dd>The data to cache</dd>
									<dt><var>$module_name</var></dt>
									<dd>Name of the module owning the entry to save</dd>
									<dt><var>$entry_name</var></dt>
									<dd>Name of the entry to save</dd>
								</dl></div>
