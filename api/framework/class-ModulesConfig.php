		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-ModulesConfig.php" class="cssmenu-title">ModulesConfig</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>ModulesConfig</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-PHPBoost.php">PHPBoost</a>\<a href="package-PHPBoost.Config.php">Config</a></span>
						...
						<span class="infos-options">
							<b>Version:</b>
							PHPBoost 5.2 - last update: 2016 06 21
						</span>
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 3.0 - 2009 12 12
						</span>
						<span class="infos-options">
							<b>Contributor:</b>
			...
			<div class="description">
				<p>This class contains the cache data of the modules which module users having common criteria.</p>
			</div>
...
<a href="source-class-ModulesConfig.php#19-27" title="Go to source code">get_default_values</a>( )
			...
			<tr data-order="get_modules" id="_get_modules">
...
<a href="source-class-ModulesConfig.php#29-36" title="Go to source code">get_modules</a>( )
							...
							<div class="description short">
								<p>Returns the list of the modules</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Returns the list of the modules</p>
								...
								<h6>Returns</h6>
								<div class="list">
									array<br>id_module => module properties (map)
								</div>
...
<a href="source-class-ModulesConfig.php#38-47" title="Go to source code">get_module</a>( <span> <var>$module_id</var></span> )
			...
			<tr data-order="set_modules" id="_set_modules">
...
<a href="source-class-ModulesConfig.php#49-56" title="Go to source code">set_modules</a>( <span>array <var>$modules</var></span> )
						...
						<div class="description detailed hidden">
							<p>Sets the modules list</p>
								...
								<div class="list"><dl>
									...
									<dd>$modules_list The modules list</dd>
								</dl></div>
			...
			<tr data-order="add_module" id="_add_module">
...
<a href="source-class-ModulesConfig.php#58-67" title="Go to source code">add_module</a>( <span><code><a href="class-Module.php">Module</a></code> <var>$module</var></span> )
						...
						<div class="description detailed hidden">
							<p>Install a new module</p>
								...
								<div class="list"><dl>
									...
									<dd>$modules The module to add (~ install)</dd>
								</dl></div>
			...
			<tr data-order="remove_module" id="_remove_module">
...
<a href="source-class-ModulesConfig.php#69-74" title="Go to source code">remove_module</a>( <span><code><a href="class-Module.php">Module</a></code> <var>$module</var></span> )
			...
			<tr data-order="remove_module_by_id" id="_remove_module_by_id">
			...
			<tr data-order="load" id="_load">
				...
				<td class="attributes">
					<code>
						...
						<code><a href="class-ModulesConfig.php">ModulesConfig</a></code>
...
<a href="source-class-ModulesConfig.php#91-98" title="Go to source code">load</a>( )
							...
							<div class="description short">
								<p>Loads and returns the modules cached data.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Loads and returns the modules cached data.</p>
								...
								<h6>Returns</h6>
								<div class="list">
									<code><a href="class-ModulesConfig.php">ModulesConfig</a></code><br>The cached data
								</div>
...
<a href="source-class-ModulesConfig.php#100-106" title="Go to source code">save</a>( )
							...
							<div class="description short">
								<p>Invalidates the current modules cached data.</p>
							</div>
