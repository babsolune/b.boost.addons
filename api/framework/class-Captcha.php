<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-Captcha.php" class="cssmenu-title">Captcha</a></li>
...
<a href="source-class-Captcha.php#22" title="Go to source code">get_name</a>( )
			...
			<tr data-order="is_available" id="_is_available">
...
<a href="source-class-Captcha.php#35-38" title="Go to source code">is_visible</a>( )
			...
			<tr data-order="display_config_form_fields" id="_display_config_form_fields">
...
<a href="source-class-Captcha.php#40-43" title="Go to source code">display_config_form_fields</a>( <span><code><a href="class-FormFieldset.php">FormFieldset</a></code> <var>$fieldset</var></span> )
			...
			<tr data-order="save_config" id="_save_config">
...
<a href="source-class-Captcha.php#45-48" title="Go to source code">save_config</a>( <span><code><a href="class-HTMLForm.php">HTMLForm</a></code> <var>$form</var></span> )
			...
			<tr data-order="get_css_stylesheet" id="_get_css_stylesheet">
					...
					<tr data-order="EXTENSION_POINT" id="EXTENSION_POINT">
						...
						<td class="value">
							<div>
								...
								<code><span class="php-quote">'captcha'</span></code>
							</div>
						</td>
					</tr>
				</table>
