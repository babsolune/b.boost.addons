		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-PDOQuerierException.php" class="cssmenu-title">PDOQuerierException</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>PDOQuerierException</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.DB.php">DB</a>\<a href="package-IO.DB.driver.php">driver</a>\<a href="package-IO.DB.driver.pdo.php">pdo</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-PDOQuerierException.php#3-25" title="Go to source code">io/db/driver/pdo/PDOQuerierException.class.php</a></span>
			</div>
...
<span>Throwable</span>
				...
				<dd style="padding-left:60px">
					<img src="resources/inherit.png" alt="Extended by">
<b><span>PDOQuerierException</span></b>					
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-PDOQuerierException.php#15-24" title="Go to source code">__construct</a>( <span> <var>$message</var></span>, <span>PDOStatement <var>$statement</var></span> )
						</code>
