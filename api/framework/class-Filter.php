		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-Filter.php" class="cssmenu-title">Filter</a></li>
	...
	<article>
		...
		<div class="content">
			...
			<div class="description">
				<p>This class represents an abstract filter</p>
			</div>
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-MenuStringFilter.php">MenuStringFilter</a>
			</div>
...
<a href="source-class-Filter.php#19-26" title="Go to source code">__construct</a>( <span>string <var>$pattern</var></span> )
			...
			<tr data-order="get_pattern" id="_get_pattern">
