		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-FormFieldMultipleCheckboxOption.php" class="cssmenu-title">FormFieldMultipleCheckboxOption</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FormFieldMultipleCheckboxOption</h2></header>
		<div class="content">
			...
			<div>
				<h6>Direct known subclasses</h6>
					<a href="class-FormFieldMultipleValuedCheckboxOption.php">FormFieldMultipleValuedCheckboxOption</a>
			</div>
