		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-EditCommentBuildForm.php" class="cssmenu-title">EditCommentBuildForm</a></li>
				</ul>
						</nav>
					</div>
					<div class="module-mini-bottom"></div>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>EditCommentBuildForm</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Content.php">Content</a>\<a href="package-Content.Comments.php">Comments</a>\<a href="package-Content.Comments.form.php">form</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-EditCommentBuildForm.php#3-87" title="Go to source code">content/comments/form/EditCommentBuildForm.class.php</a></span>
			</div>


			<dl class="tree">
				<dd style="padding-left:0px">
					<a href="class-AbstractCommentsBuildForm.php"><span>AbstractCommentsBuildForm</span></a>
...
<b><span>EditCommentBuildForm</span></b>					
			...
			<tr data-order="create" id="_create">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-EditCommentBuildForm.php#23-35" title="Go to source code">create</a>( <span> <var>$id_comment</var></span>, <span> <var>$topic_path</var></span> )
						</code>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-EditCommentBuildForm.php#37-45" title="Go to source code">__construct</a>( <span> <var>$id_comment</var></span>, <span> <var>$topic_path</var></span> )
						</code>
			...
			<tr data-order="create_form" id="_create_form">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-EditCommentBuildForm.php#47-66" title="Go to source code">create_form</a>( )
						</code>
			...
			<tr data-order="handle_submit" id="_handle_submit">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-EditCommentBuildForm.php#68-73" title="Go to source code">handle_submit</a>( )
						</code>
			...
			<div class="responsive-table">
				<table class="summary inherited">
					<caption>Methods inherited from <a href="class-AbstractCommentsBuildForm.php#methods">AbstractCommentsBuildForm</a></caption>
					<tr>
						<td>
							<code>
									<a href="class-AbstractCommentsBuildForm.php#_display">display()</a>, 
									<a href="class-AbstractCommentsBuildForm.php#_get_form">get_form()</a>, 
									<a href="class-AbstractCommentsBuildForm.php#_has_been_submited">has_been_submited()</a>, 
									<a href="class-AbstractCommentsBuildForm.php#_set_form">set_form()</a>, 
									<a href="class-AbstractCommentsBuildForm.php#_set_submit_button">set_submit_button()</a>
							</code>
						</td>
					</tr>
				</table>
