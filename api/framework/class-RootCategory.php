		...
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					...
					<li class="active"><a href="class-RootCategory.php" class="cssmenu-title">RootCategory</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>RootCategory</h2></header>
		<div class="content">
...
<a href="source-class-RootCategory.php#16-23" title="Go to source code">__construct</a>( )
			...
			<tr data-order="get_authorizations_settings" id="_get_authorizations_settings">
...
<a href="source-class-RootCategory.php#25-39" title="Go to source code">get_authorizations_settings</a>( )
						...
						<div class="description detailed hidden">
								...
								<h6>Returns</h6>
								<div class="list">
									mixed[]<br>Array of ActionAuthorization for AuthorizationsSettings
								</div>
					...
					<tr>
						<td>
							<code>
									...
									<a href="class-Category.php#_create_categories_table">create_categories_table()</a>, 
									...
									<a href="class-Category.php#_get_properties">get_properties()</a>, 
									...
									<a href="class-Category.php#_set_properties">set_properties()</a>, 
