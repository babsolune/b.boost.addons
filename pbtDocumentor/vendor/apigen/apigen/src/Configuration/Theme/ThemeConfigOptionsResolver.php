...
class ThemeConfigOptionsResolver extends Nette\Object
{
	...
	private $defaults = [
		...
		TCO::TEMPLATES => [
			...
			TCO::PACKAGE => [
				'filename' => 'package-%s.php',
				'template' => 'package.latte'
			],
			TCO::T_NAMESPACE => [
				'filename' => 'namespace-%s.php',
				'template' => 'namespace.latte'
			],
			TCO::T_CLASS => [
				'filename' => 'class-%s.php',
				'template' => 'class.latte'
			],
			TCO::T_CONSTANT => [
				'filename' => 'constant-%s.php',
				'template' => 'constant.latte'
			],
			TCO::T_FUNCTION => [
				'filename' => 'function-%s.php',
				'template' => 'function.latte'
			],
			TCO::ANNOTATION_GROUP => [
				'filename' => 'annotation-group-%s.php',
				'template' => 'annotation-group.latte'
			],
			TCO::SOURCE => [
				'filename' => 'source-%s.php',
